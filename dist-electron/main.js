import Bt, { app as Mt, BrowserWindow as Qc, ipcMain as st, shell as Zc } from "electron";
...
var Ma = { exports: {} }, kn = _d, ar = kn.Buffer, Be = {}, Me;
for (Me in kn)
  kn.hasOwnProperty(Me) && (Me === "SlowBuffer" || Me === "Buffer" || (Be[Me] = kn[Me]));
var or = Be.Buffer = {};
for (Me in ar)
  ar.hasOwnProperty(Me) && (Me === "allocUnsafe" || Me === "allocUnsafeSlow" || (or[Me] = ar[Me]));
Be.Buffer.prototype = ar.prototype;
...
qa.prototype.write = function(e) {
  return this.addBOM && (e = il + e, this.addBOM = !1), this.encoder.write(e);
};
...
Ha.prototype.write = function(e) {
  ...
  return this.pass || !t || (t[0] === il && (t = t.slice(1), typeof this.options.stripBOM == "function" && this.options.stripBOM()), this.pass = !0), t;
};
...
var dt = Ad, zd = process.cwd, Bn = null, Xd = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return Bn || (Bn = zd.call(process)), Bn;
};
try {
  process.cwd();
} catch {
...
if (typeof process.chdir == "function") {
  ...
  process.chdir = function(e) {
    Bn = null, ns.call(process, e);
  }, Object.setPrototypeOf && Object.setPrototypeOf(process.chdir, ns);
}
var Kd = Jd;
function Jd(e) {
  dt.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = o(e.chownSync), e.fchownSync = o(e.fchownSync), e.lchownSync = o(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = s(e.stat), e.fstat = s(e.fstat), e.lstat = s(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(c, u, d) {
  ...
  function t(c) {
    c.lchmod = function(u, d, h) {
      ...
      var h = c.openSync(u, dt.O_WRONLY | dt.O_SYMLINK, d), y = !0, m;
      try {
  ...
  function r(c) {
    dt.hasOwnProperty("O_SYMLINK") && c.futimes ? (c.lutimes = function(u, d, h, y) {
      c.open(u, dt.O_SYMLINK, function(m, E) {
        if (m) {
          y && y(m);
          return;
        }
      ...
      var y = c.openSync(u, dt.O_SYMLINK), m, E = !0;
      try {
...
var ie = et, nh = Kd, ih = Qd, ah = eh, bn = Ba, ye, Hn;
...
var Ut = oh;
bn.debuglog ? Ut = bn.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (Ut = function() {
...
if (!ie[ye]) {
  ...
  ol(ie, sh), ie.close = function(e) {
    ...
    Ut(ie[ye]), el.equal(ie[ye].length, 0);
  });
}
Ce[ye] || ol(Ce, ie[ye]);
var Oe = Ga(ah(ie));
...
function Ga(e) {
  ...
  function r(w, M, q) {
    ...
    function H(J, D, R, N) {
      return t(J, D, function(I) {
        I && (I.code === "EMFILE" || I.code === "ENFILE") ? Yt([H, [J, D, R], I, N || Date.now(), Date.now()]) : typeof R == "function" && R.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  ...
  function i(w, M, q, H) {
    ...
    function J(D, R, N, I, F) {
      return n(D, R, N, function(P) {
        P && (P.code === "EMFILE" || P.code === "ENFILE") ? Yt([J, [D, R, N, I], P, F || Date.now(), Date.now()]) : typeof I == "function" && I.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  function u(w, M, q) {
    ...
    function J(D, R, N, I) {
      return function(F, P) {
        F && (F.code === "EMFILE" || F.code === "ENFILE") ? Yt([
          H,
          [D, R, N],
          F,
          I || Date.now(),
...
function Yt(e) {
  Ut("ENQUEUE", e[0].name, e[1]), ie[ye].push(e), Wa();
}
var _n;
function as() {
...
function Wa() {
  if (clearTimeout(_n), _n = void 0, ie[ye].length !== 0) {
    var e = ie[ye].shift(), t = e[0], r = e[1], n = e[2], i = e[3], a = e[4];
    if (i === void 0)
      ...
      s >= f ? (Ut("RETRY", t.name, r), t.apply(null, r.concat([i]))) : ie[ye].push(e);
    }
    _n === void 0 && (_n = setTimeout(Wa, 0));
  }
}
(function(e) {
...
const cl = qt, { checkPath: ll } = sl, ul = (e) => {
  const t = { mode: 511 };
  return typeof e == "number" ? e : { ...t, ...e }.mode;
};
Va.makeDir = async (e, t) => (ll(e), cl.mkdir(e, {
  mode: ul(t),
  recursive: !0
}));
Va.makeDirSync = (e, t) => (ll(e), cl.mkdirSync(e, {
  mode: ul(t),
  recursive: !0
}));
...
const fh = Re.fromPromise, fl = qt;
function dh(e) {
  return fl.access(e).then(() => !0).catch(() => !1);
}
var Ht = {
  pathExists: fh(dh),
  pathExistsSync: fl.existsSync
};
const sr = Oe;
function hh(e, t, r, n) {
  sr.open(e, "r+", (i, a) => {
...
function hl(e, t, r, n, i) {
  ...
  lr.stat(o, { bigint: !0 }, (s, l) => s ? s.code === "ENOENT" ? i() : i(s) : Qr(t, l) ? i(new Error(ni(e, r, n))) : hl(e, t, o, n, i));
}
function pl(e, t, r, n) {
...
const Ne = Oe, $r = ae, wh = tt.mkdirs, bh = Ht.pathExists, _h = dl.utimesMillis, Fr = hr;
function Sh(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    Fr.checkParentPaths(e, o, t, "copy", (l) => l ? n(l) : r.filter ? ml(os, s, e, t, r, n) : os(s, e, t, r, n));
  });
}
function os(e, t, r, n, i) {
  ...
  bh(a, (o, s) => {
    if (o) return i(o);
    if (s) return Gn(e, t, r, n, i);
    wh(a, (l) => l ? i(l) : Gn(e, t, r, n, i));
  });
}
...
function Ah(e, t, r, n, i) {
  return n.filter ? ml(Gn, e, t, r, n, i) : Gn(e, t, r, n, i);
}
...
function Th(e, t, r, n, i, a) {
  return t ? Ch(e, r, n, i, a) : gl(e, r, n, i, a);
}
function Ch(e, t, r, n, i) {
  if (n.overwrite)
    Ne.unlink(r, (a) => a ? i(a) : gl(e, t, r, n, i));
...
function Dh(e, t, r, n, i, a) {
  return t ? vl(r, n, i, a) : Ph(e.mode, r, n, i, a);
}
function Ph(e, t, r, n, i) {
  Ne.mkdir(r, (a) => {
    if (a) return i(a);
    vl(t, r, n, (o) => o ? i(o) : ii(r, e, i));
  });
}
function vl(e, t, r, n) {
  Ne.readdir(e, (i, a) => i ? n(i) : yl(a, e, t, r, n));
}
...
function Nh(e, t, r, n, i, a) {
  ...
  Fr.checkPaths(o, s, "copy", i, (l, f) => {
    if (l) return a(l);
    const { destStat: c } = f;
    Ah(c, o, s, i, (u) => u ? a(u) : yl(e, r, n, i, a));
  });
}
...
var Lh = Sh;
const _e = Oe, Lr = ae, Uh = tt.mkdirsSync, kh = dl.utimesMillisSync, Ur = hr;
function Bh(e, t, r) {
...
function Mh(e, t, r, n) {
  ...
  return _e.existsSync(i) || Uh(i), El(e, t, r, n);
}
function jh(e, t, r, n) {
...
function El(e, t, r, n) {
  const a = (n.dereference ? _e.statSync : _e.lstatSync)(t);
...
function qh(e, t, r, n, i) {
  return t ? Hh(e, r, n, i) : wl(e, r, n, i);
}
function Hh(e, t, r, n) {
  if (n.overwrite)
    return _e.unlinkSync(r), wl(e, t, r, n);
  if (n.errorOnExist)
    throw new Error(`'${r}' already exists`);
}
function wl(e, t, r, n) {
  return _e.copyFileSync(t, r), n.preserveTimestamps && Gh(e.mode, t, r), za(r, e.mode);
}
function Gh(e, t, r) {
...
function zh(e, t, r, n, i) {
  return t ? bl(r, n, i) : Xh(e.mode, r, n, i);
}
function Xh(e, t, r, n) {
  return _e.mkdirSync(r), bl(t, r, n), za(r, e);
}
function bl(e, t, r) {
  _e.readdirSync(e).forEach((n) => Kh(n, e, t, r));
}
function Kh(e, t, r, n) {
...
function Jh(e, t, r, n) {
  ...
  if (n.dereference && (i = Lr.resolve(process.cwd(), i)), e) {
    ...
    try {
      ...
      if (o.code === "EINVAL" || o.code === "UNKNOWN") return _e.symlinkSync(i, r);
      throw o;
    }
    ...
    if (_e.statSync(r).isDirectory() && Ur.isSrcSubdir(a, i))
...
const cs = Oe, _l = ae, Z = el, kr = process.platform === "win32";
function Sl(e) {
  [
    "unlink",
    "chmod",
...
function Ka(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), Z(e, "rimraf: missing path"), Z.strictEqual(typeof e, "string", "rimraf: path should be a string"), Z.strictEqual(typeof r, "function", "rimraf: callback function required"), Z(t, "rimraf: invalid options argument provided"), Z.strictEqual(typeof t, "object", "rimraf: options should be object"), Sl(t), ls(e, t, function i(a) {
    if (a) {
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return kr ? us(e, t, a, r) : Mn(e, t, a, r);
        if (a.code === "EISDIR")
          return Mn(e, t, a, r);
      }
      return r(a);
...
function us(e, t, r, n) {
  Z(e), Z(t), Z(typeof n == "function"), t.chmod(e, 438, (i) => {
    i ? n(i.code === "ENOENT" ? null : r) : t.stat(e, (a, o) => {
      a ? n(a.code === "ENOENT" ? null : r) : o.isDirectory() ? Mn(e, t, r, n) : t.unlink(e, n);
    });
  });
}
function fs(e, t, r) {
  ...
  n.isDirectory() ? jn(e, t, r) : t.unlinkSync(e);
}
function Mn(e, t, r, n) {
...
function Al(e, t) {
  ...
  try {
    r && r.isDirectory() ? jn(e, t, null) : t.unlinkSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
      return;
    if (n.code === "EPERM")
      return kr ? fs(e, t, n) : jn(e, t, n);
    if (n.code !== "EISDIR")
      throw n;
    jn(e, t, n);
  }
...
function r0(e, t) {
  if (Z(e), Z(t), t.readdirSync(e).forEach((r) => Al(_l.join(e, r), t)), kr) {
    const r = Date.now();
    do
      try {
...
var n0 = Ka;
Ka.sync = Al;
const Wn = Oe, i0 = Re.fromCallback, Tl = n0;
function a0(e, t) {
...
const s0 = Re.fromPromise, Cl = qt, xl = ae, Il = tt, Rl = ai, ds = s0(async function(t) {
  let r;
  try {
    r = await Cl.readdir(t);
  } catch {
    return Il.mkdirs(t);
  }
  return Promise.all(r.map((n) => Rl.remove(xl.join(t, n))));
});
function hs(e) {
  let t;
  try {
...
const l0 = Re.fromCallback, Ol = ae, mt = Oe, Dl = tt;
function u0(e, t) {
  function r() {
    mt.writeFile(e, "", (n) => {
      if (n) return t(n);
  ...
  mt.stat(e, (n, i) => {
    ...
    const a = Ol.dirname(e);
    mt.stat(a, (o, s) => {
      if (o)
        return o.code === "ENOENT" ? Dl.mkdirs(a, (l) => {
          if (l) return t(l);
          r();
        }) : t(o);
...
const h0 = Re.fromCallback, Pl = ae, pt = Oe, Nl = tt, p0 = Ht.pathExists, { areIdentical: $l } = hr;
function m0(e, t, r) {
  function n(i, a) {
    pt.link(i, a, (o) => {
      if (o) return r(o);
  ...
  pt.lstat(t, (i, a) => {
    pt.lstat(e, (o, s) => {
      ...
      if (a && $l(s, a)) return r(null);
      const l = Pl.dirname(t);
      p0(l, (f, c) => {
        if (f) return r(f);
        if (c) return n(e, t);
        Nl.mkdirs(l, (u) => {
...
function g0(e, t) {
  ...
  const n = Pl.dirname(t);
  return pt.existsSync(n) || Nl.mkdirsSync(n), pt.linkSync(e, t);
}
var v0 = {
  createLink: h0(m0),
  createLinkSync: g0
};
const gt = ae, Or = Oe, y0 = Ht.pathExists;
function E0(e, t, r) {
  if (gt.isAbsolute(e))
...
const T0 = Re.fromCallback, Ll = ae, We = qt, Ul = tt, C0 = Ul.mkdirs, x0 = Ul.mkdirsSync, kl = b0, I0 = kl.symlinkPaths, R0 = kl.symlinkPathsSync, Bl = A0, O0 = Bl.symlinkType, D0 = Bl.symlinkTypeSync, P0 = Ht.pathExists, { areIdentical: Ml } = hr;
function N0(e, t, r, n) {
...
const oi = Re, { stringify: jl, stripBom: ql } = Ja;
...
const Y0 = Re.fromCallback, Dr = Oe, Hl = ae, Gl = tt, z0 = Ht.pathExists;
function X0(e, t, r, n) {
  typeof r == "function" && (n = r, r = "utf8");
  const i = Hl.dirname(e);
  z0(i, (a, o) => {
    if (a) return n(a);
...
function K0(e, ...t) {
  const r = Hl.dirname(e);
  if (Dr.existsSync(r))
    return Dr.writeFileSync(e, ...t);
  Gl.mkdirsSync(r), Dr.writeFileSync(e, ...t);
}
var Qa = {
  outputFile: Y0(X0),
  outputFileSync: K0
...
var op = Ie;
const sp = Oe, _a = ae, cp = Xa.copy, Wl = ai.remove, lp = tt.mkdirp, up = Ht.pathExists, bs = hr;
function fp(e, t, r, n) {
...
function _s(e, t, r, n, i) {
  ...
  if (r)
    return Wl(t, (a) => a ? i(a) : Gi(e, t, r, i));
...
var pp = fp;
const Vl = Oe, Sa = ae, mp = Xa.copySync, Yl = ai.removeSync, gp = tt.mkdirpSync, Ss = hr;
function vp(e, t, r) {
  r = r || {};
...
Et.CancellationToken = Tp;
class Aa extends Error {
  constructor() {
    super("cancelled");
  }
}
Et.CancellationError = Aa;
var pr = {};
...
var xe = {}, Ta = { exports: {} }, An = { exports: {} }, Vi, As;
function xp() {
  if (As) return Vi;
  As = 1;
...
function Op() {
  if (Is) return Xi;
  Is = 1;
  const e = ri, t = rl, r = Rp(), { env: n } = process;
  let i;
...
Zr.ProgressCallbackTransform = $p;
Object.defineProperty(xe, "__esModule", { value: !0 });
xe.DigestTransform = xe.HttpExecutor = xe.HttpError = void 0;
xe.createHttpError = xa;
xe.parseJson = qp;
xe.configureRequestOptionsFromUrl = Kl;
xe.configureRequestUrl = eo;
xe.safeGetHeader = cr;
xe.configureRequestOptions = Vn;
xe.safeStringifyJson = Yn;
const Fp = Jr, Lp = Pp, Up = et, kp = Kr, Ca = St, Bp = Et, Os = pr, Mp = Zr, Pt = (0, Lp.default)("electron-builder");
function xa(e, t = null) {
  return new Za(e.statusCode || -1, `${e.statusCode} ${e.statusMessage}` + (t == null ? "" : `
` + JSON.stringify(t, null, "  ")) + `
Headers: ` + Yn(e.headers), t);
}
...
class Zt {
  ...
  doApiRequest(t, r, n, i = 0) {
    return Pt.enabled && Pt(`Request: ${Yn(t)}`), r.createPromise((a, o, s) => {
  ...
  handleResponse(t, r, n, i, a, o, s) {
    var l;
    if (Pt.enabled && Pt(`Response: ${t.statusCode} ${t.statusMessage}, request options: ${Yn(r)}`), t.statusCode === 404) {
...
`));
    ...
    const f = (l = t.statusCode) !== null && l !== void 0 ? l : 0, c = f >= 300 && f < 400, u = cr(t, "location");
    if (c && u != null) {
      if (o > this.maxRedirects) {
        a(this.createMaxRedirectError());
        return;
      }
      this.doApiRequest(Zt.prepareRedirectUrlOptions(u, r), n, s, o).then(i).catch(a);
      return;
    }
    t.setEncoding("utf8");
    let d = "";
    t.on("error", a), t.on("data", (h) => d += h), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const h = cr(t, "content-type"), y = h != null && (Array.isArray(h) ? h.find((m) => m.includes("json")) != null : h.includes("json"));
          a(xa(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
  ...
  doDownload(t, r, n) {
    const i = this.createRequest(t, (a) => {
      ...
      const o = cr(a, "location");
      if (o != null) {
        n < this.maxRedirects ? this.doDownload(Zt.prepareRedirectUrlOptions(o, t), r, n++) : r.callback(this.createMaxRedirectError());
        return;
      }
  ...
  static prepareRedirectUrlOptions(t, r) {
    const n = Kl(t, { ...r }), i = n.headers;
    if (i != null && i.authorization) {
      const a = Zt.reconstructOriginalUrl(r), o = Xl(t, r);
      Zt.isCrossOriginRedirect(a, o) && (Pt.enabled && Pt(`Given the cross-origin redirect (from ${a.host} to ${o.host}), the Authorization header will be stripped out.`), delete i.authorization);
    }
    return n;
  }
...
function Gp(e, t) {
  if (!Hp(cr(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  if (e.options.onProgress != null) {
    const o = cr(t, "content-length");
...
class Wp {
  ...
  get value() {
    ...
    if (this._value !== void 0 && Jl(this.selected, t))
      return this._value;
    this.selected = t;
...
function Jl(e, t) {
  if (typeof e == "object" && e !== null && (typeof t == "object" && t !== null)) {
    ...
    return i.length === a.length && i.every((o) => Jl(e[o], t[o]));
  }
  return e === t;
}
var en = {};
...
en.githubUrl = Vp;
en.githubTagPrefix = Yp;
en.getS3LikeProviderBaseUrl = zp;
...
function Kp(e) {
  ...
  return Ql(`https://${e.name}.${e.region}.digitaloceanspaces.com`, e.path);
}
var to = {};
...
async function Zl(e, t) {
  ...
  try {
    ...
    if (await Promise.resolve((r = s == null ? void 0 : s(f)) !== null && r !== void 0 ? r : !0) && n > 0 && !l.cancelled)
      return await new Promise((c) => setTimeout(c, i + a * o)), await Zl(e, { ...t, retries: n - 1, attempt: o + 1 });
    throw f;
  }
}
var ro = {};
...
const eu = Jr, tu = pr, Zp = "options.name must be either a string or a Buffer", Ds = (0, eu.randomBytes)(16);
Ds[0] = Ds[0] | 1;
const qn = {}, X = [];
for (let e = 0; e < 256; e++) {
...
class jt {
  ...
  static parse(t) {
    ...
    let n = 0;
    for (let i = 0; i < 16; i++)
      r[i] = qn[t[n++] + t[n++]], (i === 3 || i === 5 || i === 7 || i === 9) && (n += 1);
    return r;
  }
}
fr.UUID = jt;
...
function e1(e, t, r, n, i = Pr.ASCII) {
  const a = (0, eu.createHash)(t);
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, tu.newError)(Zp, "ERR_INVALID_UUID_NAME");
  ...
  switch (i) {
    case Pr.BINARY:
      ...
      break;
    case Pr.OBJECT:
      s[6] = s[6] & 15 | r, s[8] = s[8] & 63 | 128, l = new jt(s);
      break;
    default:
...
fr.nil = new jt("00000000-0000-0000-0000-000000000000");
var tn = {}, ru = {};
(function(e) {
  (function(t) {
...
Actual: ` + g.attribValue
    ...
    function z(g, p) {
      if (g.opt.xmlns) {
        ...
        x.ns && K.ns !== x.ns && Object.keys(x.ns).forEach(function(fn) {
          H(g, "onopennamespace", {
            prefix: fn,
            uri: x.ns[fn]
          });
        ...
        for (var ee = 0, oe = g.attribList.length; ee < oe; ee++) {
          var ge = g.attribList[ee], we = ge[0], ct = ge[1], ue = P(we, !0), je = ue.prefix, Ti = ue.local, un = je === "" ? "" : x.ns[je] || "", yr = {
            name: we,
            value: ct,
            prefix: je,
            local: Ti,
          ...
          ), yr.uri = je), g.tag.attributes[we] = yr, H(g, "onattribute", yr);
        }
    ...
    function V(g) {
      ...
      for (var ee = g.tags.length; ee-- > p; ) {
        ...
        for (var we in oe.ns)
          ge[we] = oe.ns[we];
        var ct = g.tags[g.tags.length - 1] || g;
        g.opt.xmlns && oe.ns !== ct.ns && Object.keys(oe.ns).forEach(function(ue) {
          var je = oe.ns[ue];
...
` ? (p.line++, p.column = 0) : p.column++);
          ...
          case w.ATTRIB_VALUE_ENTITY_U:
            ...
            switch (p.state) {
              case w.TEXT_ENTITY:
                oe = w.TEXT, ge = "textNode";
                break;
              case w.ATTRIB_VALUE_ENTITY_Q:
                oe = w.ATTRIB_VALUE_QUOTED, ge = "attribValue";
                break;
              case w.ATTRIB_VALUE_ENTITY_U:
                oe = w.ATTRIB_VALUE_UNQUOTED, ge = "attribValue";
                break;
            }
            if (A === ";") {
              var we = Q(p);
              p.opt.unparsedEntities && !Object.values(t.XML_ENTITIES).includes(we) ? (p.entity = "", p.state = oe, p.write(we)) : (p[ge] += we, p.entity = "", p.state = oe);
            } else W(p.entity.length ? C : b, A) ? p.entity += A : (I(p, "Invalid character in entity name"), p[ge] += "&" + p.entity + A, p.entity = "", p.state = oe);
            continue;
          default:
    ...
    String.fromCodePoint || function() {
      var g = String.fromCharCode, p = Math.floor, x = function() {
        var A = 16384, K = [], ee, oe, ge = -1, we = arguments.length;
        if (!we)
          return "";
        for (var ct = ""; ++ge < we; ) {
          ...
          ue <= 65535 ? K.push(ue) : (ue -= 65536, ee = (ue >> 10) + 55296, oe = ue % 1024 + 56320, K.push(ee, oe)), (ge + 1 === we || K.length > A) && (ct += g.apply(null, K), K.length = 0);
        }
        return ct;
      };
...
var ou = Ra, y1 = De, su = new y1("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), E1 = De, cu = new E1("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), w1 = De, lu = new w1("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var fu = new _1("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: S1,
  construct: A1,
  predicate: T1,
...
var du = new C1("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: x1,
  construct: I1,
  predicate: R1,
...
var hu = new D1("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: F1,
  construct: L1,
  predicate: U1,
...
var mu = new k1("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: M1,
  construct: j1,
  predicate: G1,
...
}), vu = gu, W1 = De, yu = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"
), Eu = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$"
);
function V1(e) {
  return e === null ? !1 : yu.exec(e) !== null || Eu.exec(e) !== null;
}
function Y1(e) {
  var t, r, n, i, a, o, s, l = 0, f = null, c, u, d;
  if (t = yu.exec(e), t === null && (t = Eu.exec(e)), t === null) throw new Error("Date resolve error");
...
var wu = new W1("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: V1,
  construct: Y1,
  instanceOf: Date,
...
var bu = new X1("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: K1
...
var _u = new J1("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Q1,
  construct: Z1,
  predicate: tm,
...
var Su = new rm("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: am,
  construct: om
...
var Au = new sm("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: lm,
  construct: um
...
var Tu = new fm("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: hm,
  construct: pm
}), ao = vu.extend({
...
}), Ft = Ve, Cu = rn, mm = d1, gm = ao, wt = Object.prototype.hasOwnProperty, zn = 1, xu = 2, Iu = 3, Xn = 4, Zi = 1, vm = 2, Ls = 3, ym = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Em = /[\x85\u2028\u2029]/, wm = /[,\[\]\{\}]/, Ru = /^(?:!|!!|![a-z\-]+!)$/i, Ou = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function Us(e) {
...
function $u(e, t) {
  ...
  return r.snippet = mm(r), new Cu(t, r);
}
function U(e, t) {
  throw $u(e, t);
}
function Kn(e, t) {
  e.onWarning && e.onWarning.call(null, $u(e, t));
}
var Bs = {
  YAML: function(t, r, n) {
    var i, a, o;
    t.version !== null && U(t, "duplication of %YAML directive"), n.length !== 1 && U(t, "YAML directive accepts exactly one argument"), i = /^([0-9]+)\.([0-9]+)$/.exec(n[0]), i === null && U(t, "ill-formed argument of the YAML directive"), a = parseInt(i[1], 10), o = parseInt(i[2], 10), a !== 1 && U(t, "unacceptable YAML version of the document"), t.version = n[0], t.checkLineBreaks = o < 2, o !== 1 && o !== 2 && Kn(t, "unsupported YAML version of the document");
  },
  TAG: function(t, r, n) {
    var i, a;
    n.length !== 2 && U(t, "TAG directive accepts exactly two arguments"), i = n[0], a = n[1], Ru.test(i) || U(t, "ill-formed tag handle (first argument) of the TAG directive"), wt.call(t.tagMap, i) && U(t, 'there is a previously declared suffix for "' + i + '" tag handle'), Ou.test(a) || U(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function Ms(e, t, r, n) {
  ...
  for (Ft.isObject(r) || U(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(r), o = 0, s = i.length; o < s; o += 1)
    a = i[o], wt.call(t, a) || (Du(t, a, r[a]), n[a] = !0);
}
function tr(e, t, r, n, i, a, o, s, l) {
  var f, c;
  if (Array.isArray(i))
  ...
  if (typeof i == "object" && Us(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    ...
    !e.json && !wt.call(r, i) && wt.call(t, i) && (e.line = o || e.line, e.lineStart = s || e.lineStart, e.position = l || e.position, U(e, "duplicated mapping key")), Du(t, i, a), delete r[i];
  return t;
}
function oo(e) {
  var t;
...
function Cm(e, t, r) {
  ...
  if (h = e.input.charCodeAt(e.position), $e(h) || er(h) || h === 35 || h === 38 || h === 42 || h === 33 || h === 124 || h === 62 || h === 39 || h === 34 || h === 37 || h === 64 || h === 96 || (h === 63 || h === 45) && (i = e.input.charCodeAt(e.position + 1), $e(i) || r && er(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = o = e.position, s = !1; h !== 0; ) {
    if (h === 58) {
      if (i = e.input.charCodeAt(e.position + 1), $e(i) || r && er(i))
        break;
    } else if (h === 35) {
      if (n = e.input.charCodeAt(e.position - 1), $e(n))
        break;
    } else {
      if (e.position === e.lineStart && ci(e) || r && er(h))
        break;
      if (Ze(h))
    ...
    s && (vt(e, a, o, !1), so(e, e.line - l), a = o = e.position, s = !1), kt(h) || (o = e.position + 1), h = e.input.charCodeAt(++e.position);
  }
  return vt(e, a, o, !1), e.result ? !0 : (e.kind = u, e.result = d, !1);
}
function xm(e, t) {
  var r, n, i;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (vt(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        n = e.position, e.position++, i = e.position;
      else
        return !0;
    else Ze(r) ? (vt(e, n, i, !0), so(e, ce(e, !1, t)), n = i = e.position) : e.position === e.lineStart && ci(e) ? U(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function Im(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (s = e.input.charCodeAt(e.position)) !== 0; ) {
    if (s === 34)
      return vt(e, r, e.position, !0), e.position++, !0;
    if (s === 92) {
      if (vt(e, r, e.position, !0), s = e.input.charCodeAt(++e.position), Ze(s))
        ce(e, !1, t);
      else if (s < 256 && Pu[s])
      ...
      r = n = e.position;
    } else Ze(s) ? (vt(e, r, n, !0), so(e, ce(e, !1, t)), r = n = e.position) : e.position === e.lineStart && ci(e) ? U(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function Rm(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = s), b = e.input.charCodeAt(++e.position); b !== 0; ) {
    ...
    r ? b === 44 && U(e, "expected the node content, but found ','") : U(e, "missed comma between flow collection entries"), E = m = _ = null, u = d = !1, b === 63 && (f = e.input.charCodeAt(e.position + 1), $e(f) && (u = d = !0, e.position++, ce(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, dr(e, t, zn, !1, !0), E = e.tag, m = e.result, ce(e, !0, t), b = e.input.charCodeAt(e.position), (d || e.line === n) && b === 58 && (u = !0, b = e.input.charCodeAt(++e.position), ce(e, !0, t), dr(e, t, zn, !1, !0), _ = e.result), h ? tr(e, s, y, E, m, _, n, i, a) : u ? s.push(tr(e, null, y, E, m, _, n, i, a)) : s.push(m), ce(e, !0, t), b = e.input.charCodeAt(e.position), b === 44 ? (r = !0, b = e.input.charCodeAt(++e.position)) : r = !1;
  }
...
function js(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, U(e, "tab characters must not be used in indentation")), !(l !== 45 || (o = e.input.charCodeAt(e.position + 1), !$e(o)))); ) {
    ...
    if (r = e.line, dr(e, t, Iu, !1, !0), a.push(e.result), ce(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
function Dm(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = u), b = e.input.charCodeAt(e.position); b !== 0; ) {
    if (!E && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, U(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (b === 63 || b === 58) && $e(n))
      b === 63 ? (E && (tr(e, u, d, h, y, null, o, s, l), h = y = m = null), _ = !0, E = !0, i = !0) : E ? (E = !1, i = !0) : U(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, b = n;
    else {
      if (o = e.line, s = e.lineStart, l = e.position, !dr(e, r, xu, !1, !0))
        break;
      if (e.line === a) {
        for (b = e.input.charCodeAt(e.position); kt(b); )
          b = e.input.charCodeAt(++e.position);
        if (b === 58)
          b = e.input.charCodeAt(++e.position), $e(b) || U(e, "a whitespace character is expected after the key-value separator within a block mapping"), E && (tr(e, u, d, h, y, null, o, s, l), h = y = m = null), _ = !0, E = !1, i = !1, h = e.tag, y = e.result;
        else if (_)
    ...
    if ((e.line === a || e.lineIndent > t) && (E && (o = e.line, s = e.lineStart, l = e.position), dr(e, t, Xn, !0, i) && (E ? y = e.result : m = e.result), E || (tr(e, u, d, h, y, m, o, s, l), h = y = m = null), ce(e, !0, -1), b = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && b !== 0)
      U(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return E && tr(e, u, d, h, y, null, o, s, l), _ && (e.tag = f, e.anchor = c, e.kind = "mapping", e.result = u), _;
}
function Pm(e) {
  var t, r = !1, n = !1, i, a, o;
  ...
  if (e.tag !== null && U(e, "duplication of a tag property"), o = e.input.charCodeAt(++e.position), o === 60 ? (r = !0, o = e.input.charCodeAt(++e.position)) : o === 33 ? (n = !0, i = "!!", o = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, r) {
    ...
    for (; o !== 0 && !$e(o); )
      o === 33 && (n ? U(e, "tag suffix cannot contain exclamation marks") : (i = e.input.slice(t - 1, e.position + 1), Ru.test(i) || U(e, "named tag handle cannot contain such characters"), n = !0, t = e.position + 1)), o = e.input.charCodeAt(++e.position);
    a = e.input.slice(t, e.position), wm.test(a) && U(e, "tag suffix cannot contain flow indicator characters");
  }
  a && !Ou.test(a) && U(e, "tag name cannot contain such characters: " + a);
  try {
    a = decodeURIComponent(a);
  } catch {
    U(e, "tag name is malformed: " + a);
  }
  return r ? e.tag = a : wt.call(e.tagMap, i) ? e.tag = e.tagMap[i] + a : i === "!" ? e.tag = "!" + a : i === "!!" ? e.tag = "tag:yaml.org,2002:" + a : U(e, 'undeclared tag handle "' + i + '"'), !0;
}
function Nm(e) {
  var t, r;
  if (r = e.input.charCodeAt(e.position), r !== 38) return !1;
  for (e.anchor !== null && U(e, "duplication of an anchor property"), r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !$e(r) && !er(r); )
...
function $m(e) {
  ...
  for (n = e.input.charCodeAt(++e.position), t = e.position; n !== 0 && !$e(n) && !er(n); )
    n = e.input.charCodeAt(++e.position);
  return e.position === t && U(e, "name of an alias node must contain at least one character"), r = e.input.slice(t, e.position), wt.call(e.anchorMap, r) || U(e, 'unidentified alias "' + r + '"'), e.result = e.anchorMap[r], ce(e, !0, -1), !0;
}
function dr(e, t, r, n, i) {
  var a, o, s, l = 1, f = !1, c = !1, u, d, h, y, m, E;
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = o = s = Xn === r || Iu === r, n && ce(e, !0, -1) && (f = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; Pm(e) || Nm(e); )
      ce(e, !0, -1) ? (f = !0, s = a, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : s = !1;
  if (s && (s = f || i), (l === 1 || Xn === r) && (zn === r || xu === r ? m = t : m = t + 1, E = e.position - e.lineStart, l === 1 ? s && (js(e, E) || Dm(e, E, m)) || Rm(e, m) ? c = !0 : (o && Om(e, m) || xm(e, m) || Im(e, m) ? c = !0 : $m(e) ? (c = !0, (e.tag !== null || e.anchor !== null) && U(e, "alias node should not have any properties")) : Cm(e, m, zn === r) && (c = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (c = s && js(e, E))), e.tag === null)
...
function Fm(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (o = e.input.charCodeAt(e.position)) !== 0 && (ce(e, !0, -1), o = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || o !== 37)); ) {
    ...
    o !== 0 && oo(e), wt.call(Bs, n) ? Bs[n](e, n, i) : Kn(e, 'unknown document directive "' + n + '"');
  }
  if (ce(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, ce(e, !0, -1)) : a && U(e, "directives end mark is expected"), dr(e, e.lineIndent - 1, Xn, !1, !0), ce(e, !0, -1), e.checkLineBreaks && Em.test(e.input.slice(t, e.position)) && Kn(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && ci(e)) {
...
no.loadAll = Lm;
no.load = Um;
var Lu = {}, li = Ve, nn = rn, km = ao, Uu = Object.prototype.toString, ku = Object.prototype.hasOwnProperty, co = 65279, Bm = 9, Mr = 10, Mm = 13, jm = 32, qm = 33, Hm = 34, Oa = 35, Gm = 37, Wm = 38, Vm = 39, Ym = 42, Bu = 44, zm = 45, Jn = 58, Xm = 61, Km = 62, Jm = 63, Qm = 64, Mu = 91, ju = 93, Zm = 96, qu = 123, eg = 124, Hu = 125, Se = {};
Se[0] = "\\0";
Se[7] = "\\a";
Se[8] = "\\b";
Se[9] = "\\t";
...
function ng(e, t) {
  ...
  for (r = {}, n = Object.keys(t), i = 0, a = n.length; i < a; i += 1)
    o = n[i], s = String(t[o]), o.slice(0, 2) === "!!" && (o = "tag:yaml.org,2002:" + o.slice(2)), l = e.compiledTypeMap.fallback[o], l && ku.call(l.styleAliases, s) && (s = l.styleAliases[s]), r[o] = s;
  return r;
}
function ig(e) {
  var t, r, n;
...
function Gs(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== Bu && e !== Mu && e !== ju && e !== qu && e !== Hu) && e !== Oa && !(t === Jn && !i) || Hs(t) && !Qn(t) && e === Oa || t === Jn && i
  );
}
function cg(e) {
  return qr(e) && e !== co && !Qn(e) && e !== zm && e !== Jm && e !== Jn && e !== Bu && e !== Mu && e !== ju && e !== qu && e !== Hu && e !== Oa && e !== Wm && e !== Ym && e !== qm && e !== eg && e !== Xm && e !== Km && e !== Vm && e !== Hm && e !== Gm && e !== Qm && e !== Zm;
}
function lg(e) {
  return !Qn(e) && e !== Jn;
}
...
function ug(e, t, r, n, i, a, o, s) {
  ...
  return !u && !d ? m && !o && !i(e) ? Wu : a === jr ? Qt : Pa : r > 9 && Gu(e) ? Qt : o ? a === jr ? Qt : Pa : d ? Yu : Vu;
}
...
function hg(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Rr(e, i), n = Se[r], !n && qr(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || ig(r);
  return t;
}
function pg(e, t, r) {
  var n = "", i = e.tag, a, o, s;
...
Ee.Type = De;
Ee.Schema = ou;
Ee.FAILSAFE_SCHEMA = uu;
Ee.JSON_SCHEMA = gu;
Ee.CORE_SCHEMA = vu;
Ee.DEFAULT_SCHEMA = ao;
Ee.load = zu.load;
Ee.loadAll = zu.loadAll;
Ee.dump = Eg.dump;
Ee.YAMLException = rn;
Ee.types = {
  binary: _u,
...
ui.Lazy = wg;
var $a = { exports: {} };
const bg = "2.0.0", Xu = 256, _g = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, Sg = 16, Ag = Xu - 6, Tg = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
const xn = di, { MAX_LENGTH: Js, MAX_SAFE_INTEGER: In } = fi, { safeRe: Rn, t: On } = an, Dg = uo, { compareIdentifiers: ea } = Ju;
let Pg = class Qe {
  constructor(t, r) {
  ...
  compare(t) {
    if (xn("SemVer.compare", this.version, this.options, t), !(t instanceof Qe)) {
  ...
  inc(t, r, n) {
    if (t.startsWith("pre")) {
      ...
      if (r) {
        const i = `-${r}`.match(this.options.loose ? Rn[On.PRERELEASELOOSE] : Rn[On.PRERELEASE]);
        if (!i || i[1] !== r)
...
var mo = xv;
const Iv = Qu, Rv = Zu, Ov = hi, Dv = po, Pv = ho, Nv = mo, $v = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var ef = $v;
const Fv = Pe, Lv = mr, { safeRe: Dn, t: Pn } = an, Uv = (e, t) => {
  if (e instanceof Fv)
    return e;
  ...
  let r = null;
  if (!t.rtl)
    r = e.match(t.includePrerelease ? Dn[Pn.COERCEFULL] : Dn[Pn.COERCE]);
  else {
    const l = t.includePrerelease ? Dn[Pn.COERCERTLFULL] : Dn[Pn.COERCERTL];
    let f;
...
function ze() {
  ...
  const r = Mv, n = new r(), i = uo, a = pi(), o = di, s = Pe, {
    ...
    tildeTrimReplace: u,
    caretTrimReplace: d
  } = an, { FLAG_INCLUDE_PRERELEASE: h, FLAG_LOOSE: y } = fi, m = (D) => D.value === "<0.0.0-0", E = (D) => D.value === "", _ = (D, R) => {
    let N = !0;
    const I = D.slice();
    let F = I.pop();
    for (; N && I.length; )
...
function pi() {
  ...
  ra = t;
  const r = uo, { safeRe: n, t: i } = an, a = ef, o = di, s = Pe, l = ze();
  return ra;
}
...
var ay = iy;
const oy = Pe, tf = pi(), { ANY: sy } = tf, cy = ze(), ly = mi, oc = hi, sc = ho, uy = mo, fy = po, dy = (e, t, r, n) => {
  ...
  for (let f = 0; f < t.set.length; ++f) {
    ...
    let u = null, d = null;
    if (c.forEach((h) => {
      h.semver === sy && (h = new tf(">=0.0.0")), u = u || h, d = d || h, i(h.semver, u.semver, n) ? u = h : o(h.semver, d.semver, n) && (d = h);
...
var xy = Ay;
const aa = an, hc = fi, Iy = Pe, pc = Ju, Ry = mr, Oy = Lg, Dy = Bg, Py = jg, Ny = Hg, $y = Vg, Fy = Xg, Ly = Qg, Uy = tv, ky = Ye, By = av, My = cv, jy = fo, qy = dv, Hy = mv, Gy = hi, Wy = ho, Vy = Qu, Yy = Zu, zy = po, Xy = mo, Ky = ef, Jy = kv, Qy = pi(), Zy = ze(), eE = mi, tE = Wv, rE = Xv, nE = Zv, iE = ry, aE = ay, oE = go, sE = my, cE = yy, lE = wy, uE = Sy, fE = xy;
var rf = {
  parse: Ry,
  valid: Oy,
  clean: Dy,
...
(function(e, t) {
  ...
  var wf = Array.prototype, bf = Function.prototype, dn = Object.prototype, Ci = p["__core-js_shared__"], To = bf.toString, Je = dn.hasOwnProperty, Co = function() {
    var v = /[^.]+$/.exec(Ci && Ci.keys && Ci.keys.IE_PROTO || "");
    return v ? "Symbol(src)_1." + v : "";
  }(), xo = dn.toString, _f = RegExp(
    "^" + To.call(Je).replace(V, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Io = K ? p.Buffer : void 0, hn = p.Symbol, Ro = p.Uint8Array, Oo = dn.propertyIsEnumerable, Sf = wf.splice, xt = hn ? hn.toStringTag : void 0, Do = Object.getOwnPropertySymbols, Af = Io ? Io.isBuffer : void 0, Tf = yf(Object.keys, Object), xi = Vt(p, "DataView"), Er = Vt(p, "Map"), Ii = Vt(p, "Promise"), Ri = Vt(p, "Set"), Oi = Vt(p, "WeakMap"), wr = Vt(Object, "create"), Cf = Ot(xi), xf = Ot(Er), If = Ot(Ii), Rf = Ot(Ri), Of = Ot(Oi), Po = hn ? hn.prototype : void 0, Di = Po ? Po.valueOf : void 0;
  function It(v) {
  ...
  It.prototype.clear = Df, It.prototype.delete = Pf, It.prototype.get = Nf, It.prototype.has = $f, It.prototype.set = Ff;
  function rt(v) {
    var S = -1, O = v == null ? 0 : v.length;
    for (this.clear(); ++S < O; ) {
      var L = v[S];
  ...
  function Uf(v) {
    var S = this.__data__, O = mn(S, v);
    if (O < 0)
      return !1;
    var L = S.length - 1;
    return O == L ? S.pop() : Sf.call(S, O, 1), --this.size, !0;
  }
  function kf(v) {
    var S = this.__data__, O = mn(S, v);
  ...
  function Bf(v) {
    return mn(this.__data__, v) > -1;
  }
  function Mf(v, S) {
    var O = this.__data__, L = mn(O, v);
    return L < 0 ? (++this.size, O.push([v, S])) : O[L][1] = S, this;
  }
  rt.prototype.clear = Lf, rt.prototype.delete = Uf, rt.prototype.get = kf, rt.prototype.has = Bf, rt.prototype.set = Mf;
  function Rt(v) {
    var S = -1, O = v == null ? 0 : v.length;
    for (this.clear(); ++S < O; ) {
      var L = v[S];
  ...
  function qf(v) {
    var S = gn(this, v).delete(v);
    return this.size -= S ? 1 : 0, S;
  }
  function Hf(v) {
    return gn(this, v).get(v);
  }
  function Gf(v) {
    return gn(this, v).has(v);
  }
  function Wf(v, S) {
    var O = gn(this, v), L = O.size;
    return O.set(v, S), this.size += O.size == L ? 0 : 1, this;
  }
  Rt.prototype.clear = jf, Rt.prototype.delete = qf, Rt.prototype.get = Hf, Rt.prototype.has = Gf, Rt.prototype.set = Wf;
  function pn(v) {
    var S = -1, O = v == null ? 0 : v.length;
  ...
  pn.prototype.add = pn.prototype.push = Vf, pn.prototype.has = Yf;
  function lt(v) {
  ...
  lt.prototype.clear = zf, lt.prototype.delete = Xf, lt.prototype.get = Kf, lt.prototype.has = Jf, lt.prototype.set = Qf;
  function Zf(v, S) {
    var O = vn(v), L = !O && pd(v), te = !O && !L && Pi(v), Y = !O && !L && !te && jo(v), se = O || L || te || Y, he = se ? je(v.length, String) : [], ve = he.length;
    for (var ne in v)
  ...
  function ed(v, S, O) {
    var L = S(v);
    return vn(v) ? L : ct(L, O(v));
  }
  function br(v) {
    return v == null ? v === void 0 ? w : _ : xt && xt in Object(v) ? sd(v) : hd(v);
  }
  function No(v) {
    return _r(v) && br(v) == s;
  }
  function $o(v, S, O, L, te) {
    return v === S ? !0 : v == null || S == null || !_r(v) && !_r(S) ? v !== v && S !== S : td(v, S, O, L, $o, te);
  }
  function td(v, S, O, L, te, Y) {
    var se = vn(v), he = vn(S), ve = se ? l : ut(v), ne = he ? l : ut(S);
    ve = ve == s ? b : ve, ne = ne == s ? b : ne;
    var Le = ve == b, qe = ne == b, be = ve == ne;
    if (be && Pi(v)) {
      if (!Pi(S))
        return !1;
      se = !0, Le = !1;
    ...
    if (be && !Le)
      return Y || (Y = new lt()), se || jo(v) ? Fo(v, S, O, L, te, Y) : ad(v, S, ve, O, L, te, Y);
    if (!(O & i)) {
      var Ue = Le && Je.call(v, "__wrapped__"), ke = qe && Je.call(S, "__wrapped__");
      if (Ue || ke) {
        var ft = Ue ? v.value() : v, nt = ke ? S.value() : S;
        return Y || (Y = new lt()), te(ft, nt, O, L, Y);
      }
    }
    return be ? (Y || (Y = new lt()), od(v, S, O, L, te, Y)) : !1;
  }
  function rd(v) {
    if (!Mo(v) || fd(v))
      return !1;
  ...
  function Fo(v, S, O, L, te, Y) {
    var se = O & i, he = v.length, ve = S.length;
    if (he != ve && !(se && ve > he))
      return !1;
    var ne = Y.get(v);
    if (ne && Y.get(S))
      return ne == S;
    var Le = -1, qe = !0, be = O & a ? new pn() : void 0;
    for (Y.set(v, S), Y.set(S, v); ++Le < he; ) {
      var Ue = v[Le], ke = S[Le];
      if (L)
        var ft = se ? L(ke, Ue, Le, S, v, Y) : L(Ue, ke, Le, v, S, Y);
      if (ft !== void 0) {
        if (ft)
          continue;
        qe = !1;
      ...
      if (be) {
        if (!ue(S, function(nt, Dt) {
          if (!un(be, Dt) && (Ue === nt || te(Ue, nt, O, L, Y)))
            return be.push(Dt);
        })) {
          qe = !1;
          break;
  ...
  function od(v, S, O, L, te, Y) {
    var se = O & i, he = Lo(v), ve = he.length, ne = Lo(S), Le = ne.length;
    if (ve != Le && !se)
      return !1;
    for (var qe = ve; qe--; ) {
      var be = he[qe];
      if (!(se ? be in S : Je.call(S, be)))
        return !1;
    }
    var Ue = Y.get(v);
    if (Ue && Y.get(S))
    ...
    for (var ft = se; ++qe < ve; ) {
      ...
      var nt = v[be], Dt = S[be];
      if (L)
        var qo = se ? L(Dt, nt, be, S, v, Y) : L(nt, Dt, be, v, S, Y);
      if (!(qo === void 0 ? nt === Dt || te(nt, Dt, O, L, Y) : qo)) {
        ke = !1;
        break;
      }
      ft || (ft = be == "constructor");
    }
    if (ke && !ft) {
      var yn = v.constructor, En = S.constructor;
      yn != En && "constructor" in v && "constructor" in S && !(typeof yn == "function" && yn instanceof yn && typeof En == "function" && En instanceof En) && (ke = !1);
    }
  ...
  function gn(v, S) {
    var O = v.__data__;
    return ud(S) ? O[typeof S == "string" ? "string" : "hash"] : O.map;
  }
  function Vt(v, S) {
    var O = yr(v, S);
    return rd(O) ? O : void 0;
  }
  function sd(v) {
  ...
  var cd = Do ? function(v) {
    return v == null ? [] : (v = Object(v), we(Do(v), function(S) {
      return Oo.call(v, S);
    }));
  } : yd, ut = br;
  (xi && ut(new xi(new ArrayBuffer(1))) != H || Er && ut(new Er()) != m || Ii && ut(Ii.resolve()) != C || Ri && ut(new Ri()) != k || Oi && ut(new Oi()) != M) && (ut = function(v) {
  ...
  function dd(v) {
    var S = v && v.constructor, O = typeof S == "function" && S.prototype || dn;
    return v === O;
  }
  function hd(v) {
    return xo.call(v);
...
on.DownloadedUpdateHelper = void 0;
on.createTempUpdateFile = vE;
const hE = Jr, pE = et, mc = dE, Nt = Tt, Nr = ae;
class mE {
  constructor(t) {
...
var le = {}, TE = "[object Symbol]", of = /[\\^$.*+?()[\]{}|]/g, CE = RegExp(of.source), xE = typeof Ce == "object" && Ce && Ce.Object === Object && Ce, IE = typeof self == "object" && self && self.Object === Object && self, RE = xE || IE || Function("return this")(), OE = Object.prototype, DE = OE.toString, vc = RE.Symbol, yc = vc ? vc.prototype : void 0, Ec = yc ? yc.toString : void 0;
function PE(e) {
  if (typeof e == "string")
    return e;
  if ($E(e))
...
function LE(e) {
  return e = FE(e), e && CE.test(e) ? e.replace(of, "\\$&") : e;
}
var sf = LE;
...
le.getFileList = cf;
le.resolveFiles = HE;
const bt = fe, UE = Ee, kE = St, ei = Xe, BE = sf;
class ME {
  constructor(t) {
  ...
  getBlockMapFiles(t, r, n, i = null) {
    const a = (0, ei.newUrlFromBase)(`${t.pathname}.blockmap`, t);
    return [(0, ei.newUrlFromBase)(`${t.pathname.replace(new RegExp(BE(n), "g"), r)}.blockmap`, i ? new kE.URL(i) : t), a];
  }
  ...
  createRequestOptions(t, r) {
    const n = {};
    return this.requestHeaders == null ? r != null && (n.headers = r) : n.headers = r == null ? this.requestHeaders : { ...this.requestHeaders, ...r }, (0, bt.configureRequestUrl)(t, n), n;
  }
}
le.Provider = ME;
function jE(e, t, r) {
...
function qE(e, t, r) {
  if (e == null)
    throw (0, bt.newError)(`Cannot parse update info from ${t} in the latest release artifacts (${r}): rawData: null`, "ERR_UPDATER_INVALID_UPDATE_INFO");
  let n;
  try {
    n = (0, UE.load)(e);
  } catch (i) {
    throw (0, bt.newError)(`Cannot parse update info from ${t} in the latest release artifacts (${r}): ${i.stack || i.message}, rawData: ${e}`, "ERR_UPDATER_INVALID_UPDATE_INFO");
  }
  return n;
}
function cf(e) {
...
_t.computeReleaseNotes = uf;
const at = fe, rr = rf, VE = St, nr = Xe, Fa = le, fa = /\/tag\/([^/]+)$/;
class lf extends Fa.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      /* because GitHib uses S3 */
      isUseMultipleRangeRequest: !1
    }), this.options = t, this.baseUrl = (0, nr.newBaseUrl)((0, at.githubUrl)(t, r));
    const i = r === "github.com" ? "api.github.com" : r;
    this.baseApiUrl = (0, nr.newBaseUrl)((0, at.githubUrl)(t, i));
  }
...
class YE extends lf {
  ...
  async getLatestVersion() {
    var t, r, n, i, a;
    const o = new at.CancellationToken(), s = await this.httpRequest((0, nr.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
      accept: "application/xml, application/atom+xml, text/xml, */*"
    }, o), l = (0, at.parseXml)(s);
    let f = l.element("entry", !1, "No published versions on GitHub"), c = null;
    try {
      if (this.updater.allowPrerelease) {
        const E = ((t = this.updater) === null || t === void 0 ? void 0 : t.channel) || ((r = rr.prerelease(this.updater.currentVersion)) === null || r === void 0 ? void 0 : r[0]) || null;
        if (E === null)
          ...
          for (const _ of l.getElements("entry")) {
            ...
            if (b === null)
              continue;
            const C = b[1], T = ((n = rr.prerelease(C)) === null || n === void 0 ? void 0 : n[0]) || null, $ = !E || ["alpha", "beta"].includes(E), k = T !== null && !["alpha", "beta"].includes(String(T));
            if ($ && !k && !(E === "beta" && T === "alpha")) {
              c = C;
              break;
            }
...
${s}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let u, d = "", h = "";
    const y = async (E) => {
      d = (0, nr.getChannelFilename)(E), h = (0, nr.newUrlFromBase)(this.getBaseDownloadPath(String(c), d), this.baseUrl);
    ...
    try {
      let E = this.channel;
      this.updater.allowPrerelease && (!((i = rr.prerelease(c)) === null || i === void 0) && i[0]) && (E = this.getCustomChannelName(String((a = rr.prerelease(c)) === null || a === void 0 ? void 0 : a[0]))), u = await y(E);
    } catch (E) {
      if (this.updater.allowPrerelease)
    ...
    return m.releaseName == null && (m.releaseName = f.elementValueOrEmpty("title")), m.releaseNotes == null && (m.releaseNotes = uf(this.updater.currentVersion, this.updater.fullChangelog, l, f)), {
      tag: c,
      ...m
    };
  }
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, nr.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new VE.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
function uf(e, t, r, n) {
  ...
  return i.sort((a, o) => rr.rcompare(a.version, o.version));
}
var Ei = {};
Object.defineProperty(Ei, "__esModule", { value: !0 });
Ei.GitLabProvider = void 0;
const Ae = fe, da = St, zE = sf, Nn = Xe, ha = le;
class XE extends ha.Provider {
  ...
  constructor(t, r, n) {
    ...
    this.baseApiUrl = (0, Nn.newBaseUrl)(`https://${a}/api/v4`);
  }
  get channel() {
    const t = this.updater.channel || this.options.channel;
    return t == null ? this.getDefaultChannelName() : this.getCustomChannelName(t);
  ...
  async getLatestVersion() {
    const t = new Ae.CancellationToken(), r = (0, Nn.newUrlFromBase)(`projects/${this.options.projectId}/releases/permalink/latest`, this.baseApiUrl);
    let n;
    try {
    ...
    const l = async (d) => {
      ...
      try {
        ...
        throw m instanceof Ae.HttpError && m.statusCode === 404 ? (0, Ae.newError)(`Cannot find ${o} in the latest release artifacts (${s}): ${m.stack || m.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : m;
      }
    };
    try {
  ...
  async fetchReleaseInfoByVersion(t) {
    ...
    for (const i of n) {
      const a = (0, Nn.newUrlFromBase)(`projects/${this.options.projectId}/releases/${encodeURIComponent(i)}`, this.baseApiUrl);
      try {
...
const Xt = fe, JE = Ee, QE = ae, Ac = St, Tc = Xe, ZE = _t, ew = le;
class tw extends ZE.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new Xt.CancellationToken(), r = (0, Tc.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((s) => s.name === r);
    if (i == null)
    ...
    try {
      ...
      throw s instanceof Xt.HttpError && s.statusCode === 404 ? (0, Xt.newError)(`Cannot find ${r} in the latest release artifacts (${a}): ${s.stack || s.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : s;
    }
  ...
  async getLatestVersionInfo(t) {
    ...
    try {
      ...
      throw (0, Xt.newError)(`Unable to find latest version on GitHub (${i}), please ensure a production release exists: ${a.stack || a.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  get basePath() {
...
vi.isUrlProbablySupportMultiRangeRequests = ff;
vi.createClient = sw;
const $n = fe, rw = yi, Cc = sn, nw = _t, iw = Ei, aw = wi, ow = bi;
function ff(e) {
...
Wt.computeOperations = cw;
var Lt;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
})(Lt || (Wt.OperationKind = Lt = {}));
function cw(e, t, r) {
...
gr.copyData = df;
const Fn = fe, fw = et, dw = Kr, hw = Wt, Rc = Buffer.from(`\r
\r
`);
var ht;
(function(e) {
  ...
  copyExistingData(t, r) {
    return new Promise((n, i) => {
      const a = () => {
        ...
        df(o, this.out, this.options.oldFileFd, i, () => {
          t++, a();
        });
      };
      a();
...
const Cr = fe, ga = Tt, Ew = et, ww = gr, bw = St, Ln = Wt, Pc = Si, _w = Ai;
class Sw {
  ...
  doDownload(t, r) {
    ...
    const n = this.logger, i = (0, Ln.computeOperations)(t, r, n);
    n.debug != null && n.debug(JSON.stringify(i, null, 2));
    let a = 0, o = 0;
    for (const l of i) {
      const f = l.end - l.start;
      l.kind === Ln.OperationKind.DOWNLOAD ? a += f : o += f;
    }
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((o, s) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let b = 0;
        for (const T of t)
          T.kind === Ln.OperationKind.DOWNLOAD && (_.push(T.end - T.start), b += T.end - T.start);
        const C = {
      ...
      E.redirect = "manual", h = (_) => {
        ...
        const T = t[_++];
        if (T.kind === Ln.OperationKind.COPY) {
...
const Te = fe, xw = Jr, Iw = ri, Rw = tl, He = Tt, Ow = Ee, va = ui, Ge = ae, $t = rf, $c = on, Dw = gi, Fc = nf, Pw = sn, ya = vi, Ea = nl, Nw = _i, Kt = Ct;
class wo extends Rw.EventEmitter {
  ...
  async getOrCreateStagingUserId() {
    ...
    const r = Te.UUID.v5((0, xw.randomBytes)(4096), Te.UUID.OID);
  ...
  async executeDownload(t) {
    ...
    this.listenerCount(Kt.DOWNLOAD_PROGRESS) > 0 && (n.onProgress = (b) => this.emit(Kt.DOWNLOAD_PROGRESS, b));
    ...
    try {
      await t.task(_, n, d, E), await (0, Te.retry)(() => (0, He.rename)(_, u), {
        retries: 60,
        interval: 500,
        shouldRetry: (b) => b instanceof Error && /^EBUSY:/.test(b.message) ? !0 : (y.warn(`Cannot rename temp file to final file: ${b.message || b.stack}`), !1)
      });
    } catch (b) {
      throw await E(), b instanceof Te.CancellationError && (y.info("cancelled"), this.emit("update-cancelled", i)), b;
    }
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      this.listenerCount(Kt.DOWNLOAD_PROGRESS) > 0 && (f.onProgress = (y) => this.emit(Kt.DOWNLOAD_PROGRESS, y));
      const c = async (y, m) => {
...
ln.FileWithEmbeddedBlockMapDifferentialDownloader = Bw;
function pf(e) {
...
async function Mw(e) {
  ...
  try {
    ...
    return await (0, Jt.read)(t, i, 0, i.length, r - n.length - i.length), await (0, Jt.close)(t), pf(i);
  } catch (r) {
...
const Uc = fe, kc = ti, jw = Tt, qw = et, xr = ae, Hw = Gt, Gw = ln, Ww = le, Bc = Ct;
...
const Hc = fe, wa = Tt, t8 = et, Gc = ae, r8 = Td, n8 = yt, i8 = le, Wc = ti, Vc = Jr;
...
function s8(e, t, r) {
  return new Promise((n, i) => {
    const a = t.replace(/'/g, "''");
    r.info(`Verifying signature ${a}`), (0, mf.execFile)(...gf(`"Get-AuthenticodeSignature -LiteralPath '${a}' | ConvertTo-Json -Compress"`, 20 * 1e3), (o, s, l) => {
      var f;
      try {
        if (o != null || l) {
          ba(r, o, l, i), n(null);
...
const Un = fe, Xc = ae, u8 = Gt, f8 = ln, Kc = Ct, d8 = le, h8 = Tt, p8 = Ao, Jc = St;
    ...
    return this.executeDownload({
      ...
      task: async (i, a, o, s) => {
        ...
        if (f && t.disableWebInstaller)
          throw (0, Un.newError)(`Unable to download new version ${t.updateInfoAndProvider.info.version}. Web Installers are disabled`, "ERR_UPDATER_WEB_INSTALLER_DISABLED");
        !f && !t.disableWebInstaller && this._logger.warn("disableWebInstaller is set to false, you should set it to true if you do not plan on using a web installer. This will default to true in a future version."), (f || t.disableDifferentialDownload || await this.differentialDownloadInstaller(n, t, i, r, Un.CURRENT_APP_INSTALLER_FILE_NAME)) && await this.httpExecutor.download(n.url, i, a);
        const c = await this.verifySignature(i);
        if (c != null)
          throw await s(), (0, Un.newError)(`New version ${t.updateInfoAndProvider.info.version} is not signed by the application owner: ${c}`, "ERR_UPDATER_INVALID_SIGNATURE");
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      const a = {
        ...
        oldFile: Xc.join(this.downloadedUpdateHelper.cacheDir, Un.CURRENT_APP_PACKAGE_FILE_NAME),
        logger: this._logger,
        newFile: n,
...
const Xr = me.dirname(wd(import.meta.url));
process.env.APP_ROOT = me.join(Xr, "..");
const ka = process.env.VITE_DEV_SERVER_URL, k8 = me.join(process.env.APP_ROOT, "dist-electron"), g8 = me.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ka ? me.join(process.env.APP_ROOT, "public") : g8;
let G;
function vf() {
  G = new Qc({
    icon: me.join(process.env.VITE_PUBLIC, "balazslogo.svg"),
    title: "Navigator Studio",
    webPreferences: {
      preload: me.join(Xr, "preload.mjs"),
      contextIsolation: !0,
      nodeIntegration: !1,
      sandbox: !1
    },
  ...
  }), ka ? G.loadURL(ka) : G.loadFile(me.join(Xr, "../dist/index.html"));
}
function v8(e) {
  e && Zc.openPath(e).then((t) => {
    t && console.error("Failed to open file:", t);
  });
}
Mt.on("window-all-closed", () => {
  process.platform !== "darwin" && (Mt.quit(), G = null);
});
Mt.on("activate", () => {
  Qc.getAllWindows().length === 0 && vf();
});
st.handle("minimize-window", () => {
  G == null || G.minimize();
});
st.handle("maximize-window", () => {
  G != null && G.isMaximized() ? G.unmaximize() : G == null || G.maximize();
});
st.handle("close-window", () => {
  G == null || G.close();
});
st.handle("run-executable", (e, t, r = []) => new Promise((n, i) => {
  var c, u;
  const a = Mt.isPackaged ? me.join(process.resourcesPath, "public") : me.join(Xr, "../public"), o = me.join(a, t);
...
st.handle("open-file", async (e, t) => {
  const r = Mt.isPackaged ? me.join(process.resourcesPath, "public") : me.join(Xr, "../public");
  return v8(me.join(r, t)), !0;
});
st.handle("get-public-path", (e, ...t) => {
  const r = Mt.isPackaged ? me.join(process.resourcesPath, "public") : me.join(process.cwd(), "public");
  return me.join(r, ...t);
});
...
st.handle("check-for-updates", async () => {
  try {
...
st.handle("restart-and-install", () => {
  Fe.autoUpdater.quitAndInstall();
});
Mt.whenReady().then(() => {
  vf(), Fe.autoUpdater.checkForUpdates(), setInterval(() => {
