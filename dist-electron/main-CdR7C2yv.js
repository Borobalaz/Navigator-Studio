import Xt, { app as At, BrowserWindow as Zs, ipcMain as Qe, shell as $u, dialog as fl } from "electron";
import { fileURLToPath as bp } from "node:url";
import ve from "node:path";
import { spawn as Sp } from "node:child_process";
import Cp from "buffer";
import Ap from "string_decoder";
import * as kr from "fs";
import Je from "fs";
import Pp from "constants";
import gn from "stream";
import eo from "util";
import Bu from "assert";
import * as jn from "path";
import se from "path";
...
var to = { exports: {} }, fi = Cp, gr = fi.Buffer, He = {}, qe;
for (qe in fi)
  fi.hasOwnProperty(qe) && (qe === "SlowBuffer" || qe === "Buffer" || (He[qe] = fi[qe]));
var vr = He.Buffer = {};
for (qe in gr)
  gr.hasOwnProperty(qe) && (qe === "allocUnsafe" || qe === "allocUnsafeSlow" || (vr[qe] = gr[qe]));
He.Buffer.prototype = gr.prototype;
(!vr.from || vr.from === Uint8Array.from) && (vr.from = function(e, t, r) {
  if (typeof e == "number")
...
vr.alloc || (vr.alloc = function(e, t, r) {
  if (typeof e != "number")
...
if (!He.kStringMaxLength)
  try {
    He.kStringMaxLength = process.binding("buffer").kStringMaxLength;
  } catch {
  }
He.constants || (He.constants = {
  MAX_LENGTH: He.kMaxLength
}, He.kStringMaxLength && (He.constants.MAX_STRING_LENGTH = He.kStringMaxLength));
var Dt = He, ro = {}, Vu = "\uFEFF";
ro.PrependBOM = no;
function no(e, t) {
...
no.prototype.write = function(e) {
  return this.addBOM && (e = Vu + e, this.addBOM = !1), this.encoder.write(e);
};
...
io.prototype.write = function(e) {
  ...
  return this.pass || !t || (t[0] === Vu && (t = t.slice(1), typeof this.options.stripBOM == "function" && this.options.stripBOM()), this.pass = !0), t;
};
io.prototype.end = function() {
  return this.decoder.end();
};
var Tp = typeof Object.hasOwn > "u" ? Function.call.bind(Object.prototype.hasOwnProperty) : Object.hasOwn;
function Ip(e, t) {
  for (var r in t)
    Tp(t, r) && (e[r] = t[r]);
}
...
function Rp() {
  ...
  ut.utf32le = { type: "_utf32", isLE: !0 }, ut.utf32be = { type: "_utf32", isLE: !1 }, ut.ucs4le = "utf32le", ut.ucs4be = "utf32be", t.prototype.encoder = r, t.prototype.decoder = n;
  function r(f, o) {
...
var _t = Pp, Xp = process.cwd, hi = null, Kp = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return hi || (hi = Xp.call(process)), hi;
};
try {
  process.cwd();
} catch {
...
if (typeof process.chdir == "function") {
  var Pl = process.chdir;
  process.chdir = function(e) {
    hi = null, Pl.call(process, e);
  }, Object.setPrototypeOf && Object.setPrototypeOf(process.chdir, Pl);
}
var Jp = Qp;
function Qp(e) {
  _t.hasOwnProperty("O_SYMLINK") && process.version.match(/^v0\.6\.[0-2]|^v0\.5\./) && t(e), e.lutimes || r(e), e.chown = a(e.chown), e.fchown = a(e.fchown), e.lchown = a(e.lchown), e.chmod = n(e.chmod), e.fchmod = n(e.fchmod), e.lchmod = n(e.lchmod), e.chownSync = s(e.chownSync), e.fchownSync = s(e.fchownSync), e.lchownSync = s(e.lchownSync), e.chmodSync = i(e.chmodSync), e.fchmodSync = i(e.fchmodSync), e.lchmodSync = i(e.lchmodSync), e.stat = c(e.stat), e.fstat = c(e.fstat), e.lstat = c(e.lstat), e.statSync = l(e.statSync), e.fstatSync = l(e.fstatSync), e.lstatSync = l(e.lstatSync), e.chmod && !e.lchmod && (e.lchmod = function(o, d, u) {
    u && process.nextTick(u);
  }, e.lchmodSync = function() {
  }), e.chown && !e.lchown && (e.lchown = function(o, d, u, h) {
    h && process.nextTick(h);
  }, e.lchownSync = function() {
  }), Kp === "win32" && (e.rename = typeof e.rename != "function" ? e.rename : function(o) {
    function d(u, h, p) {
      var m = Date.now(), g = 0;
      o(u, h, function E(y) {
  ...
  function t(o) {
    o.lchmod = function(d, u, h) {
      ...
      var h = o.openSync(d, _t.O_WRONLY | _t.O_SYMLINK, u), p = !0, m;
      try {
  ...
  function r(o) {
    _t.hasOwnProperty("O_SYMLINK") && o.futimes ? (o.lutimes = function(d, u, h, p) {
      o.open(d, _t.O_SYMLINK, function(m, g) {
        if (m) {
          p && p(m);
          return;
        }
      ...
      var p = o.openSync(d, _t.O_SYMLINK), m, g = !0;
      try {
...
function e0(e) {
  ...
  function r(n, i) {
    ...
    xl.call(this), this.path = n, this.fd = null, this.writable = !0, this.flags = "w", this.encoding = "binary", this.mode = 438, this.bytesWritten = 0, i = i || {};
...
var t0 = n0, r0 = Object.getPrototypeOf || function(e) {
  return e.__proto__;
};
function n0(e) {
...
var ae = Je, i0 = Jp, a0 = Zp, s0 = t0, Vn = eo, Ee, _i;
typeof Symbol == "function" && typeof Symbol.for == "function" ? (Ee = Symbol.for("graceful-fs.queue"), _i = Symbol.for("graceful-fs.previous")) : (Ee = "___graceful-fs.queue", _i = "___graceful-fs.previous");
function o0() {
}
function zu(e, t) {
...
var zt = o0;
Vn.debuglog ? zt = Vn.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (zt = function() {
...
if (!ae[Ee]) {
  var l0 = Te[Ee] || [];
  zu(ae, l0), ae.close = function(e) {
    function t(r, n) {
      return e.call(ae, r, function(i) {
        i || Tl(), typeof n == "function" && n.apply(this, arguments);
      });
    }
    return Object.defineProperty(t, _i, {
      value: e
    }), t;
  }(ae.close), ae.closeSync = function(e) {
    function t(r) {
      e.apply(ae, arguments), Tl();
    }
    return Object.defineProperty(t, _i, {
      value: e
    }), t;
  }(ae.closeSync), /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && process.on("exit", function() {
    zt(ae[Ee]), Bu.equal(ae[Ee].length, 0);
  });
}
Te[Ee] || zu(Te, ae[Ee]);
var De = ao(s0(ae));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !ae.__patched && (De = ao(ae), ae.__patched = !0);
function ao(e) {
  i0(e), e.gracefulify = ao, e.createReadStream = A, e.createWriteStream = I;
  var t = e.readFile;
  e.readFile = r;
  function r(C, F, H) {
    return typeof F == "function" && (H = F, F = null), j(C, F, H);
    function j(K, L, D, U) {
      return t(K, L, function(R) {
        R && (R.code === "EMFILE" || R.code === "ENFILE") ? nr([j, [K, L, D], R, U || Date.now(), Date.now()]) : typeof D == "function" && D.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  e.writeFile = i;
  function i(C, F, H, j) {
    return typeof H == "function" && (j = H, H = null), K(C, F, H, j);
    function K(L, D, U, R, M) {
      return n(L, D, U, function(k) {
        k && (k.code === "EMFILE" || k.code === "ENFILE") ? nr([K, [L, D, U, R], k, M || Date.now(), Date.now()]) : typeof R == "function" && R.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  c && (e.copyFile = l);
  function l(C, F, H, j) {
    return typeof H == "function" && (j = H, H = 0), K(C, F, H, j);
    function K(L, D, U, R, M) {
  ...
  function d(C, F, H) {
    ...
    var j = o.test(process.version) ? function(D, U, R, M) {
      return f(D, K(
        D,
        U,
        R,
    ...
    function K(L, D, U, R) {
      return function(M, k) {
        M && (M.code === "EMFILE" || M.code === "ENFILE") ? nr([
          j,
          [L, D, U],
          M,
          R || Date.now(),
...
function nr(e) {
  zt("ENQUEUE", e[0].name, e[1]), ae[Ee].push(e), so();
}
var Wn;
function Tl() {
...
function so() {
  if (clearTimeout(Wn), Wn = void 0, ae[Ee].length !== 0) {
    var e = ae[Ee].shift(), t = e[0], r = e[1], n = e[2], i = e[3], a = e[4];
    if (i === void 0)
      zt("RETRY", t.name, r), t.apply(null, r);
      ...
      c >= f ? (zt("RETRY", t.name, r), t.apply(null, r.concat([i]))) : ae[Ee].push(e);
    }
    Wn === void 0 && (Wn = setTimeout(so, 0));
  }
}
(function(e) {
...
var oo = {}, Yu = {};
const c0 = se;
Yu.checkPath = function(t) {
  if (process.platform === "win32" && /[<>:"|?*]/.test(t.replace(c0.parse(t).root, ""))) {
    const n = new Error(`Path contains invalid characters: ${t}`);
    throw n.code = "EINVAL", n;
  }
};
const Xu = Jt, { checkPath: Ku } = Yu, Ju = (e) => {
  const t = { mode: 511 };
  return typeof e == "number" ? e : { ...t, ...e }.mode;
};
oo.makeDir = async (e, t) => (Ku(e), Xu.mkdir(e, {
  mode: Ju(t),
  recursive: !0
}));
oo.makeDirSync = (e, t) => (Ku(e), Xu.mkdirSync(e, {
  mode: Ju(t),
  recursive: !0
}));
const u0 = Re.fromPromise, { makeDir: f0, makeDirSync: ba } = oo, Sa = u0(f0);
var ot = {
  mkdirs: Sa,
  mkdirsSync: ba,
  // alias
...
const h0 = Re.fromPromise, Qu = Jt;
function d0(e) {
  return Qu.access(e).then(() => !0).catch(() => !1);
}
var Qt = {
  pathExists: h0(d0),
  pathExistsSync: Qu.existsSync
};
const yr = De;
function p0(e, t, r, n) {
  yr.open(e, "r+", (i, a) => {
...
function _0(e, t, r, n, i) {
  g0.callbackify(v0)(e, t, n, (a, s) => {
    if (a) return i(a);
    ...
    return c.isDirectory() && lo(e, t) ? i(new Error(ki(e, t, r))) : i(null, { srcStat: c, destStat: l });
  });
}
function E0(e, t, r, n) {
  const { srcStat: i, destStat: a } = y0(e, t, n);
  if (a) {
    if (yn(i, a)) {
...
function ef(e, t, r, n, i) {
  ...
  Er.stat(s, { bigint: !0 }, (c, l) => c ? c.code === "ENOENT" ? i() : i(c) : yn(t, l) ? i(new Error(ki(e, r, n))) : ef(e, t, s, n, i));
}
function tf(e, t, r, n) {
...
var Cr = {
  ...
  checkPathsSync: E0,
  checkParentPaths: ef,
  checkParentPathsSync: tf,
  isSrcSubdir: lo,
  areIdentical: yn
};
const ke = De, Qr = se, w0 = ot.mkdirs, b0 = Qt.pathExists, S0 = Zu.utimesMillis, Zr = Cr;
function C0(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    "Warning",
    "fs-extra-WARN0001"
  ), Zr.checkPaths(e, t, "copy", r, (i, a) => {
    if (i) return n(i);
    const { srcStat: s, destStat: c } = a;
    Zr.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? rf(Il, c, e, t, r, n) : Il(c, e, t, r, n));
  });
}
function Il(e, t, r, n, i) {
  const a = Qr.dirname(r);
  b0(a, (s, c) => {
    if (s) return i(s);
    if (c) return Ei(e, t, r, n, i);
    w0(a, (l) => l ? i(l) : Ei(e, t, r, n, i));
  });
}
...
function A0(e, t, r, n, i) {
  return n.filter ? rf(Ei, e, t, r, n, i) : Ei(e, t, r, n, i);
}
function Ei(e, t, r, n, i) {
  (n.dereference ? ke.stat : ke.lstat)(t, (s, c) => s ? i(s) : c.isDirectory() ? D0(c, e, t, r, n, i) : c.isFile() || c.isCharacterDevice() || c.isBlockDevice() ? P0(c, e, t, r, n, i) : c.isSymbolicLink() ? k0(e, t, r, n, i) : c.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : c.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
function P0(e, t, r, n, i, a) {
  return t ? x0(e, r, n, i, a) : nf(e, r, n, i, a);
}
function x0(e, t, r, n, i) {
  if (n.overwrite)
    ke.unlink(r, (a) => a ? i(a) : nf(e, t, r, n, i));
  else return n.errorOnExist ? i(new Error(`'${r}' already exists`)) : i();
}
function nf(e, t, r, n, i) {
  ke.copyFile(t, r, (a) => a ? i(a) : n.preserveTimestamps ? T0(e.mode, t, r, i) : Fi(r, e.mode, i));
}
function T0(e, t, r, n) {
  return I0(e) ? O0(r, e, (i) => i ? n(i) : Ol(e, t, r, n)) : Ol(e, t, r, n);
}
function I0(e) {
  return (e & 128) === 0;
}
...
function Ol(e, t, r, n) {
  R0(t, r, (i) => i ? n(i) : Fi(r, e, n));
}
function Fi(e, t, r) {
  return ke.chmod(e, t, r);
}
function R0(e, t, r) {
  ke.stat(e, (n, i) => n ? r(n) : S0(t, i.atime, i.mtime, r));
}
function D0(e, t, r, n, i, a) {
  return t ? af(r, n, i, a) : N0(e.mode, r, n, i, a);
}
function N0(e, t, r, n, i) {
  ke.mkdir(r, (a) => {
    if (a) return i(a);
    af(t, r, n, (s) => s ? i(s) : Fi(r, e, i));
  });
}
function af(e, t, r, n) {
  ke.readdir(e, (i, a) => i ? n(i) : sf(a, e, t, r, n));
}
function sf(e, t, r, n, i) {
  const a = e.pop();
  return a ? L0(e, a, t, r, n, i) : i();
}
function L0(e, t, r, n, i, a) {
  const s = Qr.join(r, t), c = Qr.join(n, t);
  Zr.checkPaths(s, c, "copy", i, (l, f) => {
    if (l) return a(l);
    const { destStat: o } = f;
    A0(o, s, c, i, (d) => d ? a(d) : sf(e, r, n, i, a));
  });
}
function k0(e, t, r, n, i) {
  ke.readlink(t, (a, s) => {
    if (a) return i(a);
    if (n.dereference && (s = Qr.resolve(process.cwd(), s)), e)
      ke.readlink(r, (c, l) => c ? c.code === "EINVAL" || c.code === "UNKNOWN" ? ke.symlink(s, r, i) : i(c) : (n.dereference && (l = Qr.resolve(process.cwd(), l)), Zr.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && Zr.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : F0(s, r, i)));
    else
...
var U0 = C0;
const Ce = De, en = se, M0 = ot.mkdirsSync, $0 = Zu.utimesMillisSync, tn = Cr;
function B0(e, t, r) {
  ...
  const { srcStat: n, destStat: i } = tn.checkPathsSync(e, t, "copy", r);
  return tn.checkParentPathsSync(e, n, t, "copy"), H0(i, e, t, r);
}
function H0(e, t, r, n) {
  if (n.filter && !n.filter(t, r)) return;
  const i = en.dirname(r);
  return Ce.existsSync(i) || M0(i), of(e, t, r, n);
}
function q0(e, t, r, n) {
...
function of(e, t, r, n) {
  ...
  if (a.isDirectory()) return X0(a, e, t, r, n);
  if (a.isFile() || a.isCharacterDevice() || a.isBlockDevice()) return j0(a, e, t, r, n);
  if (a.isSymbolicLink()) return Q0(e, t, r, n);
...
function j0(e, t, r, n, i) {
  return t ? G0(e, r, n, i) : lf(e, r, n, i);
}
function G0(e, t, r, n) {
  if (n.overwrite)
    return Ce.unlinkSync(r), lf(e, t, r, n);
  if (n.errorOnExist)
    throw new Error(`'${r}' already exists`);
}
function lf(e, t, r, n) {
  return Ce.copyFileSync(t, r), n.preserveTimestamps && V0(e.mode, t, r), co(r, e.mode);
}
function V0(e, t, r) {
  return W0(e) && z0(r, e), Y0(t, r);
}
function W0(e) {
  return (e & 128) === 0;
}
...
function Y0(e, t) {
  ...
  return $0(t, r.atime, r.mtime);
}
function X0(e, t, r, n, i) {
  return t ? cf(r, n, i) : K0(e.mode, r, n, i);
}
function K0(e, t, r, n) {
  return Ce.mkdirSync(r), cf(t, r, n), co(r, e);
}
function cf(e, t, r) {
  Ce.readdirSync(e).forEach((n) => J0(n, e, t, r));
}
function J0(e, t, r, n) {
  const i = en.join(t, e), a = en.join(r, e), { destStat: s } = tn.checkPathsSync(i, a, "copy", n);
  return q0(s, i, a, n);
}
function Q0(e, t, r, n) {
  let i = Ce.readlinkSync(t);
  if (n.dereference && (i = en.resolve(process.cwd(), i)), e) {
    let a;
    try {
      a = Ce.readlinkSync(r);
    } catch (s) {
    ...
    if (n.dereference && (a = en.resolve(process.cwd(), a)), tn.isSrcSubdir(i, a))
      throw new Error(`Cannot copy '${i}' to a subdirectory of itself, '${a}'.`);
    if (Ce.statSync(r).isDirectory() && tn.isSrcSubdir(a, i))
...
var e1 = B0;
const t1 = Re.fromCallback;
var uo = {
  copy: t1(U0),
  copySync: e1
};
const Rl = De, uf = se, ee = Bu, rn = process.platform === "win32";
function ff(e) {
  [
    "unlink",
    "chmod",
    ...
    e[r] = e[r] || Rl[r], r = r + "Sync", e[r] = e[r] || Rl[r];
  }), e.maxBusyTries = e.maxBusyTries || 3;
}
function fo(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ee(e, "rimraf: missing path"), ee.strictEqual(typeof e, "string", "rimraf: path should be a string"), ee.strictEqual(typeof r, "function", "rimraf: callback function required"), ee(t, "rimraf: invalid options argument provided"), ee.strictEqual(typeof t, "object", "rimraf: options should be object"), ff(t), Dl(e, t, function i(a) {
    if (a) {
      if ((a.code === "EBUSY" || a.code === "ENOTEMPTY" || a.code === "EPERM") && n < t.maxBusyTries) {
        n++;
        const s = n * 100;
        return setTimeout(() => Dl(e, t, i), s);
      }
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return rn ? Nl(e, t, a, r) : di(e, t, a, r);
        if (a.code === "EISDIR")
          return di(e, t, a, r);
      }
      return r(a);
...
function Nl(e, t, r, n) {
  ee(e), ee(t), ee(typeof n == "function"), t.chmod(e, 438, (i) => {
    i ? n(i.code === "ENOENT" ? null : r) : t.stat(e, (a, s) => {
      a ? n(a.code === "ENOENT" ? null : r) : s.isDirectory() ? di(e, t, r, n) : t.unlink(e, n);
    });
  });
}
function Ll(e, t, r) {
  ...
  n.isDirectory() ? pi(e, t, r) : t.unlinkSync(e);
}
function di(e, t, r, n) {
  ee(e), ee(t), ee(typeof n == "function"), t.rmdir(e, (i) => {
    i && (i.code === "ENOTEMPTY" || i.code === "EEXIST" || i.code === "EPERM") ? r1(e, t, n) : i && i.code === "ENOTDIR" ? n(r) : n(i);
  });
}
function r1(e, t, r) {
...
function hf(e, t) {
  let r;
  t = t || {}, ff(t), ee(e, "rimraf: missing path"), ee.strictEqual(typeof e, "string", "rimraf: path should be a string"), ee(t, "rimraf: missing options"), ee.strictEqual(typeof t, "object", "rimraf: options should be object");
  try {
    r = t.lstatSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
      return;
    n.code === "EPERM" && rn && Ll(e, t, n);
  }
  try {
    r && r.isDirectory() ? pi(e, t, null) : t.unlinkSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
      return;
    if (n.code === "EPERM")
      return rn ? Ll(e, t, n) : pi(e, t, n);
    if (n.code !== "EISDIR")
      throw n;
    pi(e, t, n);
  }
...
function n1(e, t) {
  if (ee(e), ee(t), t.readdirSync(e).forEach((r) => hf(uf.join(e, r), t)), rn) {
    const r = Date.now();
    do
      try {
...
var i1 = fo;
fo.sync = hf;
const wi = De, a1 = Re.fromCallback, df = i1;
function s1(e, t) {
  if (wi.rm) return wi.rm(e, { recursive: !0, force: !0 }, t);
  df(e, t);
}
function o1(e) {
  if (wi.rmSync) return wi.rmSync(e, { recursive: !0, force: !0 });
  df.sync(e);
}
var Ui = {
  remove: a1(s1),
...
const l1 = Re.fromPromise, pf = Jt, mf = se, gf = ot, vf = Ui, kl = l1(async function(t) {
  let r;
  try {
    r = await pf.readdir(t);
  } catch {
    return gf.mkdirs(t);
  }
  return Promise.all(r.map((n) => vf.remove(mf.join(t, n))));
});
function Fl(e) {
  let t;
  try {
    ...
    return gf.mkdirsSync(e);
  }
  t.forEach((r) => {
    r = mf.join(e, r), vf.removeSync(r);
  });
}
var c1 = {
  emptyDirSync: Fl,
...
const u1 = Re.fromCallback, yf = se, bt = De, _f = ot;
function f1(e, t) {
  function r() {
    bt.writeFile(e, "", (n) => {
      if (n) return t(n);
  ...
  bt.stat(e, (n, i) => {
    ...
    const a = yf.dirname(e);
    bt.stat(a, (s, c) => {
      if (s)
        return s.code === "ENOENT" ? _f.mkdirs(a, (l) => {
          if (l) return t(l);
          r();
        }) : t(s);
      c.isDirectory() ? r() : bt.readdir(a, (l) => {
        if (l) return t(l);
      });
    });
  });
...
function h1(e) {
  ...
  const r = yf.dirname(e);
  try {
    bt.statSync(r).isDirectory() || bt.readdirSync(r);
  } catch (n) {
    if (n && n.code === "ENOENT") _f.mkdirsSync(r);
    else throw n;
  }
  bt.writeFileSync(e, "");
}
...
const p1 = Re.fromCallback, Ef = se, wt = De, wf = ot, m1 = Qt.pathExists, { areIdentical: bf } = Cr;
function g1(e, t, r) {
  function n(i, a) {
    wt.link(i, a, (s) => {
      if (s) return r(s);
  ...
  wt.lstat(t, (i, a) => {
    wt.lstat(e, (s, c) => {
      ...
      if (a && bf(c, a)) return r(null);
      const l = Ef.dirname(t);
      m1(l, (f, o) => {
        if (f) return r(f);
        if (o) return n(e, t);
        wf.mkdirs(l, (d) => {
...
function v1(e, t) {
  ...
  try {
    const a = wt.lstatSync(e);
    if (r && bf(a, r)) return;
  } catch (a) {
    throw a.message = a.message.replace("lstat", "ensureLink"), a;
  }
  const n = Ef.dirname(t);
  return wt.existsSync(n) || wf.mkdirsSync(n), wt.linkSync(e, t);
}
var y1 = {
  createLink: p1(g1),
  createLinkSync: v1
};
const St = se, zr = De, _1 = Qt.pathExists;
function E1(e, t, r) {
  if (St.isAbsolute(e))
    ...
    }));
  {
    ...
    return _1(i, (a, s) => a ? r(a) : s ? r(null, {
      toCwd: i,
      toDst: e
...
const P1 = Re.fromCallback, Cf = se, Ke = Jt, Af = ot, x1 = Af.mkdirs, T1 = Af.mkdirsSync, Pf = b1, I1 = Pf.symlinkPaths, O1 = Pf.symlinkPathsSync, xf = A1, R1 = xf.symlinkType, D1 = xf.symlinkTypeSync, N1 = Qt.pathExists, { areIdentical: Tf } = Cr;
function L1(e, t, r, n) {
...
function Ul(e, t, r, n) {
  I1(e, t, (i, a) => {
    if (i) return n(i);
    e = a.toDst, R1(a.toCwd, r, (s, c) => {
      if (s) return n(s);
      const l = Cf.dirname(t);
      N1(l, (f, o) => {
        if (f) return n(f);
        if (o) return Ke.symlink(e, t, c, n);
        x1(l, (d) => {
          if (d) return n(d);
          Ke.symlink(e, t, c, n);
        });
...
function k1(e, t, r) {
  ...
  if (n && n.isSymbolicLink()) {
    const c = Ke.statSync(e), l = Ke.statSync(t);
    if (Tf(c, l)) return;
  }
  const i = O1(e, t);
  e = i.toDst, r = D1(i.toCwd, r);
  const a = Cf.dirname(t);
  return Ke.existsSync(a) || T1(a), Ke.symlinkSync(e, t, r);
}
var F1 = {
  createSymlink: P1(L1),
  createSymlinkSync: k1
};
const { createFile: Ml, createFileSync: $l } = d1, { createLink: Bl, createLinkSync: Hl } = y1, { createSymlink: ql, createSymlinkSync: jl } = F1;
var U1 = {
  // file
  createFile: Ml,
  createFileSync: $l,
  ...
  // symlink
  createSymlink: ql,
  createSymlinkSync: jl,
  ensureSymlink: ql,
  ensureSymlinkSync: jl
};
function M1(e, { EOL: t = `
...
var ho = { stringify: M1, stripBom: $1 };
let wr;
try {
  wr = De;
} catch {
...
const Mi = Re, { stringify: If, stripBom: Of } = ho;
async function B1(e, t = {}) {
  typeof t == "string" && (t = { encoding: t });
  const r = t.fs || wr, n = "throws" in t ? t.throws : !0;
...
const H1 = Mi.fromPromise(B1);
function q1(e, t = {}) {
  typeof t == "string" && (t = { encoding: t });
  const r = t.fs || wr, n = "throws" in t ? t.throws : !0;
  try {
    let i = r.readFileSync(e, t);
    return i = Of(i), JSON.parse(i, t.reviver);
  } catch (i) {
    if (n)
...
async function j1(e, t, r = {}) {
  const n = r.fs || wr, i = If(t, r);
  await Mi.fromCallback(n.writeFile)(e, i, r);
}
const G1 = Mi.fromPromise(j1);
function V1(e, t, r = {}) {
  const n = r.fs || wr, i = If(t, r);
...
const Y1 = Re.fromCallback, Yr = De, Rf = se, Df = ot, X1 = Qt.pathExists;
function K1(e, t, r, n) {
  typeof r == "function" && (n = r, r = "utf8");
  const i = Rf.dirname(e);
  X1(i, (a, s) => {
    if (a) return n(a);
    if (s) return Yr.writeFile(e, t, r, n);
    Df.mkdirs(i, (c) => {
      if (c) return n(c);
...
function J1(e, ...t) {
  const r = Rf.dirname(e);
  if (Yr.existsSync(r))
    return Yr.writeFileSync(e, ...t);
  Df.mkdirsSync(r), Yr.writeFileSync(e, ...t);
}
var po = {
  outputFile: Y1(K1),
  outputFileSync: J1
};
const { stringify: Q1 } = ho, { outputFile: Z1 } = po;
async function em(e, t, r = {}) {
  const n = Q1(t, r);
  await Z1(e, n, r);
}
var tm = em;
const { stringify: rm } = ho, { outputFileSync: nm } = po;
function im(e, t, r) {
  const n = rm(t, r);
  nm(e, n, r);
}
var am = im;
const sm = Re.fromPromise, Oe = z1;
Oe.outputJson = sm(tm);
Oe.outputJsonSync = am;
...
var om = Oe;
const lm = De, fs = se, cm = uo.copy, Nf = Ui.remove, um = ot.mkdirp, fm = Qt.pathExists, Gl = Cr;
function hm(e, t, r, n) {
  typeof r == "function" && (n = r, r = {}), r = r || {};
  const i = r.overwrite || r.clobber || !1;
  Gl.checkPaths(e, t, "move", r, (a, s) => {
    if (a) return n(a);
    const { srcStat: c, isChangingCase: l = !1 } = s;
    Gl.checkParentPaths(e, c, t, "move", (f) => {
      if (f) return n(f);
      if (dm(t)) return Vl(e, t, i, l, n);
      um(fs.dirname(t), (o) => o ? n(o) : Vl(e, t, i, l, n));
    });
  });
}
function dm(e) {
  const t = fs.dirname(e);
  return fs.parse(t).root === t;
}
function Vl(e, t, r, n, i) {
  if (n) return Ca(e, t, r, i);
  if (r)
    return Nf(t, (a) => a ? i(a) : Ca(e, t, r, i));
  fm(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : Ca(e, t, r, i));
}
function Ca(e, t, r, n) {
  lm.rename(e, t, (i) => i ? i.code !== "EXDEV" ? n(i) : pm(e, t, r, n) : n());
}
function pm(e, t, r, n) {
  cm(e, t, {
    overwrite: r,
...
var mm = hm;
const Lf = De, hs = se, gm = uo.copySync, kf = Ui.removeSync, vm = ot.mkdirpSync, Wl = Cr;
function ym(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Wl.checkPathsSync(e, t, "move", r);
  return Wl.checkParentPathsSync(e, i, t, "move"), _m(t) || vm(hs.dirname(t)), Em(e, t, n, a);
}
function _m(e) {
  const t = hs.dirname(e);
  return hs.parse(t).root === t;
}
function Em(e, t, r, n) {
  if (n) return Aa(e, t, r);
  if (r)
    return kf(t), Aa(e, t, r);
  if (Lf.existsSync(t)) throw new Error("dest already exists.");
  return Aa(e, t, r);
}
function Aa(e, t, r) {
  try {
...
const Am = Hu;
class Pm extends Am.EventEmitter {
  get cancelled() {
...
xt.CancellationToken = Pm;
class ds extends Error {
  constructor() {
    super("cancelled");
  }
}
xt.CancellationError = ds;
var Ar = {};
...
var Ie = {}, ps = { exports: {} }, Yn = { exports: {} }, Pa, zl;
function Tm() {
  if (zl) return Pa;
  zl = 1;
...
function Ff() {
  ...
  Yl = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = f, n.disable = c, n.enable = a, n.enabled = l, n.humanize = Tm(), n.destroy = o, Object.keys(t).forEach((d) => {
      n[d] = t[d];
...
var Xn = { exports: {} }, Ta, Kl;
function Om() {
  return Kl || (Kl = 1, Ta = (e, t = process.argv) => {
...
function Rm() {
  if (Jl) return Ia;
  Jl = 1;
  const e = Li, t = qu, r = Om(), { env: n } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? ps.exports = Im() : ps.exports = Dm();
var Nm = ps.exports, _n = {};
Object.defineProperty(_n, "__esModule", { value: !0 });
_n.ProgressCallbackTransform = void 0;
const Lm = gn;
class km extends Lm.Transform {
  constructor(t, r, n) {
...
_n.ProgressCallbackTransform = km;
Object.defineProperty(Ie, "__esModule", { value: !0 });
Ie.DigestTransform = Ie.HttpExecutor = Ie.HttpError = void 0;
Ie.createHttpError = gs;
Ie.parseJson = jm;
Ie.configureRequestOptionsFromUrl = Mf;
Ie.configureRequestUrl = go;
Ie.safeGetHeader = _r;
Ie.configureRequestOptions = bi;
Ie.safeStringifyJson = Si;
const Fm = vn, Um = Nm, Mm = Je, $m = gn, ms = Rt, Bm = xt, Zl = Ar, Hm = _n, Ht = (0, Um.default)("electron-builder");
function gs(e, t = null) {
  return new mo(e.statusCode || -1, `${e.statusCode} ${e.statusMessage}` + (t == null ? "" : `
` + JSON.stringify(t, null, "  ")) + `
Headers: ` + Si(e.headers), t);
}
...
class cr {
  ...
  doApiRequest(t, r, n, i = 0) {
    return Ht.enabled && Ht(`Request: ${Si(t)}`), r.createPromise((a, s, c) => {
  ...
  handleResponse(t, r, n, i, a, s, c) {
    var l;
    if (Ht.enabled && Ht(`Response: ${t.statusCode} ${t.statusMessage}, request options: ${Si(r)}`), t.statusCode === 404) {
      a(gs(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
`));
    ...
    const f = (l = t.statusCode) !== null && l !== void 0 ? l : 0, o = f >= 300 && f < 400, d = _r(t, "location");
    if (o && d != null) {
      if (s > this.maxRedirects) {
        a(this.createMaxRedirectError());
        return;
      }
      this.doApiRequest(cr.prepareRedirectUrlOptions(d, r), n, c, s).then(i).catch(a);
      return;
    }
    t.setEncoding("utf8");
    let u = "";
    t.on("error", a), t.on("data", (h) => u += h), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const h = _r(t, "content-type"), p = h != null && (Array.isArray(h) ? h.find((m) => m.includes("json")) != null : h.includes("json"));
          a(gs(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
  ...
  doDownload(t, r, n) {
    const i = this.createRequest(t, (a) => {
      ...
      const s = _r(a, "location");
      if (s != null) {
        n < this.maxRedirects ? this.doDownload(cr.prepareRedirectUrlOptions(s, t), r, n++) : r.callback(this.createMaxRedirectError());
        return;
      }
      r.responseHandler == null ? Vm(r, a) : r.responseHandler(a, r.callback);
    });
  ...
  static prepareRedirectUrlOptions(t, r) {
    const n = Mf(t, { ...r }), i = n.headers;
    if (i != null && i.authorization) {
      const a = cr.reconstructOriginalUrl(r), s = Uf(t, r);
      cr.isCrossOriginRedirect(a, s) && (Ht.enabled && Ht(`Given the cross-origin redirect (from ${a.host} to ${s.host}), the Authorization header will be stripped out.`), delete i.authorization);
    }
    return n;
  }
  ...
  static retryOnServerError(t, r = 3) {
    for (let n = 0; ; n++)
      try {
        ...
        if (n < r && (i instanceof mo && i.isServerError() || i.code === "EPIPE"))
          continue;
        throw i;
      }
  }
...
function Uf(e, t) {
  try {
    ...
    return new ms.URL(e, a);
  }
}
function Mf(e, t) {
  const r = bi(t), n = Uf(e, t);
  return go(n, r), r;
}
function go(e, t) {
  t.protocol = e.protocol, t.hostname = e.hostname, e.port ? t.port = e.port : t.port && delete t.port, t.path = e.pathname + e.search;
}
class vs extends $m.Transform {
  ...
  validate() {
    if (this._actual == null)
      throw (0, Zl.newError)("Not finished yet", "ERR_STREAM_NOT_FINISHED");
    if (this._actual !== this.expected)
      throw (0, Zl.newError)(`${this.algorithm} checksum mismatch, expected ${this.expected}, got ${this._actual}`, "ERR_CHECKSUM_MISMATCH");
    return null;
  }
}
Ie.DigestTransform = vs;
function Gm(e, t, r) {
...
function Vm(e, t) {
  if (!Gm(_r(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  if (e.options.onProgress != null) {
    const s = _r(t, "content-length");
    s != null && r.push(new Hm.ProgressCallbackTransform(parseInt(s, 10), e.options.cancellationToken, e.options.onProgress));
  }
  const n = e.options.sha512;
  n != null ? r.push(new vs(n, "sha512", n.length === 128 && !n.includes("+") && !n.includes("Z") && !n.includes("=") ? "hex" : "base64")) : e.options.sha2 != null && r.push(new vs(e.options.sha2, "sha256", "hex"));
...
class Wm {
  ...
  get value() {
    ...
    if (this._value !== void 0 && $f(this.selected, t))
      return this._value;
    this.selected = t;
...
function $f(e, t) {
  if (typeof e == "object" && e !== null && (typeof t == "object" && t !== null)) {
    ...
    return i.length === a.length && i.every((s) => $f(e[s], t[s]));
  }
  return e === t;
}
var En = {};
...
En.githubUrl = zm;
En.githubTagPrefix = Ym;
En.getS3LikeProviderBaseUrl = Xm;
...
function Jm(e) {
  ...
  return Bf(`https://${e.name}.${e.region}.digitaloceanspaces.com`, e.path);
}
var vo = {};
...
async function Hf(e, t) {
  var r;
  const { retries: n, interval: i, backoff: a = 0, attempt: s = 0, shouldRetry: c, cancellationToken: l = new Qm.CancellationToken() } = t;
  try {
    return await e();
  } catch (f) {
    if (await Promise.resolve((r = c == null ? void 0 : c(f)) !== null && r !== void 0 ? r : !0) && n > 0 && !l.cancelled)
      return await new Promise((o) => setTimeout(o, i + a * s)), await Hf(e, { ...t, retries: n - 1, attempt: s + 1 });
    throw f;
  }
}
var yo = {};
...
br.nil = br.UUID = void 0;
const qf = vn, jf = Ar, eg = "options.name must be either a string or a Buffer", ec = (0, qf.randomBytes)(16);
ec[0] = ec[0] | 1;
const mi = {}, J = [];
for (let e = 0; e < 256; e++) {
...
class Kt {
  ...
  static check(t, r = 0) {
    if (typeof t == "string")
      return t = t.toLowerCase(), /^[a-f0-9]{8}(-[a-f0-9]{4}){3}-([a-f0-9]{12})$/.test(t) ? t === "00000000-0000-0000-0000-000000000000" ? { version: void 0, variant: "nil", format: "ascii" } : {
        version: (mi[t[14] + t[15]] & 240) >> 4,
        variant: tc((mi[t[19] + t[20]] & 224) >> 5),
        format: "ascii"
      } : !1;
    if (Buffer.isBuffer(t)) {
      ...
      return n === 16 ? { version: void 0, variant: "nil", format: "binary" } : {
        version: (t[r + 6] & 240) >> 4,
        variant: tc((t[r + 8] & 224) >> 5),
        format: "binary"
      };
    }
    throw (0, jf.newError)("Unknown type of uuid", "ERR_UNKNOWN_UUID_TYPE");
  }
  ...
  static parse(t) {
    ...
    let n = 0;
    for (let i = 0; i < 16; i++)
      r[i] = mi[t[n++] + t[n++]], (i === 3 || i === 5 || i === 7 || i === 9) && (n += 1);
    return r;
  }
}
br.UUID = Kt;
...
function tg(e, t, r, n, i = Xr.ASCII) {
  const a = (0, qf.createHash)(t);
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, jf.newError)(eg, "ERR_INVALID_UUID_NAME");
  ...
  switch (i) {
    case Xr.BINARY:
      ...
      break;
    case Xr.OBJECT:
      c[6] = c[6] & 15 | r, c[8] = c[8] & 63 | 128, l = new Kt(c);
      break;
    default:
...
br.nil = new Kt("00000000-0000-0000-0000-000000000000");
var wn = {}, Gf = {};
(function(e) {
  (function(t) {
        ...
        if (re > v)
          switch (r[x]) {
            case "textNode":
              ...
              break;
            case "cdata":
              j(w, "oncdata", w.cdata), w.cdata = "";
              break;
            case "script":
              j(w, "onscript", w.script), w.script = "";
              break;
            default:
    ...
    function s(w) {
      K(w), w.cdata !== "" && (j(w, "oncdata", w.cdata), w.cdata = ""), w.script !== "" && (j(w, "onscript", w.script), w.script = "");
    }
    n.prototype = {
      end: function() {
        U(this);
...
Char: ` + w.c), v = new Error(v), w.error = v, H(w, "onerror", v), w;
    ...
    function M(w) {
      ...
      w.opt.xmlns && (O.ns = v.ns), w.attribList.length = 0, j(w, "onopentagstart", O);
    }
    function k(w, v) {
...
Actual: ` + w.attribValue
        ...
        w.tag.attributes[w.attribName] = w.attribValue, j(w, "onattribute", {
          name: w.attribName,
          value: w.attribValue
        });
      w.attribName = w.attribValue = "";
    ...
    function X(w, v) {
      if (w.opt.xmlns) {
        ...
        O.ns && Q.ns !== O.ns && Object.keys(O.ns).forEach(function(Ln) {
          j(w, "onopennamespace", {
            prefix: Ln,
            uri: O.ns[Ln]
          });
        ...
        for (var re = 0, oe = w.attribList.length; re < oe; re++) {
          var ye = w.attribList[re], be = ye[0], mt = ye[1], he = k(be, !0), We = he.prefix, aa = he.local, Nn = We === "" ? "" : O.ns[We] || "", Or = {
            name: be,
            value: mt,
            prefix: We,
            local: aa,
          ...
          ), Or.uri = We), w.tag.attributes[be] = Or, j(w, "onattribute", Or);
        }
        w.attribList.length = 0;
      }
      w.tag.isSelfClosing = !!v, w.sawRoot = !0, w.tags.push(w.tag), j(w, "onopentag", w.tag), v || (!w.noscript && w.tagName.toLowerCase() === "script" ? w.state = C.SCRIPT : w.state = C.TEXT, w.tag = null, w.tagName = ""), w.attribName = w.attribValue = "", w.attribList.length = 0;
    }
    function z(w) {
      if (!w.tagName) {
      ...
      for (var re = w.tags.length; re-- > v; ) {
        ...
        w.tagName = w.tag.name, j(w, "onclosetag", w.tagName);
        var ye = {};
        for (var be in oe.ns)
          ye[be] = oe.ns[be];
        var mt = w.tags[w.tags.length - 1] || w;
        w.opt.xmlns && oe.ns !== mt.ns && Object.keys(oe.ns).forEach(function(he) {
          var We = oe.ns[he];
          j(w, "onclosenamespace", { prefix: he, uri: We });
        });
      }
          ...
          case C.TEXT:
            if (v.sawRoot && !v.closedRoot) {
              for (var re = O - 1; x && x !== "<" && x !== "&"; )
                x = G(w, O++), x && v.trackPosition && (v.position++, x === `
` ? (v.line++, v.column = 0) : v.column++);
          ...
          case C.SGML_DECL:
            ...
            v.doctype && v.doctype !== !0 && v.sgmlDecl ? (v.state = C.DOCTYPE_DTD, v.doctype += "<!" + v.sgmlDecl + x, v.sgmlDecl = "") : (v.sgmlDecl + x).toUpperCase() === d ? (j(v, "onopencdata"), v.state = C.CDATA, v.sgmlDecl = "", v.cdata = "") : (v.sgmlDecl + x).toUpperCase() === u ? (v.state = C.DOCTYPE, (v.doctype || v.sawRoot) && R(
              v,
              "Inappropriately located doctype declaration"
            ), v.doctype = "", v.sgmlDecl = "") : x === ">" ? (j(v, "onsgmldeclaration", v.sgmlDecl), v.sgmlDecl = "", v.state = C.TEXT) : (A(x) && (v.state = C.SGML_DECL_QUOTED), v.sgmlDecl += x);
            continue;
          case C.SGML_DECL_QUOTED:
            x === v.q && (v.state = C.SGML_DECL, v.q = ""), v.sgmlDecl += x;
            continue;
          case C.DOCTYPE:
            x === ">" ? (v.state = C.TEXT, j(v, "ondoctype", v.doctype), v.doctype = !0) : (v.doctype += x, x === "[" ? v.state = C.DOCTYPE_DTD : A(x) && (v.state = C.DOCTYPE_QUOTED, v.q = x));
            continue;
          ...
          case C.COMMENT_ENDING:
            x === "-" ? (v.state = C.COMMENT_ENDED, v.comment = L(v.opt, v.comment), v.comment && j(v, "oncomment", v.comment), v.comment = "") : (v.comment += "-" + x, v.state = C.COMMENT);
            continue;
...
` ? (v.line++, v.column = 0) : v.column++);
          ...
          case C.CDATA_ENDING_2:
            x === ">" ? (v.cdata && j(v, "oncdata", v.cdata), j(v, "onclosecdata"), v.cdata = "", v.state = C.TEXT) : x === "]" ? v.cdata += "]" : (v.cdata += "]]" + x, v.state = C.CDATA);
            continue;
          case C.PROC_INST:
          ...
          case C.ATTRIB:
            ...
            continue;
          case C.ATTRIB_NAME:
            x === "=" ? v.state = C.ATTRIB_VALUE : x === ">" ? (R(v, "Attribute without value"), v.attribValue = v.attribName, V(v), X(v)) : _(x) ? v.state = C.ATTRIB_NAME_SAW_WHITE : T(E, x) ? v.attribName += x : R(v, "Invalid attribute name");
            continue;
          case C.ATTRIB_NAME_SAW_WHITE:
            if (x === "=")
              ...
              if (_(x))
                continue;
              R(v, "Attribute without value"), v.tag.attributes[v.attribName] = "", v.attribValue = "", j(v, "onattribute", {
                name: v.attribName,
                value: ""
          ...
          case C.ATTRIB_VALUE_QUOTED:
            ...
            V(v), v.q = "", v.state = C.ATTRIB_VALUE_CLOSED;
            continue;
    ...
    String.fromCodePoint || function() {
      var w = String.fromCharCode, v = Math.floor, O = function() {
        ...
        for (var mt = ""; ++ye < be; ) {
          ...
          he <= 65535 ? Q.push(he) : (he -= 65536, re = (he >> 10) + 55296, oe = he % 1024 + 56320, Q.push(re, oe)), (ye + 1 === be || Q.length > x) && (mt += w.apply(null, Q), Q.length = 0);
        }
        return mt;
      };
...
class Vf {
  constructor(t) {
    if (this.name = t, this.value = "", this.attributes = null, this.isCData = !1, this.elements = null, !t)
      throw (0, Kn.newError)("Element name cannot be empty", "ERR_XML_ELEMENT_NAME_EMPTY");
    if (!ag(t))
      throw (0, Kn.newError)(`Invalid element name: ${t}`, "ERR_XML_ELEMENT_INVALID_NAME");
  }
  attribute(t) {
    const r = this.attributes === null ? null : this.attributes[t];
    if (r == null)
      throw (0, Kn.newError)(`No attribute "${t}"`, "ERR_XML_MISSED_ATTRIBUTE");
    return r;
  }
  removeAttribute(t) {
  ...
  element(t, r = !1, n = null) {
    ...
    if (i === null)
      throw (0, Kn.newError)(n || `No element "${t}"`, "ERR_XML_MISSED_ELEMENT");
    return i;
  }
  elementOrNull(t, r = !1) {
  ...
  getElements(t, r = !1) {
    return this.elements === null ? [] : this.elements.filter((n) => rc(n, t, r));
  }
...
function lg(e) {
  return Array.isArray(e) ? e : Wf(e) ? [] : [e];
}
function cg(e, t) {
  var r, n, i, a;
  if (t)
...
function hg(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(s - l < 0); l++)
    f = Oa(
      ...
      d
    ), c = Vr.repeat(" ", t.indent) + Ra((e.line - l + 1).toString(), o) + " | " + f.str + `
` + c;
  for (f = Oa(e.buffer, n[s], i[s], e.position, d), c += Vr.repeat(" ", t.indent) + Ra((e.line + 1).toString(), o) + " | " + f.str + `
`, c += Vr.repeat("-", t.indent + o + 3 + f.pos) + `^
...
function vg(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    if (pg.indexOf(r) === -1)
      throw new nc('Unknown option "' + r + '" is met in definition of "' + e + '" YAML type.');
    ...
    throw new nc('Unknown kind "' + this.kind + '" is specified for "' + e + '" YAML type.');
}
var Ne = vg, Ur = bn, Da = Ne;
function ic(e, t) {
  var r = [];
...
ys.prototype.extend = function(t) {
  var r = [], n = [];
  if (t instanceof Da)
    n.push(t);
    ...
    throw new Ur("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");
  r.forEach(function(a) {
    if (!(a instanceof Da))
      throw new Ur("Specified list of YAML types (or a single Type object) contains a non-Type object.");
    if (a.loadKind && a.loadKind !== "scalar")
      throw new Ur("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");
    if (a.multi)
      throw new Ur("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.");
  }), n.forEach(function(a) {
    if (!(a instanceof Da))
      throw new Ur("Specified list of YAML types (or a single Type object) contains a non-Type object.");
  });
  var i = Object.create(ys.prototype);
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = ic(i, "implicit"), i.compiledExplicit = ic(i, "explicit"), i.compiledTypeMap = yg(i.compiledImplicit, i.compiledExplicit), i;
};
var Yf = ys, _g = Ne, Xf = new _g("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), Eg = Ne, Kf = new Eg("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), wg = Ne, Jf = new wg("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var Zf = new Sg("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: Cg,
  construct: Ag,
  predicate: Pg,
...
var eh = new xg("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: Tg,
  construct: Ig,
  predicate: Og,
...
var th = new Dg("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: Fg,
  construct: Ug,
  predicate: Mg,
...
function Gg(e, t) {
  ...
  else if (rh.isNegativeZero(e))
    return "-0.0";
  return r = e.toString(10), jg.test(r) ? r.replace("e", ".e") : r;
}
function Vg(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && (e % 1 !== 0 || rh.isNegativeZero(e));
}
var nh = new $g("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: Hg,
  construct: qg,
  predicate: Vg,
...
}), ah = ih, Wg = Ne, sh = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"
), oh = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$"
);
function zg(e) {
  return e === null ? !1 : sh.exec(e) !== null || oh.exec(e) !== null;
}
function Yg(e) {
  var t, r, n, i, a, s, c, l = 0, f = null, o, d, u;
  if (t = sh.exec(e), t === null && (t = oh.exec(e)), t === null) throw new Error("Date resolve error");
...
var lh = new Wg("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: zg,
  construct: Yg,
  instanceOf: Date,
...
var ch = new Kg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: Jg
}), Qg = Ne, Eo = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function Zg(e) {
  if (e === null) return !1;
  var t, r, n = 0, i = e.length, a = Eo;
  for (r = 0; r < i; r++)
...
var uh = new Qg("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Zg,
  construct: e2,
  predicate: r2,
  represent: t2
}), n2 = Ne, i2 = Object.prototype.hasOwnProperty, a2 = Object.prototype.toString;
function s2(e) {
  if (e === null) return !0;
  var t = [], r, n, i, a, s, c = e;
  for (r = 0, n = c.length; r < n; r += 1) {
    if (i = c[r], s = !1, a2.call(i) !== "[object Object]") return !1;
    for (a in i)
      if (i2.call(i, a))
        if (!s) s = !0;
        else return !1;
...
var fh = new n2("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: s2,
  construct: o2
}), l2 = Ne, c2 = Object.prototype.toString;
function u2(e) {
  if (e === null) return !0;
  var t, r, n, i, a, s = e;
  for (a = new Array(s.length), t = 0, r = s.length; t < r; t += 1) {
    if (n = s[t], c2.call(n) !== "[object Object]" || (i = Object.keys(n), i.length !== 1)) return !1;
    a[t] = [i[0], n[i[0]]];
  }
  return !0;
}
...
var hh = new l2("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: u2,
  construct: f2
}), h2 = Ne, d2 = Object.prototype.hasOwnProperty;
function p2(e) {
  if (e === null) return !0;
  var t, r = e;
  for (t in r)
    if (d2.call(r, t) && r[t] !== null)
      return !1;
  return !0;
}
function m2(e) {
...
var dh = new h2("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: p2,
  construct: m2
}), wo = ah.extend({
...
}), Vt = Ze, ph = bn, g2 = dg, v2 = wo, Tt = Object.prototype.hasOwnProperty, Ci = 1, mh = 2, gh = 3, Ai = 4, Na = 1, y2 = 2, ac = 3, _2 = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, E2 = /[\x85\u2028\u2029]/, w2 = /[,\[\]\{\}]/, vh = /^(?:!|!!|![a-z\-]+!)$/i, yh = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function sc(e) {
...
var Eh = new Array(256), wh = new Array(256);
for (var ir = 0; ir < 256; ir++)
  Eh[ir] = oc(ir) ? 1 : 0, wh[ir] = oc(ir);
function P2(e, t) {
  this.input = e, this.filename = t.filename || null, this.schema = t.schema || v2, this.onWarning = t.onWarning || null, this.legacy = t.legacy || !1, this.json = t.json || !1, this.listener = t.listener || null, this.implicitTypes = this.schema.compiledImplicit, this.typeMap = this.schema.compiledTypeMap, this.length = e.length, this.position = 0, this.line = 0, this.lineStart = 0, this.lineIndent = 0, this.firstTabInLine = -1, this.documents = [];
}
function bh(e, t) {
  var r = {
    name: e.filename,
  ...
  return r.snippet = g2(r), new ph(t, r);
}
function q(e, t) {
  throw bh(e, t);
}
function Pi(e, t) {
  e.onWarning && e.onWarning.call(null, bh(e, t));
}
var lc = {
  YAML: function(t, r, n) {
    var i, a, s;
    t.version !== null && q(t, "duplication of %YAML directive"), n.length !== 1 && q(t, "YAML directive accepts exactly one argument"), i = /^([0-9]+)\.([0-9]+)$/.exec(n[0]), i === null && q(t, "ill-formed argument of the YAML directive"), a = parseInt(i[1], 10), s = parseInt(i[2], 10), a !== 1 && q(t, "unacceptable YAML version of the document"), t.version = n[0], t.checkLineBreaks = s < 2, s !== 1 && s !== 2 && Pi(t, "unsupported YAML version of the document");
  },
  TAG: function(t, r, n) {
    var i, a;
    n.length !== 2 && q(t, "TAG directive accepts exactly two arguments"), i = n[0], a = n[1], vh.test(i) || q(t, "ill-formed tag handle (first argument) of the TAG directive"), Tt.call(t.tagMap, i) && q(t, 'there is a previously declared suffix for "' + i + '" tag handle'), yh.test(a) || q(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function Ct(e, t, r, n) {
  ...
  if (t < r) {
    ...
    else _2.test(c) && q(e, "the stream contains non-printable characters");
    e.result += c;
  }
}
function cc(e, t, r, n) {
  var i, a, s, c;
  for (Vt.isObject(r) || q(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(r), s = 0, c = i.length; s < c; s += 1)
    a = i[s], Tt.call(t, a) || (_h(t, a, r[a]), n[a] = !0);
}
function fr(e, t, r, n, i, a, s, c, l) {
  var f, o;
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), f = 0, o = i.length; f < o; f += 1)
      Array.isArray(i[f]) && q(e, "nested arrays are not supported inside keys"), typeof i == "object" && sc(i[f]) === "[object Object]" && (i[f] = "[object Object]");
  if (typeof i == "object" && sc(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    if (Array.isArray(a))
    ...
    !e.json && !Tt.call(r, i) && Tt.call(t, i) && (e.line = s || e.line, e.lineStart = c || e.lineStart, e.position = l || e.position, q(e, "duplicated mapping key")), _h(t, i, a), delete r[i];
  return t;
}
function bo(e) {
  var t;
...
function x2(e, t, r) {
  ...
  if (h = e.input.charCodeAt(e.position), Fe(h) || ur(h) || h === 35 || h === 38 || h === 42 || h === 33 || h === 124 || h === 62 || h === 39 || h === 34 || h === 37 || h === 64 || h === 96 || (h === 63 || h === 45) && (i = e.input.charCodeAt(e.position + 1), Fe(i) || r && ur(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = s = e.position, c = !1; h !== 0; ) {
    if (h === 58) {
      if (i = e.input.charCodeAt(e.position + 1), Fe(i) || r && ur(i))
        break;
    } else if (h === 35) {
      if (n = e.input.charCodeAt(e.position - 1), Fe(n))
        break;
    } else {
      if (e.position === e.lineStart && Bi(e) || r && ur(h))
        break;
      if (st(h))
    ...
    c && (Ct(e, a, s, !1), So(e, e.line - l), a = s = e.position, c = !1), Yt(h) || (s = e.position + 1), h = e.input.charCodeAt(++e.position);
  }
  return Ct(e, a, s, !1), e.result ? !0 : (e.kind = d, e.result = u, !1);
}
function T2(e, t) {
  var r, n, i;
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (Ct(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else st(r) ? (Ct(e, n, i, !0), So(e, ue(e, !1, t)), n = i = e.position) : e.position === e.lineStart && Bi(e) ? q(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
...
function I2(e, t) {
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (c = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (c === 92) {
      if (Ct(e, r, e.position, !0), c = e.input.charCodeAt(++e.position), st(c))
        ue(e, !1, t);
      else if (c < 256 && Eh[c])
        e.result += wh[c], e.position++;
      else if ((s = S2(c)) > 0) {
        for (i = s, a = 0; i > 0; i--)
          c = e.input.charCodeAt(++e.position), (s = b2(c)) >= 0 ? a = (a << 4) + s : q(e, "expected hexadecimal character");
        e.result += A2(a), e.position++;
      } else
        q(e, "unknown escape sequence");
      r = n = e.position;
    } else st(c) ? (Ct(e, r, n, !0), So(e, ue(e, !1, t)), r = n = e.position) : e.position === e.lineStart && Bi(e) ? q(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function O2(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = c), y = e.input.charCodeAt(++e.position); y !== 0; ) {
    ...
    r ? y === 44 && q(e, "expected the node content, but found ','") : q(e, "missed comma between flow collection entries"), g = m = E = null, d = u = !1, y === 63 && (f = e.input.charCodeAt(e.position + 1), Fe(f) && (d = u = !0, e.position++, ue(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Sr(e, t, Ci, !1, !0), g = e.tag, m = e.result, ue(e, !0, t), y = e.input.charCodeAt(e.position), (u || e.line === n) && y === 58 && (d = !0, y = e.input.charCodeAt(++e.position), ue(e, !0, t), Sr(e, t, Ci, !1, !0), E = e.result), h ? fr(e, c, p, g, m, E, n, i, a) : d ? c.push(fr(e, null, p, g, m, E, n, i, a)) : c.push(m), ue(e, !0, t), y = e.input.charCodeAt(e.position), y === 44 ? (r = !0, y = e.input.charCodeAt(++e.position)) : r = !1;
  }
  q(e, "unexpected end of the stream within a flow collection");
}
function R2(e, t) {
  var r, n, i = Na, a = !1, s = !1, c = t, l = 0, f = !1, o, d;
  ...
  for (e.kind = "scalar", e.result = ""; d !== 0; )
    if (d = e.input.charCodeAt(++e.position), d === 43 || d === 45)
      Na === i ? i = d === 43 ? ac : y2 : q(e, "repeat of a chomping mode identifier");
    else if ((o = C2(d)) >= 0)
  ...
  for (; d !== 0; ) {
    for (bo(e), e.lineIndent = 0, d = e.input.charCodeAt(e.position); (!s || e.lineIndent < c) && d === 32; )
      e.lineIndent++, d = e.input.charCodeAt(++e.position);
    if (!s && e.lineIndent > c && (c = e.lineIndent), st(d)) {
      l++;
      continue;
    }
    if (e.lineIndent < c) {
      i === ac ? e.result += Vt.repeat(`
`, a ? 1 + l : l) : i === Na && a && (e.result += `
`);
      break;
    }
    for (n ? Yt(d) ? (f = !0, e.result += Vt.repeat(`
`, a ? 1 + l : l)) : f ? (f = !1, e.result += Vt.repeat(`
`, l + 1)) : l === 0 ? a && (e.result += " ") : e.result += Vt.repeat(`
`, l) : e.result += Vt.repeat(`
`, a ? 1 + l : l), a = !0, s = !0, l = 0, r = e.position; !st(d) && d !== 0; )
      d = e.input.charCodeAt(++e.position);
    Ct(e, r, e.position, !1);
  }
  return !0;
...
function uc(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, q(e, "tab characters must not be used in indentation")), !(l !== 45 || (s = e.input.charCodeAt(e.position + 1), !Fe(s)))); ) {
    ...
    if (r = e.line, Sr(e, t, gh, !1, !0), a.push(e.result), ue(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
function D2(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = d), y = e.input.charCodeAt(e.position); y !== 0; ) {
    if (!g && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, q(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (y === 63 || y === 58) && Fe(n))
      y === 63 ? (g && (fr(e, d, u, h, p, null, s, c, l), h = p = m = null), E = !0, g = !0, i = !0) : g ? (g = !1, i = !0) : q(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, y = n;
    else {
      if (s = e.line, c = e.lineStart, l = e.position, !Sr(e, r, mh, !1, !0))
        break;
      if (e.line === a) {
        for (y = e.input.charCodeAt(e.position); Yt(y); )
          y = e.input.charCodeAt(++e.position);
        if (y === 58)
          y = e.input.charCodeAt(++e.position), Fe(y) || q(e, "a whitespace character is expected after the key-value separator within a block mapping"), g && (fr(e, d, u, h, p, null, s, c, l), h = p = m = null), E = !0, g = !1, i = !1, h = e.tag, p = e.result;
        else if (E)
    ...
    if ((e.line === a || e.lineIndent > t) && (g && (s = e.line, c = e.lineStart, l = e.position), Sr(e, t, Ai, !0, i) && (g ? p = e.result : m = e.result), g || (fr(e, d, u, h, p, m, s, c, l), h = p = m = null), ue(e, !0, -1), y = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && y !== 0)
      q(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return g && fr(e, d, u, h, p, null, s, c, l), E && (e.tag = f, e.anchor = o, e.kind = "mapping", e.result = d), E;
}
function N2(e) {
  var t, r = !1, n = !1, i, a, s;
  ...
  if (e.tag !== null && q(e, "duplication of a tag property"), s = e.input.charCodeAt(++e.position), s === 60 ? (r = !0, s = e.input.charCodeAt(++e.position)) : s === 33 ? (n = !0, i = "!!", s = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, r) {
    ...
    for (; s !== 0 && !Fe(s); )
      s === 33 && (n ? q(e, "tag suffix cannot contain exclamation marks") : (i = e.input.slice(t - 1, e.position + 1), vh.test(i) || q(e, "named tag handle cannot contain such characters"), n = !0, t = e.position + 1)), s = e.input.charCodeAt(++e.position);
    a = e.input.slice(t, e.position), w2.test(a) && q(e, "tag suffix cannot contain flow indicator characters");
  }
  a && !yh.test(a) && q(e, "tag name cannot contain such characters: " + a);
  try {
    a = decodeURIComponent(a);
  } catch {
    q(e, "tag name is malformed: " + a);
  }
  return r ? e.tag = a : Tt.call(e.tagMap, i) ? e.tag = e.tagMap[i] + a : i === "!" ? e.tag = "!" + a : i === "!!" ? e.tag = "tag:yaml.org,2002:" + a : q(e, 'undeclared tag handle "' + i + '"'), !0;
}
function L2(e) {
  var t, r;
  if (r = e.input.charCodeAt(e.position), r !== 38) return !1;
  for (e.anchor !== null && q(e, "duplication of an anchor property"), r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !Fe(r) && !ur(r); )
...
function k2(e) {
  ...
  for (n = e.input.charCodeAt(++e.position), t = e.position; n !== 0 && !Fe(n) && !ur(n); )
    n = e.input.charCodeAt(++e.position);
  return e.position === t && q(e, "name of an alias node must contain at least one character"), r = e.input.slice(t, e.position), Tt.call(e.anchorMap, r) || q(e, 'unidentified alias "' + r + '"'), e.result = e.anchorMap[r], ue(e, !0, -1), !0;
}
function Sr(e, t, r, n, i) {
  var a, s, c, l = 1, f = !1, o = !1, d, u, h, p, m, g;
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = s = c = Ai === r || gh === r, n && ue(e, !0, -1) && (f = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; N2(e) || L2(e); )
      ue(e, !0, -1) ? (f = !0, c = a, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : c = !1;
  if (c && (c = f || i), (l === 1 || Ai === r) && (Ci === r || mh === r ? m = t : m = t + 1, g = e.position - e.lineStart, l === 1 ? c && (uc(e, g) || D2(e, g, m)) || O2(e, m) ? o = !0 : (s && R2(e, m) || T2(e, m) || I2(e, m) ? o = !0 : k2(e) ? (o = !0, (e.tag !== null || e.anchor !== null) && q(e, "alias node should not have any properties")) : x2(e, m, Ci === r) && (o = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (o = c && uc(e, g))), e.tag === null)
...
function F2(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (ue(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && bo(e), Tt.call(lc, n) ? lc[n](e, n, i) : Pi(e, 'unknown document directive "' + n + '"');
  }
  if (ue(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, ue(e, !0, -1)) : a && q(e, "directives end mark is expected"), Sr(e, e.lineIndent - 1, Ai, !1, !0), ue(e, !0, -1), e.checkLineBreaks && E2.test(e.input.slice(t, e.position)) && Pi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Bi(e)) {
...
`), e.charCodeAt(0) === 65279 && (e = e.slice(1)));
  var r = new P2(e, t), n = e.indexOf("\0");
...
function M2(e, t) {
  ...
  if (r.length !== 0) {
    if (r.length === 1)
      return r[0];
    throw new ph("expected a single document in the stream, but found more");
  }
}
_o.loadAll = U2;
_o.load = M2;
var Ch = {}, Hi = Ze, Sn = bn, $2 = wo, Ah = Object.prototype.toString, Ph = Object.prototype.hasOwnProperty, Co = 65279, B2 = 9, an = 10, H2 = 13, q2 = 32, j2 = 33, G2 = 34, _s = 35, V2 = 37, W2 = 38, z2 = 39, Y2 = 42, xh = 44, X2 = 45, xi = 58, K2 = 61, J2 = 62, Q2 = 63, Z2 = 64, Th = 91, Ih = 93, ev = 96, Oh = 123, tv = 124, Rh = 125, Ae = {};
Ae[0] = "\\0";
Ae[7] = "\\a";
Ae[8] = "\\b";
Ae[9] = "\\t";
...
function iv(e, t) {
  ...
  for (r = {}, n = Object.keys(t), i = 0, a = n.length; i < a; i += 1)
    s = n[i], c = String(t[s]), s.slice(0, 2) === "!!" && (s = "tag:yaml.org,2002:" + s.slice(2)), l = e.compiledTypeMap.fallback[s], l && Ph.call(l.styleAliases, c) && (c = l.styleAliases[c]), r[s] = c;
  return r;
}
function av(e) {
  var t, r, n;
  if (t = e.toString(16).toUpperCase(), e <= 255)
    ...
    throw new Sn("code point within a string may not be greater than 0xFFFFFFFF");
  return "\\" + r + Hi.repeat("0", n - t.length) + t;
}
var sv = 1, sn = 2;
function ov(e) {
  this.schema = e.schema || $2, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = Hi.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = iv(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? sn : sv, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function fc(e, t) {
  for (var r = Hi.repeat(" ", t), n = 0, i = -1, a = "", s, c = e.length; n < c; )
    i = e.indexOf(`
...
function dc(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== xh && e !== Th && e !== Ih && e !== Oh && e !== Rh) && e !== _s && !(t === xi && !i) || hc(t) && !Ti(t) && e === _s || t === xi && i
  );
}
function cv(e) {
  return on(e) && e !== Co && !Ti(e) && e !== X2 && e !== Q2 && e !== xi && e !== xh && e !== Th && e !== Ih && e !== Oh && e !== Rh && e !== _s && e !== W2 && e !== Y2 && e !== j2 && e !== tv && e !== K2 && e !== J2 && e !== z2 && e !== G2 && e !== V2 && e !== Z2 && e !== ev;
}
function uv(e) {
  return !Ti(e) && e !== xi;
}
...
var Nh = 1, ws = 2, Lh = 3, kh = 4, lr = 5;
function fv(e, t, r, n, i, a, s, c) {
  var l, f = 0, o = null, d = !1, u = !1, h = n !== -1, p = -1, m = cv(Wr(e, 0)) && uv(Wr(e, e.length - 1));
  if (t || s)
  ...
  return !d && !u ? m && !s && !i(e) ? Nh : a === sn ? lr : ws : r > 9 && Dh(e) ? lr : s ? a === sn ? lr : ws : u ? kh : Lh;
}
function hv(e, t, r, n, i) {
  e.dump = function() {
    if (t.length === 0)
      return e.quotingType === sn ? '""' : "''";
    if (!e.noCompatMode && (rv.indexOf(t) !== -1 || nv.test(t)))
      return e.quotingType === sn ? '"' + t + '"' : "'" + t + "'";
    ...
    switch (fv(
      ...
      case ws:
        return "'" + t.replace(/'/g, "''") + "'";
      case Lh:
        return "|" + pc(t, e.indent) + mc(fc(t, a));
      case kh:
        return ">" + pc(t, e.indent) + mc(fc(dv(t, s), a));
      case lr:
        return '"' + pv(t) + '"';
      default:
...
function pc(e, t) {
  var r = Dh(e) ? String(t) : "", n = e[e.length - 1] === `
`, i = n && (e[e.length - 2] === `
` || e === `
`), a = i ? "+" : n ? "" : "-";
  return r + a + `
...
function dv(e, t) {
  for (var r = /(\n+)([^\n]*)/g, n = function() {
    var f = e.indexOf(`
`);
    return f = f !== -1 ? f : e.length, r.lastIndex = f, gc(e.slice(0, f), t);
  }(), i = e[0] === `
` || e[0] === " ", a, s; s = r.exec(e); ) {
    var c = s[1], l = s[2];
    a = l[0] === " ", n += c + (!i && !a && l !== "" ? `
...
function pv(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Wr(e, i), n = Ae[r], !n && on(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || av(r);
  return t;
}
function mv(e, t, r) {
  var n = "", i = e.tag, a, s, c;
  for (a = 0, s = r.length; a < s; a += 1)
    c = r[a], e.replacer && (c = e.replacer.call(r, String(a), c)), (pt(e, t, c, !1, !1) || typeof c > "u" && pt(e, t, null, !1, !1)) && (n !== "" && (n += "," + (e.condenseFlow ? "" : " ")), n += e.dump);
  e.tag = i, e.dump = "[" + n + "]";
}
function vc(e, t, r, n) {
  var i = "", a = e.tag, s, c, l;
  for (s = 0, c = r.length; s < c; s += 1)
    l = r[s], e.replacer && (l = e.replacer.call(r, String(s), l)), (pt(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && pt(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Es(e, t)), e.dump && an === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function gv(e, t, r) {
  var n = "", i = e.tag, a = Object.keys(r), s, c, l, f, o;
  for (s = 0, c = a.length; s < c; s += 1)
    o = "", n !== "" && (o += ", "), e.condenseFlow && (o += '"'), l = a[s], f = r[l], e.replacer && (f = e.replacer.call(r, l, f)), pt(e, t, l, !1, !1) && (e.dump.length > 1024 && (o += "? "), o += e.dump + (e.condenseFlow ? '"' : "") + ":" + (e.condenseFlow ? "" : " "), pt(e, t, f, !1, !1) && (o += e.dump, n += o));
  e.tag = i, e.dump = "{" + n + "}";
}
function vv(e, t, r, n) {
  ...
  if (e.sortKeys === !0)
    ...
    throw new Sn("sortKeys must be a boolean or a function");
  for (c = 0, l = s.length; c < l; c += 1)
    u = "", (!n || i !== "") && (u += Es(e, t)), f = s[c], o = r[f], e.replacer && (o = e.replacer.call(r, f, o)), pt(e, t + 1, f, !0, !0, !0) && (d = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, d && (e.dump && an === e.dump.charCodeAt(0) ? u += "?" : u += "? "), u += e.dump, d && (u += Es(e, t)), pt(e, t + 1, o, !0, d) && (e.dump && an === e.dump.charCodeAt(0) ? u += ":" : u += ": ", u += e.dump, i += u));
  e.tag = a, e.dump = i || "{}";
}
function yc(e, t, r) {
  var n, i, a, s, c, l;
  for (i = r ? e.explicitTypes : e.implicitTypes, a = 0, s = i.length; a < s; a += 1)
    if (c = i[a], (c.instanceOf || c.predicate) && (!c.instanceOf || typeof t == "object" && t instanceof c.instanceOf) && (!c.predicate || c.predicate(t))) {
      if (r ? c.multi && c.representName ? e.tag = c.representName(t) : e.tag = c.tag : e.tag = "?", c.represent) {
        if (l = e.styleMap[c.tag] || c.defaultStyle, Ah.call(c.represent) === "[object Function]")
          n = c.represent(t, l);
        else if (Ph.call(c.represent, l))
          n = c.represent[l](t, l);
        else
          throw new Sn("!<" + c.tag + '> tag resolver accepts not "' + l + '" style');
        e.dump = n;
      }
      return !0;
    }
...
function pt(e, t, r, n, i, a, s) {
  e.tag = null, e.dump = r, yc(e, r, !1) || yc(e, r, !0);
  var c = Ah.call(e.dump), l = n, f;
  ...
  if (o && (d = e.duplicates.indexOf(r), u = d !== -1), (e.tag !== null && e.tag !== "?" || u || e.indent !== 2 && t > 0) && (i = !1), u && e.usedDuplicates[d])
    ...
    if (o && u && !e.usedDuplicates[d] && (e.usedDuplicates[d] = !0), c === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (vv(e, t, e.dump, i), u && (e.dump = "&ref_" + d + e.dump)) : (gv(e, t, e.dump), u && (e.dump = "&ref_" + d + " " + e.dump));
    else if (c === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? vc(e, t - 1, e.dump, i) : vc(e, t, e.dump, i), u && (e.dump = "&ref_" + d + e.dump)) : (mv(e, t, e.dump), u && (e.dump = "&ref_" + d + " " + e.dump));
    else if (c === "[object String]")
      e.tag !== "?" && hv(e, e.dump, t, a, l);
    else {
      if (c === "[object Undefined]")
        return !1;
      if (e.skipInvalid) return !1;
      throw new Sn("unacceptable kind of an object to dump " + c);
    }
...
function yv(e, t) {
  var r = [], n = [], i, a;
  for (bs(e, r, n), i = 0, a = n.length; i < a; i += 1)
...
we.Type = Ne;
we.Schema = Yf;
we.FAILSAFE_SCHEMA = Qf;
we.JSON_SCHEMA = ih;
we.CORE_SCHEMA = ah;
we.DEFAULT_SCHEMA = wo;
we.load = Fh.load;
we.loadAll = Fh.loadAll;
we.dump = Ev.dump;
we.YAMLException = bn;
we.types = {
  binary: uh,
...
we.safeLoad = Ao("safeLoad", "load");
we.safeLoadAll = Ao("safeLoadAll", "loadAll");
we.safeDump = Ao("safeDump", "dump");
var qi = {};
...
qi.Lazy = wv;
var Ss = { exports: {} };
const bv = "2.0.0", Uh = 256, Sv = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, Cv = 16, Av = Uh - 6, Pv = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
const xv = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...e) => console.error("SEMVER", ...e) : () => {
};
var Gi = xv;
(function(e, t) {
  const {
...
var Cn = Ss.exports;
const Tv = Object.freeze({ loose: !0 }), Iv = Object.freeze({}), Ov = (e) => e ? typeof e != "object" ? Tv : e : Iv;
var Po = Ov;
const _c = /^[0-9]+$/, Mh = (e, t) => {
...
var $h = {
  compareIdentifiers: Mh,
  rcompareIdentifiers: Rv
};
const Jn = Gi, { MAX_LENGTH: Ec, MAX_SAFE_INTEGER: Qn } = ji, { safeRe: Zn, t: ei } = Cn, Dv = Po, { compareIdentifiers: La } = $h;
let Nv = class at {
  constructor(t, r) {
    if (r = Dv(r), t instanceof at) {
    ...
    const n = t.trim().match(r.loose ? Zn[ei.LOOSE] : Zn[ei.FULL]);
    if (!n)
  ...
  inc(t, r, n) {
    if (t.startsWith("pre")) {
      ...
      if (r) {
        const i = `-${r}`.match(this.options.loose ? Zn[ei.PRERELEASELOOSE] : Zn[ei.PRERELEASE]);
        if (!i || i[1] !== r)
    ...
    switch (t) {
      ...
      case "pre": {
        ...
        if (r) {
          let a = [r, i];
          n === !1 && (a = [r]), La(this.prerelease[0], r) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = a) : this.prerelease = a;
        }
        break;
      }
      default:
...
var qv = Hv;
const Sc = Pr, jv = (e, t) => {
  const r = Sc(e, null, !0), n = Sc(t, null, !0), i = r.compare(n);
  if (i === 0)
    return null;
...
var Gv = jv;
const Vv = Le, Wv = (e, t) => new Vv(e, t).major;
var zv = Wv;
const Yv = Le, Xv = (e, t) => new Yv(e, t).minor;
var Kv = Xv;
const Jv = Le, Qv = (e, t) => new Jv(e, t).patch;
var Zv = Qv;
const ey = Pr, ty = (e, t) => {
  const r = ey(e, t);
...
var ry = ty;
const Cc = Le, ny = (e, t, r) => new Cc(e, r).compare(new Cc(t, r));
var et = ny;
const iy = et, ay = (e, t, r) => iy(t, e, r);
var sy = ay;
const oy = et, ly = (e, t) => oy(e, t, !0);
var cy = ly;
const Ac = Le, uy = (e, t, r) => {
  const n = new Ac(e, r), i = new Ac(t, r);
  return n.compare(i) || n.compareBuild(i);
};
var xo = uy;
const fy = xo, hy = (e, t) => e.sort((r, n) => fy(r, n, t));
var dy = hy;
const py = xo, my = (e, t) => e.sort((r, n) => py(n, r, t));
var gy = my;
const vy = et, yy = (e, t, r) => vy(e, t, r) > 0;
var Vi = yy;
const _y = et, Ey = (e, t, r) => _y(e, t, r) < 0;
var To = Ey;
const wy = et, by = (e, t, r) => wy(e, t, r) === 0;
var Bh = by;
const Sy = et, Cy = (e, t, r) => Sy(e, t, r) !== 0;
var Hh = Cy;
const Ay = et, Py = (e, t, r) => Ay(e, t, r) >= 0;
var Io = Py;
const xy = et, Ty = (e, t, r) => xy(e, t, r) <= 0;
var Oo = Ty;
const Iy = Bh, Oy = Hh, Ry = Vi, Dy = Io, Ny = To, Ly = Oo, ky = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var qh = ky;
const Fy = Le, Uy = Pr, { safeRe: ti, t: ri } = Cn, My = (e, t) => {
  if (e instanceof Fy)
    return e;
  ...
  let r = null;
  if (!t.rtl)
    r = e.match(t.includePrerelease ? ti[ri.COERCEFULL] : ti[ri.COERCE]);
  else {
    const l = t.includePrerelease ? ti[ri.COERCERTLFULL] : ti[ri.COERCERTL];
    let f;
...
function tt() {
  ...
  class t {
    ...
    parseRange(D) {
      ...
      if (M)
        return M;
      const k = this.options.loose, V = k ? l[f.HYPHENRANGELOOSE] : l[f.HYPHENRANGE];
      D = D.replace(V, j(this.options.includePrerelease)), s("hyphen replace", D), D = D.replace(l[f.COMPARATORTRIM], o), s("comparator trim", D), D = D.replace(l[f.TILDETRIM], d), s("tilde trim", D), D = D.replace(l[f.CARETTRIM], u), s("caret trim", D);
      let X = D.split(" ").map((G) => y(G, this.options)).join(" ").split(/\s+/).map((G) => H(G, this.options));
      k && (X = X.filter((G) => (s("loose invalid filter", G, this.options), !!G.match(l[f.COMPARATORLOOSE])))), s("range list", X);
      const z = /* @__PURE__ */ new Map(), Z = X.map((G) => new a(G, this.options));
      for (const G of Z) {
        if (m(G))
          return [G];
        z.set(G.value, G);
    ...
    intersects(D, U) {
      ...
      return this.set.some((R) => E(R, U) && D.set.some((M) => E(M, U) && R.every((k) => M.every((V) => k.intersects(V, U)))));
    }
  ...
  ka = t;
  const r = Hy, n = new r(), i = Po, a = Wi(), s = Gi, c = Le, {
    safeRe: l,
    t: f,
    comparatorTrimReplace: o,
    tildeTrimReplace: d,
    caretTrimReplace: u
  } = Cn, { FLAG_INCLUDE_PRERELEASE: h, FLAG_LOOSE: p } = ji, m = (L) => L.value === "<0.0.0-0", g = (L) => L.value === "", E = (L, D) => {
    let U = !0;
    const R = L.slice();
    let M = R.pop();
    for (; U && R.length; )
    ...
    return L.replace(U, (R, M, k, V, X) => {
      s("tilde", L, R, M, k, V, X);
      let z;
      return S(M) ? z = "" : S(k) ? z = `>=${M}.0.0 <${+M + 1}.0.0-0` : S(V) ? z = `>=${M}.${k}.0 <${M}.${+k + 1}.0-0` : X ? (s("replaceTilde pr", X), z = `>=${M}.${k}.${V}-${X} <${M}.${+k + 1}.0-0`) : z = `>=${M}.${k}.${V} <${M}.${+k + 1}.0-0`, s("tilde return", z), z;
    });
  }, I = (L, D) => L.trim().split(/\s+/).map((U) => T(U, D)).join(" "), T = (L, D) => {
    s("caret", L, D);
    const U = D.loose ? l[f.CARETLOOSE] : l[f.CARET], R = D.includePrerelease ? "-0" : "";
    return L.replace(U, (M, k, V, X, z) => {
      s("caret", L, M, k, V, X, z);
      let Z;
      return S(k) ? Z = "" : S(V) ? Z = `>=${k}.0.0${R} <${+k + 1}.0.0-0` : S(X) ? k === "0" ? Z = `>=${k}.${V}.0${R} <${k}.${+V + 1}.0-0` : Z = `>=${k}.${V}.0${R} <${+k + 1}.0.0-0` : z ? (s("replaceCaret pr", z), k === "0" ? V === "0" ? Z = `>=${k}.${V}.${X}-${z} <${k}.${V}.${+X + 1}-0` : Z = `>=${k}.${V}.${X}-${z} <${k}.${+V + 1}.0-0` : Z = `>=${k}.${V}.${X}-${z} <${+k + 1}.0.0-0`) : (s("no pr"), k === "0" ? V === "0" ? Z = `>=${k}.${V}.${X}${R} <${k}.${V}.${+X + 1}-0` : Z = `>=${k}.${V}.${X}${R} <${k}.${+V + 1}.0-0` : Z = `>=${k}.${V}.${X} <${+k + 1}.0.0-0`), s("caret return", Z), Z;
    });
  }, $ = (L, D) => (s("replaceXRanges", L, D), L.split(/\s+/).map((U) => C(U, D)).join(" ")), C = (L, D) => {
    L = L.trim();
    const U = D.loose ? l[f.XRANGELOOSE] : l[f.XRANGE];
    return L.replace(U, (R, M, k, V, X, z) => {
      s("xRange", L, R, M, k, V, X, z);
      const Z = S(k), pe = Z || S(V), G = pe || S(X), nt = G;
      return M === "=" && nt && (M = ""), z = D.includePrerelease ? "-0" : "", Z ? M === ">" || M === "<" ? R = "<0.0.0-0" : R = "*" : M && nt ? (pe && (V = 0), X = 0, M === ">" ? (M = ">=", pe ? (k = +k + 1, V = 0, X = 0) : (V = +V + 1, X = 0)) : M === "<=" && (M = "<", pe ? k = +k + 1 : V = +V + 1), M === "<" && (z = "-0"), R = `${M + k}.${V}.${X}${z}`) : pe ? R = `>=${k}.0.0${z} <${+k + 1}.0.0-0` : G && (R = `>=${k}.${V}.0${z} <${k}.${+V + 1}.0-0`), s("xRange return", R), R;
    });
  }, F = (L, D) => (s("replaceStars", L, D), L.trim().replace(l[f.STAR], "")), H = (L, D) => (s("replaceGTE0", L, D), L.trim().replace(l[D.includePrerelease ? f.GTE0PRE : f.GTE0], "")), j = (L) => (D, U, R, M, k, V, X, z, Z, pe, G, nt) => (S(R) ? U = "" : S(M) ? U = `>=${R}.0.0${L ? "-0" : ""}` : S(k) ? U = `>=${R}.${M}.0${L ? "-0" : ""}` : V ? U = `>=${U}` : U = `>=${U}${L ? "-0" : ""}`, S(Z) ? z = "" : S(pe) ? z = `<${+Z + 1}.0.0-0` : S(G) ? z = `<${Z}.${+pe + 1}.0-0` : nt ? z = `<=${Z}.${pe}.${G}-${nt}` : L ? z = `<${Z}.${pe}.${+G + 1}-0` : z = `<=${z}`, `${U} ${z}`.trim()), K = (L, D, U) => {
...
function Wi() {
  ...
  Fa = t;
  const r = Po, { safeRe: n, t: i } = Cn, a = qh, s = Gi, c = Le, l = tt();
  return Fa;
}
const qy = tt(), jy = (e, t, r) => {
  try {
    t = new qy(t, r);
  } catch {
    return !1;
...
var zi = jy;
const Gy = tt(), Vy = (e, t) => new Gy(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var Wy = Vy;
const zy = Le, Yy = tt(), Xy = (e, t, r) => {
...
const Jy = Le, Qy = tt(), Zy = (e, t, r) => {
  ...
  return e.forEach((s) => {
    a.test(s) && (!n || i.compare(s) === 1) && (n = s, i = new Jy(n, r));
  }), n;
};
var e8 = Zy;
const Ua = Le, t8 = tt(), Tc = Vi, r8 = (e, t) => {
  e = new t8(e, t);
  let r = new Ua("0.0.0");
  if (e.test(r) || (r = new Ua("0.0.0-0"), e.test(r)))
    return r;
  r = null;
  for (let n = 0; n < e.set.length; ++n) {
    ...
    let a = null;
    i.forEach((s) => {
      const c = new Ua(s.semver.version);
      switch (s.operator) {
        case ">":
...
const i8 = tt(), a8 = (e, t) => {
  try {
    return new i8(e, t).range || "*";
  } catch {
    return null;
  }
};
var s8 = a8;
const o8 = Le, jh = Wi(), { ANY: l8 } = jh, c8 = tt(), u8 = zi, Ic = Vi, Oc = To, f8 = Oo, h8 = Io, d8 = (e, t, r, n) => {
  e = new o8(e, n), t = new c8(t, n);
  let i, a, s, c, l;
  switch (r) {
    case ">":
      i = Ic, a = f8, s = Oc, c = ">", l = ">=";
  ...
  for (let f = 0; f < t.set.length; ++f) {
    ...
    let d = null, u = null;
    if (o.forEach((h) => {
      h.semver === l8 && (h = new jh(">=0.0.0")), d = d || h, u = u || h, i(h.semver, d.semver, n) ? d = h : s(h.semver, u.semver, n) && (u = h);
...
var Ro = d8;
const p8 = Ro, m8 = (e, t, r) => p8(e, t, ">", r);
var g8 = m8;
const v8 = Ro, y8 = (e, t, r) => v8(e, t, "<", r);
var _8 = y8;
const Rc = tt(), E8 = (e, t, r) => (e = new Rc(e, r), t = new Rc(t, r), e.intersects(t, r));
var w8 = E8;
const b8 = zi, S8 = et;
var C8 = (e, t, r) => {
  const n = [];
  let i = null, a = null;
  const s = e.sort((o, d) => S8(o, d, r));
  for (const o of s)
    b8(o, t, r) ? (a = o, i || (i = o)) : (a && n.push([i, a]), a = null, i = null);
  i && n.push([i, null]);
  const c = [];
  for (const [o, d] of n)
...
const Dc = tt(), Do = Wi(), { ANY: Ma } = Do, Mr = zi, No = et, A8 = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, P8 = [new Do(">=0.0.0-0")], Nc = [new Do(">=0.0.0")], x8 = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === Ma) {
    if (t.length === 1 && t[0].semver === Ma)
      return !0;
    r.includePrerelease ? e = P8 : e = Nc;
  }
  if (t.length === 1 && t[0].semver === Ma) {
  ...
  let i, a;
  for (const h of e)
    h.operator === ">" || h.operator === ">=" ? i = Lc(i, h, r) : h.operator === "<" || h.operator === "<=" ? a = kc(a, h, r) : n.add(h.semver);
  if (n.size > 1)
    return null;
  let s;
  if (i && a) {
    if (s = No(i.semver, a.semver, r), s > 0)
      return null;
    if (s === 0 && (i.operator !== ">=" || a.operator !== "<="))
      return null;
  }
  for (const h of n) {
    if (i && !Mr(h, String(i), r) || a && !Mr(h, String(a), r))
      return null;
    for (const p of t)
      if (!Mr(h, String(p), r))
        return !1;
  ...
  for (const h of t) {
    if (o = o || h.operator === ">" || h.operator === ">=", f = f || h.operator === "<" || h.operator === "<=", i) {
      if (u && h.semver.prerelease && h.semver.prerelease.length && h.semver.major === u.major && h.semver.minor === u.minor && h.semver.patch === u.patch && (u = !1), h.operator === ">" || h.operator === ">=") {
        if (c = Lc(i, h, r), c === h && c !== i)
          return !1;
      } else if (i.operator === ">=" && !Mr(i.semver, String(h), r))
        return !1;
    }
    if (a) {
      if (d && h.semver.prerelease && h.semver.prerelease.length && h.semver.major === d.major && h.semver.minor === d.minor && h.semver.patch === d.patch && (d = !1), h.operator === "<" || h.operator === "<=") {
        if (l = kc(a, h, r), l === h && l !== a)
          return !1;
      } else if (a.operator === "<=" && !Mr(a.semver, String(h), r))
        return !1;
    }
...
var T8 = A8;
const $a = Cn, Fc = ji, I8 = Le, Uc = $h, O8 = Pr, R8 = Uv, D8 = Bv, N8 = qv, L8 = Gv, k8 = zv, F8 = Kv, U8 = Zv, M8 = ry, $8 = et, B8 = sy, H8 = cy, q8 = xo, j8 = dy, G8 = gy, V8 = Vi, W8 = To, z8 = Bh, Y8 = Hh, X8 = Io, K8 = Oo, J8 = qh, Q8 = $y, Z8 = Wi(), e_ = tt(), t_ = zi, r_ = Wy, n_ = Ky, i_ = e8, a_ = n8, s_ = s8, o_ = Ro, l_ = g8, c_ = _8, u_ = w8, f_ = C8, h_ = T8;
var Gh = {
  parse: O8,
  valid: R8,
  clean: D8,
  ...
  compareIdentifiers: Uc.compareIdentifiers,
  rcompareIdentifiers: Uc.rcompareIdentifiers
}, An = {}, Ii = { exports: {} };
Ii.exports;
(function(e, t) {
  var r = 200, n = "__lodash_hash_undefined__", i = 1, a = 2, s = 9007199254740991, c = "[object Arguments]", l = "[object Array]", f = "[object AsyncFunction]", o = "[object Boolean]", d = "[object Date]", u = "[object Error]", h = "[object Function]", p = "[object GeneratorFunction]", m = "[object Map]", g = "[object Number]", E = "[object Null]", y = "[object Object]", S = "[object Promise]", _ = "[object Proxy]", A = "[object RegExp]", I = "[object Set]", T = "[object String]", $ = "[object Symbol]", C = "[object Undefined]", F = "[object WeakMap]", H = "[object ArrayBuffer]", j = "[object DataView]", K = "[object Float32Array]", L = "[object Float64Array]", D = "[object Int8Array]", U = "[object Int16Array]", R = "[object Int32Array]", M = "[object Uint8Array]", k = "[object Uint8ClampedArray]", V = "[object Uint16Array]", X = "[object Uint32Array]", z = /[\\^$.*+?()[\]{}|]/g, Z = /^\[object .+?Constructor\]$/, pe = /^(?:0|[1-9]\d*)$/, G = {};
  G[K] = G[L] = G[D] = G[U] = G[R] = G[M] = G[k] = G[V] = G[X] = !0, G[c] = G[l] = G[H] = G[o] = G[j] = G[d] = G[u] = G[h] = G[m] = G[g] = G[y] = G[A] = G[I] = G[T] = G[F] = !1;
  var nt = typeof Te == "object" && Te && Te.Object === Object && Te, w = typeof self == "object" && self && self.Object === Object && self, v = nt || w || Function("return this")(), O = t && !t.nodeType && t, x = O && !0 && e && !e.nodeType && e, Q = x && x.exports === O, re = Q && nt.process, oe = function() {
    try {
  ...
  var bd = Array.prototype, Sd = Function.prototype, kn = Object.prototype, sa = v["__core-js_shared__"], zo = Sd.toString, it = kn.hasOwnProperty, Yo = function() {
    var b = /[^.]+$/.exec(sa && sa.keys && sa.keys.IE_PROTO || "");
    return b ? "Symbol(src)_1." + b : "";
  }(), Xo = kn.toString, Cd = RegExp(
    "^" + zo.call(it).replace(z, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Ko = Q ? v.Buffer : void 0, Fn = v.Symbol, Jo = v.Uint8Array, Qo = kn.propertyIsEnumerable, Ad = bd.splice, Ft = Fn ? Fn.toStringTag : void 0, Zo = Object.getOwnPropertySymbols, Pd = Ko ? Ko.isBuffer : void 0, xd = Ed(Object.keys, Object), oa = rr(v, "DataView"), Rr = rr(v, "Map"), la = rr(v, "Promise"), ca = rr(v, "Set"), ua = rr(v, "WeakMap"), Dr = rr(Object, "create"), Td = $t(oa), Id = $t(Rr), Od = $t(la), Rd = $t(ca), Dd = $t(ua), el = Fn ? Fn.prototype : void 0, fa = el ? el.valueOf : void 0;
  function Ut(b) {
  ...
  function kd(b) {
    ...
    return it.call(P, b) ? P[b] : void 0;
  }
  function Fd(b) {
    var P = this.__data__;
    return Dr ? P[b] !== void 0 : it.call(P, b);
  }
  function Ud(b, P) {
    var N = this.__data__;
    return this.size += this.has(b) ? 0 : 1, N[b] = Dr && P === void 0 ? n : P, this;
  }
  Ut.prototype.clear = Nd, Ut.prototype.delete = Ld, Ut.prototype.get = kd, Ut.prototype.has = Fd, Ut.prototype.set = Ud;
  function lt(b) {
    var P = -1, N = b == null ? 0 : b.length;
    for (this.clear(); ++P < N; ) {
      var B = b[P];
  ...
  function $d(b) {
    var P = this.__data__, N = Mn(P, b);
    if (N < 0)
      return !1;
    var B = P.length - 1;
    return N == B ? P.pop() : Ad.call(P, N, 1), --this.size, !0;
  }
  function Bd(b) {
    var P = this.__data__, N = Mn(P, b);
  ...
  function qd(b, P) {
    var N = this.__data__, B = Mn(N, b);
    return B < 0 ? (++this.size, N.push([b, P])) : N[B][1] = P, this;
  }
  lt.prototype.clear = Md, lt.prototype.delete = $d, lt.prototype.get = Bd, lt.prototype.has = Hd, lt.prototype.set = qd;
  function Mt(b) {
    var P = -1, N = b == null ? 0 : b.length;
    for (this.clear(); ++P < N; ) {
      var B = b[P];
  ...
  function Gd(b) {
    var P = $n(this, b).delete(b);
    return this.size -= P ? 1 : 0, P;
  }
  function Vd(b) {
    return $n(this, b).get(b);
  }
  function Wd(b) {
    return $n(this, b).has(b);
  }
  function zd(b, P) {
    var N = $n(this, b), B = N.size;
    return N.set(b, P), this.size += N.size == B ? 0 : 1, this;
  }
  Mt.prototype.clear = jd, Mt.prototype.delete = Gd, Mt.prototype.get = Vd, Mt.prototype.has = Wd, Mt.prototype.set = zd;
  function Un(b) {
    var P = -1, N = b == null ? 0 : b.length;
    for (this.__data__ = new Mt(); ++P < N; )
      this.add(b[P]);
  }
  function Yd(b) {
  ...
  function ep(b, P) {
    ...
    if (N instanceof lt) {
      ...
      N = this.__data__ = new Mt(B);
    }
    return N.set(b, P), this.size = N.size, this;
  }
  gt.prototype.clear = Kd, gt.prototype.delete = Jd, gt.prototype.get = Qd, gt.prototype.has = Zd, gt.prototype.set = ep;
  function tp(b, P) {
    var N = Bn(b), B = !N && gp(b), ne = !N && !B && ha(b), Y = !N && !B && !ne && cl(b), le = N || B || ne || Y, me = le ? We(b.length, String) : [], _e = me.length;
    for (var ie in b)
      it.call(b, ie) && !(le && // Safari 9 has enumerable `arguments.length` in strict mode.
  ...
  function rp(b, P, N) {
    var B = P(b);
    return Bn(b) ? B : mt(B, N(b));
  }
  function Nr(b) {
    return b == null ? b === void 0 ? C : E : Ft && Ft in Object(b) ? cp(b) : mp(b);
  }
  function tl(b) {
    return Lr(b) && Nr(b) == c;
  }
  function rl(b, P, N, B, ne) {
    return b === P ? !0 : b == null || P == null || !Lr(b) && !Lr(P) ? b !== b && P !== P : np(b, P, N, B, rl, ne);
  }
  function np(b, P, N, B, ne, Y) {
    var le = Bn(b), me = Bn(P), _e = le ? l : vt(b), ie = me ? l : vt(P);
    _e = _e == c ? y : _e, ie = ie == c ? y : ie;
    var Me = _e == y, ze = ie == y, Se = _e == ie;
    if (Se && ha(b)) {
      if (!ha(P))
        return !1;
      le = !0, Me = !1;
    ...
    if (Se && !Me)
      return Y || (Y = new gt()), le || cl(b) ? nl(b, P, N, B, ne, Y) : op(b, P, _e, N, B, ne, Y);
    if (!(N & i)) {
      var $e = Me && it.call(b, "__wrapped__"), Be = ze && it.call(P, "__wrapped__");
      if ($e || Be) {
        var yt = $e ? b.value() : b, ct = Be ? P.value() : P;
        return Y || (Y = new gt()), ne(yt, ct, N, B, Y);
      }
    }
    return Se ? (Y || (Y = new gt()), lp(b, P, N, B, ne, Y)) : !1;
  }
  function ip(b) {
    if (!ll(b) || dp(b))
      return !1;
  ...
  function ap(b) {
    return Lr(b) && ol(b.length) && !!G[Nr(b)];
  }
  function sp(b) {
    if (!pp(b))
      return xd(b);
    ...
    for (var N in Object(b))
      it.call(b, N) && N != "constructor" && P.push(N);
    return P;
  }
  function nl(b, P, N, B, ne, Y) {
    ...
    if (ie && Y.get(P))
      return ie == P;
    var Me = -1, ze = !0, Se = N & a ? new Un() : void 0;
    for (Y.set(b, P), Y.set(P, b); ++Me < me; ) {
      var $e = b[Me], Be = P[Me];
      if (B)
        var yt = le ? B(Be, $e, Me, P, b, Y) : B($e, Be, Me, b, P, Y);
      if (yt !== void 0) {
        if (yt)
          continue;
        ze = !1;
      ...
      if (Se) {
        if (!he(P, function(ct, Bt) {
          if (!Nn(Se, Bt) && ($e === ct || ne($e, ct, N, B, Y)))
            return Se.push(Bt);
        })) {
          ze = !1;
          break;
        }
      } else if (!($e === Be || ne($e, Be, N, B, Y))) {
        ze = !1;
        break;
      }
    }
    return Y.delete(b), Y.delete(P), ze;
  }
  function op(b, P, N, B, ne, Y, le) {
    switch (N) {
      case j:
      ...
      case H:
        return !(b.byteLength != P.byteLength || !Y(new Jo(b), new Jo(P)));
      case o:
      case d:
      case g:
        return al(+b, +P);
      ...
      case I:
        var _e = B & i;
        if (me || (me = wd), b.size != P.size && !_e)
          return !1;
        var ie = le.get(b);
        if (ie)
          return ie == P;
        B |= a, le.set(b, P);
        var Me = nl(me(b), me(P), B, ne, Y, le);
        return le.delete(b), Me;
      case $:
        if (fa)
          return fa.call(b) == fa.call(P);
    }
    return !1;
  }
  function lp(b, P, N, B, ne, Y) {
    var le = N & i, me = il(b), _e = me.length, ie = il(P), Me = ie.length;
    if (_e != Me && !le)
      return !1;
    for (var ze = _e; ze--; ) {
      var Se = me[ze];
      if (!(le ? Se in P : it.call(P, Se)))
        return !1;
    }
    var $e = Y.get(b);
    if ($e && Y.get(P))
    ...
    for (var yt = le; ++ze < _e; ) {
      ...
      var ct = b[Se], Bt = P[Se];
      if (B)
        var ul = le ? B(Bt, ct, Se, P, b, Y) : B(ct, Bt, Se, b, P, Y);
      if (!(ul === void 0 ? ct === Bt || ne(ct, Bt, N, B, Y) : ul)) {
        Be = !1;
        break;
      }
    ...
    if (Be && !yt) {
      var Hn = b.constructor, qn = P.constructor;
      Hn != qn && "constructor" in b && "constructor" in P && !(typeof Hn == "function" && Hn instanceof Hn && typeof qn == "function" && qn instanceof qn) && (Be = !1);
    }
    return Y.delete(b), Y.delete(P), Be;
  }
  function il(b) {
    return rp(b, _p, up);
  }
  function $n(b, P) {
    var N = b.__data__;
    return hp(P) ? N[typeof P == "string" ? "string" : "hash"] : N.map;
  }
  function rr(b, P) {
    var N = Or(b, P);
  ...
  function cp(b) {
    ...
    var ne = Xo.call(b);
    return B && (P ? b[Ft] = N : delete b[Ft]), ne;
  }
  var up = Zo ? function(b) {
    return b == null ? [] : (b = Object(b), be(Zo(b), function(P) {
      return Qo.call(b, P);
    }));
  } : Ep, vt = Nr;
  (oa && vt(new oa(new ArrayBuffer(1))) != j || Rr && vt(new Rr()) != m || la && vt(la.resolve()) != S || ca && vt(new ca()) != I || ua && vt(new ua()) != F) && (vt = function(b) {
    var P = Nr(b), N = P == y ? b.constructor : void 0, B = N ? $t(N) : "";
    if (B)
      switch (B) {
        case Td:
          return j;
  ...
  function pp(b) {
    var P = b && b.constructor, N = typeof P == "function" && P.prototype || kn;
    return b === N;
  }
  function mp(b) {
    return Xo.call(b);
  ...
  var gp = tl(/* @__PURE__ */ function() {
    return arguments;
  }()) ? tl : function(b) {
    return Lr(b) && it.call(b, "callee") && !Qo.call(b, "callee");
  }, Bn = Array.isArray;
  function vp(b) {
    return b != null && ol(b.length) && !sl(b);
  }
  var ha = Pd || wp;
  function yp(b, P) {
    return rl(b, P);
...
An.createTempUpdateFile = y_;
const p_ = vn, m_ = Je, Mc = d_, qt = Nt, Kr = se;
class g_ {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return Mc(this.versionInfo, r) && Mc(this.fileInfo.info, n.info) && await (0, qt.pathExists)(t) ? t : null;
  ...
  async setDownloadedFile(t, r, n, i, a, s) {
    ...
    }, s && await (0, qt.outputJson)(this.getUpdateInfoFile(), this._downloadedFileInfo);
  }
  async clear() {
  ...
  async cleanCacheDirForPendingUpdate() {
    try {
      await (0, qt.emptyDir)(this.cacheDirForPendingUpdate);
    } catch {
    }
  }
  /**
  ...
  async getValidCachedUpdateFile(t, r) {
    ...
    if (!await (0, qt.pathExists)(n))
      return null;
    let a;
    try {
      a = await (0, qt.readJson)(n);
    } catch (f) {
    ...
    const c = Kr.join(this.cacheDirForPendingUpdate, a.fileName);
    if (!await (0, qt.pathExists)(c))
...
An.DownloadedUpdateHelper = g_;
function v_(e, t = "sha512", r = "base64", n) {
  return new Promise((i, a) => {
    const s = (0, p_.createHash)(t);
    s.on("error", a).setEncoding(r), (0, m_.createReadStream)(e, {
      ...n,
...
async function y_(e, t, r) {
  let n = 0, i = Kr.join(t, e);
  for (let a = 0; a < 3; a++)
    try {
      return await (0, qt.unlink)(i), i;
    } catch (s) {
      if (s.code === "ENOENT")
        return i;
      r.warn(`Error on remove temp update file: ${s}`), i = Kr.join(t, `${n++}-${e}`);
    }
  return i;
}
var Yi = {}, Lo = {};
Object.defineProperty(Lo, "__esModule", { value: !0 });
Lo.getAppCacheDir = E_;
const Ba = se, __ = Li;
function E_() {
  const e = (0, __.homedir)();
  let t;
...
class b_ {
  ...
  get appUpdateConfigPath() {
    return this.isPackaged ? $c.join(process.resourcesPath, "app-update.yml") : $c.join(this.app.getAppPath(), "dev-app-update.yml");
  }
  get userDataPath() {
    return this.app.getPath("userData");
  }
  get baseCachePath() {
    return (0, w_.getAppCacheDir)();
  }
  quit() {
    this.app.quit();
  }
...
rt.newBaseUrl = S_;
rt.newUrlFromBase = C_;
rt.getChannelFilename = A_;
const Wh = Rt;
function S_(e) {
  const t = new Wh.URL(e);
  return t.pathname.endsWith("/") || (t.pathname += "/"), t;
}
function C_(e, t, r = !1) {
  const n = new Wh.URL(e, t), i = t.search;
  return i != null && i.length !== 0 ? n.search = i : r && (n.search = `noCache=${Date.now().toString(32)}`), n;
}
function A_(e) {
  return `${e}.yml`;
}
var fe = {}, P_ = "[object Symbol]", zh = /[\\^$.*+?()[\]{}|]/g, x_ = RegExp(zh.source), T_ = typeof Te == "object" && Te && Te.Object === Object && Te, I_ = typeof self == "object" && self && self.Object === Object && self, O_ = T_ || I_ || Function("return this")(), R_ = Object.prototype, D_ = R_.toString, Bc = O_.Symbol, Hc = Bc ? Bc.prototype : void 0, qc = Hc ? Hc.toString : void 0;
function N_(e) {
  if (typeof e == "string")
    return e;
  if (k_(e))
...
function k_(e) {
  return typeof e == "symbol" || L_(e) && D_.call(e) == P_;
}
function F_(e) {
  return e == null ? "" : N_(e);
}
function U_(e) {
  return e = F_(e), e && x_.test(e) ? e.replace(zh, "\\$&") : e;
}
var Yh = U_;
Object.defineProperty(fe, "__esModule", { value: !0 });
fe.Provider = void 0;
fe.findFile = q_;
fe.parseUpdateInfo = j_;
fe.getFileList = Xh;
fe.resolveFiles = G_;
const It = de, M_ = we, $_ = Rt, Oi = rt, B_ = Yh;
class H_ {
  constructor(t) {
  ...
  getBlockMapFiles(t, r, n, i = null) {
    const a = (0, Oi.newUrlFromBase)(`${t.pathname}.blockmap`, t);
    return [(0, Oi.newUrlFromBase)(`${t.pathname.replace(new RegExp(B_(n), "g"), r)}.blockmap`, i ? new $_.URL(i) : t), a];
  }
  ...
  createRequestOptions(t, r) {
    const n = {};
    return this.requestHeaders == null ? r != null && (n.headers = r) : n.headers = r == null ? this.requestHeaders : { ...this.requestHeaders, ...r }, (0, It.configureRequestUrl)(t, n), n;
  }
}
fe.Provider = H_;
function q_(e, t, r) {
  var n;
  if (e.length === 0)
    throw (0, It.newError)("No files provided", "ERR_UPDATER_NO_FILES_PROVIDED");
...
function j_(e, t, r) {
  if (e == null)
    throw (0, It.newError)(`Cannot parse update info from ${t} in the latest release artifacts (${r}): rawData: null`, "ERR_UPDATER_INVALID_UPDATE_INFO");
  let n;
  try {
    n = (0, M_.load)(e);
  } catch (i) {
    throw (0, It.newError)(`Cannot parse update info from ${t} in the latest release artifacts (${r}): ${i.stack || i.message}, rawData: ${e}`, "ERR_UPDATER_INVALID_UPDATE_INFO");
  }
  return n;
}
function Xh(e) {
  ...
  throw (0, It.newError)(`No files provided: ${(0, It.safeStringifyJson)(e)}`, "ERR_UPDATER_NO_FILES_PROVIDED");
}
function G_(e, t, r = (n) => n) {
  const i = Xh(e).map((c) => {
    if (c.sha2 == null && c.sha512 == null)
      throw (0, It.newError)(`Update info doesn't contain nor sha256 neither sha512 checksum: ${(0, It.safeStringifyJson)(c)}`, "ERR_UPDATER_NO_CHECKSUM");
    return {
      url: (0, Oi.newUrlFromBase)(r(c.url), t),
      info: c
    };
  }), a = e.packages, s = a == null ? null : a[process.arch] || a.ia32;
  return s != null && (i[0].packageInfo = {
    ...s,
    path: (0, Oi.newUrlFromBase)(r(s.path), t).href
  }), i;
}
Object.defineProperty(Pn, "__esModule", { value: !0 });
Pn.GenericProvider = void 0;
const jc = de, Ha = rt, qa = fe;
class V_ extends qa.Provider {
  constructor(t, r, n) {
    super(n), this.configuration = t, this.updater = r, this.baseUrl = (0, Ha.newBaseUrl)(this.configuration.url);
  }
  get channel() {
  ...
  async getLatestVersion() {
    const t = (0, Ha.getChannelFilename)(this.channel), r = (0, Ha.newUrlFromBase)(t, this.baseUrl, this.updater.isAddNoCacheQuery);
    for (let n = 0; ; n++)
      try {
        return (0, qa.parseUpdateInfo)(await this.httpRequest(r), t, r);
      } catch (i) {
        if (i instanceof jc.HttpError && i.statusCode === 404)
          throw (0, jc.newError)(`Cannot find channel "${t}" update info: ${i.stack || i.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
  ...
  resolveFiles(t) {
    return (0, qa.resolveFiles)(t, this.baseUrl);
  }
}
Pn.GenericProvider = V_;
var Xi = {}, Ki = {};
Object.defineProperty(Ki, "__esModule", { value: !0 });
Ki.BitbucketProvider = void 0;
const Gc = de, ja = rt, Ga = fe;
class W_ extends Ga.Provider {
  constructor(t, r, n) {
    super({
      ...n,
    ...
    this.baseUrl = (0, ja.newBaseUrl)(`https://api.bitbucket.org/2.0/repositories/${i}/${a}/downloads`);
  }
  get channel() {
    return this.updater.channel || this.configuration.channel || "latest";
  }
  async getLatestVersion() {
    const t = new Gc.CancellationToken(), r = (0, ja.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, ja.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
      const i = await this.httpRequest(n, void 0, t);
      return (0, Ga.parseUpdateInfo)(i, r, n);
    } catch (i) {
      throw (0, Gc.newError)(`Unable to find latest version on ${this.toString()}, please ensure release exists: ${i.stack || i.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  resolveFiles(t) {
    return (0, Ga.resolveFiles)(t, this.baseUrl);
  }
  toString() {
...
Ki.BitbucketProvider = W_;
var Ot = {};
Object.defineProperty(Ot, "__esModule", { value: !0 });
Ot.GitHubProvider = Ot.BaseGitHubProvider = void 0;
Ot.computeReleaseNotes = Jh;
const ft = de, hr = Gh, z_ = Rt, dr = rt, Cs = fe, Va = /\/tag\/([^/]+)$/;
class Kh extends Cs.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      /* because GitHib uses S3 */
      isUseMultipleRangeRequest: !1
    }), this.options = t, this.baseUrl = (0, dr.newBaseUrl)((0, ft.githubUrl)(t, r));
    const i = r === "github.com" ? "api.github.com" : r;
    this.baseApiUrl = (0, dr.newBaseUrl)((0, ft.githubUrl)(t, i));
  }
...
class Y_ extends Kh {
  ...
  async getLatestVersion() {
    var t, r, n, i, a;
    const s = new ft.CancellationToken(), c = await this.httpRequest((0, dr.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
      accept: "application/xml, application/atom+xml, text/xml, */*"
    }, s), l = (0, ft.parseXml)(c);
    let f = l.element("entry", !1, "No published versions on GitHub"), o = null;
    try {
      if (this.updater.allowPrerelease) {
        const g = ((t = this.updater) === null || t === void 0 ? void 0 : t.channel) || ((r = hr.prerelease(this.updater.currentVersion)) === null || r === void 0 ? void 0 : r[0]) || null;
        if (g === null)
          o = Va.exec(f.element("link").attribute("href"))[1];
        else
          for (const E of l.getElements("entry")) {
            const y = Va.exec(E.element("link").attribute("href"));
            if (y === null)
              continue;
            const S = y[1], _ = ((n = hr.prerelease(S)) === null || n === void 0 ? void 0 : n[0]) || null, A = !g || ["alpha", "beta"].includes(g), I = _ !== null && !["alpha", "beta"].includes(String(_));
        ...
        for (const g of l.getElements("entry"))
          if (Va.exec(g.element("link").attribute("href"))[1] === o) {
            f = g;
            break;
          }
      }
    } catch (g) {
      throw (0, ft.newError)(`Cannot parse releases feed: ${g.stack || g.message},
XML:
${c}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let d, u = "", h = "";
    const p = async (g) => {
      u = (0, dr.getChannelFilename)(g), h = (0, dr.newUrlFromBase)(this.getBaseDownloadPath(String(o), u), this.baseUrl);
      const E = this.createRequestOptions(h);
      try {
        return await this.executor.request(E, s);
      } catch (y) {
        throw y instanceof ft.HttpError && y.statusCode === 404 ? (0, ft.newError)(`Cannot find ${u} in the latest release artifacts (${h}): ${y.stack || y.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : y;
      }
    };
    try {
      let g = this.channel;
      this.updater.allowPrerelease && (!((i = hr.prerelease(o)) === null || i === void 0) && i[0]) && (g = this.getCustomChannelName(String((a = hr.prerelease(o)) === null || a === void 0 ? void 0 : a[0]))), d = await p(g);
    } catch (g) {
      if (this.updater.allowPrerelease)
    ...
    const m = (0, Cs.parseUpdateInfo)(d, u, h);
    return m.releaseName == null && (m.releaseName = f.elementValueOrEmpty("title")), m.releaseNotes == null && (m.releaseNotes = Jh(this.updater.currentVersion, this.updater.fullChangelog, l, f)), {
      tag: o,
      ...m
    };
  }
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, dr.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new z_.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
  ...
  resolveFiles(t) {
    return (0, Cs.resolveFiles)(t, this.baseUrl, (r) => this.getBaseDownloadPath(t.tag, r.replace(/ /g, "-")));
  }
  getBaseDownloadPath(t, r) {
    return `${this.basePath}/download/${t}/${r}`;
  }
}
Ot.GitHubProvider = Y_;
function Vc(e) {
...
Ji.GitLabProvider = void 0;
const Pe = de, Wa = Rt, X_ = Yh, ni = rt, za = fe;
class K_ extends za.Provider {
  /**
  ...
  constructor(t, r, n) {
    ...
    this.baseApiUrl = (0, ni.newBaseUrl)(`https://${a}/api/v4`);
  }
  get channel() {
    const t = this.updater.channel || this.options.channel;
    return t == null ? this.getDefaultChannelName() : this.getCustomChannelName(t);
  ...
  async getLatestVersion() {
    const t = new Pe.CancellationToken(), r = (0, ni.newUrlFromBase)(`projects/${this.options.projectId}/releases/permalink/latest`, this.baseApiUrl);
    let n;
    try {
    ...
    const l = async (u) => {
      ...
      c = new Wa.URL(h.direct_asset_url);
    ...
    const f = (0, za.parseUpdateInfo)(a, s, c);
  ...
  async fetchReleaseInfoByVersion(t) {
    ...
    for (const i of n) {
      const a = (0, ni.newUrlFromBase)(`projects/${this.options.projectId}/releases/${encodeURIComponent(i)}`, this.baseApiUrl);
      try {
  ...
  async findBlockMapUrlsFromAssets(t, r, n) {
    ...
    if (c) {
      const l = n.replace(new RegExp(X_(r), "g"), t);
  ...
  resolveFiles(t) {
    return (0, za.getFileList)(t).map((r) => {
      const i = [
        r.url,
        // Original filename
...
Ji.GitLabProvider = K_;
var Qi = {};
Object.defineProperty(Qi, "__esModule", { value: !0 });
Qi.KeygenProvider = void 0;
const Wc = de, Ya = rt, Xa = fe;
class J_ extends Xa.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      isUseMultipleRangeRequest: !1
    ...
    this.baseUrl = (0, Ya.newBaseUrl)(`https://${i}/v1/accounts/${this.configuration.account}/artifacts?product=${this.configuration.product}`);
  }
  get channel() {
    return this.updater.channel || this.configuration.channel || "stable";
  }
  async getLatestVersion() {
    const t = new Wc.CancellationToken(), r = (0, Ya.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Ya.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
      ...
      throw (0, Wc.newError)(`Unable to find latest version on ${this.toString()}, please ensure release exists: ${i.stack || i.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  resolveFiles(t) {
...
Qi.KeygenProvider = J_;
var Zi = {};
Object.defineProperty(Zi, "__esModule", { value: !0 });
Zi.PrivateGitHubProvider = void 0;
const ar = de, Q_ = we, Z_ = se, zc = Rt, Yc = rt, e4 = Ot, t4 = fe;
class r4 extends e4.BaseGitHubProvider {
  constructor(t, r, n, i) {
  ...
  async getLatestVersion() {
    const t = new ar.CancellationToken(), r = (0, Yc.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((c) => c.name === r);
    if (i == null)
    ...
    let s;
    try {
      s = (0, Q_.load)(await this.httpRequest(a, this.configureHeaders("application/octet-stream"), t));
    } catch (c) {
      throw c instanceof ar.HttpError && c.statusCode === 404 ? (0, ar.newError)(`Cannot find ${r} in the latest release artifacts (${a}): ${c.stack || c.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : c;
    }
  ...
  async getLatestVersionInfo(t) {
    ...
    let n = this.basePath;
    r || (n = `${n}/latest`);
    const i = (0, Yc.newUrlFromBase)(n, this.baseUrl);
    try {
  ...
  resolveFiles(t) {
    return (0, t4.getFileList)(t).map((r) => {
      const n = Z_.posix.basename(r.url).replace(/ /g, "-"), i = t.assets.find((a) => a != null && a.name === n);
      if (i == null)
...
Zi.PrivateGitHubProvider = r4;
Object.defineProperty(Xi, "__esModule", { value: !0 });
Xi.isUrlProbablySupportMultiRangeRequests = Qh;
Xi.createClient = l4;
const ii = de, n4 = Ki, Xc = Pn, i4 = Ot, a4 = Ji, s4 = Qi, o4 = Zi;
function Qh(e) {
...
function l4(e, t, r) {
  ...
  switch (n) {
    case "github": {
      ...
      return a == null ? new i4.GitHubProvider(i, t, r) : new o4.PrivateGitHubProvider(i, t, a, r);
    }
    case "bitbucket":
      return new n4.BitbucketProvider(e, t, r);
    case "gitlab":
      return new a4.GitLabProvider(e, t, r);
    case "keygen":
      return new s4.KeygenProvider(e, t, r);
    case "s3":
    case "spaces":
      return new Xc.GenericProvider({
        provider: "generic",
        url: (0, ii.getS3LikeProviderBaseUrl)(e),
    ...
    case "generic": {
      const i = e;
      return new Xc.GenericProvider(i, t, {
        ...r,
        isUseMultipleRangeRequest: i.useMultipleRangeRequest !== !1 && Qh(i.url)
      });
    }
    case "custom": {
      const i = e, a = i.updateProvider;
      if (!a)
        throw (0, ii.newError)("Custom provider not specified", "ERR_UPDATER_INVALID_PROVIDER_CONFIGURATION");
      return new a(i, t, r);
    }
    default:
...
er.OperationKind = void 0;
er.computeOperations = c4;
var Wt;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
})(Wt || (er.OperationKind = Wt = {}));
function c4(e, t, r) {
  const n = Jc(e.files), i = Jc(t.files);
  let a = null;
  ...
  const o = i.get(l);
  let d = 0;
  const { checksumToOffset: u, checksumToOldSize: h } = f4(n.get(l), f.offset, r);
  let p = s.offset;
  for (let m = 0; m < o.checksums.length; p += o.sizes[m], m++) {
    const g = o.sizes[m], E = o.checksums[m];
    let y = u.get(E);
    y != null && h.get(E) !== g && (r.warn(`Checksum ("${E}") matches, but size differs (old: ${h.get(E)}, new: ${g})`), y = void 0), y === void 0 ? (d++, a != null && a.kind === Wt.DOWNLOAD && a.end === p ? a.end += g : (a = {
      kind: Wt.DOWNLOAD,
      start: p,
      end: p + g
      // oldBlocks: null,
    }, Kc(a, c, E, m))) : a != null && a.kind === Wt.COPY && a.end === y ? a.end += g : (a = {
      kind: Wt.COPY,
      start: y,
      end: y + g
      // oldBlocks: [checksum]
...
const u4 = process.env.DIFFERENTIAL_DOWNLOAD_PLAN_BUILDER_VALIDATE_RANGES === "true";
function Kc(e, t, r, n) {
  if (u4 && t.length !== 0) {
...
xr.DataSplitter = void 0;
xr.copyData = Zh;
const ai = de, h4 = Je, d4 = gn, p4 = er, Qc = Buffer.from(`\r
\r
`);
var Et;
(function(e) {
...
class m4 extends d4.Writable {
  ...
  async handleData(t) {
    ...
    if (this.ignoreByteCount !== 0 && this.remainingPartDataCount !== 0)
      throw (0, ai.newError)("Internal error", "ERR_DATA_SPLITTER_BYTE_COUNT_MISMATCH");
        ...
        if (this.readState === Et.BODY)
          ...
          if (s == null)
            if (this.isFinished)
              ...
              throw (0, ai.newError)("taskIndex is null", "ERR_DATA_SPLITTER_TASK_INDEX_IS_NULL");
          ...
          if (c < s)
            ...
            throw (0, ai.newError)("prevTaskIndex must be < taskIndex", "ERR_DATA_SPLITTER_TASK_INDEX_ASSERT_FAILED");
          if (this.isFinished) {
  ...
  copyExistingData(t, r) {
    return new Promise((n, i) => {
      const a = () => {
        ...
        if (s.kind !== p4.OperationKind.COPY) {
          i(new Error("Task kind must be COPY"));
          return;
        }
        Zh(s, this.out, this.options.oldFileFd, i, () => {
          t++, a();
        });
      };
      a();
  ...
  onPartEnd() {
    ...
    if (this.actualPartLength !== t)
      throw (0, ai.newError)(`Expected length: ${t} differs from actual: ${this.actualPartLength}`, "ERR_DATA_SPLITTER_LENGTH_MISMATCH");
...
ta.executeTasksUsingMultipleRangeRequests = g4;
ta.checkIsRangesSupported = Ps;
const As = de, Zc = xr, eu = er;
...
function v4(e, t, r, n, i) {
  ...
  for (let d = t.start; d < t.end; d++) {
    const u = t.tasks[d];
    u.kind === eu.OperationKind.DOWNLOAD && (a += `${u.start}-${u.end - 1}, `, c.set(s, d), s++, l.push(u.end - u.start));
  }
  if (s <= 1) {
    const d = (u) => {
      if (u >= t.end) {
  ...
  const o = e.httpExecutor.createRequest(f, (d) => {
    if (!Ps(d, i))
      return;
    const u = (0, As.safeGetHeader)(d, "content-type"), h = /^multipart\/.+?\s*;\s*boundary=(?:"([^"]+)"|([^\s";]+))\s*$/i.exec(u);
    if (h == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${u}"`));
      return;
    }
    const p = new Zc.DataSplitter(r, t, c, h[1] || h[2], l, n);
...
function Ps(e, t) {
  if (e.statusCode >= 400)
    return t((0, As.createHttpError)(e)), !1;
  if (e.statusCode !== 206) {
    const r = (0, As.safeGetHeader)(e, "accept-ranges");
    if (r == null || r === "none")
...
ra.ProgressDifferentialDownloadCallbackTransform = void 0;
const y4 = gn;
var pr;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
})(pr || (pr = {}));
class _4 extends y4.Transform {
  constructor(t, r, n) {
    super(), this.progressDifferentialDownloadInfo = t, this.cancellationToken = r, this.onProgress = n, this.start = Date.now(), this.transferred = 0, this.delta = 0, this.expectedBytes = 0, this.index = 0, this.operationType = pr.COPY, this.nextUpdate = this.start + 1e3;
  }
  _transform(t, r, n) {
    if (this.cancellationToken.cancelled) {
      n(new Error("cancelled"), null);
  ...
  beginFileCopy() {
    this.operationType = pr.COPY;
  }
  beginRangeDownload() {
    this.operationType = pr.DOWNLOAD, this.expectedBytes += this.progressDifferentialDownloadInfo.expectedByteCounts[this.index++];
  }
  endRangeDownload() {
...
ra.ProgressDifferentialDownloadCallbackTransform = _4;
Object.defineProperty(xn, "__esModule", { value: !0 });
xn.DifferentialDownloader = void 0;
const $r = de, Ka = Nt, E4 = Je, w4 = xr, b4 = Rt, si = er, tu = ta, S4 = ra;
class C4 {
  ...
  doDownload(t, r) {
    ...
    const n = this.logger, i = (0, si.computeOperations)(t, r, n);
    n.debug != null && n.debug(JSON.stringify(i, null, 2));
    let a = 0, s = 0;
    for (const l of i) {
      const f = l.end - l.start;
      l.kind === si.OperationKind.DOWNLOAD ? a += f : s += f;
    }
    ...
    return n.info(`Full: ${ru(c)}, To download: ${ru(a)} (${Math.round(a / (c / 100))}%)`), this.downloadFile(i);
  }
  downloadFile(t) {
    const r = [], n = () => Promise.all(r.map((i) => (0, Ka.close)(i.descriptor).catch((a) => {
  ...
  async doDownloadFile(t, r) {
    const n = await (0, Ka.open)(this.options.oldFile, "r");
    r.push({ descriptor: n, path: this.options.oldFile });
    const i = await (0, Ka.open)(this.options.newFile, "w");
    r.push({ descriptor: i, path: this.options.newFile });
    const a = (0, E4.createWriteStream)(this.options.newFile, { fd: i });
    await new Promise((s, c) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let y = 0;
        for (const _ of t)
          _.kind === si.OperationKind.DOWNLOAD && (E.push(_.end - _.start), y += _.end - _.start);
        const S = {
          expectedByteCounts: E,
          grandTotal: y
        };
        f = new S4.ProgressDifferentialDownloadCallbackTransform(S, this.options.cancellationToken, this.options.onProgress), l.push(f);
      }
      const o = new $r.DigestTransform(this.blockAwareFileInfo.sha512);
      ...
      if (this.options.isUseMultipleRangeRequest) {
        h = (0, tu.executeTasksUsingMultipleRangeRequests)(this, t, u, n, c), h(0);
        return;
      }
      let p = 0, m = null;
      ...
      g.redirect = "manual", h = (E) => {
        ...
        const _ = t[E++];
        if (_.kind === si.OperationKind.COPY) {
          f && f.beginFileCopy(), (0, w4.copyData)(_, u, n, c, () => h(E));
          return;
        }
        ...
        const I = this.httpExecutor.createRequest(g, (T) => {
          ...
          }), T.statusCode >= 400 && c((0, $r.createHttpError)(T)), T.pipe(u, {
            end: !1
          }), T.once("end", () => {
        ...
        I.on("redirect", (T, $, C) => {
          this.logger.info(`Redirect to ${A4(C)}`), m = C, (0, $r.configureRequestUrl)(new b4.URL(m), g), I.followRedirect();
  ...
  request(t, r) {
    return new Promise((n, i) => {
      const a = this.httpExecutor.createRequest(t, (s) => {
        (0, tu.checkIsRangesSupported)(s, i) && (s.on("error", i), s.on("aborted", () => {
...
ea.GenericDifferentialDownloader = void 0;
const P4 = xn;
class x4 extends P4.DifferentialDownloader {
  download(t, r) {
    return this.doDownload(t, r);
  }
}
ea.GenericDifferentialDownloader = x4;
var Lt = {};
(function(e) {
...
const xe = de, T4 = vn, I4 = Li, O4 = Hu, Ye = Nt, R4 = we, Ja = qi, Xe = se, jt = Gh, nu = An, D4 = Yi, iu = Vh, N4 = Pn, Qa = Xi, Za = ju, L4 = ea, sr = Lt;
class ko extends O4.EventEmitter {
  /**
  ...
  set updateConfigPath(t) {
    this.clientPromise = null, this._appUpdateConfigPath = t, this.configOnDisk = new Ja.Lazy(() => this.loadUpdateConfig());
  }
  /**
  ...
  constructor(t, r) {
    super(), this.autoDownload = !0, this.autoInstallOnAppQuit = !0, this.autoRunAppAfterInstall = !0, this.allowPrerelease = !1, this.fullChangelog = !1, this.allowDowngrade = !1, this.disableWebInstaller = !1, this.disableDifferentialDownload = !1, this.forceDevUpdateConfig = !1, this.previousBlockmapBaseUrlOverride = null, this._channel = null, this.downloadedUpdateHelper = null, this.requestHeaders = null, this._logger = console, this.signals = new sr.UpdaterSignal(this), this._appUpdateConfigPath = null, this._isUpdateSupported = (a) => this.checkIfUpdateSupported(a), this._isUserWithinRollout = (a) => this.isStagingMatch(a), this.clientPromise = null, this.stagingUserIdPromise = new Ja.Lazy(() => this.getOrCreateStagingUserId()), this.configOnDisk = new Ja.Lazy(() => this.loadUpdateConfig()), this.checkForUpdatesPromise = null, this.downloadPromise = null, this.updateInfoAndProvider = null, this._testOnlyOptions = null, this.on("error", (a) => {
      this._logger.error(`Error: ${a.stack || a.message}`);
    }), r == null ? (this.app = new D4.ElectronAppAdapter(), this.httpExecutor = new iu.ElectronHttpExecutor((a, s) => this.emit("login", a, s))) : (this.app = r, this.httpExecutor = null);
    ...
    this.currentVersion = i, this.allowPrerelease = k4(i), t != null && (this.setFeedURL(t), typeof t != "string" && t.requestHeaders && (this.requestHeaders = t.requestHeaders));
  }
  //noinspection JSMethodCanBeStatic,JSUnusedGlobalSymbols
  getFeedURL() {
  ...
  setFeedURL(t) {
    ...
    let n;
    typeof t == "string" ? n = new N4.GenericProvider({ provider: "generic", url: t }, this, {
      ...r,
      isUseMultipleRangeRequest: (0, Qa.isUrlProbablySupportMultiRangeRequests)(t)
    }) : n = (0, Qa.createClient)(t, this, r), this.clientPromise = Promise.resolve(n);
  }
  /**
  ...
  checkForUpdatesAndNotify(t) {
    return this.checkForUpdates().then((r) => r != null && r.downloadPromise ? (r.downloadPromise.then(() => {
      const n = ko.formatDownloadNotification(r.updateInfo.version, this.app.name, t);
      new Xt.Notification(n).show();
  ...
  async isUpdateAvailable(t) {
    ...
    if ((0, jt.eq)(r, n) || !await Promise.resolve(this.isUpdateSupported(t)) || !await Promise.resolve(this.isUserWithinRollout(t)))
      return !1;
    const a = (0, jt.gt)(r, n), s = (0, jt.lt)(r, n);
    return a ? !0 : this.allowDowngrade && s;
  }
  checkIfUpdateSupported(t) {
    const r = t == null ? void 0 : t.minimumSystemVersion, n = (0, I4.release)();
    if (r)
      try {
        if ((0, jt.lt)(n, r))
  ...
  async getUpdateInfoAndProvider() {
    await this.app.whenReady(), this.clientPromise == null && (this.clientPromise = this.configOnDisk.value.then((n) => (0, Qa.createClient)(n, this, this.createProviderRuntimeOptions())));
  ...
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, R4.load)(await (0, Ye.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
  ...
  async getOrCreateStagingUserId() {
    ...
    try {
      const n = await (0, Ye.readFile)(t, "utf-8");
      if (xe.UUID.check(n))
        return n;
    ...
    const r = xe.UUID.v5((0, T4.randomBytes)(4096), xe.UUID.OID);
    this._logger.info(`Generated new staging user ID: ${r}`);
    try {
      await (0, Ye.outputFile)(t, r);
    } catch (n) {
  ...
  async getOrCreateDownloadHelper() {
    ...
    if (t == null) {
      ...
      const i = Xe.join(this.app.baseCachePath, r || this.app.name);
      n.debug != null && n.debug(`updater cache dir: ${i}`), t = new nu.DownloadedUpdateHelper(i), this.downloadedUpdateHelper = t;
    }
    return t;
  }
  async executeDownload(t) {
    ...
    this.listenerCount(sr.DOWNLOAD_PROGRESS) > 0 && (n.onProgress = (y) => this.emit(sr.DOWNLOAD_PROGRESS, y));
    ...
    function c() {
      ...
      return y.toLowerCase().endsWith(`.${t.fileExtension.toLowerCase()}`) ? Xe.basename(y) : t.fileInfo.info.url;
    }
    const l = await this.getOrCreateDownloadHelper(), f = l.cacheDirForPendingUpdate;
    await (0, Ye.mkdir)(f, { recursive: !0 });
    const o = c();
    let d = Xe.join(f, o);
    const u = s == null ? null : Xe.join(f, `package-${a}${Xe.extname(s.path) || ".7z"}`), h = async (y) => {
      await l.setDownloadedFile(d, u, i, r, o, y), await t.done({
        ...i,
        downloadedFile: d
      });
      const S = Xe.join(f, "current.blockmap");
      return await (0, Ye.pathExists)(S) && await (0, Ye.copyFile)(S, Xe.join(l.cacheDir, "current.blockmap")), u == null ? [d] : [d, u];
    }, p = this._logger, m = await l.validateDownloadedPath(d, i, r, p);
    if (m != null)
      return d = m, await h(!1);
    const g = async () => (await l.clear().catch(() => {
    }), await (0, Ye.unlink)(d).catch(() => {
    })), E = await (0, nu.createTempUpdateFile)(`temp-${o}`, f, p);
    try {
      await t.task(E, n, u, g), await (0, xe.retry)(() => (0, Ye.rename)(E, d), {
        retries: 60,
        interval: 500,
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      const l = async (p) => {
        ...
        try {
          return JSON.parse((0, Za.gunzipSync)(m).toString());
        } catch (g) {
          throw new Error(`Cannot parse blockmap "${p.href}", error: ${g}`);
        }
      }, f = {
        newUrl: t.url,
        oldFile: Xe.join(this.downloadedUpdateHelper.cacheDir, a),
        logger: this._logger,
        newFile: n,
      ...
      this.listenerCount(sr.DOWNLOAD_PROGRESS) > 0 && (f.onProgress = (p) => this.emit(sr.DOWNLOAD_PROGRESS, p));
      const o = async (p, m) => {
        const g = Xe.join(m, "current.blockmap");
        await (0, Ye.outputFile)(g, (0, Za.gzipSync)(JSON.stringify(p)));
      }, d = async (p) => {
        const m = Xe.join(p, "current.blockmap");
        try {
          if (await (0, Ye.pathExists)(m))
            return JSON.parse((0, Za.gunzipSync)(await (0, Ye.readFile)(m)).toString());
        } catch (g) {
      ...
      return h == null && (h = await l(c[0])), await new L4.GenericDifferentialDownloader(t.info, this.httpExecutor, f).download(h, u), !1;
    } catch (s) {
...
const au = Ni, F4 = Pt;
class U4 extends F4.AppUpdater {
  constructor(t, r) {
  ...
  async spawnLog(t, r = [], n = void 0, i = "ignore") {
    return this._logger.info(`Executing: ${t} with args: ${r}`), new Promise((a, s) => {
      try {
        const c = { stdio: i, env: n, detached: !0 }, l = (0, au.spawn)(t, r, c);
        l.on("error", (f) => {
          s(f);
...
const or = Nt, M4 = xn, $4 = ju;
class B4 extends M4.DifferentialDownloader {
  async download() {
    const t = this.blockAwareFileInfo, r = t.size, n = r - (t.blockMapSize + 4);
    this.fileMetadataBuffer = await this.readRemoteBytes(n, r - 1);
    const i = td(this.fileMetadataBuffer.slice(0, this.fileMetadataBuffer.length - 4));
    await this.doDownload(await H4(this.options.oldFile), i);
  }
}
Tn.FileWithEmbeddedBlockMapDifferentialDownloader = B4;
function td(e) {
  return JSON.parse((0, $4.inflateRawSync)(e).toString());
}
async function H4(e) {
  ...
  try {
    ...
    return await (0, or.read)(t, i, 0, i.length, r - n.length - i.length), await (0, or.close)(t), td(i);
  } catch (r) {
...
const su = de, ou = Ni, q4 = Nt, j4 = Je, Br = se, G4 = Zt, V4 = Tn, W4 = fe, lu = Lt;
class z4 extends G4.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  isUpdaterActive() {
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, W4.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "AppImage", ["rpm", "deb", "pacman"]);
    return this.executeDownload({
      ...
      task: async (i, a) => {
        ...
        if (s == null)
          throw (0, su.newError)("APPIMAGE env is not defined", "ERR_UPDATER_OLD_FILE_NOT_FOUND");
        (t.disableDifferentialDownload || await this.downloadDifferential(n, s, i, r, t)) && await this.httpExecutor.download(n.url, i, a), await (0, q4.chmod)(i, 493);
      }
    });
  }
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(lu.DOWNLOAD_PROGRESS) > 0 && (s.onProgress = (c) => this.emit(lu.DOWNLOAD_PROGRESS, c)), await new V4.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, s).download(), !1;
    } catch (s) {
  ...
  doInstall(t) {
    ...
    if (a == null)
      return this.dispatchError(new Error("No update filepath provided, can't quit and install")), !1;
    Br.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = Br.join(Br.dirname(r), Br.basename(a)), (0, ou.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
      APPIMAGE_SILENT_INSTALL: "true"
    };
    return t.isForceRunAfter ? this.spawnLog(n, [], s) : (s.APPIMAGE_EXIT_AFTER_INSTALL = "true", (0, ou.execFileSync)(n, [], { env: s })), !0;
  }
}
ln.AppImageUpdater = z4;
var cn = {}, Tr = {};
Object.defineProperty(Tr, "__esModule", { value: !0 });
Tr.LinuxUpdater = void 0;
const Y4 = Zt;
class X4 extends Y4.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /**
...
cn.DebUpdater = void 0;
const K4 = fe, cu = Lt, J4 = Tr;
class Fo extends J4.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, K4.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "deb", ["AppImage", "rpm", "pacman"]);
    return this.executeDownload({
      fileExtension: "deb",
      fileInfo: n,
      downloadUpdateOptions: t,
      task: async (i, a) => {
        this.listenerCount(cu.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(cu.DOWNLOAD_PROGRESS, s)), await this.httpExecutor.download(n.url, i, a);
      }
    });
  }
  doInstall(t) {
    ...
    try {
      Fo.installWithCommandRunner(i, r, this.runCommandWithSudoIfNeeded.bind(this), this._logger);
    } catch (a) {
...
const uu = Lt, Q4 = fe, Z4 = Tr;
class Uo extends Z4.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, Q4.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "pacman", ["AppImage", "deb", "rpm"]);
    return this.executeDownload({
      fileExtension: "pacman",
      fileInfo: n,
      downloadUpdateOptions: t,
      task: async (i, a) => {
        this.listenerCount(uu.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(uu.DOWNLOAD_PROGRESS, s)), await this.httpExecutor.download(n.url, i, a);
      }
    });
  }
  doInstall(t) {
    ...
    if (r == null)
      return this.dispatchError(new Error("No update filepath provided, can't quit and install")), !1;
    try {
      Uo.installWithCommandRunner(r, this.runCommandWithSudoIfNeeded.bind(this), this._logger);
    } catch (n) {
...
fn.RpmUpdater = void 0;
const fu = Lt, eE = fe, tE = Tr;
class Mo extends tE.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, eE.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "rpm", ["AppImage", "deb", "pacman"]);
    return this.executeDownload({
      fileExtension: "rpm",
      fileInfo: n,
      downloadUpdateOptions: t,
      task: async (i, a) => {
        this.listenerCount(fu.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(fu.DOWNLOAD_PROGRESS, s)), await this.httpExecutor.download(n.url, i, a);
      }
    });
  }
  doInstall(t) {
    ...
    try {
      Mo.installWithCommandRunner(i, r, this.runCommandWithSudoIfNeeded.bind(this), this._logger);
    } catch (a) {
      return this.dispatchError(a), !1;
    }
    return t.isForceRunAfter && this.app.relaunch(), !0;
...
const hu = de, es = Nt, rE = Je, du = se, nE = xp, iE = Pt, aE = fe, pu = Ni, mu = vn;
class sE extends iE.AppUpdater {
  constructor(t, r) {
    super(t, r), this.nativeUpdater = Xt.autoUpdater, this.squirrelDownloadedUpdate = !1, this.nativeUpdater.on("error", (n) => {
  ...
  async doDownloadUpdate(t) {
    ...
    let a = !1;
    try {
      this.debug("Checking for macOS Rosetta environment"), a = (0, pu.execFileSync)("sysctl", [i], { encoding: "utf8" }).includes(`${i}: 1`), n.info(`Checked for macOS Rosetta environment (isRosetta=${a})`);
    } catch (d) {
    ...
    try {
      ...
      const u = (0, pu.execFileSync)("uname", ["-a"], { encoding: "utf8" }).includes("ARM");
    ...
    const l = (0, aE.findFile)(r, "zip", ["pkg", "dmg"]);
    if (l == null)
      throw (0, hu.newError)(`ZIP file not provided: ${(0, hu.safeStringifyJson)(r)}`, "ERR_UPDATER_ZIP_FILE_NOT_FOUND");
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (d, u) => {
        const h = du.join(this.downloadedUpdateHelper.cacheDir, o), p = () => (0, es.pathExistsSync)(h) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let m = !0;
        ...
        if (!t.disableDifferentialDownload)
          try {
            const u = du.join(this.downloadedUpdateHelper.cacheDir, o);
            await (0, es.copyFile)(d.downloadedFile, u);
          } catch (u) {
  ...
  async updateDownloaded(t, r) {
    var n;
    const i = r.downloadedFile, a = (n = t.info.size) !== null && n !== void 0 ? n : (await (0, es.stat)(i)).size, s = this._logger, c = `fileToProxy=${t.url.href}`;
    this.closeServerIfExists(), this.debug(`Creating proxy server for native Squirrel.Mac (${c})`), this.server = (0, nE.createServer)(), this.debug(`Proxy server for native Squirrel.Mac is created (${c})`), this.server.on("close", () => {
    ...
    return await new Promise((f, o) => {
      const d = (0, mu.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), u = Buffer.from(`autoupdater:${d}`, "ascii"), h = `/${(0, mu.randomBytes)(64).toString("hex")}.zip`;
      this.server.on("request", (p, m) => {
        ...
        const y = (0, rE.createReadStream)(i);
        y.on("error", (S) => {
          try {
            m.end();
          } catch (_) {
...
$o.verifySignature = lE;
const gu = de, rd = Ni, oE = Li, vu = se;
function nd(e, t) {
...
function lE(e, t, r) {
  return new Promise((n, i) => {
    const a = t.replace(/'/g, "''");
    r.info(`Verifying signature ${a}`), (0, rd.execFile)(...nd(`"Get-AuthenticodeSignature -LiteralPath '${a}' | ConvertTo-Json -Compress"`, 20 * 1e3), (s, c, l) => {
      var f;
      try {
        if (s != null || l) {
          ts(r, s, l, i), n(null);
        ...
        if (o.Status === 0) {
          try {
            const p = vu.normalize(o.Path), m = vu.normalize(t);
            if (r.info(`LiteralPath: ${p}. Update Path: ${m}`), p !== m) {
              ts(r, new Error(`LiteralPath of ${p} is different than ${m}`), l, i), n(null);
              return;
            }
          } catch (p) {
          ...
          const u = (0, gu.parseDn)(o.SignerCertificate.Subject);
          let h = !1;
          for (const p of e) {
            const m = (0, gu.parseDn)(p);
...
function ts(e, t, r, n) {
  ...
  try {
    (0, rd.execFileSync)(...nd("ConvertTo-Json test", 10 * 1e3));
  } catch (i) {
...
dn.NsisUpdater = void 0;
const oi = de, yu = se, fE = Zt, hE = Tn, _u = Lt, dE = fe, pE = Nt, mE = $o, Eu = Rt;
class gE extends fE.BaseUpdater {
  constructor(t, r) {
    super(t, r), this._verifyUpdateCodeSignature = (n, i) => (0, mE.verifySignature)(n, i, this._logger);
  }
  /**
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, dE.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "exe");
    return this.executeDownload({
      fileExtension: "exe",
      downloadUpdateOptions: t,
      fileInfo: n,
      task: async (i, a, s, c) => {
        ...
        if (f && t.disableWebInstaller)
          throw (0, oi.newError)(`Unable to download new version ${t.updateInfoAndProvider.info.version}. Web Installers are disabled`, "ERR_UPDATER_WEB_INSTALLER_DISABLED");
        !f && !t.disableWebInstaller && this._logger.warn("disableWebInstaller is set to false, you should set it to true if you do not plan on using a web installer. This will default to true in a future version."), (f || t.disableDifferentialDownload || await this.differentialDownloadInstaller(n, t, i, r, oi.CURRENT_APP_INSTALLER_FILE_NAME)) && await this.httpExecutor.download(n.url, i, a);
        const o = await this.verifySignature(i);
        if (o != null)
          throw await c(), (0, oi.newError)(`New version ${t.updateInfoAndProvider.info.version} is not signed by the application owner: ${o}`, "ERR_UPDATER_INVALID_SIGNATURE");
        if (f && await this.differentialDownloadWebPackage(t, l, s, r))
          try {
            await this.httpExecutor.download(new Eu.URL(l.path), s, {
  ...
  doInstall(t) {
    ...
    const a = () => {
      this.spawnLog(yu.join(process.resourcesPath, "elevate.exe"), [r].concat(n)).catch((s) => this.dispatchError(s));
    };
    return t.isAdminRightsRequired ? (this._logger.info("isAdminRightsRequired is set to true, run installer using elevate.exe"), a(), !0) : (this.spawnLog(r, n).catch((s) => {
      const c = s.code;
      this._logger.info(`Cannot run installer: error code: ${c}, error message: "${s.message}", will be executed again using elevate if EACCES, and will try to use electron.shell.openItem if ENOENT`), c === "UNKNOWN" || c === "EACCES" ? a() : c === "ENOENT" ? Xt.shell.openPath(r).catch((l) => this.dispatchError(l)) : this.dispatchError(s);
    }), !0);
  }
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      const a = {
        newUrl: new Eu.URL(r.path),
        oldFile: yu.join(this.downloadedUpdateHelper.cacheDir, oi.CURRENT_APP_PACKAGE_FILE_NAME),
        logger: this._logger,
        newFile: n,
      ...
      this.listenerCount(_u.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(_u.DOWNLOAD_PROGRESS, s)), await new hE.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
(function(e) {
  ...
  function m() {
    if (process.platform === "win32")
      p = new dn.NsisUpdater();
    else if (process.platform === "darwin")
      p = new hn.MacUpdater();
    else {
      p = new ln.AppImageUpdater();
      try {
...
var xs = { exports: {} }, Ts = { exports: {} }, je = {}, te = {};
te.__esModule = !0;
te.extend = id;
te.indexOf = wE;
te.escapeExpression = bE;
te.isEmpty = SE;
te.createFrame = CE;
te.blockParams = AE;
te.appendContextPath = PE;
var vE = {
  "&": "&amp;",
  "<": "&lt;",
  ">": "&gt;",
...
Is(/x/) && (te.isFunction = Is = function(e) {
  return typeof e == "function" && Bo.call(e) === "[object Function]";
});
te.isFunction = Is;
var ad = Array.isArray || function(e) {
  return e && typeof e == "object" ? Bo.call(e) === "[object Array]" : !1;
};
te.isArray = ad;
function wE(e, t) {
...
function bE(e) {
  ...
  return _E.test(e) ? e.replace(yE, EE) : e;
}
function SE(e) {
  return !e && e !== 0 ? !0 : !!(ad(e) && e.length === 0);
}
function CE(e) {
  var t = id({}, e);
...
var Ge = Os.exports, In = {}, Rs = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  var r = te;
...
var NE = Us.exports;
In.__esModule = !0;
In.registerDefaultHelpers = YE;
In.moveHelperToHooks = XE;
function tr(e) {
  return e && e.__esModule ? e : { default: e };
}
var LE = xE, kE = tr(LE), FE = TE, UE = tr(FE), ME = IE, $E = tr(ME), BE = OE, HE = tr(BE), qE = RE, jE = tr(qE), GE = DE, VE = tr(GE), WE = NE, zE = tr(WE);
function YE(e) {
  kE.default(e), UE.default(e), $E.default(e), HE.default(e), jE.default(e), VE.default(e), zE.default(e);
}
function XE(e, t, r) {
...
var KE = Ms.exports;
Ho.__esModule = !0;
Ho.registerDefaultDecorators = ew;
function JE(e) {
  return e && e.__esModule ? e : { default: e };
}
var QE = KE, ZE = JE(QE);
...
var sd = $s.exports, Ir = {};
Ir.__esModule = !0;
Ir.createProtoAccessControl = iw;
Ir.resultIsAllowed = aw;
Ir.resetLoggedProperties = ow;
function tw(e) {
  return e && e.__esModule ? e : { default: e };
}
var wu = te, rw = sd, nw = tw(rw), Ri = /* @__PURE__ */ Object.create(null);
function iw(e) {
  var t = /* @__PURE__ */ Object.create(null);
  t.__proto__ = !1, wu.extend(t, e.allowedProtoProperties);
  var r = /* @__PURE__ */ Object.create(null);
  return r.constructor = !1, r.__defineGetter__ = !1, r.__defineSetter__ = !1, r.__lookupGetter__ = !1, r.__lookupSetter__ = !1, wu.extend(r, e.allowedProtoMethods), {
    properties: {
      whitelist: t,
...
function aw(e, t, r) {
  return bu(typeof e == "function" ? t.methods : t.properties, r);
}
function bu(e, t) {
  return e.whitelist[t] !== void 0 ? e.whitelist[t] === !0 : e.defaultValue !== void 0 ? e.defaultValue : (sw(t), !1);
}
function sw(e) {
  Ri[e] !== !0 && (Ri[e] = !0, nw.default.log("error", 'Handlebars: Access has been denied to resolve the property "' + e + `" because it is not an "own property" of its parent.
...
je.__esModule = !0;
je.HandlebarsEnvironment = Bs;
function od(e) {
  return e && e.__esModule ? e : { default: e };
}
var Gt = te, lw = Ge, rs = od(lw), cw = In, uw = Ho, fw = sd, Di = od(fw), hw = Ir, dw = "4.7.9";
je.VERSION = dw;
var pw = 8;
je.COMPILER_REVISION = pw;
var mw = 7;
je.LAST_COMPATIBLE_COMPILER_REVISION = mw;
var gw = {
  1: "<= 1.0.rc.2",
...
je.REVISION_CHANGES = gw;
var ns = "[object Object]";
function Bs(e, t, r) {
  this.helpers = e || {}, this.partials = t || {}, this.decorators = r || {}, cw.registerDefaultHelpers(this), uw.registerDefaultDecorators(this);
}
Bs.prototype = {
  constructor: Bs,
  logger: Di.default,
  ...
  registerHelper: function(t, r) {
    if (Gt.toString.call(t) === ns) {
      if (r)
        throw new rs.default("Arg not supported with multiple helpers");
      Gt.extend(this.helpers, t);
    } else
      this.helpers[t] = r;
  },
  ...
  registerPartial: function(t, r) {
    if (Gt.toString.call(t) === ns)
      Gt.extend(this.partials, t);
    else {
      if (typeof r > "u")
        throw new rs.default('Attempting to register a partial called "' + t + '" as undefined');
      this.partials[t] = r;
    }
  },
  ...
  registerDecorator: function(t, r) {
    if (Gt.toString.call(t) === ns) {
      if (r)
        throw new rs.default("Arg not supported with multiple decorators");
      Gt.extend(this.decorators, t);
    } else
      this.decorators[t] = r;
  },
  ...
  resetLoggedPropertyAccesses: function() {
    hw.resetLoggedProperties();
  }
};
var vw = Di.default.log;
je.log = vw;
je.createFrame = Gt.createFrame;
je.logger = Di.default;
var Hs = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  function r(n) {
...
var bw = te, mr = ww(bw), Sw = Ge, ht = Ew(Sw), dt = je, Su = In, Cw = qo, Cu = Ir;
function Aw(e) {
  var t = e && e[0] || 1, r = dt.COMPILER_REVISION;
  if (!(t >= dt.LAST_COMPATIBLE_COMPILER_REVISION && t <= dt.COMPILER_REVISION))
    if (t < dt.LAST_COMPATIBLE_COMPILER_REVISION) {
      var n = dt.REVISION_CHANGES[r], i = dt.REVISION_CHANGES[t];
      throw new ht.default("Template was precompiled with an older version of Handlebars than the current runtime. Please update your precompiler to a newer version (" + n + ") or downgrade your runtime to an older version (" + i + ").");
    } else
      throw new ht.default("Template was precompiled with a newer version of Handlebars than the current runtime. Please update your runtime to a newer version (" + e[1] + ").");
}
function Pw(e, t) {
  if (!t)
    throw new ht.default("No environment passed to template");
  if (!e || !e.main)
    throw new ht.default("Unknown template object: " + typeof e);
  e.main.decorator = e.main_d, t.VM.checkRevision(e.compiler);
  var r = e.compiler && e.compiler[0] === 7;
  function n(s, c, l) {
    l.hash && (c = mr.extend({}, c, l.hash), l.ids && (l.ids[0] = !0)), s = t.VM.resolvePartial.call(this, s, c, l), l.hooks = this.hooks, l.protoAccessControl = this.protoAccessControl;
...
`);
      ...
      throw new ht.default("The partial " + l.name + " could not be compiled when running in runtime-only mode");
  }
  var i = {
    strict: function(c, l, f) {
      if (!c || !(l in c))
        throw new ht.default('"' + l + '" not defined in ' + c, {
          loc: f
        });
    ...
    lookupProperty: function(c, l) {
      var f = c[l];
      if (f == null || Object.prototype.hasOwnProperty.call(c, l) || Cu.resultIsAllowed(f, i.protoAccessControl, l))
        return f;
    },
    lookup: function(c, l) {
    ...
    escapeExpression: mr.escapeExpression,
    invokePartial: n,
    fn: function(c) {
      var l = e[c];
    ...
    program: function(c, l, f, o, d) {
      ...
      return l || d || o || f ? u = gi(this, c, h, l, f, o, d) : u || (u = this.programs[c] = gi(this, c, h)), u;
    },
    data: function(c, l) {
      for (; c && l--; )
        c = c._parent;
    ...
    mergeIfNeeded: function(c, l) {
      var f = c || l;
      return c && l && c !== l && (f = mr.extend({}, l, c)), f;
    },
  ...
  function a(s) {
    ...
    a._setup(c), !c.partial && e.useData && (l = Iw(s, l));
    ...
    return d = cd(e.main, d, i, c.depths || [], l, o), d(s, c);
  }
  return a.isTop = !0, a._setup = function(s) {
    if (s.partial)
      ...
      var c = {};
      Au(c, t.helpers, i), Au(c, s.helpers, i), i.helpers = c, e.usePartial && (i.partials = i.mergeIfNeeded(s.partials, t.partials)), (e.usePartial || e.useDecorators) && (i.decorators = mr.extend({}, t.decorators, s.decorators)), i.hooks = {}, i.protoAccessControl = Cu.createProtoAccessControl(s);
      var l = s.allowCallsToHelperMissing || r;
      Su.moveHelperToHooks(i, "helperMissing", l), Su.moveHelperToHooks(i, "blockHelperMissing", l);
    }
    ...
    return gi(i, s, e[s], c, 0, l, f);
  }, a;
}
function gi(e, t, r, n, i, a, s) {
  function c(l) {
  ...
  return c = cd(r, c, e, s, n, a), c.program = t, c.depth = s ? s.length : 0, c.blockParams = i || 0, c;
}
function xw(e, t, r) {
  return e ? !e.call && !r.name && (r.name = e, e = vi(r.partials, e)) : r.name === "@partial-block" ? e = vi(r.data, "partial-block") : e = vi(r.partials, r.name), e;
}
function Tw(e, t, r) {
  var n = vi(r.data, "partial-block");
  r.partial = !0, r.ids && (r.data.contextPath = r.ids[0] || r.data.contextPath);
  var i = void 0;
  if (r.fn && r.fn !== ld && function() {
    r.data = dt.createFrame(r.data);
    var a = r.fn;
    i = r.data["partial-block"] = function(c) {
      var l = arguments.length <= 1 || arguments[1] === void 0 ? {} : arguments[1];
      return l.data = dt.createFrame(l.data), l.data["partial-block"] = n, a(c, l);
    }, a.partials && (r.partials = mr.extend({}, r.partials, a.partials));
  }(), e === void 0 && i && (e = i), e === void 0)
    throw new ht.default("The partial " + r.name + " could not be found");
...
function Iw(e, t) {
  return (!t || !("root" in t)) && (t = t ? dt.createFrame(t) : {}, t.root = e), t;
}
function cd(e, t, r, n, i, a) {
  if (e.decorator) {
    var s = {};
    t = e.decorator(t, s, r, n && n[0], i, a, n), mr.extend(t, s);
  }
  return t;
}
function Au(e, t, r) {
...
function Ow(e, t) {
  ...
  return Cw.wrapHelper(e, function(n) {
...
(function(e, t) {
  ...
  var i = je, a = n(i), s = yw, c = r(s), l = Ge, f = r(l), o = te, d = n(o), u = kt, h = n(u), p = ud, m = r(p);
  function g() {
...
var fd = js.exports, On = {}, Gs = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  var r = function() {
    var n = {
        ...
        for (var S, _, A, I, T = {}, $, C, F, H; ; ) {
          if (_ = f[f.length - 1], this.defaultActions[_] ? A = this.defaultActions[_] : ((S === null || typeof S > "u") && (S = y()), A = u[_] && u[_][S]), typeof A > "u" || !A.length || !A[0]) {
            var j = "";
            {
              ...
              this.lexer.showPosition ? j = "Parse error on line " + (p + 1) + `:
` + this.lexer.showPosition() + `
Expecting ` + H.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : j = "Parse error on line " + (p + 1) + ": Unexpected " + (S == 1 ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(j, { text: this.lexer.match, token: this.terminals_[S] || S, line: this.lexer.yylineno, loc: g, expected: H });
            }
          }
...
var Dw = Gs.exports, Vs = { exports: {} }, Ws = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  function r(f) {
...
var Nw = Vs.exports, Ve = {};
Ve.__esModule = !0;
Ve.SourceLocation = Fw;
Ve.id = Uw;
Ve.stripFlags = Mw;
Ve.stripComment = $w;
Ve.preparePath = Bw;
Ve.prepareMustache = Hw;
Ve.prepareRawBlock = qw;
Ve.prepareBlock = jw;
Ve.prepareProgram = Gw;
Ve.preparePartialBlock = Vw;
function Lw(e) {
  return e && e.__esModule ? e : { default: e };
}
var kw = Ge, Go = Lw(kw);
function Vo(e, t) {
  if (t = t.path ? t.path.original : t, e.path.original !== t) {
    ...
    throw new Go.default(e.path.original + " doesn't match " + t, r);
  }
}
function Fw(e, t) {
...
function Bw(e, t, r) {
  ...
  for (var n = e ? "@" : "", i = [], a = 0, s = 0, c = t.length; s < c; s++) {
    ...
    if (n += (t[s].separator || "") + l, !f && (l === ".." || l === "." || l === "this")) {
      if (i.length > 0)
        throw new Go.default("Invalid path: " + n, { loc: r });
      l === ".." && a++;
    } else
      i.push(l);
  }
...
function jw(e, t, r, n, i, a) {
  ...
  if (r) {
    if (s)
      throw new Go.default("Unexpected inverse block on decorator", r);
...
var zw = Dw, zs = Wo(zw), Yw = Nw, Xw = Wo(Yw), Kw = Ve, Jw = Ww(Kw), Qw = Ge, Hr = Wo(Qw), Zw = te;
On.parser = zs.default;
var yi = {};
Zw.extend(yi, Jw);
function hd(e, t) {
  if (e.type === "Program")
    return tb(e), e;
  zs.default.yy = yi, yi.locInfo = function(n) {
    return new yi.SourceLocation(t && t.srcName, n);
  };
  var r = zs.default.parse(e);
  return r;
}
function eb(e, t) {
  var r = hd(e, t), n = new Xw.default(t);
  return n.accept(r);
}
function tb(e) {
  Ys(e);
  ...
  if (e != null) {
    ...
    if (typeof e == "object") {
      if (e.type === "PathExpression") {
        if (!rb(e.depth))
          throw new Hr.default("Invalid AST: PathExpression.depth must be an integer");
        if (!Array.isArray(e.parts))
          throw new Hr.default("Invalid AST: PathExpression.parts must be an array");
        for (var t = 0; t < e.parts.length; t++)
          if (typeof e.parts[t] != "string")
            throw new Hr.default("Invalid AST: PathExpression.parts must only contain strings");
      } else if (e.type === "NumberLiteral") {
        if (typeof e.value != "number" || !isFinite(e.value))
          throw new Hr.default("Invalid AST: NumberLiteral.value must be a number");
      } else if (e.type === "BooleanLiteral" && typeof e.value != "boolean")
        throw new Hr.default("Invalid AST: BooleanLiteral.value must be a boolean");
...
var nb = Ge, Jr = dd(nb), pn = te, ib = fd, qr = dd(ib), ab = [].slice;
function Xs() {
}
Xs.prototype = {
  compiler: Xs,
  equals: function(t) {
    ...
    for (var n = 0; n < r; n++) {
      ...
      if (i.opcode !== a.opcode || !pd(i.args, a.args))
        return !1;
    }
  ...
  compile: function(t, r) {
    return this.sourceNode = [], this.opcodes = [], this.children = [], this.options = r, this.stringParams = r.stringParams, this.trackIds = r.trackIds, r.blockParams = r.blockParams || [], r.knownHelpers = pn.extend(/* @__PURE__ */ Object.create(null), {
      helperMissing: !0,
  ...
  accept: function(t) {
    if (!this[t.type])
      throw new Jr.default("Unknown type: " + t.type, t);
  ...
  PartialStatement: function(t) {
    ...
    var n = t.params;
    if (n.length > 1)
      throw new Jr.default("Unsupported number of partial arguments: " + n.length, t);
  ...
  helperSexpr: function(t, r, n) {
    ...
    if (this.options.knownHelpers[s])
      ...
      if (this.options.knownHelpersOnly)
        throw new Jr.default("You specified knownHelpersOnly, but used the unknown helper " + s, t);
      a.strict = !0, a.falsy = !0, this.accept(a), this.opcode("invokeHelper", i.length, a.original, qr.default.helpers.simpleId(a));
    }
  },
  PathExpression: function(t) {
    this.addDepth(t.depth), this.opcode("getContext", t.depth);
    var r = t.parts[0], n = qr.default.helpers.scopedId(t), i = !t.depth && !n && this.blockParamIndex(r);
  ...
  classifySexpr: function(t) {
    var r = qr.default.helpers.simpleId(t.path), n = r && !!this.blockParamIndex(t.path.parts[0]), i = !n && qr.default.helpers.helperExpression(t), a = !n && (i || r);
    if (a && !i) {
  ...
  pushParam: function(t) {
    ...
    if (this.stringParams)
      ...
      if (this.trackIds) {
        var n = void 0;
        if (t.parts && !qr.default.helpers.scopedId(t) && !t.depth && (n = this.blockParamIndex(t.parts[0])), n) {
  ...
  blockParamIndex: function(t) {
    for (var r = 0, n = this.options.blockParams.length; r < n; r++) {
      var i = this.options.blockParams[r], a = i && pn.indexOf(i, t);
      if (i && a >= 0)
        return [r, a];
    }
  }
...
function sb(e, t, r) {
  if (e == null || typeof e != "string" && e.type !== "Program")
    throw new Jr.default("You must pass a string or Handlebars AST to Handlebars.precompile. You passed " + e);
...
function ob(e, t, r) {
  if (t === void 0 && (t = {}), e == null || typeof e != "string" && e.type !== "Program")
    throw new Jr.default("You must pass a string or Handlebars AST to Handlebars.compile. You passed " + e);
  t = pn.extend({}, t), "data" in t || (t.data = !0), t.compat && (t.useDepths = !0);
  var n = void 0;
  function i() {
...
function pd(e, t) {
  if (e === t)
    return !0;
  if (pn.isArray(e) && pn.isArray(t) && e.length === t.length) {
...
var Ks = { exports: {} }, Js = { exports: {} }, jr = {}, is = {}, ci = {}, ui = {}, xu;
function lb() {
  if (xu) return ui;
  xu = 1;
  var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("");
  return ui.encode = function(t) {
    if (0 <= t && t < e.length)
      return e[t];
    throw new TypeError("Must be between 0 and 63: " + t);
  }, ui.decode = function(t) {
...
function md() {
  ...
  return ci.encode = function(l) {
    var f = "", o, d = a(l);
    do
      o = d & n, d >>>= t, d > 0 && (o |= i), f += e.encode(o);
    while (d > 0);
    return f;
  }, ci.decode = function(l, f, o) {
...
function gd() {
  if (Ou) return ss;
  Ou = 1;
  var e = Dn(), t = Object.prototype.hasOwnProperty, r = typeof Map < "u";
  function n() {
...
function vd() {
  if (Du) return is;
  Du = 1;
  var e = md(), t = Dn(), r = gd().ArraySet, n = cb().MappingList;
  function i(a) {
...
function fb() {
  ...
  return cs.quickSort = function(n, i) {
    r(n, i, 0, n.length - 1);
  }, cs;
}
var ku;
function hb() {
  if (ku) return Gr;
  ku = 1;
  var e = Dn(), t = ub(), r = gd().ArraySet, n = md(), i = fb().quickSort;
  function a(f, o) {
    var d = f;
  ...
  s.prototype._parseMappings = function(o, d) {
    for (var u = 1, h = 0, p = 0, m = 0, g = 0, E = 0, y = o.length, S = 0, _ = {}, A = {}, I = [], T = [], $, C, F, H, j; S < y; )
      if (o.charAt(S) === ";")
        u++, S++, h = 0;
      else if (o.charAt(S) === ",")
        S++;
        ...
        if (C = o.slice(S, H), F = _[C], F)
          ...
          for (F = []; S < H; )
            n.decode(o, S, A), j = A.value, S = A.rest, F.push(j);
          if (F.length === 2)
  ...
  }, Gr.IndexedSourceMapConsumer = l, Gr;
}
var us = {}, Fu;
function db() {
  if (Fu) return us;
  Fu = 1;
  var e = vd().SourceMapGenerator, t = Dn(), r = /(\r?\n)/, n = 10, i = "$$$isSourceNode$$$";
...
var Uu;
function pb() {
  return Uu || (Uu = 1, jr.SourceMapGenerator = vd().SourceMapGenerator, jr.SourceMapConsumer = hb().SourceMapConsumer, jr.SourceNode = db().SourceNode), jr;
}
(function(e, t) {
  t.__esModule = !0;
  var r = te, n = void 0;
...
(function(e, t) {
  ...
  var n = je, i = Ge, a = r(i), s = te, c = mb, l = r(c);
  function f(u) {
    this.value = u;
  }
  function o() {
...
(function(e, t) {
  ...
  var n = Rw, i = r(n), a = fd, s = r(a), c = On, l = Rn, f = gb, o = r(f), d = jo, u = r(d), h = ud, p = r(h), m = i.default.create;
  function g() {
    var y = m();
...
var ia = vb.default, yd = na;
ia.PrintVisitor = yd.PrintVisitor;
ia.print = yd.print;
var bb = ia;
function Mu(e, t) {
  var r = Je, n = r.readFileSync(t, "utf8");
  e.exports = ia.compile(n);
}
typeof li < "u" && li.extensions && (li.extensions[".handlebars"] = Mu, li.extensions[".hbs"] = Mu);
const Sb = /* @__PURE__ */ Gu(bb);
class Cb {
  /**
  ...
  static getTemplateDir() {
    return process.env.VITE_DEV_SERVER_URL ? jn.join(process.cwd(), "public", "pdf_templates") : jn.join(At.getAppPath(), "..", "resources", "public", "pdf_templates");
  }
  /**
   * Load and compile a Handlebars template
   */
  static async loadTemplate(t) {
    const r = this.getTemplateDir(), n = jn.join(r, `${t}.html`);
    if (!kr.existsSync(n))
      throw new Error(`Sablon nem található: ${t}`);
    const i = kr.readFileSync(n, "utf-8");
    return Sb.compile(i);
  }
  /**
  ...
  static async generatePdf(t, r) {
    const n = jn.dirname(r);
    kr.existsSync(n) || kr.mkdirSync(n, { recursive: !0 });
    const i = new Zs({
      webPreferences: {
        sandbox: !0
      },
    ...
    try {
      ...
      return await kr.promises.writeFile(r, a), { success: !0, pageCount: Math.max(1, Math.ceil(a.length / 15e3)) };
    } catch (a) {
  ...
  static async saveAndOpen(t, r = !0) {
    if (r)
      try {
        const { default: n } = await import("./index-Dl2oE-xp.js");
        n(t).catch((i) => {
          console.warn(
...
const mn = ve.dirname(bp(import.meta.url));
process.env.APP_ROOT = ve.join(mn, "..");
const Qs = process.env.VITE_DEV_SERVER_URL, zb = ve.join(process.env.APP_ROOT, "dist-electron"), Ab = ve.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = Qs ? ve.join(process.env.APP_ROOT, "public") : Ab;
let W;
function _d() {
  W = new Zs({
    ...
    webPreferences: {
      preload: ve.join(mn, "preload.mjs"),
      contextIsolation: !0,
      nodeIntegration: !1,
      sandbox: !1
    },
  ...
  }), Qs ? W.loadURL(Qs) : W.loadFile(ve.join(mn, "../dist/index.html"));
}
function Pb(e) {
  e && $u.openPath(e).then((t) => {
    t && console.error("Failed to open file:", t);
  });
}
At.on("window-all-closed", () => {
  process.platform !== "darwin" && (At.quit(), W = null);
});
At.on("activate", () => {
  Zs.getAllWindows().length === 0 && _d();
});
Qe.handle("minimize-window", () => {
  W == null || W.minimize();
});
Qe.handle("maximize-window", () => {
  W != null && W.isMaximized() ? W.unmaximize() : W == null || W.maximize();
});
Qe.handle("close-window", () => {
  W == null || W.close();
});
Qe.handle("run-executable", (e, t, r = []) => new Promise((n, i) => {
  var o, d;
  const a = At.isPackaged ? ve.join(process.resourcesPath, "public") : ve.join(mn, "../public"), s = ve.join(a, t);
...
Qe.handle("open-folder", async (e, t) => {
  try {
    Je.existsSync(t) || (Je.mkdirSync(t, { recursive: !0 }), console.log("Folder created:", t));
    const r = await $u.openPath(t);
    if (r)
...
Qe.handle("open-file", async (e, t) => {
  const r = At.isPackaged ? ve.join(process.resourcesPath, "public") : ve.join(mn, "../public");
  return Pb(ve.join(r, t)), !0;
});
Qe.handle("select-folder", async (e, t) => {
  const r = {
    properties: ["openDirectory", "createDirectory"],
    defaultPath: t
  }, n = W ? await fl.showOpenDialog(W, r) : await fl.showOpenDialog(r);
  return n.canceled || n.filePaths.length === 0 ? null : n.filePaths[0];
});
Qe.handle("get-public-path", (e, ...t) => {
  const r = At.isPackaged ? ve.join(process.resourcesPath, "public") : ve.join(process.cwd(), "public");
  return ve.join(r, ...t);
});
Qe.handle("pdf-create-schematic", async (e, t) => {
  try {
    return console.log("PDF creation request received:", { companyId: t.companyId, templateId: t.templateId }), await Cb.createSchematicPdf(t);
  } catch (r) {
...
Ue.autoUpdater.autoDownload = !1;
Ue.autoUpdater.autoInstallOnAppQuit = !0;
Ue.autoUpdater.on("checking-for-update", () => {
  W == null || W.webContents.send("update-status", "Checking for updates..."), console.log("Checking for updates...");
});
Ue.autoUpdater.on("update-available", () => {
  W == null || W.webContents.send("update-status", "Update available. Starting download..."), console.log("Update available, starting download..."), Ue.autoUpdater.downloadUpdate();
});
Ue.autoUpdater.on("update-not-available", () => {
  W == null || W.webContents.send("update-status", ""), console.log("Already up to date.");
});
Ue.autoUpdater.on("download-progress", (e) => {
  W == null || W.webContents.send("update-progress", Math.round(e.percent)), console.log(`Download progress: ${Math.round(e.percent)}%`);
});
Ue.autoUpdater.on("update-downloaded", () => {
  W == null || W.webContents.send("update-status", "Update ready. Restart to install."), W == null || W.webContents.send("update-ready"), console.log("Update downloaded and ready to install.");
});
Ue.autoUpdater.on("error", (e) => {
  W == null || W.webContents.send("update-status", ""), W == null || W.webContents.send("update-error", e.message), console.error("Update error:", e.message);
});
Qe.handle("check-for-updates", async () => {
  try {
    const e = await Ue.autoUpdater.checkForUpdates();
    return { found: !!(e != null && e.updateInfo) };
  } catch (e) {
    throw console.error("Error checking for updates:", e), e;
  }
});
Qe.handle("restart-and-install", () => {
  Ue.autoUpdater.quitAndInstall();
});
At.whenReady().then(() => {
  _d(), Ue.autoUpdater.checkForUpdates(), setInterval(() => {
