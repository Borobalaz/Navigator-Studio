...
import { g as getDefaultExportFromCjs, c as commonjsGlobal } from "./main-BSZluC_Y.js";
...
var untildify$1 = (pathWithTilde) => {
  if (typeof pathWithTilde !== "string") {
    throw new TypeError(`Expected a string, got ${typeof pathWithTilde}`);
  }
  return homeDirectory ? pathWithTilde.replace(/^~(?=$|\/|\\)/, homeDirectory) : pathWithTilde;
};
const untildify = /* @__PURE__ */ getDefaultExportFromCjs(untildify$1);
...
const mergeStream$1 = /* @__PURE__ */ getDefaultExportFromCjs(mergeStream$2);
const isStream$1 = isStream_1;
const getStream$3 = getStreamExports$1;
const mergeStream = mergeStream$2;
...
async function runAppleScriptAsync(script) {
  ...
  const { stdout } = await execa$1("osascript", ["-e", script]);
  return stdout;
}
...
const getStream = /* @__PURE__ */ getDefaultExportFromCjs(getStreamExports);
...
const baseOpen = async (options) => {
  ...
  if (platform === "darwin") {
    ...
    command2 = isWsl ? `${mountPoint}c/Windows/System32/WindowsPowerShell/v1.0/powershell.exe` : `${process$3.env.SYSTEMROOT}\\System32\\WindowsPowerShell\\v1.0\\powershell`;
    cliArguments.push(
      "-NoProfile",
      "-NonInteractive",
      "-ExecutionPolicy",
