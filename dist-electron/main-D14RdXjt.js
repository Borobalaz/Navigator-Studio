import Xt, { app as At, BrowserWindow as no, ipcMain as Qe, shell as qu, dialog as ds } from "electron";
import { fileURLToPath as Ap } from "node:url";
import ve from "node:path";
import { spawn as Pp } from "node:child_process";
import xp from "buffer";
import Tp from "string_decoder";
import * as Mr from "fs";
import Je from "fs";
import Ip from "constants";
import _n from "stream";
import io from "util";
import ju from "assert";
import * as ir from "path";
import se from "path";
import ki from "child_process";
...
var ao = { exports: {} }, di = xp, yr = di.Buffer, He = {}, qe;
for (qe in di)
  di.hasOwnProperty(qe) && (qe === "SlowBuffer" || qe === "Buffer" || (He[qe] = di[qe]));
var _r = He.Buffer = {};
for (qe in yr)
  yr.hasOwnProperty(qe) && (qe === "allocUnsafe" || qe === "allocUnsafeSlow" || (_r[qe] = yr[qe]));
He.Buffer.prototype = yr.prototype;
(!_r.from || _r.from === Uint8Array.from) && (_r.from = function(e, t, r) {
  if (typeof e == "number")
...
_r.alloc || (_r.alloc = function(e, t, r) {
  if (typeof e != "number")
...
oo.prototype.write = function(e) {
  return this.addBOM && (e = Yu + e, this.addBOM = !1), this.encoder.write(e);
};
oo.prototype.end = function() {
...
lo.prototype.write = function(e) {
  ...
  return this.pass || !t || (t[0] === Yu && (t = t.slice(1), typeof this.options.stripBOM == "function" && this.options.stripBOM()), this.pass = !0), t;
};
lo.prototype.end = function() {
  return this.decoder.end();
};
var Rp = typeof Object.hasOwn > "u" ? Function.call.bind(Object.prototype.hasOwnProperty) : Object.hasOwn;
function Dp(e, t) {
  for (var r in t)
    Rp(t, r) && (e[r] = t[r]);
}
...
var _t = Ip, Qp = process.cwd, pi = null, Zp = process.env.GRACEFUL_FS_PLATFORM || process.platform;
process.cwd = function() {
  return pi || (pi = Qp.call(process)), pi;
};
try {
  process.cwd();
} catch {
...
if (typeof process.chdir == "function") {
  var Il = process.chdir;
  process.chdir = function(e) {
    pi = null, Il.call(process, e);
  }, Object.setPrototypeOf && Object.setPrototypeOf(process.chdir, Il);
}
var e0 = t0;
function t0(e) {
  ...
  }), Zp === "win32" && (e.rename = typeof e.rename != "function" ? e.rename : function(o) {
    function d(u, h, p) {
      var m = Date.now(), g = 0;
      o(u, h, function E(y) {
...
function n0(e) {
  ...
  function r(n, i) {
    ...
    Ol.call(this), this.path = n, this.fd = null, this.writable = !0, this.flags = "w", this.encoding = "binary", this.mode = 438, this.bytesWritten = 0, i = i || {};
...
var i0 = s0, a0 = Object.getPrototypeOf || function(e) {
  return e.__proto__;
};
function s0(e) {
...
var ae = Je, o0 = e0, l0 = r0, c0 = i0, zn = io, Ee, wi;
typeof Symbol == "function" && typeof Symbol.for == "function" ? (Ee = Symbol.for("graceful-fs.queue"), wi = Symbol.for("graceful-fs.previous")) : (Ee = "___graceful-fs.queue", wi = "___graceful-fs.previous");
function u0() {
}
function Ku(e, t) {
...
var zt = u0;
zn.debuglog ? zt = zn.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (zt = function() {
...
if (!ae[Ee]) {
  var f0 = Te[Ee] || [];
  Ku(ae, f0), ae.close = function(e) {
    function t(r, n) {
      return e.call(ae, r, function(i) {
        i || Rl(), typeof n == "function" && n.apply(this, arguments);
      });
    }
    return Object.defineProperty(t, wi, {
      value: e
    }), t;
  }(ae.close), ae.closeSync = function(e) {
    function t(r) {
      e.apply(ae, arguments), Rl();
    }
    return Object.defineProperty(t, wi, {
      value: e
    }), t;
  }(ae.closeSync), /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && process.on("exit", function() {
    zt(ae[Ee]), ju.equal(ae[Ee].length, 0);
  });
}
Te[Ee] || Ku(Te, ae[Ee]);
var De = co(c0(ae));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !ae.__patched && (De = co(ae), ae.__patched = !0);
function co(e) {
  o0(e), e.gracefulify = co, e.createReadStream = A, e.createWriteStream = I;
  var t = e.readFile;
  e.readFile = r;
  function r(C, F, H) {
    ...
    function j(K, L, D, U) {
      return t(K, L, function(R) {
        R && (R.code === "EMFILE" || R.code === "ENFILE") ? ar([j, [K, L, D], R, U || Date.now(), Date.now()]) : typeof D == "function" && D.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  ...
  function i(C, F, H, j) {
    ...
    function K(L, D, U, R, M) {
      return n(L, D, U, function(k) {
        k && (k.code === "EMFILE" || k.code === "ENFILE") ? ar([K, [L, D, U, R], k, M || Date.now(), Date.now()]) : typeof R == "function" && R.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  function d(C, F, H) {
    ...
    function K(L, D, U, R) {
      return function(M, k) {
        M && (M.code === "EMFILE" || M.code === "ENFILE") ? ar([
          j,
          [L, D, U],
          M,
          R || Date.now(),
...
function ar(e) {
  zt("ENQUEUE", e[0].name, e[1]), ae[Ee].push(e), uo();
}
var Yn;
function Rl() {
...
function uo() {
  if (clearTimeout(Yn), Yn = void 0, ae[Ee].length !== 0) {
...
var fo = {}, Ju = {};
const h0 = se;
Ju.checkPath = function(t) {
  if (process.platform === "win32" && /[<>:"|?*]/.test(t.replace(h0.parse(t).root, ""))) {
    const n = new Error(`Path contains invalid characters: ${t}`);
    throw n.code = "EINVAL", n;
  }
};
const Qu = Qt, { checkPath: Zu } = Ju, ef = (e) => {
  const t = { mode: 511 };
  return typeof e == "number" ? e : { ...t, ...e }.mode;
};
fo.makeDir = async (e, t) => (Zu(e), Qu.mkdir(e, {
  mode: ef(t),
  recursive: !0
}));
fo.makeDirSync = (e, t) => (Zu(e), Qu.mkdirSync(e, {
  mode: ef(t),
  recursive: !0
}));
const d0 = Re.fromPromise, { makeDir: p0, makeDirSync: Ca } = fo, Aa = d0(p0);
var ot = {
  mkdirs: Aa,
  mkdirsSync: Ca,
  // alias
...
const m0 = Re.fromPromise, tf = Qt;
function g0(e) {
  return tf.access(e).then(() => !0).catch(() => !1);
}
var Zt = {
  pathExists: m0(g0),
  pathExistsSync: tf.existsSync
};
const Er = De;
function v0(e, t, r, n) {
  Er.open(e, "r+", (i, a) => {
...
const br = Qt, ge = se, _0 = io;
function E0(e, t, r) {
  const n = r.dereference ? (i) => br.stat(i, { bigint: !0 }) : (i) => br.lstat(i, { bigint: !0 });
  return Promise.all([
    n(e),
    n(t).catch((i) => {
...
function w0(e, t, r) {
  let n;
  const i = r.dereference ? (s) => br.statSync(s, { bigint: !0 }) : (s) => br.lstatSync(s, { bigint: !0 }), a = i(e);
  try {
    n = i(t);
  } catch (s) {
...
function b0(e, t, r, n, i) {
  _0.callbackify(E0)(e, t, n, (a, s) => {
    ...
    return c.isDirectory() && ho(e, t) ? i(new Error(Ui(e, t, r))) : i(null, { srcStat: c, destStat: l });
  });
}
function S0(e, t, r, n) {
  const { srcStat: i, destStat: a } = w0(e, t, n);
  if (a) {
    if (wn(i, a)) {
...
function nf(e, t, r, n, i) {
  ...
  br.stat(s, { bigint: !0 }, (c, l) => c ? c.code === "ENOENT" ? i() : i(c) : wn(t, l) ? i(new Error(Ui(e, r, n))) : nf(e, t, s, n, i));
}
function af(e, t, r, n) {
  ...
  let s;
  try {
    s = br.statSync(a, { bigint: !0 });
  } catch (c) {
    if (c.code === "ENOENT") return;
    throw c;
  }
  if (wn(t, s))
    throw new Error(Ui(e, r, n));
  return af(e, t, a, n);
}
function wn(e, t) {
...
var Pr = {
  ...
  checkPathsSync: S0,
  checkParentPaths: nf,
  checkParentPathsSync: af,
  isSrcSubdir: ho,
  areIdentical: wn
};
const ke = De, tn = se, C0 = ot.mkdirs, A0 = Zt.pathExists, P0 = rf.utimesMillis, rn = Pr;
function x0(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    rn.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? sf(Dl, c, e, t, r, n) : Dl(c, e, t, r, n));
  });
}
function Dl(e, t, r, n, i) {
  const a = tn.dirname(r);
  A0(a, (s, c) => {
    if (s) return i(s);
    if (c) return bi(e, t, r, n, i);
    C0(a, (l) => l ? i(l) : bi(e, t, r, n, i));
  });
}
...
function T0(e, t, r, n, i) {
  return n.filter ? sf(bi, e, t, r, n, i) : bi(e, t, r, n, i);
}
function bi(e, t, r, n, i) {
  (n.dereference ? ke.stat : ke.lstat)(t, (s, c) => s ? i(s) : c.isDirectory() ? k0(c, e, t, r, n, i) : c.isFile() || c.isCharacterDevice() || c.isBlockDevice() ? I0(c, e, t, r, n, i) : c.isSymbolicLink() ? M0(e, t, r, n, i) : c.isSocket() ? i(new Error(`Cannot copy a socket file: ${t}`)) : c.isFIFO() ? i(new Error(`Cannot copy a FIFO pipe: ${t}`)) : i(new Error(`Unknown file: ${t}`)));
}
function I0(e, t, r, n, i, a) {
  return t ? O0(e, r, n, i, a) : of(e, r, n, i, a);
}
function O0(e, t, r, n, i) {
  if (n.overwrite)
    ke.unlink(r, (a) => a ? i(a) : of(e, t, r, n, i));
  else return n.errorOnExist ? i(new Error(`'${r}' already exists`)) : i();
}
function of(e, t, r, n, i) {
  ke.copyFile(t, r, (a) => a ? i(a) : n.preserveTimestamps ? R0(e.mode, t, r, i) : Mi(r, e.mode, i));
}
function R0(e, t, r, n) {
  return D0(e) ? N0(r, e, (i) => i ? n(i) : Nl(e, t, r, n)) : Nl(e, t, r, n);
}
function D0(e) {
  return (e & 128) === 0;
}
...
function Nl(e, t, r, n) {
  L0(t, r, (i) => i ? n(i) : Mi(r, e, n));
}
function Mi(e, t, r) {
  return ke.chmod(e, t, r);
}
function L0(e, t, r) {
  ke.stat(e, (n, i) => n ? r(n) : P0(t, i.atime, i.mtime, r));
}
function k0(e, t, r, n, i, a) {
  return t ? lf(r, n, i, a) : F0(e.mode, r, n, i, a);
}
function F0(e, t, r, n, i) {
  ke.mkdir(r, (a) => {
    if (a) return i(a);
    lf(t, r, n, (s) => s ? i(s) : Mi(r, e, i));
  });
}
function lf(e, t, r, n) {
  ke.readdir(e, (i, a) => i ? n(i) : cf(a, e, t, r, n));
}
function cf(e, t, r, n, i) {
  const a = e.pop();
  return a ? U0(e, a, t, r, n, i) : i();
}
function U0(e, t, r, n, i, a) {
  const s = tn.join(r, t), c = tn.join(n, t);
  rn.checkPaths(s, c, "copy", i, (l, f) => {
    if (l) return a(l);
    const { destStat: o } = f;
    T0(o, s, c, i, (d) => d ? a(d) : cf(e, r, n, i, a));
  });
}
function M0(e, t, r, n, i) {
  ke.readlink(t, (a, s) => {
    if (a) return i(a);
    if (n.dereference && (s = tn.resolve(process.cwd(), s)), e)
      ke.readlink(r, (c, l) => c ? c.code === "EINVAL" || c.code === "UNKNOWN" ? ke.symlink(s, r, i) : i(c) : (n.dereference && (l = tn.resolve(process.cwd(), l)), rn.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && rn.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : $0(s, r, i)));
    else
...
var B0 = x0;
const Ce = De, nn = se, H0 = ot.mkdirsSync, q0 = rf.utimesMillisSync, an = Pr;
function j0(e, t, r) {
  ...
  const { srcStat: n, destStat: i } = an.checkPathsSync(e, t, "copy", r);
  return an.checkParentPathsSync(e, n, t, "copy"), G0(i, e, t, r);
}
function G0(e, t, r, n) {
  if (n.filter && !n.filter(t, r)) return;
  const i = nn.dirname(r);
  return Ce.existsSync(i) || H0(i), uf(e, t, r, n);
}
function V0(e, t, r, n) {
...
function uf(e, t, r, n) {
  ...
  if (a.isDirectory()) return Q0(a, e, t, r, n);
  if (a.isFile() || a.isCharacterDevice() || a.isBlockDevice()) return W0(a, e, t, r, n);
  if (a.isSymbolicLink()) return t1(e, t, r, n);
...
function W0(e, t, r, n, i) {
  return t ? z0(e, r, n, i) : ff(e, r, n, i);
}
function z0(e, t, r, n) {
  if (n.overwrite)
    return Ce.unlinkSync(r), ff(e, t, r, n);
  if (n.errorOnExist)
    throw new Error(`'${r}' already exists`);
}
function ff(e, t, r, n) {
  return Ce.copyFileSync(t, r), n.preserveTimestamps && Y0(e.mode, t, r), po(r, e.mode);
}
function Y0(e, t, r) {
  return X0(e) && K0(r, e), J0(t, r);
}
function X0(e) {
  return (e & 128) === 0;
}
...
function J0(e, t) {
  ...
  return q0(t, r.atime, r.mtime);
}
function Q0(e, t, r, n, i) {
  return t ? hf(r, n, i) : Z0(e.mode, r, n, i);
}
function Z0(e, t, r, n) {
  return Ce.mkdirSync(r), hf(t, r, n), po(r, e);
}
function hf(e, t, r) {
  Ce.readdirSync(e).forEach((n) => e1(n, e, t, r));
}
function e1(e, t, r, n) {
  const i = nn.join(t, e), a = nn.join(r, e), { destStat: s } = an.checkPathsSync(i, a, "copy", n);
  return V0(s, i, a, n);
}
function t1(e, t, r, n) {
  let i = Ce.readlinkSync(t);
  if (n.dereference && (i = nn.resolve(process.cwd(), i)), e) {
    let a;
    try {
      a = Ce.readlinkSync(r);
    } catch (s) {
    ...
    if (n.dereference && (a = nn.resolve(process.cwd(), a)), an.isSrcSubdir(i, a))
      throw new Error(`Cannot copy '${i}' to a subdirectory of itself, '${a}'.`);
    if (Ce.statSync(r).isDirectory() && an.isSrcSubdir(a, i))
...
var n1 = j0;
const i1 = Re.fromCallback;
var mo = {
  copy: i1(B0),
  copySync: n1
};
const Ll = De, df = se, ee = ju, sn = process.platform === "win32";
function pf(e) {
  [
    "unlink",
    "chmod",
    ...
    e[r] = e[r] || Ll[r], r = r + "Sync", e[r] = e[r] || Ll[r];
  }), e.maxBusyTries = e.maxBusyTries || 3;
}
function go(e, t, r) {
  let n = 0;
  typeof t == "function" && (r = t, t = {}), ee(e, "rimraf: missing path"), ee.strictEqual(typeof e, "string", "rimraf: path should be a string"), ee.strictEqual(typeof r, "function", "rimraf: callback function required"), ee(t, "rimraf: invalid options argument provided"), ee.strictEqual(typeof t, "object", "rimraf: options should be object"), pf(t), kl(e, t, function i(a) {
    if (a) {
      if ((a.code === "EBUSY" || a.code === "ENOTEMPTY" || a.code === "EPERM") && n < t.maxBusyTries) {
        n++;
        const s = n * 100;
        return setTimeout(() => kl(e, t, i), s);
      }
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return sn ? Fl(e, t, a, r) : mi(e, t, a, r);
        if (a.code === "EISDIR")
          return mi(e, t, a, r);
      }
      return r(a);
...
function Fl(e, t, r, n) {
  ee(e), ee(t), ee(typeof n == "function"), t.chmod(e, 438, (i) => {
    i ? n(i.code === "ENOENT" ? null : r) : t.stat(e, (a, s) => {
      a ? n(a.code === "ENOENT" ? null : r) : s.isDirectory() ? mi(e, t, r, n) : t.unlink(e, n);
    });
  });
}
function Ul(e, t, r) {
...
function mi(e, t, r, n) {
  ee(e), ee(t), ee(typeof n == "function"), t.rmdir(e, (i) => {
    i && (i.code === "ENOTEMPTY" || i.code === "EEXIST" || i.code === "EPERM") ? a1(e, t, n) : i && i.code === "ENOTDIR" ? n(r) : n(i);
  });
}
function a1(e, t, r) {
...
function mf(e, t) {
  let r;
  t = t || {}, pf(t), ee(e, "rimraf: missing path"), ee.strictEqual(typeof e, "string", "rimraf: path should be a string"), ee(t, "rimraf: missing options"), ee.strictEqual(typeof t, "object", "rimraf: options should be object");
  try {
    r = t.lstatSync(e);
  } catch (n) {
    if (n.code === "ENOENT")
      return;
    n.code === "EPERM" && sn && Ul(e, t, n);
  }
  try {
...
function s1(e, t) {
  if (ee(e), ee(t), t.readdirSync(e).forEach((r) => mf(df.join(e, r), t)), sn) {
    const r = Date.now();
    do
      try {
...
var o1 = go;
go.sync = mf;
const Si = De, l1 = Re.fromCallback, gf = o1;
function c1(e, t) {
...
const f1 = Re.fromPromise, vf = Qt, yf = se, _f = ot, Ef = $i, Ml = f1(async function(t) {
  let r;
  try {
    r = await vf.readdir(t);
  } catch {
    return _f.mkdirs(t);
  }
  return Promise.all(r.map((n) => Ef.remove(yf.join(t, n))));
});
function $l(e) {
  let t;
  try {
    ...
    return _f.mkdirsSync(e);
  }
  t.forEach((r) => {
    r = yf.join(e, r), Ef.removeSync(r);
  });
}
var h1 = {
  emptyDirSync: $l,
...
const d1 = Re.fromCallback, wf = se, bt = De, bf = ot;
function p1(e, t) {
  function r() {
    bt.writeFile(e, "", (n) => {
      if (n) return t(n);
  ...
  bt.stat(e, (n, i) => {
    ...
    const a = wf.dirname(e);
    bt.stat(a, (s, c) => {
      if (s)
        return s.code === "ENOENT" ? bf.mkdirs(a, (l) => {
          if (l) return t(l);
          r();
        }) : t(s);
...
function m1(e) {
  ...
  const r = wf.dirname(e);
  try {
    bt.statSync(r).isDirectory() || bt.readdirSync(r);
  } catch (n) {
    if (n && n.code === "ENOENT") bf.mkdirsSync(r);
    else throw n;
  }
  bt.writeFileSync(e, "");
}
...
const v1 = Re.fromCallback, Sf = se, wt = De, Cf = ot, y1 = Zt.pathExists, { areIdentical: Af } = Pr;
function _1(e, t, r) {
  function n(i, a) {
    wt.link(i, a, (s) => {
      if (s) return r(s);
  ...
  wt.lstat(t, (i, a) => {
    wt.lstat(e, (s, c) => {
      ...
      if (a && Af(c, a)) return r(null);
      const l = Sf.dirname(t);
      y1(l, (f, o) => {
        if (f) return r(f);
        if (o) return n(e, t);
        Cf.mkdirs(l, (d) => {
...
function E1(e, t) {
  ...
  const n = Sf.dirname(t);
  return wt.existsSync(n) || Cf.mkdirsSync(n), wt.linkSync(e, t);
}
var w1 = {
  createLink: v1(_1),
  createLinkSync: E1
};
const St = se, Kr = De, b1 = Zt.pathExists;
function S1(e, t, r) {
  if (St.isAbsolute(e))
    ...
    }));
  {
    ...
    return b1(i, (a, s) => a ? r(a) : s ? r(null, {
      toCwd: i,
      toDst: e
    }) : Kr.lstat(e, (c) => c ? (c.message = c.message.replace("lstat", "ensureSymlink"), r(c)) : r(null, {
      toCwd: e,
...
const I1 = Re.fromCallback, xf = se, Ke = Qt, Tf = ot, O1 = Tf.mkdirs, R1 = Tf.mkdirsSync, If = A1, D1 = If.symlinkPaths, N1 = If.symlinkPathsSync, Of = T1, L1 = Of.symlinkType, k1 = Of.symlinkTypeSync, F1 = Zt.pathExists, { areIdentical: Rf } = Pr;
function U1(e, t, r, n) {
...
function Bl(e, t, r, n) {
  D1(e, t, (i, a) => {
    if (i) return n(i);
    e = a.toDst, L1(a.toCwd, r, (s, c) => {
      if (s) return n(s);
      const l = xf.dirname(t);
      F1(l, (f, o) => {
        if (f) return n(f);
...
function M1(e, t, r) {
  ...
  const i = N1(e, t);
  e = i.toDst, r = k1(i.toCwd, r);
  const a = xf.dirname(t);
  return Ke.existsSync(a) || R1(a), Ke.symlinkSync(e, t, r);
}
var $1 = {
  createSymlink: I1(U1),
  createSymlinkSync: M1
};
const { createFile: Hl, createFileSync: ql } = g1, { createLink: jl, createLinkSync: Gl } = w1, { createSymlink: Vl, createSymlinkSync: Wl } = $1;
var B1 = {
  // file
  createFile: Hl,
  createFileSync: ql,
  ...
  // symlink
  createSymlink: Vl,
  createSymlinkSync: Wl,
  ensureSymlink: Vl,
  ensureSymlinkSync: Wl
};
function H1(e, { EOL: t = `
...
var vo = { stringify: H1, stripBom: q1 };
let Sr;
try {
  Sr = De;
} catch {
...
const Bi = Re, { stringify: Df, stripBom: Nf } = vo;
async function j1(e, t = {}) {
  typeof t == "string" && (t = { encoding: t });
  const r = t.fs || Sr, n = "throws" in t ? t.throws : !0;
  let i = await Bi.fromCallback(r.readFile)(e, t);
  i = Nf(i);
  let a;
  try {
...
const G1 = Bi.fromPromise(j1);
function V1(e, t = {}) {
  typeof t == "string" && (t = { encoding: t });
  const r = t.fs || Sr, n = "throws" in t ? t.throws : !0;
  try {
    let i = r.readFileSync(e, t);
    return i = Nf(i), JSON.parse(i, t.reviver);
  } catch (i) {
    if (n)
...
async function W1(e, t, r = {}) {
  const n = r.fs || Sr, i = Df(t, r);
  await Bi.fromCallback(n.writeFile)(e, i, r);
}
const z1 = Bi.fromPromise(W1);
function Y1(e, t, r = {}) {
  const n = r.fs || Sr, i = Df(t, r);
...
var K1 = {
  // jsonfile exports
  readJson: Xn.readFile,
  readJsonSync: Xn.readFileSync,
  writeJson: Xn.writeFile,
  writeJsonSync: Xn.writeFileSync
};
const J1 = Re.fromCallback, Jr = De, Lf = se, kf = ot, Q1 = Zt.pathExists;
function Z1(e, t, r, n) {
  typeof r == "function" && (n = r, r = "utf8");
  const i = Lf.dirname(e);
  Q1(i, (a, s) => {
    if (a) return n(a);
    if (s) return Jr.writeFile(e, t, r, n);
    kf.mkdirs(i, (c) => {
      if (c) return n(c);
...
function em(e, ...t) {
  const r = Lf.dirname(e);
  if (Jr.existsSync(r))
    return Jr.writeFileSync(e, ...t);
  kf.mkdirsSync(r), Jr.writeFileSync(e, ...t);
}
var yo = {
  outputFile: J1(Z1),
  outputFileSync: em
};
const { stringify: tm } = vo, { outputFile: rm } = yo;
async function nm(e, t, r = {}) {
  const n = tm(t, r);
  await rm(e, n, r);
}
var im = nm;
const { stringify: am } = vo, { outputFileSync: sm } = yo;
function om(e, t, r) {
  const n = am(t, r);
  sm(e, n, r);
}
var lm = om;
const cm = Re.fromPromise, Oe = K1;
Oe.outputJson = cm(im);
Oe.outputJsonSync = lm;
...
var um = Oe;
const fm = De, ps = se, hm = mo.copy, Ff = $i.remove, dm = ot.mkdirp, pm = Zt.pathExists, zl = Pr;
function mm(e, t, r, n) {
  typeof r == "function" && (n = r, r = {}), r = r || {};
  const i = r.overwrite || r.clobber || !1;
  zl.checkPaths(e, t, "move", r, (a, s) => {
    if (a) return n(a);
    const { srcStat: c, isChangingCase: l = !1 } = s;
    zl.checkParentPaths(e, c, t, "move", (f) => {
      if (f) return n(f);
      if (gm(t)) return Yl(e, t, i, l, n);
      dm(ps.dirname(t), (o) => o ? n(o) : Yl(e, t, i, l, n));
    });
  });
}
function gm(e) {
...
function Yl(e, t, r, n, i) {
  if (n) return Pa(e, t, r, i);
  if (r)
    return Ff(t, (a) => a ? i(a) : Pa(e, t, r, i));
  pm(t, (a, s) => a ? i(a) : s ? i(new Error("dest already exists.")) : Pa(e, t, r, i));
}
function Pa(e, t, r, n) {
  fm.rename(e, t, (i) => i ? i.code !== "EXDEV" ? n(i) : vm(e, t, r, n) : n());
}
function vm(e, t, r, n) {
  hm(e, t, {
    overwrite: r,
...
var ym = mm;
const Uf = De, ms = se, _m = mo.copySync, Mf = $i.removeSync, Em = ot.mkdirpSync, Xl = Pr;
function wm(e, t, r) {
  r = r || {};
  const n = r.overwrite || r.clobber || !1, { srcStat: i, isChangingCase: a = !1 } = Xl.checkPathsSync(e, t, "move", r);
  return Xl.checkParentPathsSync(e, i, t, "move"), bm(t) || Em(ms.dirname(t)), Sm(e, t, n, a);
}
function bm(e) {
  const t = ms.dirname(e);
  return ms.parse(t).root === t;
}
function Sm(e, t, r, n) {
  if (n) return xa(e, t, r);
  if (r)
    return Mf(t), xa(e, t, r);
  if (Uf.existsSync(t)) throw new Error("dest already exists.");
  return xa(e, t, r);
}
function xa(e, t, r) {
  try {
...
const Tm = Gu;
class Im extends Tm.EventEmitter {
  get cancelled() {
...
xt.CancellationToken = Im;
class gs extends Error {
  constructor() {
    super("cancelled");
  }
}
xt.CancellationError = gs;
var xr = {};
...
var Ie = {}, vs = { exports: {} }, Kn = { exports: {} }, Ta, Kl;
function Rm() {
  if (Kl) return Ta;
  Kl = 1;
...
function $f() {
  ...
  Jl = 1;
  function e(t) {
    n.debug = n, n.default = n, n.coerce = f, n.disable = c, n.enable = a, n.enabled = l, n.humanize = Rm(), n.destroy = o, Object.keys(t).forEach((d) => {
      n[d] = t[d];
...
var Jn = { exports: {} }, Oa, Zl;
function Nm() {
  return Zl || (Zl = 1, Oa = (e, t = process.argv) => {
...
function Lm() {
  if (ec) return Ra;
  ec = 1;
  const e = Fi, t = Vu, r = Nm(), { env: n } = process;
  let i;
...
typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? vs.exports = Dm() : vs.exports = km();
var Fm = vs.exports, bn = {};
Object.defineProperty(bn, "__esModule", { value: !0 });
bn.ProgressCallbackTransform = void 0;
const Um = _n;
class Mm extends Um.Transform {
  constructor(t, r, n) {
...
bn.ProgressCallbackTransform = Mm;
Object.defineProperty(Ie, "__esModule", { value: !0 });
Ie.DigestTransform = Ie.HttpExecutor = Ie.HttpError = void 0;
Ie.createHttpError = _s;
Ie.parseJson = Wm;
Ie.configureRequestOptionsFromUrl = Hf;
Ie.configureRequestUrl = Eo;
Ie.safeGetHeader = wr;
Ie.configureRequestOptions = Ci;
Ie.safeStringifyJson = Ai;
const $m = En, Bm = Fm, Hm = Je, qm = _n, ys = Rt, jm = xt, rc = xr, Gm = bn, Ht = (0, Bm.default)("electron-builder");
function _s(e, t = null) {
  return new _o(e.statusCode || -1, `${e.statusCode} ${e.statusMessage}` + (t == null ? "" : `
...
class _o extends Error {
  constructor(t, r = `HTTP error: ${Vm.get(t) || t}`, n = null) {
...
class fr {
  ...
  doApiRequest(t, r, n, i = 0) {
    return Ht.enabled && Ht(`Request: ${Ai(t)}`), r.createPromise((a, s, c) => {
  ...
  handleResponse(t, r, n, i, a, s, c) {
    var l;
    if (Ht.enabled && Ht(`Response: ${t.statusCode} ${t.statusMessage}, request options: ${Ai(r)}`), t.statusCode === 404) {
      a(_s(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
...
`));
    ...
    const f = (l = t.statusCode) !== null && l !== void 0 ? l : 0, o = f >= 300 && f < 400, d = wr(t, "location");
    if (o && d != null) {
      if (s > this.maxRedirects) {
        a(this.createMaxRedirectError());
        return;
      }
      this.doApiRequest(fr.prepareRedirectUrlOptions(d, r), n, c, s).then(i).catch(a);
      return;
    }
    t.setEncoding("utf8");
    let u = "";
    t.on("error", a), t.on("data", (h) => u += h), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const h = wr(t, "content-type"), p = h != null && (Array.isArray(h) ? h.find((m) => m.includes("json")) != null : h.includes("json"));
          a(_s(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
  ...
  doDownload(t, r, n) {
    const i = this.createRequest(t, (a) => {
      ...
      if (s != null) {
        n < this.maxRedirects ? this.doDownload(fr.prepareRedirectUrlOptions(s, t), r, n++) : r.callback(this.createMaxRedirectError());
        return;
      }
      r.responseHandler == null ? Ym(r, a) : r.responseHandler(a, r.callback);
    });
  ...
  static prepareRedirectUrlOptions(t, r) {
    const n = Hf(t, { ...r }), i = n.headers;
    if (i != null && i.authorization) {
      const a = fr.reconstructOriginalUrl(r), s = Bf(t, r);
      fr.isCrossOriginRedirect(a, s) && (Ht.enabled && Ht(`Given the cross-origin redirect (from ${a.host} to ${s.host}), the Authorization header will be stripped out.`), delete i.authorization);
    }
    return n;
  }
  ...
  static retryOnServerError(t, r = 3) {
    for (let n = 0; ; n++)
      try {
        ...
        if (n < r && (i instanceof _o && i.isServerError() || i.code === "EPIPE"))
          continue;
        throw i;
      }
  }
...
function Bf(e, t) {
  try {
    ...
    return new ys.URL(e, a);
  }
}
function Hf(e, t) {
  const r = Ci(t), n = Bf(e, t);
  return Eo(n, r), r;
}
function Eo(e, t) {
  t.protocol = e.protocol, t.hostname = e.hostname, e.port ? t.port = e.port : t.port && delete t.port, t.path = e.pathname + e.search;
}
class Es extends qm.Transform {
  // noinspection JSUnusedGlobalSymbols
  get actual() {
    return this._actual;
  }
  constructor(t, r = "sha512", n = "base64") {
    super(), this.expected = t, this.algorithm = r, this.encoding = n, this._actual = null, this.isValidateOnEnd = !0, this.digester = (0, $m.createHash)(r);
  }
  // noinspection JSUnusedGlobalSymbols
  _transform(t, r, n) {
  ...
  validate() {
    if (this._actual == null)
      throw (0, rc.newError)("Not finished yet", "ERR_STREAM_NOT_FINISHED");
    if (this._actual !== this.expected)
      throw (0, rc.newError)(`${this.algorithm} checksum mismatch, expected ${this.expected}, got ${this._actual}`, "ERR_CHECKSUM_MISMATCH");
    return null;
  }
}
Ie.DigestTransform = Es;
function zm(e, t, r) {
...
function Ym(e, t) {
  if (!zm(wr(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
  if (e.options.onProgress != null) {
    const s = wr(t, "content-length");
    s != null && r.push(new Gm.ProgressCallbackTransform(parseInt(s, 10), e.options.cancellationToken, e.options.onProgress));
  }
  const n = e.options.sha512;
  n != null ? r.push(new Es(n, "sha512", n.length === 128 && !n.includes("+") && !n.includes("Z") && !n.includes("=") ? "hex" : "base64")) : e.options.sha2 != null && r.push(new Es(e.options.sha2, "sha256", "hex"));
...
class Xm {
  ...
  get value() {
    ...
    if (this._value !== void 0 && qf(this.selected, t))
      return this._value;
    this.selected = t;
...
function qf(e, t) {
  if (typeof e == "object" && e !== null && (typeof t == "object" && t !== null)) {
    ...
    return i.length === a.length && i.every((s) => qf(e[s], t[s]));
  }
  return e === t;
}
var Sn = {};
...
Sn.githubUrl = Km;
Sn.githubTagPrefix = Jm;
Sn.getS3LikeProviderBaseUrl = Qm;
function Km(e, t = "github.com") {
...
function eg(e) {
  ...
  return jf(`https://${e.name}.${e.region}.digitaloceanspaces.com`, e.path);
}
var wo = {};
...
async function Gf(e, t) {
  var r;
  const { retries: n, interval: i, backoff: a = 0, attempt: s = 0, shouldRetry: c, cancellationToken: l = new tg.CancellationToken() } = t;
  try {
    return await e();
  } catch (f) {
    if (await Promise.resolve((r = c == null ? void 0 : c(f)) !== null && r !== void 0 ? r : !0) && n > 0 && !l.cancelled)
      return await new Promise((o) => setTimeout(o, i + a * s)), await Gf(e, { ...t, retries: n - 1, attempt: s + 1 });
    throw f;
  }
}
var bo = {};
...
const Vf = En, Wf = xr, ng = "options.name must be either a string or a Buffer", nc = (0, Vf.randomBytes)(16);
nc[0] = nc[0] | 1;
const vi = {}, J = [];
for (let e = 0; e < 256; e++) {
...
class Kt {
  ...
  static check(t, r = 0) {
    if (typeof t == "string")
      return t = t.toLowerCase(), /^[a-f0-9]{8}(-[a-f0-9]{4}){3}-([a-f0-9]{12})$/.test(t) ? t === "00000000-0000-0000-0000-000000000000" ? { version: void 0, variant: "nil", format: "ascii" } : {
        version: (vi[t[14] + t[15]] & 240) >> 4,
        variant: ic((vi[t[19] + t[20]] & 224) >> 5),
        format: "ascii"
      } : !1;
    if (Buffer.isBuffer(t)) {
      ...
      return n === 16 ? { version: void 0, variant: "nil", format: "binary" } : {
        version: (t[r + 6] & 240) >> 4,
        variant: ic((t[r + 8] & 224) >> 5),
        format: "binary"
      };
    }
    throw (0, Wf.newError)("Unknown type of uuid", "ERR_UNKNOWN_UUID_TYPE");
  }
  ...
  static parse(t) {
    ...
    let n = 0;
    for (let i = 0; i < 16; i++)
      r[i] = vi[t[n++] + t[n++]], (i === 3 || i === 5 || i === 7 || i === 9) && (n += 1);
    return r;
  }
}
Cr.UUID = Kt;
...
function ig(e, t, r, n, i = Qr.ASCII) {
  const a = (0, Vf.createHash)(t);
  if (typeof e != "string" && !Buffer.isBuffer(e))
    throw (0, Wf.newError)(ng, "ERR_INVALID_UUID_NAME");
...
Cr.nil = new Kt("00000000-0000-0000-0000-000000000000");
var Cn = {}, zf = {};
(function(e) {
  (function(t) {
...
Actual: ` + w.attribValue
    ...
    function X(w, v) {
      if (w.opt.xmlns) {
        ...
        O.ns && Q.ns !== O.ns && Object.keys(O.ns).forEach(function(Un) {
          j(w, "onopennamespace", {
            prefix: Un,
            uri: O.ns[Un]
          });
        ...
        for (var re = 0, oe = w.attribList.length; re < oe; re++) {
          var ye = w.attribList[re], be = ye[0], mt = ye[1], he = k(be, !0), We = he.prefix, oa = he.local, Fn = We === "" ? "" : O.ns[We] || "", Nr = {
            name: be,
            value: mt,
            prefix: We,
            local: oa,
          ...
          ), Nr.uri = We), w.tag.attributes[be] = Nr, j(w, "onattribute", Nr);
        }
...
class Yf {
  constructor(t) {
    ...
    if (!lg(t))
      throw (0, Qn.newError)(`Invalid element name: ${t}`, "ERR_XML_ELEMENT_INVALID_NAME");
  }
  attribute(t) {
    const r = this.attributes === null ? null : this.attributes[t];
    if (r == null)
      throw (0, Qn.newError)(`No attribute "${t}"`, "ERR_XML_MISSED_ATTRIBUTE");
    return r;
  }
  removeAttribute(t) {
  ...
  element(t, r = !1, n = null) {
    ...
    if (i === null)
      throw (0, Qn.newError)(n || `No element "${t}"`, "ERR_XML_MISSED_ELEMENT");
    return i;
  }
  elementOrNull(t, r = !1) {
  ...
  getElements(t, r = !1) {
    return this.elements === null ? [] : this.elements.filter((n) => ac(n, t, r));
  }
...
Cn.XElement = Yf;
const og = new RegExp(/^[A-Za-z_][:A-Za-z0-9_-]*$/i);
function lg(e) {
  return og.test(e);
}
function ac(e, t, r) {
...
function cg(e) {
  let t = null;
  const r = sg.parser(!0, {}), n = [];
  return r.onopentag = (i) => {
    const a = new Yf(i.name);
...
function fg(e) {
  return Array.isArray(e) ? e : Xf(e) ? [] : [e];
}
function hg(e, t) {
  var r, n, i, a;
  if (t)
...
function on(e, t) {
  Error.call(this), this.name = "YAMLException", this.reason = e, this.mark = t, this.message = Kf(this, !1), Error.captureStackTrace ? Error.captureStackTrace(this, this.constructor) : this.stack = new Error().stack || "";
}
on.prototype = Object.create(Error.prototype);
on.prototype.constructor = on;
on.prototype.toString = function(t) {
  return this.name + ": " + Kf(this, t);
};
var An = on, Yr = Ze;
...
function mg(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(s - l < 0); l++)
    f = Da(
      ...
      d
    ), c = Yr.repeat(" ", t.indent) + Na((e.line - l + 1).toString(), o) + " | " + f.str + `
` + c;
  for (f = Da(e.buffer, n[s], i[s], e.position, d), c += Yr.repeat(" ", t.indent) + Na((e.line + 1).toString(), o) + " | " + f.str + `
`, c += Yr.repeat("-", t.indent + o + 3 + f.pos) + `^
...
function Eg(e, t) {
  if (t = t || {}, Object.keys(t).forEach(function(r) {
    if (vg.indexOf(r) === -1)
      throw new sc('Unknown option "' + r + '" is met in definition of "' + e + '" YAML type.');
  }), this.options = t, this.tag = e, this.kind = t.kind || null, this.resolve = t.resolve || function() {
    return !0;
  }, this.construct = t.construct || function(r) {
    return r;
  }, this.instanceOf = t.instanceOf || null, this.predicate = t.predicate || null, this.represent = t.represent || null, this.representName = t.representName || null, this.defaultStyle = t.defaultStyle || null, this.multi = t.multi || !1, this.styleAliases = _g(t.styleAliases || null), yg.indexOf(this.kind) === -1)
    throw new sc('Unknown kind "' + this.kind + '" is specified for "' + e + '" YAML type.');
}
var Ne = Eg, Br = An, La = Ne;
function oc(e, t) {
  var r = [];
...
ws.prototype.extend = function(t) {
  var r = [], n = [];
  if (t instanceof La)
    n.push(t);
  ...
  var i = Object.create(ws.prototype);
  return i.implicit = (this.implicit || []).concat(r), i.explicit = (this.explicit || []).concat(n), i.compiledImplicit = oc(i, "implicit"), i.compiledExplicit = oc(i, "explicit"), i.compiledTypeMap = wg(i.compiledImplicit, i.compiledExplicit), i;
};
var Jf = ws, bg = Ne, Qf = new bg("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(e) {
    return e !== null ? e : "";
  }
}), Sg = Ne, Zf = new Sg("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(e) {
    return e !== null ? e : [];
  }
}), Cg = Ne, eh = new Cg("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
var rh = new Pg("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: xg,
  construct: Tg,
  predicate: Ig,
...
var nh = new Og("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: Rg,
  construct: Dg,
  predicate: Ng,
...
var ih = new kg("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: $g,
  construct: Bg,
  predicate: Hg,
...
function zg(e, t) {
  ...
  else if (ah.isNegativeZero(e))
    return "-0.0";
  return r = e.toString(10), Wg.test(r) ? r.replace("e", ".e") : r;
}
function Yg(e) {
  return Object.prototype.toString.call(e) === "[object Number]" && (e % 1 !== 0 || ah.isNegativeZero(e));
}
var sh = new qg("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: Gg,
  construct: Vg,
  predicate: Yg,
...
}), lh = oh, Xg = Ne, ch = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"
), uh = new RegExp(
  "^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$"
);
function Kg(e) {
  return e === null ? !1 : ch.exec(e) !== null || uh.exec(e) !== null;
}
function Jg(e) {
  var t, r, n, i, a, s, c, l = 0, f = null, o, d, u;
  if (t = ch.exec(e), t === null && (t = uh.exec(e)), t === null) throw new Error("Date resolve error");
...
var fh = new Xg("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: Kg,
  construct: Jg,
  instanceOf: Date,
...
var hh = new Zg("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: e2
}), t2 = Ne, Co = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;
function r2(e) {
  if (e === null) return !1;
  var t, r, n = 0, i = e.length, a = Co;
  for (r = 0; r < i; r++)
...
var dh = new t2("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: r2,
  construct: n2,
  predicate: a2,
  represent: i2
}), s2 = Ne, o2 = Object.prototype.hasOwnProperty, l2 = Object.prototype.toString;
function c2(e) {
  if (e === null) return !0;
  var t = [], r, n, i, a, s, c = e;
  for (r = 0, n = c.length; r < n; r += 1) {
    if (i = c[r], s = !1, l2.call(i) !== "[object Object]") return !1;
    for (a in i)
      if (o2.call(i, a))
        if (!s) s = !0;
        else return !1;
...
var ph = new s2("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: c2,
  construct: u2
}), f2 = Ne, h2 = Object.prototype.toString;
function d2(e) {
  if (e === null) return !0;
  var t, r, n, i, a, s = e;
  for (a = new Array(s.length), t = 0, r = s.length; t < r; t += 1) {
    if (n = s[t], h2.call(n) !== "[object Object]" || (i = Object.keys(n), i.length !== 1)) return !1;
    a[t] = [i[0], n[i[0]]];
  }
  return !0;
}
...
var mh = new f2("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: d2,
  construct: p2
}), m2 = Ne, g2 = Object.prototype.hasOwnProperty;
function v2(e) {
  if (e === null) return !0;
  var t, r = e;
  for (t in r)
    if (g2.call(r, t) && r[t] !== null)
      return !1;
  return !0;
}
function y2(e) {
...
var gh = new m2("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: v2,
  construct: y2
}), Ao = lh.extend({
...
}), Vt = Ze, vh = An, _2 = gg, E2 = Ao, Tt = Object.prototype.hasOwnProperty, Pi = 1, yh = 2, _h = 3, xi = 4, ka = 1, w2 = 2, lc = 3, b2 = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, S2 = /[\x85\u2028\u2029]/, C2 = /[,\[\]\{\}]/, Eh = /^(?:!|!!|![a-z\-]+!)$/i, wh = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function cc(e) {
...
var Sh = new Array(256), Ch = new Array(256);
for (var sr = 0; sr < 256; sr++)
  Sh[sr] = uc(sr) ? 1 : 0, Ch[sr] = uc(sr);
function I2(e, t) {
  this.input = e, this.filename = t.filename || null, this.schema = t.schema || E2, this.onWarning = t.onWarning || null, this.legacy = t.legacy || !1, this.json = t.json || !1, this.listener = t.listener || null, this.implicitTypes = this.schema.compiledImplicit, this.typeMap = this.schema.compiledTypeMap, this.length = e.length, this.position = 0, this.line = 0, this.lineStart = 0, this.lineIndent = 0, this.firstTabInLine = -1, this.documents = [];
}
function Ah(e, t) {
  var r = {
    name: e.filename,
  ...
  return r.snippet = _2(r), new vh(t, r);
}
function q(e, t) {
  throw Ah(e, t);
}
...
var fc = {
  YAML: function(t, r, n) {
    var i, a, s;
    t.version !== null && q(t, "duplication of %YAML directive"), n.length !== 1 && q(t, "YAML directive accepts exactly one argument"), i = /^([0-9]+)\.([0-9]+)$/.exec(n[0]), i === null && q(t, "ill-formed argument of the YAML directive"), a = parseInt(i[1], 10), s = parseInt(i[2], 10), a !== 1 && q(t, "unacceptable YAML version of the document"), t.version = n[0], t.checkLineBreaks = s < 2, s !== 1 && s !== 2 && Ti(t, "unsupported YAML version of the document");
  },
  TAG: function(t, r, n) {
    var i, a;
    n.length !== 2 && q(t, "TAG directive accepts exactly two arguments"), i = n[0], a = n[1], Eh.test(i) || q(t, "ill-formed tag handle (first argument) of the TAG directive"), Tt.call(t.tagMap, i) && q(t, 'there is a previously declared suffix for "' + i + '" tag handle'), wh.test(a) || q(t, "ill-formed tag prefix (second argument) of the TAG directive");
    try {
...
function Ct(e, t, r, n) {
  ...
  if (t < r) {
    ...
    else b2.test(c) && q(e, "the stream contains non-printable characters");
    e.result += c;
  }
}
function hc(e, t, r, n) {
  ...
  for (Vt.isObject(r) || q(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(r), s = 0, c = i.length; s < c; s += 1)
    a = i[s], Tt.call(t, a) || (bh(t, a, r[a]), n[a] = !0);
}
function dr(e, t, r, n, i, a, s, c, l) {
  var f, o;
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), f = 0, o = i.length; f < o; f += 1)
      Array.isArray(i[f]) && q(e, "nested arrays are not supported inside keys"), typeof i == "object" && cc(i[f]) === "[object Object]" && (i[f] = "[object Object]");
  if (typeof i == "object" && cc(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), n === "tag:yaml.org,2002:merge")
    if (Array.isArray(a))
    ...
    !e.json && !Tt.call(r, i) && Tt.call(t, i) && (e.line = s || e.line, e.lineStart = c || e.lineStart, e.position = l || e.position, q(e, "duplicated mapping key")), bh(t, i, a), delete r[i];
  return t;
}
function Po(e) {
  var t;
...
function ue(e, t, r) {
  ...
  return r !== -1 && n !== 0 && e.lineIndent < r && Ti(e, "deficient indentation"), n;
}
function qi(e) {
  var t = e.position, r;
...
function O2(e, t, r) {
  ...
  if (h = e.input.charCodeAt(e.position), Fe(h) || hr(h) || h === 35 || h === 38 || h === 42 || h === 33 || h === 124 || h === 62 || h === 39 || h === 34 || h === 37 || h === 64 || h === 96 || (h === 63 || h === 45) && (i = e.input.charCodeAt(e.position + 1), Fe(i) || r && hr(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = s = e.position, c = !1; h !== 0; ) {
    if (h === 58) {
      if (i = e.input.charCodeAt(e.position + 1), Fe(i) || r && hr(i))
        break;
    } else if (h === 35) {
      if (n = e.input.charCodeAt(e.position - 1), Fe(n))
        break;
    } else {
      if (e.position === e.lineStart && qi(e) || r && hr(h))
        break;
      if (st(h))
    ...
    c && (Ct(e, a, s, !1), xo(e, e.line - l), a = s = e.position, c = !1), Yt(h) || (s = e.position + 1), h = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; (r = e.input.charCodeAt(e.position)) !== 0; )
    if (r === 39)
      if (Ct(e, n, e.position, !0), r = e.input.charCodeAt(++e.position), r === 39)
        ...
        return !0;
    else st(r) ? (Ct(e, n, i, !0), xo(e, ue(e, !1, t)), n = i = e.position) : e.position === e.lineStart && qi(e) ? q(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = n = e.position; (c = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (c === 92) {
      if (Ct(e, r, e.position, !0), c = e.input.charCodeAt(++e.position), st(c))
        ...
        e.result += Ch[c], e.position++;
      else if ((s = P2(c)) > 0) {
        for (i = s, a = 0; i > 0; i--)
          c = e.input.charCodeAt(++e.position), (s = A2(c)) >= 0 ? a = (a << 4) + s : q(e, "expected hexadecimal character");
        e.result += T2(a), e.position++;
      } else
        q(e, "unknown escape sequence");
      r = n = e.position;
    } else st(c) ? (Ct(e, r, n, !0), xo(e, ue(e, !1, t)), r = n = e.position) : e.position === e.lineStart && qi(e) ? q(e, "unexpected end of the document within a double quoted scalar") : (e.position++, n = e.position);
  }
...
function N2(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = c), y = e.input.charCodeAt(++e.position); y !== 0; ) {
    ...
    r ? y === 44 && q(e, "expected the node content, but found ','") : q(e, "missed comma between flow collection entries"), g = m = E = null, d = u = !1, y === 63 && (f = e.input.charCodeAt(e.position + 1), Fe(f) && (d = u = !0, e.position++, ue(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Ar(e, t, Pi, !1, !0), g = e.tag, m = e.result, ue(e, !0, t), y = e.input.charCodeAt(e.position), (u || e.line === n) && y === 58 && (d = !0, y = e.input.charCodeAt(++e.position), ue(e, !0, t), Ar(e, t, Pi, !1, !0), E = e.result), h ? dr(e, c, p, g, m, E, n, i, a) : d ? c.push(dr(e, null, p, g, m, E, n, i, a)) : c.push(m), ue(e, !0, t), y = e.input.charCodeAt(e.position), y === 44 ? (r = !0, y = e.input.charCodeAt(++e.position)) : r = !1;
  }
  q(e, "unexpected end of the stream within a flow collection");
}
function L2(e, t) {
  var r, n, i = ka, a = !1, s = !1, c = t, l = 0, f = !1, o, d;
  ...
  for (e.kind = "scalar", e.result = ""; d !== 0; )
    if (d = e.input.charCodeAt(++e.position), d === 43 || d === 45)
      ka === i ? i = d === 43 ? lc : w2 : q(e, "repeat of a chomping mode identifier");
    else if ((o = x2(d)) >= 0)
  ...
  for (; d !== 0; ) {
    for (Po(e), e.lineIndent = 0, d = e.input.charCodeAt(e.position); (!s || e.lineIndent < c) && d === 32; )
    ...
    if (e.lineIndent < c) {
      i === lc ? e.result += Vt.repeat(`
`, a ? 1 + l : l) : i === ka && a && (e.result += `
`);
      break;
    }
...
function dc(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, q(e, "tab characters must not be used in indentation")), !(l !== 45 || (s = e.input.charCodeAt(e.position + 1), !Fe(s)))); ) {
    ...
    if (r = e.line, Ar(e, t, _h, !1, !0), a.push(e.result), ue(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
function k2(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = d), y = e.input.charCodeAt(e.position); y !== 0; ) {
    if (!g && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, q(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (y === 63 || y === 58) && Fe(n))
      y === 63 ? (g && (dr(e, d, u, h, p, null, s, c, l), h = p = m = null), E = !0, g = !0, i = !0) : g ? (g = !1, i = !0) : q(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, y = n;
    else {
      if (s = e.line, c = e.lineStart, l = e.position, !Ar(e, r, yh, !1, !0))
        break;
      if (e.line === a) {
        for (y = e.input.charCodeAt(e.position); Yt(y); )
          y = e.input.charCodeAt(++e.position);
        if (y === 58)
          y = e.input.charCodeAt(++e.position), Fe(y) || q(e, "a whitespace character is expected after the key-value separator within a block mapping"), g && (dr(e, d, u, h, p, null, s, c, l), h = p = m = null), E = !0, g = !1, i = !1, h = e.tag, p = e.result;
        else if (E)
    ...
    if ((e.line === a || e.lineIndent > t) && (g && (s = e.line, c = e.lineStart, l = e.position), Ar(e, t, xi, !0, i) && (g ? p = e.result : m = e.result), g || (dr(e, d, u, h, p, m, s, c, l), h = p = m = null), ue(e, !0, -1), y = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && y !== 0)
      q(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return g && dr(e, d, u, h, p, null, s, c, l), E && (e.tag = f, e.anchor = o, e.kind = "mapping", e.result = d), E;
}
function F2(e) {
  var t, r = !1, n = !1, i, a, s;
  ...
  if (e.tag !== null && q(e, "duplication of a tag property"), s = e.input.charCodeAt(++e.position), s === 60 ? (r = !0, s = e.input.charCodeAt(++e.position)) : s === 33 ? (n = !0, i = "!!", s = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, r) {
    ...
    for (; s !== 0 && !Fe(s); )
      s === 33 && (n ? q(e, "tag suffix cannot contain exclamation marks") : (i = e.input.slice(t - 1, e.position + 1), Eh.test(i) || q(e, "named tag handle cannot contain such characters"), n = !0, t = e.position + 1)), s = e.input.charCodeAt(++e.position);
    a = e.input.slice(t, e.position), C2.test(a) && q(e, "tag suffix cannot contain flow indicator characters");
  }
  a && !wh.test(a) && q(e, "tag name cannot contain such characters: " + a);
  try {
    a = decodeURIComponent(a);
  } catch {
...
function U2(e) {
  ...
  for (e.anchor !== null && q(e, "duplication of an anchor property"), r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !Fe(r) && !hr(r); )
...
function M2(e) {
  ...
  for (n = e.input.charCodeAt(++e.position), t = e.position; n !== 0 && !Fe(n) && !hr(n); )
...
function Ar(e, t, r, n, i) {
  ...
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = s = c = xi === r || _h === r, n && ue(e, !0, -1) && (f = !0, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)), l === 1)
    for (; F2(e) || U2(e); )
      ue(e, !0, -1) ? (f = !0, c = a, e.lineIndent > t ? l = 1 : e.lineIndent === t ? l = 0 : e.lineIndent < t && (l = -1)) : c = !1;
  if (c && (c = f || i), (l === 1 || xi === r) && (Pi === r || yh === r ? m = t : m = t + 1, g = e.position - e.lineStart, l === 1 ? c && (dc(e, g) || k2(e, g, m)) || N2(e, m) ? o = !0 : (s && L2(e, m) || R2(e, m) || D2(e, m) ? o = !0 : M2(e) ? (o = !0, (e.tag !== null || e.anchor !== null) && q(e, "alias node should not have any properties")) : O2(e, m, Pi === r) && (o = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : l === 0 && (o = c && dc(e, g))), e.tag === null)
...
function $2(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (ue(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Po(e), Tt.call(fc, n) ? fc[n](e, n, i) : Ti(e, 'unknown document directive "' + n + '"');
  }
  if (ue(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, ue(e, !0, -1)) : a && q(e, "directives end mark is expected"), Ar(e, e.lineIndent - 1, xi, !1, !0), ue(e, !0, -1), e.checkLineBreaks && S2.test(e.input.slice(t, e.position)) && Ti(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && qi(e)) {
...
`), e.charCodeAt(0) === 65279 && (e = e.slice(1)));
  var r = new I2(e, t), n = e.indexOf("\0");
...
function H2(e, t) {
  ...
  if (r.length !== 0) {
    if (r.length === 1)
      return r[0];
    throw new vh("expected a single document in the stream, but found more");
  }
}
So.loadAll = B2;
So.load = H2;
var xh = {}, ji = Ze, Pn = An, q2 = Ao, Th = Object.prototype.toString, Ih = Object.prototype.hasOwnProperty, To = 65279, j2 = 9, ln = 10, G2 = 13, V2 = 32, W2 = 33, z2 = 34, bs = 35, Y2 = 37, X2 = 38, K2 = 39, J2 = 42, Oh = 44, Q2 = 45, Ii = 58, Z2 = 61, ev = 62, tv = 63, rv = 64, Rh = 91, Dh = 93, nv = 96, Nh = 123, iv = 124, Lh = 125, Ae = {};
Ae[0] = "\\0";
Ae[7] = "\\a";
Ae[8] = "\\b";
Ae[9] = "\\t";
...
function ov(e, t) {
  ...
  for (r = {}, n = Object.keys(t), i = 0, a = n.length; i < a; i += 1)
    s = n[i], c = String(t[s]), s.slice(0, 2) === "!!" && (s = "tag:yaml.org,2002:" + s.slice(2)), l = e.compiledTypeMap.fallback[s], l && Ih.call(l.styleAliases, c) && (c = l.styleAliases[c]), r[s] = c;
  return r;
}
function lv(e) {
  var t, r, n;
  if (t = e.toString(16).toUpperCase(), e <= 255)
    ...
    throw new Pn("code point within a string may not be greater than 0xFFFFFFFF");
  return "\\" + r + ji.repeat("0", n - t.length) + t;
}
var cv = 1, cn = 2;
function uv(e) {
  this.schema = e.schema || q2, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = ji.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = ov(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? cn : cv, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function pc(e, t) {
  for (var r = ji.repeat(" ", t), n = 0, i = -1, a = "", s, c = e.length; n < c; )
    i = e.indexOf(`
...
function gc(e, t, r) {
  ...
  return (
    ...
    (r ? (
      // c = flow-in
      n
    ) : n && e !== Oh && e !== Rh && e !== Dh && e !== Nh && e !== Lh) && e !== bs && !(t === Ii && !i) || mc(t) && !Oi(t) && e === bs || t === Ii && i
  );
}
function hv(e) {
  return un(e) && e !== To && !Oi(e) && e !== Q2 && e !== tv && e !== Ii && e !== Oh && e !== Rh && e !== Dh && e !== Nh && e !== Lh && e !== bs && e !== X2 && e !== J2 && e !== W2 && e !== iv && e !== Z2 && e !== ev && e !== K2 && e !== z2 && e !== Y2 && e !== rv && e !== nv;
}
function dv(e) {
  return !Oi(e) && e !== Ii;
}
...
var Fh = 1, Cs = 2, Uh = 3, Mh = 4, ur = 5;
function pv(e, t, r, n, i, a, s, c) {
  var l, f = 0, o = null, d = !1, u = !1, h = n !== -1, p = -1, m = hv(Xr(e, 0)) && dv(Xr(e, e.length - 1));
  if (t || s)
  ...
  return !d && !u ? m && !s && !i(e) ? Fh : a === cn ? ur : Cs : r > 9 && kh(e) ? ur : s ? a === cn ? ur : Cs : u ? Mh : Uh;
}
function mv(e, t, r, n, i) {
  e.dump = function() {
    if (t.length === 0)
      return e.quotingType === cn ? '""' : "''";
    if (!e.noCompatMode && (av.indexOf(t) !== -1 || sv.test(t)))
      return e.quotingType === cn ? '"' + t + '"' : "'" + t + "'";
    ...
    switch (pv(
      ...
      case Cs:
        return "'" + t.replace(/'/g, "''") + "'";
      case Uh:
        return "|" + vc(t, e.indent) + yc(pc(t, a));
      case Mh:
        return ">" + vc(t, e.indent) + yc(pc(gv(t, s), a));
      case ur:
        return '"' + vv(t) + '"';
      default:
        throw new Pn("impossible error: invalid scalar style");
    }
  }();
}
function vc(e, t) {
  var r = kh(e) ? String(t) : "", n = e[e.length - 1] === `
`, i = n && (e[e.length - 2] === `
` || e === `
`), a = i ? "+" : n ? "" : "-";
  return r + a + `
...
function gv(e, t) {
  for (var r = /(\n+)([^\n]*)/g, n = function() {
    var f = e.indexOf(`
`);
    return f = f !== -1 ? f : e.length, r.lastIndex = f, _c(e.slice(0, f), t);
  }(), i = e[0] === `
` || e[0] === " ", a, s; s = r.exec(e); ) {
    var c = s[1], l = s[2];
    a = l[0] === " ", n += c + (!i && !a && l !== "" ? `
...
function vv(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = Xr(e, i), n = Ae[r], !n && un(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || lv(r);
  return t;
}
function yv(e, t, r) {
  var n = "", i = e.tag, a, s, c;
...
function Ec(e, t, r, n) {
  ...
  for (s = 0, c = r.length; s < c; s += 1)
    l = r[s], e.replacer && (l = e.replacer.call(r, String(s), l)), (pt(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && pt(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Ss(e, t)), e.dump && ln === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function _v(e, t, r) {
...
function Ev(e, t, r, n) {
  ...
  if (e.sortKeys === !0)
    ...
    throw new Pn("sortKeys must be a boolean or a function");
  for (c = 0, l = s.length; c < l; c += 1)
    u = "", (!n || i !== "") && (u += Ss(e, t)), f = s[c], o = r[f], e.replacer && (o = e.replacer.call(r, f, o)), pt(e, t + 1, f, !0, !0, !0) && (d = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, d && (e.dump && ln === e.dump.charCodeAt(0) ? u += "?" : u += "? "), u += e.dump, d && (u += Ss(e, t)), pt(e, t + 1, o, !0, d) && (e.dump && ln === e.dump.charCodeAt(0) ? u += ":" : u += ": ", u += e.dump, i += u));
  e.tag = a, e.dump = i || "{}";
}
function wc(e, t, r) {
  var n, i, a, s, c, l;
  for (i = r ? e.explicitTypes : e.implicitTypes, a = 0, s = i.length; a < s; a += 1)
    if (c = i[a], (c.instanceOf || c.predicate) && (!c.instanceOf || typeof t == "object" && t instanceof c.instanceOf) && (!c.predicate || c.predicate(t))) {
      if (r ? c.multi && c.representName ? e.tag = c.representName(t) : e.tag = c.tag : e.tag = "?", c.represent) {
        if (l = e.styleMap[c.tag] || c.defaultStyle, Th.call(c.represent) === "[object Function]")
          n = c.represent(t, l);
        else if (Ih.call(c.represent, l))
          n = c.represent[l](t, l);
        else
          throw new Pn("!<" + c.tag + '> tag resolver accepts not "' + l + '" style');
        e.dump = n;
      }
      return !0;
    }
...
function pt(e, t, r, n, i, a, s) {
  e.tag = null, e.dump = r, wc(e, r, !1) || wc(e, r, !0);
  var c = Th.call(e.dump), l = n, f;
  ...
  if (o && (d = e.duplicates.indexOf(r), u = d !== -1), (e.tag !== null && e.tag !== "?" || u || e.indent !== 2 && t > 0) && (i = !1), u && e.usedDuplicates[d])
    ...
    if (o && u && !e.usedDuplicates[d] && (e.usedDuplicates[d] = !0), c === "[object Object]")
      n && Object.keys(e.dump).length !== 0 ? (Ev(e, t, e.dump, i), u && (e.dump = "&ref_" + d + e.dump)) : (_v(e, t, e.dump), u && (e.dump = "&ref_" + d + " " + e.dump));
    else if (c === "[object Array]")
      n && e.dump.length !== 0 ? (e.noArrayIndent && !s && t > 0 ? Ec(e, t - 1, e.dump, i) : Ec(e, t, e.dump, i), u && (e.dump = "&ref_" + d + e.dump)) : (yv(e, t, e.dump), u && (e.dump = "&ref_" + d + " " + e.dump));
    else if (c === "[object String]")
      e.tag !== "?" && mv(e, e.dump, t, a, l);
    else {
      if (c === "[object Undefined]")
        return !1;
      if (e.skipInvalid) return !1;
      throw new Pn("unacceptable kind of an object to dump " + c);
    }
...
function wv(e, t) {
  var r = [], n = [], i, a;
  for (As(e, r, n), i = 0, a = n.length; i < a; i += 1)
...
we.Type = Ne;
we.Schema = Jf;
we.FAILSAFE_SCHEMA = th;
we.JSON_SCHEMA = oh;
we.CORE_SCHEMA = lh;
we.DEFAULT_SCHEMA = Ao;
we.load = $h.load;
we.loadAll = $h.loadAll;
we.dump = Sv.dump;
we.YAMLException = An;
we.types = {
  binary: dh,
...
we.safeLoad = Io("safeLoad", "load");
we.safeLoadAll = Io("safeLoadAll", "loadAll");
we.safeDump = Io("safeDump", "dump");
var Gi = {};
...
Gi.Lazy = Cv;
var Ps = { exports: {} };
const Av = "2.0.0", Bh = 256, Pv = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, xv = 16, Tv = Bh - 6, Iv = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
var xn = Ps.exports;
const Rv = Object.freeze({ loose: !0 }), Dv = Object.freeze({}), Nv = (e) => e ? typeof e != "object" ? Rv : e : Dv;
var Oo = Nv;
const bc = /^[0-9]+$/, Hh = (e, t) => {
  if (typeof e == "number" && typeof t == "number")
    return e === t ? 0 : e < t ? -1 : 1;
  const r = bc.test(e), n = bc.test(t);
  return r && n && (e = +e, t = +t), e === t ? 0 : r && !n ? -1 : n && !r ? 1 : e < t ? -1 : 1;
}, Lv = (e, t) => Hh(t, e);
var qh = {
  compareIdentifiers: Hh,
  rcompareIdentifiers: Lv
};
const Zn = Wi, { MAX_LENGTH: Sc, MAX_SAFE_INTEGER: ei } = Vi, { safeRe: ti, t: ri } = xn, kv = Oo, { compareIdentifiers: Fa } = qh;
let Fv = class at {
  constructor(t, r) {
    if (r = kv(r), t instanceof at) {
    ...
    if (t.length > Sc)
      throw new TypeError(
        `version is longer than ${Sc} characters`
      );
    Zn("SemVer", t, r), this.options = r, this.loose = !!r.loose, this.includePrerelease = !!r.includePrerelease;
    const n = t.trim().match(r.loose ? ti[ri.LOOSE] : ti[ri.FULL]);
    if (!n)
      throw new TypeError(`Invalid Version: ${t}`);
    if (this.raw = t, this.major = +n[1], this.minor = +n[2], this.patch = +n[3], this.major > ei || this.major < 0)
      throw new TypeError("Invalid major version");
    if (this.minor > ei || this.minor < 0)
      throw new TypeError("Invalid minor version");
    if (this.patch > ei || this.patch < 0)
  ...
  compare(t) {
    if (Zn("SemVer.compare", this.version, this.options, t), !(t instanceof at)) {
  ...
  inc(t, r, n) {
    if (t.startsWith("pre")) {
      ...
      if (r) {
        const i = `-${r}`.match(this.options.loose ? ti[ri.PRERELEASELOOSE] : ti[ri.PRERELEASE]);
        if (!i || i[1] !== r)
    ...
    switch (t) {
      ...
      case "pre": {
        ...
        if (r) {
          let a = [r, i];
          n === !1 && (a = [r]), Fa(this.prerelease[0], r) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = a) : this.prerelease = a;
        }
        break;
      }
      default:
...
var Bv = $v;
const Hv = Tr, qv = (e, t) => {
  const r = Hv(e.trim().replace(/^[=v]+/, ""), t);
  return r ? r.version : null;
};
var jv = qv;
const Ac = Le, Gv = (e, t, r, n, i) => {
  typeof r == "string" && (i = n, n = r, r = void 0);
  try {
    return new Ac(
      e instanceof Ac ? e.version : e,
      r
    ).inc(t, n, i).version;
  } catch {
    return null;
...
var Vv = Gv;
const Pc = Tr, Wv = (e, t) => {
  const r = Pc(e, null, !0), n = Pc(t, null, !0), i = r.compare(n);
  if (i === 0)
    return null;
...
var zv = Wv;
const Yv = Le, Xv = (e, t) => new Yv(e, t).major;
var Kv = Xv;
const Jv = Le, Qv = (e, t) => new Jv(e, t).minor;
var Zv = Qv;
const ey = Le, ty = (e, t) => new ey(e, t).patch;
var ry = ty;
const ny = Tr, iy = (e, t) => {
  const r = ny(e, t);
...
var ay = iy;
const xc = Le, sy = (e, t, r) => new xc(e, r).compare(new xc(t, r));
var et = sy;
const oy = et, ly = (e, t, r) => oy(t, e, r);
var cy = ly;
const uy = et, fy = (e, t) => uy(e, t, !0);
var hy = fy;
const Tc = Le, dy = (e, t, r) => {
  const n = new Tc(e, r), i = new Tc(t, r);
  return n.compare(i) || n.compareBuild(i);
};
var Ro = dy;
const py = Ro, my = (e, t) => e.sort((r, n) => py(r, n, t));
var gy = my;
const vy = Ro, yy = (e, t) => e.sort((r, n) => vy(n, r, t));
var _y = yy;
const Ey = et, wy = (e, t, r) => Ey(e, t, r) > 0;
var zi = wy;
const by = et, Sy = (e, t, r) => by(e, t, r) < 0;
var Do = Sy;
const Cy = et, Ay = (e, t, r) => Cy(e, t, r) === 0;
var jh = Ay;
const Py = et, xy = (e, t, r) => Py(e, t, r) !== 0;
var Gh = xy;
const Ty = et, Iy = (e, t, r) => Ty(e, t, r) >= 0;
var No = Iy;
const Oy = et, Ry = (e, t, r) => Oy(e, t, r) <= 0;
var Lo = Ry;
const Dy = jh, Ny = Gh, Ly = zi, ky = No, Fy = Do, Uy = Lo, My = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var Vh = My;
const $y = Le, By = Tr, { safeRe: ni, t: ii } = xn, Hy = (e, t) => {
  if (e instanceof $y)
    return e;
  ...
  let r = null;
  if (!t.rtl)
    r = e.match(t.includePrerelease ? ni[ii.COERCEFULL] : ni[ii.COERCE]);
  else {
    const l = t.includePrerelease ? ni[ii.COERCERTLFULL] : ni[ii.COERCERTL];
    let f;
...
function tt() {
  ...
  class t {
    ...
    parseRange(D) {
      ...
      D = D.replace(W, j(this.options.includePrerelease)), s("hyphen replace", D), D = D.replace(l[f.COMPARATORTRIM], o), s("comparator trim", D), D = D.replace(l[f.TILDETRIM], d), s("tilde trim", D), D = D.replace(l[f.CARETTRIM], u), s("caret trim", D);
  ...
  Ua = t;
  const r = Gy, n = new r(), i = Oo, a = Yi(), s = Wi, c = Le, {
    safeRe: l,
    t: f,
    comparatorTrimReplace: o,
    tildeTrimReplace: d,
    caretTrimReplace: u
  } = xn, { FLAG_INCLUDE_PRERELEASE: h, FLAG_LOOSE: p } = Vi, m = (L) => L.value === "<0.0.0-0", g = (L) => L.value === "", E = (L, D) => {
    let U = !0;
    const R = L.slice();
    let M = R.pop();
    for (; U && R.length; )
    ...
    return L.replace(U, (R, M, k, W, X, z) => {
      ...
      const Z = S(k), pe = Z || S(W), V = pe || S(X), nt = V;
      return M === "=" && nt && (M = ""), z = D.includePrerelease ? "-0" : "", Z ? M === ">" || M === "<" ? R = "<0.0.0-0" : R = "*" : M && nt ? (pe && (W = 0), X = 0, M === ">" ? (M = ">=", pe ? (k = +k + 1, W = 0, X = 0) : (W = +W + 1, X = 0)) : M === "<=" && (M = "<", pe ? k = +k + 1 : W = +W + 1), M === "<" && (z = "-0"), R = `${M + k}.${W}.${X}${z}`) : pe ? R = `>=${k}.0.0${z} <${+k + 1}.0.0-0` : V && (R = `>=${k}.${W}.0${z} <${k}.${+W + 1}.0-0`), s("xRange return", R), R;
    });
  }, F = (L, D) => (s("replaceStars", L, D), L.trim().replace(l[f.STAR], "")), H = (L, D) => (s("replaceGTE0", L, D), L.trim().replace(l[D.includePrerelease ? f.GTE0PRE : f.GTE0], "")), j = (L) => (D, U, R, M, k, W, X, z, Z, pe, V, nt) => (S(R) ? U = "" : S(M) ? U = `>=${R}.0.0${L ? "-0" : ""}` : S(k) ? U = `>=${R}.${M}.0${L ? "-0" : ""}` : W ? U = `>=${U}` : U = `>=${U}${L ? "-0" : ""}`, S(Z) ? z = "" : S(pe) ? z = `<${+Z + 1}.0.0-0` : S(V) ? z = `<${Z}.${+pe + 1}.0-0` : nt ? z = `<=${Z}.${pe}.${V}-${nt}` : L ? z = `<${Z}.${pe}.${+V + 1}-0` : z = `<=${z}`, `${U} ${z}`.trim()), K = (L, D, U) => {
...
function Yi() {
  ...
  Ma = t;
  const r = Oo, { safeRe: n, t: i } = xn, a = Vh, s = Wi, c = Le, l = tt();
  return Ma;
}
const Vy = tt(), Wy = (e, t, r) => {
  try {
    t = new Vy(t, r);
  } catch {
    return !1;
...
var Xi = Wy;
const zy = tt(), Yy = (e, t) => new zy(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var Xy = Yy;
const Ky = Le, Jy = tt(), Qy = (e, t, r) => {
  ...
  return e.forEach((s) => {
    a.test(s) && (!n || i.compare(s) === -1) && (n = s, i = new Ky(n, r));
  }), n;
};
var Zy = Qy;
const e8 = Le, t8 = tt(), r8 = (e, t, r) => {
  let n = null, i = null, a = null;
  try {
    a = new t8(t, r);
  } catch {
  ...
  return e.forEach((s) => {
    a.test(s) && (!n || i.compare(s) === 1) && (n = s, i = new e8(n, r));
  }), n;
};
var n8 = r8;
const $a = Le, i8 = tt(), Rc = zi, a8 = (e, t) => {
  e = new i8(e, t);
  let r = new $a("0.0.0");
  if (e.test(r) || (r = new $a("0.0.0-0"), e.test(r)))
    return r;
  r = null;
  for (let n = 0; n < e.set.length; ++n) {
    ...
    let a = null;
    i.forEach((s) => {
      const c = new $a(s.semver.version);
      switch (s.operator) {
        case ">":
...
const o8 = tt(), l8 = (e, t) => {
  try {
    return new o8(e, t).range || "*";
  } catch {
    return null;
  }
};
var c8 = l8;
const u8 = Le, Wh = Yi(), { ANY: f8 } = Wh, h8 = tt(), d8 = Xi, Dc = zi, Nc = Do, p8 = Lo, m8 = No, g8 = (e, t, r, n) => {
  e = new u8(e, n), t = new h8(t, n);
  let i, a, s, c, l;
  switch (r) {
    case ">":
      i = Dc, a = p8, s = Nc, c = ">", l = ">=";
  ...
  for (let f = 0; f < t.set.length; ++f) {
    ...
    let d = null, u = null;
    if (o.forEach((h) => {
      h.semver === f8 && (h = new Wh(">=0.0.0")), d = d || h, u = u || h, i(h.semver, d.semver, n) ? d = h : s(h.semver, u.semver, n) && (u = h);
...
var ko = g8;
const v8 = ko, y8 = (e, t, r) => v8(e, t, ">", r);
var _8 = y8;
const E8 = ko, w8 = (e, t, r) => E8(e, t, "<", r);
var b8 = w8;
const Lc = tt(), S8 = (e, t, r) => (e = new Lc(e, r), t = new Lc(t, r), e.intersects(t, r));
var C8 = S8;
const A8 = Xi, P8 = et;
var x8 = (e, t, r) => {
  const n = [];
  let i = null, a = null;
  const s = e.sort((o, d) => P8(o, d, r));
  for (const o of s)
    A8(o, t, r) ? (a = o, i || (i = o)) : (a && n.push([i, a]), a = null, i = null);
  i && n.push([i, null]);
  const c = [];
  for (const [o, d] of n)
...
const kc = tt(), Fo = Yi(), { ANY: Ba } = Fo, Hr = Xi, Uo = et, T8 = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, I8 = [new Fo(">=0.0.0-0")], Fc = [new Fo(">=0.0.0")], O8 = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === Ba) {
    if (t.length === 1 && t[0].semver === Ba)
      return !0;
    r.includePrerelease ? e = I8 : e = Fc;
  }
  if (t.length === 1 && t[0].semver === Ba) {
  ...
  let i, a;
  for (const h of e)
    h.operator === ">" || h.operator === ">=" ? i = Uc(i, h, r) : h.operator === "<" || h.operator === "<=" ? a = Mc(a, h, r) : n.add(h.semver);
  if (n.size > 1)
    return null;
  let s;
  if (i && a) {
    if (s = Uo(i.semver, a.semver, r), s > 0)
      return null;
    if (s === 0 && (i.operator !== ">=" || a.operator !== "<="))
      return null;
  }
  for (const h of n) {
    if (i && !Hr(h, String(i), r) || a && !Hr(h, String(a), r))
      return null;
    for (const p of t)
      if (!Hr(h, String(p), r))
        return !1;
  ...
  for (const h of t) {
    if (o = o || h.operator === ">" || h.operator === ">=", f = f || h.operator === "<" || h.operator === "<=", i) {
      if (u && h.semver.prerelease && h.semver.prerelease.length && h.semver.major === u.major && h.semver.minor === u.minor && h.semver.patch === u.patch && (u = !1), h.operator === ">" || h.operator === ">=") {
        if (c = Uc(i, h, r), c === h && c !== i)
          return !1;
      } else if (i.operator === ">=" && !Hr(i.semver, String(h), r))
        return !1;
    }
    if (a) {
      if (d && h.semver.prerelease && h.semver.prerelease.length && h.semver.major === d.major && h.semver.minor === d.minor && h.semver.patch === d.patch && (d = !1), h.operator === "<" || h.operator === "<=") {
        if (l = Mc(a, h, r), l === h && l !== a)
          return !1;
      } else if (a.operator === "<=" && !Hr(a.semver, String(h), r))
        return !1;
    }
  ...
  if (!e)
    return t;
  const n = Uo(e.semver, t.semver, r);
...
var R8 = T8;
const Ha = xn, $c = Vi, D8 = Le, Bc = qh, N8 = Tr, L8 = Bv, k8 = jv, F8 = Vv, U8 = zv, M8 = Kv, $8 = Zv, B8 = ry, H8 = ay, q8 = et, j8 = cy, G8 = hy, V8 = Ro, W8 = gy, z8 = _y, Y8 = zi, X8 = Do, K8 = jh, J8 = Gh, Q8 = No, Z8 = Lo, e_ = Vh, t_ = qy, r_ = Yi(), n_ = tt(), i_ = Xi, a_ = Xy, s_ = Zy, o_ = n8, l_ = s8, c_ = c8, u_ = ko, f_ = _8, h_ = b8, d_ = C8, p_ = x8, m_ = R8;
var zh = {
  parse: N8,
  valid: L8,
  clean: k8,
...
(function(e, t) {
  ...
  V[K] = V[L] = V[D] = V[U] = V[R] = V[M] = V[k] = V[W] = V[X] = !0, V[c] = V[l] = V[H] = V[o] = V[j] = V[d] = V[u] = V[h] = V[m] = V[g] = V[y] = V[A] = V[I] = V[T] = V[F] = !1;
  ...
  var Ad = Array.prototype, Pd = Function.prototype, Mn = Object.prototype, la = v["__core-js_shared__"], Jo = Pd.toString, it = Mn.hasOwnProperty, Qo = function() {
    var b = /[^.]+$/.exec(la && la.keys && la.keys.IE_PROTO || "");
    return b ? "Symbol(src)_1." + b : "";
  }(), Zo = Mn.toString, xd = RegExp(
    "^" + Jo.call(it).replace(z, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), el = Q ? v.Buffer : void 0, $n = v.Symbol, tl = v.Uint8Array, rl = Mn.propertyIsEnumerable, Td = Ad.splice, Ft = $n ? $n.toStringTag : void 0, nl = Object.getOwnPropertySymbols, Id = el ? el.isBuffer : void 0, Od = Sd(Object.keys, Object), ca = nr(v, "DataView"), Lr = nr(v, "Map"), ua = nr(v, "Promise"), fa = nr(v, "Set"), ha = nr(v, "WeakMap"), kr = nr(Object, "create"), Rd = $t(ca), Dd = $t(Lr), Nd = $t(ua), Ld = $t(fa), kd = $t(ha), il = $n ? $n.prototype : void 0, da = il ? il.valueOf : void 0;
  function Ut(b) {
  ...
  function $d(b) {
    var P = this.__data__;
    return kr ? P[b] !== void 0 : it.call(P, b);
  }
  function Bd(b, P) {
    var N = this.__data__;
    return this.size += this.has(b) ? 0 : 1, N[b] = kr && P === void 0 ? n : P, this;
  }
  Ut.prototype.clear = Fd, Ut.prototype.delete = Ud, Ut.prototype.get = Md, Ut.prototype.has = $d, Ut.prototype.set = Bd;
  function lt(b) {
    var P = -1, N = b == null ? 0 : b.length;
    for (this.clear(); ++P < N; ) {
      var B = b[P];
  ...
  function qd(b) {
    var P = this.__data__, N = Hn(P, b);
    if (N < 0)
      return !1;
    var B = P.length - 1;
    return N == B ? P.pop() : Td.call(P, N, 1), --this.size, !0;
  }
  function jd(b) {
    var P = this.__data__, N = Hn(P, b);
  ...
  function Vd(b, P) {
    var N = this.__data__, B = Hn(N, b);
    return B < 0 ? (++this.size, N.push([b, P])) : N[B][1] = P, this;
  }
  lt.prototype.clear = Hd, lt.prototype.delete = qd, lt.prototype.get = jd, lt.prototype.has = Gd, lt.prototype.set = Vd;
  function Mt(b) {
    var P = -1, N = b == null ? 0 : b.length;
    for (this.clear(); ++P < N; ) {
      var B = b[P];
  ...
  function zd(b) {
    var P = qn(this, b).delete(b);
    return this.size -= P ? 1 : 0, P;
  }
  function Yd(b) {
    return qn(this, b).get(b);
  }
  function Xd(b) {
    return qn(this, b).has(b);
  }
  function Kd(b, P) {
    var N = qn(this, b), B = N.size;
    return N.set(b, P), this.size += N.size == B ? 0 : 1, this;
  }
  Mt.prototype.clear = Wd, Mt.prototype.delete = zd, Mt.prototype.get = Yd, Mt.prototype.has = Xd, Mt.prototype.set = Kd;
  function Bn(b) {
    var P = -1, N = b == null ? 0 : b.length;
  ...
  Bn.prototype.add = Bn.prototype.push = Jd, Bn.prototype.has = Qd;
  function gt(b) {
  ...
  gt.prototype.clear = Zd, gt.prototype.delete = ep, gt.prototype.get = tp, gt.prototype.has = rp, gt.prototype.set = np;
  function ip(b, P) {
    var N = jn(b), B = !N && _p(b), ne = !N && !B && pa(b), Y = !N && !B && !ne && dl(b), le = N || B || ne || Y, me = le ? We(b.length, String) : [], _e = me.length;
    for (var ie in b)
  ...
  function ap(b, P, N) {
    var B = P(b);
    return jn(b) ? B : mt(B, N(b));
  }
  function Fr(b) {
    return b == null ? b === void 0 ? C : E : Ft && Ft in Object(b) ? hp(b) : yp(b);
  }
  function al(b) {
    return Ur(b) && Fr(b) == c;
  }
  function sl(b, P, N, B, ne) {
    return b === P ? !0 : b == null || P == null || !Ur(b) && !Ur(P) ? b !== b && P !== P : sp(b, P, N, B, sl, ne);
  }
  function sp(b, P, N, B, ne, Y) {
    var le = jn(b), me = jn(P), _e = le ? l : vt(b), ie = me ? l : vt(P);
    ...
    if (Se && !Me)
      return Y || (Y = new gt()), le || dl(b) ? ol(b, P, N, B, ne, Y) : up(b, P, _e, N, B, ne, Y);
    if (!(N & i)) {
    ...
    return Se ? (Y || (Y = new gt()), fp(b, P, N, B, ne, Y)) : !1;
  }
  function op(b) {
    if (!hl(b) || gp(b))
      return !1;
  ...
  function lp(b) {
    return Ur(b) && fl(b.length) && !!V[Fr(b)];
  }
  function cp(b) {
    if (!vp(b))
      return Od(b);
  ...
  function ol(b, P, N, B, ne, Y) {
    ...
    if (ie && Y.get(P))
      return ie == P;
    var Me = -1, ze = !0, Se = N & a ? new Bn() : void 0;
    for (Y.set(b, P), Y.set(P, b); ++Me < me; ) {
      ...
      if (Se) {
        if (!he(P, function(ct, Bt) {
          if (!Fn(Se, Bt) && ($e === ct || ne($e, ct, N, B, Y)))
            return Se.push(Bt);
        })) {
          ze = !1;
          break;
  ...
  function up(b, P, N, B, ne, Y, le) {
    switch (N) {
      ...
      case H:
        return !(b.byteLength != P.byteLength || !Y(new tl(b), new tl(P)));
      case o:
      case d:
      case g:
        return cl(+b, +P);
      ...
      case I:
        var _e = B & i;
        if (me || (me = Cd), b.size != P.size && !_e)
          return !1;
        var ie = le.get(b);
        if (ie)
          return ie == P;
        B |= a, le.set(b, P);
        var Me = ol(me(b), me(P), B, ne, Y, le);
        return le.delete(b), Me;
      case $:
        if (da)
          return da.call(b) == da.call(P);
    }
    return !1;
  }
  function fp(b, P, N, B, ne, Y) {
    var le = N & i, me = ll(b), _e = me.length, ie = ll(P), Me = ie.length;
    if (_e != Me && !le)
      return !1;
    for (var ze = _e; ze--; ) {
      var Se = me[ze];
    ...
    for (var yt = le; ++ze < _e; ) {
      ...
      var ct = b[Se], Bt = P[Se];
      if (B)
        var pl = le ? B(Bt, ct, Se, P, b, Y) : B(ct, Bt, Se, b, P, Y);
      if (!(pl === void 0 ? ct === Bt || ne(ct, Bt, N, B, Y) : pl)) {
        Be = !1;
        break;
      }
    ...
    if (Be && !yt) {
      var Gn = b.constructor, Vn = P.constructor;
      Gn != Vn && "constructor" in b && "constructor" in P && !(typeof Gn == "function" && Gn instanceof Gn && typeof Vn == "function" && Vn instanceof Vn) && (Be = !1);
    }
  ...
  function qn(b, P) {
    var N = b.__data__;
    return mp(P) ? N[typeof P == "string" ? "string" : "hash"] : N.map;
  }
  function nr(b, P) {
    var N = Nr(b, P);
    return op(N) ? N : void 0;
  }
  function hp(b) {
  ...
  var dp = nl ? function(b) {
    return b == null ? [] : (b = Object(b), be(nl(b), function(P) {
      return rl.call(b, P);
    }));
  } : Sp, vt = Fr;
  (ca && vt(new ca(new ArrayBuffer(1))) != j || Lr && vt(new Lr()) != m || ua && vt(ua.resolve()) != S || fa && vt(new fa()) != I || ha && vt(new ha()) != F) && (vt = function(b) {
    var P = Fr(b), N = P == y ? b.constructor : void 0, B = N ? $t(N) : "";
    if (B)
      switch (B) {
        case Rd:
          return j;
  ...
  function vp(b) {
    var P = b && b.constructor, N = typeof P == "function" && P.prototype || Mn;
    return b === N;
  }
  function yp(b) {
    return Zo.call(b);
  ...
  var _p = al(/* @__PURE__ */ function() {
    return arguments;
  }()) ? al : function(b) {
    return Ur(b) && it.call(b, "callee") && !rl.call(b, "callee");
  }, jn = Array.isArray;
  function Ep(b) {
    return b != null && fl(b.length) && !ul(b);
  }
  var pa = Id || Cp;
  function wp(b, P) {
    return sl(b, P);
...
Tn.createTempUpdateFile = w_;
const v_ = En, y_ = Je, Hc = g_, qt = Nt, Zr = se;
class __ {
  constructor(t) {
  ...
  async validateDownloadedPath(t, r, n, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return Hc(this.versionInfo, r) && Hc(this.fileInfo.info, n.info) && await (0, qt.pathExists)(t) ? t : null;
  ...
  async getValidCachedUpdateFile(t, r) {
    ...
    const c = Zr.join(this.cacheDirForPendingUpdate, a.fileName);
...
Tn.DownloadedUpdateHelper = __;
function E_(e, t = "sha512", r = "base64", n) {
  return new Promise((i, a) => {
    const s = (0, v_.createHash)(t);
    s.on("error", a).setEncoding(r), (0, y_.createReadStream)(e, {
      ...n,
...
async function w_(e, t, r) {
  ...
  for (let a = 0; a < 3; a++)
    try {
      ...
      if (s.code === "ENOENT")
        return i;
      r.warn(`Error on remove temp update file: ${s}`), i = Zr.join(t, `${n++}-${e}`);
    }
  return i;
}
var Ki = {}, Mo = {};
Object.defineProperty(Mo, "__esModule", { value: !0 });
Mo.getAppCacheDir = S_;
const qa = se, b_ = Fi;
function S_() {
  const e = (0, b_.homedir)();
  let t;
  return process.platform === "win32" ? t = process.env.LOCALAPPDATA || qa.join(e, "AppData", "Local") : process.platform === "darwin" ? t = qa.join(e, "Library", "Caches") : t = process.env.XDG_CACHE_HOME || qa.join(e, ".cache"), t;
}
Object.defineProperty(Ki, "__esModule", { value: !0 });
Ki.ElectronAppAdapter = void 0;
const qc = se, C_ = Mo;
class A_ {
  ...
  get appUpdateConfigPath() {
    return this.isPackaged ? qc.join(process.resourcesPath, "app-update.yml") : qc.join(this.app.getAppPath(), "dev-app-update.yml");
  }
  get userDataPath() {
    return this.app.getPath("userData");
  }
  get baseCachePath() {
    return (0, C_.getAppCacheDir)();
  }
  quit() {
    this.app.quit();
  }
...
rt.newBaseUrl = P_;
rt.newUrlFromBase = x_;
rt.getChannelFilename = T_;
const Xh = Rt;
function P_(e) {
  const t = new Xh.URL(e);
  return t.pathname.endsWith("/") || (t.pathname += "/"), t;
}
function x_(e, t, r = !1) {
  const n = new Xh.URL(e, t), i = t.search;
  return i != null && i.length !== 0 ? n.search = i : r && (n.search = `noCache=${Date.now().toString(32)}`), n;
}
function T_(e) {
  return `${e}.yml`;
}
var fe = {}, I_ = "[object Symbol]", Kh = /[\\^$.*+?()[\]{}|]/g, O_ = RegExp(Kh.source), R_ = typeof Te == "object" && Te && Te.Object === Object && Te, D_ = typeof self == "object" && self && self.Object === Object && self, N_ = R_ || D_ || Function("return this")(), L_ = Object.prototype, k_ = L_.toString, jc = N_.Symbol, Gc = jc ? jc.prototype : void 0, Vc = Gc ? Gc.toString : void 0;
function F_(e) {
  if (typeof e == "string")
    return e;
  if (M_(e))
...
function M_(e) {
  return typeof e == "symbol" || U_(e) && k_.call(e) == I_;
}
function $_(e) {
  return e == null ? "" : F_(e);
}
function B_(e) {
  return e = $_(e), e && O_.test(e) ? e.replace(Kh, "\\$&") : e;
}
var Jh = B_;
Object.defineProperty(fe, "__esModule", { value: !0 });
fe.Provider = void 0;
fe.findFile = V_;
fe.parseUpdateInfo = W_;
fe.getFileList = Qh;
fe.resolveFiles = z_;
const It = de, H_ = we, q_ = Rt, Di = rt, j_ = Jh;
class G_ {
  constructor(t) {
  ...
  getBlockMapFiles(t, r, n, i = null) {
    const a = (0, Di.newUrlFromBase)(`${t.pathname}.blockmap`, t);
    return [(0, Di.newUrlFromBase)(`${t.pathname.replace(new RegExp(j_(n), "g"), r)}.blockmap`, i ? new q_.URL(i) : t), a];
  }
...
function z_(e, t, r = (n) => n) {
  const i = Qh(e).map((c) => {
    ...
    return {
      url: (0, Di.newUrlFromBase)(r(c.url), t),
      info: c
    };
  }), a = e.packages, s = a == null ? null : a[process.arch] || a.ia32;
  return s != null && (i[0].packageInfo = {
    ...s,
    path: (0, Di.newUrlFromBase)(r(s.path), t).href
  }), i;
}
Object.defineProperty(In, "__esModule", { value: !0 });
In.GenericProvider = void 0;
const Wc = de, ja = rt, Ga = fe;
class Y_ extends Ga.Provider {
  constructor(t, r, n) {
    super(n), this.configuration = t, this.updater = r, this.baseUrl = (0, ja.newBaseUrl)(this.configuration.url);
  }
  get channel() {
  ...
  async getLatestVersion() {
    const t = (0, ja.getChannelFilename)(this.channel), r = (0, ja.newUrlFromBase)(t, this.baseUrl, this.updater.isAddNoCacheQuery);
    for (let n = 0; ; n++)
      try {
        return (0, Ga.parseUpdateInfo)(await this.httpRequest(r), t, r);
      } catch (i) {
...
In.GenericProvider = Y_;
var Ji = {}, Qi = {};
Object.defineProperty(Qi, "__esModule", { value: !0 });
Qi.BitbucketProvider = void 0;
const zc = de, Va = rt, Wa = fe;
class X_ extends Wa.Provider {
  constructor(t, r, n) {
    super({
      ...n,
    ...
    this.baseUrl = (0, Va.newBaseUrl)(`https://api.bitbucket.org/2.0/repositories/${i}/${a}/downloads`);
  }
  get channel() {
    return this.updater.channel || this.configuration.channel || "latest";
  }
  async getLatestVersion() {
    const t = new zc.CancellationToken(), r = (0, Va.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Va.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
      const i = await this.httpRequest(n, void 0, t);
      return (0, Wa.parseUpdateInfo)(i, r, n);
    } catch (i) {
      throw (0, zc.newError)(`Unable to find latest version on ${this.toString()}, please ensure release exists: ${i.stack || i.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  resolveFiles(t) {
...
Qi.BitbucketProvider = X_;
var Ot = {};
Object.defineProperty(Ot, "__esModule", { value: !0 });
Ot.GitHubProvider = Ot.BaseGitHubProvider = void 0;
Ot.computeReleaseNotes = ed;
const ft = de, pr = zh, K_ = Rt, mr = rt, xs = fe, za = /\/tag\/([^/]+)$/;
class Zh extends xs.Provider {
  constructor(t, r, n) {
    super({
      ...n,
...
class J_ extends Zh {
  ...
  async getLatestVersion() {
    var t, r, n, i, a;
    const s = new ft.CancellationToken(), c = await this.httpRequest((0, mr.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
      accept: "application/xml, application/atom+xml, text/xml, */*"
    }, s), l = (0, ft.parseXml)(c);
    let f = l.element("entry", !1, "No published versions on GitHub"), o = null;
    try {
      if (this.updater.allowPrerelease) {
        const g = ((t = this.updater) === null || t === void 0 ? void 0 : t.channel) || ((r = pr.prerelease(this.updater.currentVersion)) === null || r === void 0 ? void 0 : r[0]) || null;
        if (g === null)
          o = za.exec(f.element("link").attribute("href"))[1];
        else
          for (const E of l.getElements("entry")) {
            const y = za.exec(E.element("link").attribute("href"));
            if (y === null)
              continue;
            const S = y[1], _ = ((n = pr.prerelease(S)) === null || n === void 0 ? void 0 : n[0]) || null, A = !g || ["alpha", "beta"].includes(g), I = _ !== null && !["alpha", "beta"].includes(String(_));
        ...
        for (const g of l.getElements("entry"))
          if (za.exec(g.element("link").attribute("href"))[1] === o) {
            f = g;
            break;
          }
      }
...
${c}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let d, u = "", h = "";
    const p = async (g) => {
      u = (0, mr.getChannelFilename)(g), h = (0, mr.newUrlFromBase)(this.getBaseDownloadPath(String(o), u), this.baseUrl);
    ...
    try {
      let g = this.channel;
      this.updater.allowPrerelease && (!((i = pr.prerelease(o)) === null || i === void 0) && i[0]) && (g = this.getCustomChannelName(String((a = pr.prerelease(o)) === null || a === void 0 ? void 0 : a[0]))), d = await p(g);
    } catch (g) {
      if (this.updater.allowPrerelease)
    ...
    const m = (0, xs.parseUpdateInfo)(d, u, h);
    return m.releaseName == null && (m.releaseName = f.elementValueOrEmpty("title")), m.releaseNotes == null && (m.releaseNotes = ed(this.updater.currentVersion, this.updater.fullChangelog, l, f)), {
      tag: o,
      ...m
    };
  }
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, mr.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new K_.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
  ...
  resolveFiles(t) {
    return (0, xs.resolveFiles)(t, this.baseUrl, (r) => this.getBaseDownloadPath(t.tag, r.replace(/ /g, "-")));
  }
  getBaseDownloadPath(t, r) {
    return `${this.basePath}/download/${t}/${r}`;
  }
}
Ot.GitHubProvider = J_;
function Yc(e) {
...
Zi.GitLabProvider = void 0;
const Pe = de, Ya = Rt, Q_ = Jh, ai = rt, Xa = fe;
class Z_ extends Xa.Provider {
  /**
  ...
  constructor(t, r, n) {
    ...
    this.baseApiUrl = (0, ai.newBaseUrl)(`https://${a}/api/v4`);
  }
  get channel() {
    const t = this.updater.channel || this.options.channel;
    return t == null ? this.getDefaultChannelName() : this.getCustomChannelName(t);
  ...
  async getLatestVersion() {
    const t = new Pe.CancellationToken(), r = (0, ai.newUrlFromBase)(`projects/${this.options.projectId}/releases/permalink/latest`, this.baseApiUrl);
    let n;
    try {
    ...
    const l = async (u) => {
      ...
      c = new Ya.URL(h.direct_asset_url);
    ...
    const f = (0, Xa.parseUpdateInfo)(a, s, c);
  ...
  async fetchReleaseInfoByVersion(t) {
    ...
    for (const i of n) {
      const a = (0, ai.newUrlFromBase)(`projects/${this.options.projectId}/releases/${encodeURIComponent(i)}`, this.baseApiUrl);
      try {
  ...
  async findBlockMapUrlsFromAssets(t, r, n) {
    ...
    if (c) {
      const l = n.replace(new RegExp(Q_(r), "g"), t);
  ...
  resolveFiles(t) {
    return (0, Xa.getFileList)(t).map((r) => {
      const i = [
        r.url,
        // Original filename
...
Zi.GitLabProvider = Z_;
var ea = {};
Object.defineProperty(ea, "__esModule", { value: !0 });
ea.KeygenProvider = void 0;
const Xc = de, Ka = rt, Ja = fe;
class e4 extends Ja.Provider {
  constructor(t, r, n) {
    super({
      ...n,
      isUseMultipleRangeRequest: !1
    ...
    this.baseUrl = (0, Ka.newBaseUrl)(`https://${i}/v1/accounts/${this.configuration.account}/artifacts?product=${this.configuration.product}`);
  }
  get channel() {
    return this.updater.channel || this.configuration.channel || "stable";
  }
  async getLatestVersion() {
    const t = new Xc.CancellationToken(), r = (0, Ka.getChannelFilename)(this.getCustomChannelName(this.channel)), n = (0, Ka.newUrlFromBase)(r, this.baseUrl, this.updater.isAddNoCacheQuery);
    try {
      const i = await this.httpRequest(n, {
        Accept: "application/vnd.api+json",
        "Keygen-Version": "1.1"
      }, t);
      return (0, Ja.parseUpdateInfo)(i, r, n);
    } catch (i) {
      throw (0, Xc.newError)(`Unable to find latest version on ${this.toString()}, please ensure release exists: ${i.stack || i.message}`, "ERR_UPDATER_LATEST_VERSION_NOT_FOUND");
    }
  }
  resolveFiles(t) {
    return (0, Ja.resolveFiles)(t, this.baseUrl);
  }
  toString() {
...
ea.KeygenProvider = e4;
var ta = {};
Object.defineProperty(ta, "__esModule", { value: !0 });
ta.PrivateGitHubProvider = void 0;
const or = de, t4 = we, r4 = se, Kc = Rt, Jc = rt, n4 = Ot, i4 = fe;
class a4 extends n4.BaseGitHubProvider {
  constructor(t, r, n, i) {
  ...
  async getLatestVersion() {
    const t = new or.CancellationToken(), r = (0, Jc.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((c) => c.name === r);
    if (i == null)
      throw (0, or.newError)(`Cannot find ${r} in the release ${n.html_url || n.name}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
    const a = new Kc.URL(i.url);
    let s;
    try {
      s = (0, t4.load)(await this.httpRequest(a, this.configureHeaders("application/octet-stream"), t));
    } catch (c) {
      throw c instanceof or.HttpError && c.statusCode === 404 ? (0, or.newError)(`Cannot find ${r} in the latest release artifacts (${a}): ${c.stack || c.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : c;
    }
  ...
  async getLatestVersionInfo(t) {
    ...
    let n = this.basePath;
    r || (n = `${n}/latest`);
    const i = (0, Jc.newUrlFromBase)(n, this.baseUrl);
    try {
  ...
  resolveFiles(t) {
    return (0, i4.getFileList)(t).map((r) => {
      const n = r4.posix.basename(r.url).replace(/ /g, "-"), i = t.assets.find((a) => a != null && a.name === n);
      if (i == null)
        throw (0, or.newError)(`Cannot find asset "${n}" in: ${JSON.stringify(t.assets, null, 2)}`, "ERR_UPDATER_ASSET_NOT_FOUND");
      return {
        url: new Kc.URL(i.url),
        info: r
      };
    });
  }
}
ta.PrivateGitHubProvider = a4;
Object.defineProperty(Ji, "__esModule", { value: !0 });
Ji.isUrlProbablySupportMultiRangeRequests = td;
Ji.createClient = f4;
const si = de, s4 = Qi, Qc = In, o4 = Ot, l4 = Zi, c4 = ea, u4 = ta;
function td(e) {
  return !e.includes("s3.amazonaws.com");
}
function f4(e, t, r) {
  if (typeof e == "string")
    throw (0, si.newError)("Please pass PublishConfiguration object", "ERR_UPDATER_INVALID_PROVIDER_CONFIGURATION");
  const n = e.provider;
  switch (n) {
    case "github": {
      const i = e, a = (i.private ? process.env.GH_TOKEN || process.env.GITHUB_TOKEN : null) || i.token;
      return a == null ? new o4.GitHubProvider(i, t, r) : new u4.PrivateGitHubProvider(i, t, a, r);
    }
    case "bitbucket":
      return new s4.BitbucketProvider(e, t, r);
    case "gitlab":
      return new l4.GitLabProvider(e, t, r);
    case "keygen":
      return new c4.KeygenProvider(e, t, r);
    case "s3":
    case "spaces":
      return new Qc.GenericProvider({
        provider: "generic",
        url: (0, si.getS3LikeProviderBaseUrl)(e),
    ...
    case "generic": {
      const i = e;
      return new Qc.GenericProvider(i, t, {
        ...r,
        isUseMultipleRangeRequest: i.useMultipleRangeRequest !== !1 && td(i.url)
      });
    }
    case "custom": {
      const i = e, a = i.updateProvider;
      if (!a)
        throw (0, si.newError)("Custom provider not specified", "ERR_UPDATER_INVALID_PROVIDER_CONFIGURATION");
      return new a(i, t, r);
    }
    default:
      throw (0, si.newError)(`Unsupported provider: ${n}`, "ERR_UPDATER_UNSUPPORTED_PROVIDER");
  }
}
var ra = {}, On = {}, Ir = {}, tr = {};
Object.defineProperty(tr, "__esModule", { value: !0 });
tr.OperationKind = void 0;
tr.computeOperations = h4;
var Wt;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
})(Wt || (tr.OperationKind = Wt = {}));
function h4(e, t, r) {
  const n = eu(e.files), i = eu(t.files);
  let a = null;
  ...
  const o = i.get(l);
  let d = 0;
  const { checksumToOffset: u, checksumToOldSize: h } = p4(n.get(l), f.offset, r);
  let p = s.offset;
  for (let m = 0; m < o.checksums.length; p += o.sizes[m], m++) {
    ...
    y != null && h.get(E) !== g && (r.warn(`Checksum ("${E}") matches, but size differs (old: ${h.get(E)}, new: ${g})`), y = void 0), y === void 0 ? (d++, a != null && a.kind === Wt.DOWNLOAD && a.end === p ? a.end += g : (a = {
      ...
      // oldBlocks: null,
    }, Zc(a, c, E, m))) : a != null && a.kind === Wt.COPY && a.end === y ? a.end += g : (a = {
      kind: Wt.COPY,
      start: y,
      end: y + g
      // oldBlocks: [checksum]
...
const d4 = process.env.DIFFERENTIAL_DOWNLOAD_PLAN_BUILDER_VALIDATE_RANGES === "true";
function Zc(e, t, r, n) {
  if (d4 && t.length !== 0) {
...
Ir.DataSplitter = void 0;
Ir.copyData = rd;
const oi = de, m4 = Je, g4 = _n, v4 = tr, tu = Buffer.from(`\r
\r
`);
var Et;
(function(e) {
  ...
  copyExistingData(t, r) {
    return new Promise((n, i) => {
      const a = () => {
        ...
        if (s.kind !== v4.OperationKind.COPY) {
          i(new Error("Task kind must be COPY"));
          return;
        }
        rd(s, this.out, this.options.oldFileFd, i, () => {
          t++, a();
        });
      };
      a();
...
na.executeTasksUsingMultipleRangeRequests = _4;
na.checkIsRangesSupported = Is;
const Ts = de, ru = Ir, nu = tr;
function _4(e, t, r, n, i) {
  const a = (s) => {
    if (s >= t.length) {
...
function E4(e, t, r, n, i) {
  ...
  for (let d = t.start; d < t.end; d++) {
    const u = t.tasks[d];
    u.kind === nu.OperationKind.DOWNLOAD && (a += `${u.start}-${u.end - 1}, `, c.set(s, d), s++, l.push(u.end - u.start));
  }
  if (s <= 1) {
    const d = (u) => {
      if (u >= t.end) {
  ...
  const o = e.httpExecutor.createRequest(f, (d) => {
    if (!Is(d, i))
      return;
    const u = (0, Ts.safeGetHeader)(d, "content-type"), h = /^multipart\/.+?\s*;\s*boundary=(?:"([^"]+)"|([^\s";]+))\s*$/i.exec(u);
    if (h == null) {
      i(new Error(`Content-Type "multipart/byteranges" is expected, but got "${u}"`));
      return;
    }
    const p = new ru.DataSplitter(r, t, c, h[1] || h[2], l, n);
...
ia.ProgressDifferentialDownloadCallbackTransform = void 0;
const w4 = _n;
var gr;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
})(gr || (gr = {}));
class b4 extends w4.Transform {
  constructor(t, r, n) {
...
ia.ProgressDifferentialDownloadCallbackTransform = b4;
Object.defineProperty(On, "__esModule", { value: !0 });
On.DifferentialDownloader = void 0;
const qr = de, Qa = Nt, S4 = Je, C4 = Ir, A4 = Rt, li = tr, iu = na, P4 = ia;
class x4 {
  ...
  createRequestOptions() {
    ...
    return (0, qr.configureRequestUrl)(this.options.newUrl, t), (0, qr.configureRequestOptions)(t), t;
  }
  doDownload(t, r) {
    if (t.version !== r.version)
      throw new Error(`version is different (${t.version} - ${r.version}), full download is required`);
    const n = this.logger, i = (0, li.computeOperations)(t, r, n);
    n.debug != null && n.debug(JSON.stringify(i, null, 2));
    let a = 0, s = 0;
    for (const l of i) {
      const f = l.end - l.start;
      l.kind === li.OperationKind.DOWNLOAD ? a += f : s += f;
    }
    ...
    return n.info(`Full: ${au(c)}, To download: ${au(a)} (${Math.round(a / (c / 100))}%)`), this.downloadFile(i);
  }
  downloadFile(t) {
    const r = [], n = () => Promise.all(r.map((i) => (0, Qa.close)(i.descriptor).catch((a) => {
  ...
  async doDownloadFile(t, r) {
    const n = await (0, Qa.open)(this.options.oldFile, "r");
    r.push({ descriptor: n, path: this.options.oldFile });
    const i = await (0, Qa.open)(this.options.newFile, "w");
    r.push({ descriptor: i, path: this.options.newFile });
    const a = (0, S4.createWriteStream)(this.options.newFile, { fd: i });
    await new Promise((s, c) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let y = 0;
        for (const _ of t)
          _.kind === li.OperationKind.DOWNLOAD && (E.push(_.end - _.start), y += _.end - _.start);
        const S = {
          expectedByteCounts: E,
          grandTotal: y
        };
        f = new P4.ProgressDifferentialDownloadCallbackTransform(S, this.options.cancellationToken, this.options.onProgress), l.push(f);
      }
      const o = new qr.DigestTransform(this.blockAwareFileInfo.sha512);
      ...
      if (this.options.isUseMultipleRangeRequest) {
        h = (0, iu.executeTasksUsingMultipleRangeRequests)(this, t, u, n, c), h(0);
        return;
      }
      let p = 0, m = null;
      ...
      g.redirect = "manual", h = (E) => {
        ...
        const _ = t[E++];
        if (_.kind === li.OperationKind.COPY) {
          f && f.beginFileCopy(), (0, C4.copyData)(_, u, n, c, () => h(E));
          return;
        }
        ...
        const I = this.httpExecutor.createRequest(g, (T) => {
          ...
          }), T.statusCode >= 400 && c((0, qr.createHttpError)(T)), T.pipe(u, {
            end: !1
          }), T.once("end", () => {
        ...
        I.on("redirect", (T, $, C) => {
          this.logger.info(`Redirect to ${T4(C)}`), m = C, (0, qr.configureRequestUrl)(new A4.URL(m), g), I.followRedirect();
  ...
  request(t, r) {
    return new Promise((n, i) => {
      const a = this.httpExecutor.createRequest(t, (s) => {
        (0, iu.checkIsRangesSupported)(s, i) && (s.on("error", i), s.on("aborted", () => {
...
ra.GenericDifferentialDownloader = void 0;
const I4 = On;
class O4 extends I4.DifferentialDownloader {
  download(t, r) {
    return this.doDownload(t, r);
  }
}
ra.GenericDifferentialDownloader = O4;
var Lt = {};
(function(e) {
...
const xe = de, R4 = En, D4 = Fi, N4 = Gu, Ye = Nt, L4 = we, Za = Gi, Xe = se, jt = zh, su = Tn, k4 = Ki, ou = Yh, F4 = In, es = Ji, ts = Wu, U4 = ra, lr = Lt;
class $o extends N4.EventEmitter {
  /**
  ...
  set updateConfigPath(t) {
    this.clientPromise = null, this._appUpdateConfigPath = t, this.configOnDisk = new Za.Lazy(() => this.loadUpdateConfig());
  }
  /**
  ...
  constructor(t, r) {
    super(), this.autoDownload = !0, this.autoInstallOnAppQuit = !0, this.autoRunAppAfterInstall = !0, this.allowPrerelease = !1, this.fullChangelog = !1, this.allowDowngrade = !1, this.disableWebInstaller = !1, this.disableDifferentialDownload = !1, this.forceDevUpdateConfig = !1, this.previousBlockmapBaseUrlOverride = null, this._channel = null, this.downloadedUpdateHelper = null, this.requestHeaders = null, this._logger = console, this.signals = new lr.UpdaterSignal(this), this._appUpdateConfigPath = null, this._isUpdateSupported = (a) => this.checkIfUpdateSupported(a), this._isUserWithinRollout = (a) => this.isStagingMatch(a), this.clientPromise = null, this.stagingUserIdPromise = new Za.Lazy(() => this.getOrCreateStagingUserId()), this.configOnDisk = new Za.Lazy(() => this.loadUpdateConfig()), this.checkForUpdatesPromise = null, this.downloadPromise = null, this.updateInfoAndProvider = null, this._testOnlyOptions = null, this.on("error", (a) => {
      this._logger.error(`Error: ${a.stack || a.message}`);
    }), r == null ? (this.app = new k4.ElectronAppAdapter(), this.httpExecutor = new ou.ElectronHttpExecutor((a, s) => this.emit("login", a, s))) : (this.app = r, this.httpExecutor = null);
    ...
    this.currentVersion = i, this.allowPrerelease = M4(i), t != null && (this.setFeedURL(t), typeof t != "string" && t.requestHeaders && (this.requestHeaders = t.requestHeaders));
  }
  //noinspection JSMethodCanBeStatic,JSUnusedGlobalSymbols
  getFeedURL() {
  ...
  setFeedURL(t) {
    ...
    let n;
    typeof t == "string" ? n = new F4.GenericProvider({ provider: "generic", url: t }, this, {
      ...r,
      isUseMultipleRangeRequest: (0, es.isUrlProbablySupportMultiRangeRequests)(t)
    }) : n = (0, es.createClient)(t, this, r), this.clientPromise = Promise.resolve(n);
  }
  /**
  ...
  checkForUpdatesAndNotify(t) {
    return this.checkForUpdates().then((r) => r != null && r.downloadPromise ? (r.downloadPromise.then(() => {
      const n = $o.formatDownloadNotification(r.updateInfo.version, this.app.name, t);
  ...
  checkIfUpdateSupported(t) {
    const r = t == null ? void 0 : t.minimumSystemVersion, n = (0, D4.release)();
    if (r)
      try {
        if ((0, jt.lt)(n, r))
  ...
  async getUpdateInfoAndProvider() {
    await this.app.whenReady(), this.clientPromise == null && (this.clientPromise = this.configOnDisk.value.then((n) => (0, es.createClient)(n, this, this.createProviderRuntimeOptions())));
  ...
  async loadUpdateConfig() {
    return this._appUpdateConfigPath == null && (this._appUpdateConfigPath = this.app.appUpdateConfigPath), (0, L4.load)(await (0, Ye.readFile)(this._appUpdateConfigPath, "utf-8"));
  }
  ...
  async getOrCreateStagingUserId() {
    ...
    const r = xe.UUID.v5((0, R4.randomBytes)(4096), xe.UUID.OID);
  ...
  async getOrCreateDownloadHelper() {
    ...
    if (t == null) {
      ...
      n.debug != null && n.debug(`updater cache dir: ${i}`), t = new su.DownloadedUpdateHelper(i), this.downloadedUpdateHelper = t;
    }
    return t;
  }
  async executeDownload(t) {
    ...
    this.listenerCount(lr.DOWNLOAD_PROGRESS) > 0 && (n.onProgress = (y) => this.emit(lr.DOWNLOAD_PROGRESS, y));
    ...
    })), E = await (0, su.createTempUpdateFile)(`temp-${o}`, f, p);
    try {
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      const l = async (p) => {
        ...
        try {
          return JSON.parse((0, ts.gunzipSync)(m).toString());
        } catch (g) {
      ...
      this.listenerCount(lr.DOWNLOAD_PROGRESS) > 0 && (f.onProgress = (p) => this.emit(lr.DOWNLOAD_PROGRESS, p));
      const o = async (p, m) => {
        const g = Xe.join(m, "current.blockmap");
        await (0, Ye.outputFile)(g, (0, ts.gzipSync)(JSON.stringify(p)));
      }, d = async (p) => {
        const m = Xe.join(p, "current.blockmap");
        try {
          if (await (0, Ye.pathExists)(m))
            return JSON.parse((0, ts.gunzipSync)(await (0, Ye.readFile)(m)).toString());
        } catch (g) {
      ...
      return h == null && (h = await l(c[0])), await new U4.GenericDifferentialDownloader(t.info, this.httpExecutor, f).download(h, u), !1;
    } catch (s) {
...
er.BaseUpdater = void 0;
const lu = ki, $4 = Pt;
class B4 extends $4.AppUpdater {
  constructor(t, r) {
  ...
  async spawnLog(t, r = [], n = void 0, i = "ignore") {
    return this._logger.info(`Executing: ${t} with args: ${r}`), new Promise((a, s) => {
      try {
        const c = { stdio: i, env: n, detached: !0 }, l = (0, lu.spawn)(t, r, c);
        l.on("error", (f) => {
          s(f);
...
const cr = Nt, H4 = On, q4 = Wu;
class j4 extends H4.DifferentialDownloader {
  async download() {
    const t = this.blockAwareFileInfo, r = t.size, n = r - (t.blockMapSize + 4);
    this.fileMetadataBuffer = await this.readRemoteBytes(n, r - 1);
    const i = id(this.fileMetadataBuffer.slice(0, this.fileMetadataBuffer.length - 4));
    await this.doDownload(await G4(this.options.oldFile), i);
  }
}
Rn.FileWithEmbeddedBlockMapDifferentialDownloader = j4;
function id(e) {
  return JSON.parse((0, q4.inflateRawSync)(e).toString());
}
async function G4(e) {
  ...
  try {
    ...
    return await (0, cr.read)(t, i, 0, i.length, r - n.length - i.length), await (0, cr.close)(t), id(i);
  } catch (r) {
...
const cu = de, uu = ki, V4 = Nt, W4 = Je, jr = se, z4 = er, Y4 = Rn, X4 = fe, fu = Lt;
class K4 extends z4.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  isUpdaterActive() {
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, X4.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "AppImage", ["rpm", "deb", "pacman"]);
    return this.executeDownload({
      ...
      task: async (i, a) => {
        ...
        if (s == null)
          throw (0, cu.newError)("APPIMAGE env is not defined", "ERR_UPDATER_OLD_FILE_NOT_FOUND");
        (t.disableDifferentialDownload || await this.downloadDifferential(n, s, i, r, t)) && await this.httpExecutor.download(n.url, i, a), await (0, V4.chmod)(i, 493);
      }
    });
  }
  async downloadDifferential(t, r, n, i, a) {
    try {
      ...
      return this.listenerCount(fu.DOWNLOAD_PROGRESS) > 0 && (s.onProgress = (c) => this.emit(fu.DOWNLOAD_PROGRESS, c)), await new Y4.FileWithEmbeddedBlockMapDifferentialDownloader(t.info, this.httpExecutor, s).download(), !1;
    } catch (s) {
  ...
  doInstall(t) {
    ...
    (0, W4.unlinkSync)(r);
    let n;
    const i = jr.basename(r), a = this.installerPath;
    if (a == null)
      return this.dispatchError(new Error("No update filepath provided, can't quit and install")), !1;
    jr.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = jr.join(jr.dirname(r), jr.basename(a)), (0, uu.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
      APPIMAGE_SILENT_INSTALL: "true"
    };
    return t.isForceRunAfter ? this.spawnLog(n, [], s) : (s.APPIMAGE_EXIT_AFTER_INSTALL = "true", (0, uu.execFileSync)(n, [], { env: s })), !0;
  }
}
fn.AppImageUpdater = K4;
var hn = {}, Or = {};
Object.defineProperty(Or, "__esModule", { value: !0 });
Or.LinuxUpdater = void 0;
const J4 = er;
class Q4 extends J4.BaseUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /**
...
hn.DebUpdater = void 0;
const Z4 = fe, hu = Lt, eE = Or;
class Bo extends eE.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, Z4.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "deb", ["AppImage", "rpm", "pacman"]);
    return this.executeDownload({
      fileExtension: "deb",
      fileInfo: n,
      downloadUpdateOptions: t,
      task: async (i, a) => {
        this.listenerCount(hu.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(hu.DOWNLOAD_PROGRESS, s)), await this.httpExecutor.download(n.url, i, a);
      }
    });
  }
  doInstall(t) {
...
const du = Lt, tE = fe, rE = Or;
class Ho extends rE.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, tE.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "pacman", ["AppImage", "deb", "rpm"]);
    return this.executeDownload({
      fileExtension: "pacman",
      fileInfo: n,
      downloadUpdateOptions: t,
      task: async (i, a) => {
        this.listenerCount(du.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(du.DOWNLOAD_PROGRESS, s)), await this.httpExecutor.download(n.url, i, a);
      }
    });
  }
  doInstall(t) {
    ...
    if (r == null)
      return this.dispatchError(new Error("No update filepath provided, can't quit and install")), !1;
    try {
      Ho.installWithCommandRunner(r, this.runCommandWithSudoIfNeeded.bind(this), this._logger);
    } catch (n) {
...
pn.RpmUpdater = void 0;
const pu = Lt, nE = fe, iE = Or;
class qo extends iE.LinuxUpdater {
  constructor(t, r) {
    super(t, r);
  }
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, nE.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "rpm", ["AppImage", "deb", "pacman"]);
    return this.executeDownload({
      fileExtension: "rpm",
      fileInfo: n,
      downloadUpdateOptions: t,
      task: async (i, a) => {
        this.listenerCount(pu.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(pu.DOWNLOAD_PROGRESS, s)), await this.httpExecutor.download(n.url, i, a);
      }
    });
  }
  doInstall(t) {
...
const mu = de, rs = Nt, aE = Je, gu = se, sE = Op, oE = Pt, lE = fe, vu = ki, yu = En;
class cE extends oE.AppUpdater {
  constructor(t, r) {
  ...
  async doDownloadUpdate(t) {
    ...
    let a = !1;
    try {
      this.debug("Checking for macOS Rosetta environment"), a = (0, vu.execFileSync)("sysctl", [i], { encoding: "utf8" }).includes(`${i}: 1`), n.info(`Checked for macOS Rosetta environment (isRosetta=${a})`);
    } catch (d) {
    ...
    try {
      ...
      const u = (0, vu.execFileSync)("uname", ["-a"], { encoding: "utf8" }).includes("ARM");
    ...
    const l = (0, lE.findFile)(r, "zip", ["pkg", "dmg"]);
    if (l == null)
      throw (0, mu.newError)(`ZIP file not provided: ${(0, mu.safeStringifyJson)(r)}`, "ERR_UPDATER_ZIP_FILE_NOT_FOUND");
    ...
    return this.executeDownload({
      ...
      downloadUpdateOptions: t,
      task: async (d, u) => {
        const h = gu.join(this.downloadedUpdateHelper.cacheDir, o), p = () => (0, rs.pathExistsSync)(h) ? !t.disableDifferentialDownload : (n.info("Unable to locate previous update.zip for differential download (is this first install?), falling back to full download"), !1);
        let m = !0;
        ...
        if (!t.disableDifferentialDownload)
          try {
            const u = gu.join(this.downloadedUpdateHelper.cacheDir, o);
            await (0, rs.copyFile)(d.downloadedFile, u);
          } catch (u) {
  ...
  async updateDownloaded(t, r) {
    var n;
    const i = r.downloadedFile, a = (n = t.info.size) !== null && n !== void 0 ? n : (await (0, rs.stat)(i)).size, s = this._logger, c = `fileToProxy=${t.url.href}`;
    this.closeServerIfExists(), this.debug(`Creating proxy server for native Squirrel.Mac (${c})`), this.server = (0, sE.createServer)(), this.debug(`Proxy server for native Squirrel.Mac is created (${c})`), this.server.on("close", () => {
    ...
    return await new Promise((f, o) => {
      const d = (0, yu.randomBytes)(64).toString("base64").replace(/\//g, "_").replace(/\+/g, "-"), u = Buffer.from(`autoupdater:${d}`, "ascii"), h = `/${(0, yu.randomBytes)(64).toString("hex")}.zip`;
      this.server.on("request", (p, m) => {
        ...
        const y = (0, aE.createReadStream)(i);
        y.on("error", (S) => {
          try {
            m.end();
          } catch (_) {
...
jo.verifySignature = fE;
const _u = de, ad = ki, uE = Fi, Eu = se;
function sd(e, t) {
...
function fE(e, t, r) {
  return new Promise((n, i) => {
    const a = t.replace(/'/g, "''");
    r.info(`Verifying signature ${a}`), (0, ad.execFile)(...sd(`"Get-AuthenticodeSignature -LiteralPath '${a}' | ConvertTo-Json -Compress"`, 20 * 1e3), (s, c, l) => {
      var f;
      try {
        if (s != null || l) {
          ns(r, s, l, i), n(null);
        ...
        if (o.Status === 0) {
          try {
            const p = Eu.normalize(o.Path), m = Eu.normalize(t);
            if (r.info(`LiteralPath: ${p}. Update Path: ${m}`), p !== m) {
              ns(r, new Error(`LiteralPath of ${p} is different than ${m}`), l, i), n(null);
              return;
            }
          } catch (p) {
          ...
          const u = (0, _u.parseDn)(o.SignerCertificate.Subject);
          let h = !1;
          for (const p of e) {
            const m = (0, _u.parseDn)(p);
...
function ns(e, t, r, n) {
  ...
  try {
    (0, ad.execFileSync)(...sd("ConvertTo-Json test", 10 * 1e3));
  } catch (i) {
...
const ci = de, wu = se, pE = er, mE = Rn, bu = Lt, gE = fe, vE = Nt, yE = jo, Su = Rt;
class _E extends pE.BaseUpdater {
  constructor(t, r) {
    super(t, r), this._verifyUpdateCodeSignature = (n, i) => (0, yE.verifySignature)(n, i, this._logger);
  }
  /**
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const r = t.updateInfoAndProvider.provider, n = (0, gE.findFile)(r.resolveFiles(t.updateInfoAndProvider.info), "exe");
    return this.executeDownload({
      fileExtension: "exe",
      downloadUpdateOptions: t,
      fileInfo: n,
      task: async (i, a, s, c) => {
        ...
        if (f && t.disableWebInstaller)
          throw (0, ci.newError)(`Unable to download new version ${t.updateInfoAndProvider.info.version}. Web Installers are disabled`, "ERR_UPDATER_WEB_INSTALLER_DISABLED");
        !f && !t.disableWebInstaller && this._logger.warn("disableWebInstaller is set to false, you should set it to true if you do not plan on using a web installer. This will default to true in a future version."), (f || t.disableDifferentialDownload || await this.differentialDownloadInstaller(n, t, i, r, ci.CURRENT_APP_INSTALLER_FILE_NAME)) && await this.httpExecutor.download(n.url, i, a);
        const o = await this.verifySignature(i);
        if (o != null)
          throw await c(), (0, ci.newError)(`New version ${t.updateInfoAndProvider.info.version} is not signed by the application owner: ${o}`, "ERR_UPDATER_INVALID_SIGNATURE");
        if (f && await this.differentialDownloadWebPackage(t, l, s, r))
          try {
            await this.httpExecutor.download(new Su.URL(l.path), s, {
  ...
  doInstall(t) {
    ...
    const a = () => {
      this.spawnLog(wu.join(process.resourcesPath, "elevate.exe"), [r].concat(n)).catch((s) => this.dispatchError(s));
    };
  ...
  async differentialDownloadWebPackage(t, r, n, i) {
    ...
    try {
      const a = {
        newUrl: new Su.URL(r.path),
        oldFile: wu.join(this.downloadedUpdateHelper.cacheDir, ci.CURRENT_APP_PACKAGE_FILE_NAME),
        logger: this._logger,
        newFile: n,
      ...
      this.listenerCount(bu.DOWNLOAD_PROGRESS) > 0 && (a.onProgress = (s) => this.emit(bu.DOWNLOAD_PROGRESS, s)), await new mE.FileWithEmbeddedBlockMapDifferentialDownloader(r, this.httpExecutor, a).download();
    } catch (a) {
...
(function(e) {
  ...
  function m() {
    if (process.platform === "win32")
      p = new gn.NsisUpdater();
    else if (process.platform === "darwin")
      p = new mn.MacUpdater();
    else {
      p = new fn.AppImageUpdater();
      try {
...
var Os = { exports: {} }, Rs = { exports: {} }, je = {}, te = {};
te.__esModule = !0;
te.extend = od;
te.indexOf = CE;
te.escapeExpression = AE;
te.isEmpty = PE;
te.createFrame = xE;
te.blockParams = TE;
te.appendContextPath = IE;
var EE = {
  "&": "&amp;",
  "<": "&lt;",
  ">": "&gt;",
...
Ds(/x/) && (te.isFunction = Ds = function(e) {
  return typeof e == "function" && Go.call(e) === "[object Function]";
});
te.isFunction = Ds;
var ld = Array.isArray || function(e) {
  return e && typeof e == "object" ? Go.call(e) === "[object Array]" : !1;
};
te.isArray = ld;
function CE(e, t) {
...
function AE(e) {
  ...
  return bE.test(e) ? e.replace(wE, SE) : e;
}
function PE(e) {
  return !e && e !== 0 ? !0 : !!(ld(e) && e.length === 0);
}
function xE(e) {
  var t = od({}, e);
...
var Ge = Ns.exports, Dn = {}, Ls = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  var r = te;
...
var FE = Bs.exports;
Dn.__esModule = !0;
Dn.registerDefaultHelpers = JE;
Dn.moveHelperToHooks = QE;
function rr(e) {
  return e && e.__esModule ? e : { default: e };
}
var UE = OE, ME = rr(UE), $E = RE, BE = rr($E), HE = DE, qE = rr(HE), jE = NE, GE = rr(jE), VE = LE, WE = rr(VE), zE = kE, YE = rr(zE), XE = FE, KE = rr(XE);
function JE(e) {
  ME.default(e), BE.default(e), qE.default(e), GE.default(e), WE.default(e), YE.default(e), KE.default(e);
}
function QE(e, t, r) {
...
var ZE = Hs.exports;
Vo.__esModule = !0;
Vo.registerDefaultDecorators = nw;
function ew(e) {
  return e && e.__esModule ? e : { default: e };
}
var tw = ZE, rw = ew(tw);
...
var cd = qs.exports, Rr = {};
Rr.__esModule = !0;
Rr.createProtoAccessControl = ow;
Rr.resultIsAllowed = lw;
Rr.resetLoggedProperties = uw;
function iw(e) {
  return e && e.__esModule ? e : { default: e };
}
var Cu = te, aw = cd, sw = iw(aw), Ni = /* @__PURE__ */ Object.create(null);
function ow(e) {
  var t = /* @__PURE__ */ Object.create(null);
  t.__proto__ = !1, Cu.extend(t, e.allowedProtoProperties);
  var r = /* @__PURE__ */ Object.create(null);
  return r.constructor = !1, r.__defineGetter__ = !1, r.__defineSetter__ = !1, r.__lookupGetter__ = !1, r.__lookupSetter__ = !1, Cu.extend(r, e.allowedProtoMethods), {
    properties: {
      whitelist: t,
...
function lw(e, t, r) {
  return Au(typeof e == "function" ? t.methods : t.properties, r);
}
function Au(e, t) {
  return e.whitelist[t] !== void 0 ? e.whitelist[t] === !0 : e.defaultValue !== void 0 ? e.defaultValue : (cw(t), !1);
}
function cw(e) {
  Ni[e] !== !0 && (Ni[e] = !0, sw.default.log("error", 'Handlebars: Access has been denied to resolve the property "' + e + `" because it is not an "own property" of its parent.
...
je.__esModule = !0;
je.HandlebarsEnvironment = js;
function ud(e) {
  return e && e.__esModule ? e : { default: e };
}
var Gt = te, fw = Ge, is = ud(fw), hw = Dn, dw = Vo, pw = cd, Li = ud(pw), mw = Rr, gw = "4.7.9";
je.VERSION = gw;
var vw = 8;
je.COMPILER_REVISION = vw;
var yw = 7;
je.LAST_COMPATIBLE_COMPILER_REVISION = yw;
var _w = {
  1: "<= 1.0.rc.2",
...
je.REVISION_CHANGES = _w;
var as = "[object Object]";
function js(e, t, r) {
  this.helpers = e || {}, this.partials = t || {}, this.decorators = r || {}, hw.registerDefaultHelpers(this), dw.registerDefaultDecorators(this);
}
js.prototype = {
  constructor: js,
  logger: Li.default,
  ...
  registerHelper: function(t, r) {
    if (Gt.toString.call(t) === as) {
      if (r)
        throw new is.default("Arg not supported with multiple helpers");
  ...
  registerPartial: function(t, r) {
    if (Gt.toString.call(t) === as)
      ...
      if (typeof r > "u")
        throw new is.default('Attempting to register a partial called "' + t + '" as undefined');
      this.partials[t] = r;
    }
  },
  ...
  registerDecorator: function(t, r) {
    if (Gt.toString.call(t) === as) {
      if (r)
        throw new is.default("Arg not supported with multiple decorators");
  ...
  resetLoggedPropertyAccesses: function() {
    mw.resetLoggedProperties();
  }
};
var Ew = Li.default.log;
je.log = Ew;
je.createFrame = Gt.createFrame;
je.logger = Li.default;
var Gs = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  function r(n) {
...
var Aw = te, vr = Cw(Aw), Pw = Ge, ht = Sw(Pw), dt = je, Pu = Dn, xw = Wo, xu = Rr;
function Tw(e) {
...
function Iw(e, t) {
  ...
  function n(s, c, l) {
    l.hash && (c = vr.extend({}, c, l.hash), l.ids && (l.ids[0] = !0)), s = t.VM.resolvePartial.call(this, s, c, l), l.hooks = this.hooks, l.protoAccessControl = this.protoAccessControl;
...
`);
  ...
  var i = {
    ...
    lookupProperty: function(c, l) {
      var f = c[l];
      if (f == null || Object.prototype.hasOwnProperty.call(c, l) || xu.resultIsAllowed(f, i.protoAccessControl, l))
        return f;
    },
    lookup: function(c, l) {
    ...
    escapeExpression: vr.escapeExpression,
    invokePartial: n,
    fn: function(c) {
      var l = e[c];
    ...
    program: function(c, l, f, o, d) {
      ...
      return l || d || o || f ? u = yi(this, c, h, l, f, o, d) : u || (u = this.programs[c] = yi(this, c, h)), u;
    },
    data: function(c, l) {
      for (; c && l--; )
        c = c._parent;
    ...
    mergeIfNeeded: function(c, l) {
      var f = c || l;
      return c && l && c !== l && (f = vr.extend({}, l, c)), f;
    },
  ...
  function a(s) {
    ...
    a._setup(c), !c.partial && e.useData && (l = Dw(s, l));
    ...
    return d = hd(e.main, d, i, c.depths || [], l, o), d(s, c);
  }
  return a.isTop = !0, a._setup = function(s) {
    if (s.partial)
      ...
      var c = {};
      Tu(c, t.helpers, i), Tu(c, s.helpers, i), i.helpers = c, e.usePartial && (i.partials = i.mergeIfNeeded(s.partials, t.partials)), (e.usePartial || e.useDecorators) && (i.decorators = vr.extend({}, t.decorators, s.decorators)), i.hooks = {}, i.protoAccessControl = xu.createProtoAccessControl(s);
      var l = s.allowCallsToHelperMissing || r;
      Pu.moveHelperToHooks(i, "helperMissing", l), Pu.moveHelperToHooks(i, "blockHelperMissing", l);
    }
    ...
    return yi(i, s, e[s], c, 0, l, f);
  }, a;
}
function yi(e, t, r, n, i, a, s) {
  function c(l) {
  ...
  return c = hd(r, c, e, s, n, a), c.program = t, c.depth = s ? s.length : 0, c.blockParams = i || 0, c;
}
function Ow(e, t, r) {
  return e ? !e.call && !r.name && (r.name = e, e = _i(r.partials, e)) : r.name === "@partial-block" ? e = _i(r.data, "partial-block") : e = _i(r.partials, r.name), e;
}
function Rw(e, t, r) {
  var n = _i(r.data, "partial-block");
  r.partial = !0, r.ids && (r.data.contextPath = r.ids[0] || r.data.contextPath);
  var i = void 0;
  if (r.fn && r.fn !== fd && function() {
    ...
    }, a.partials && (r.partials = vr.extend({}, r.partials, a.partials));
...
function hd(e, t, r, n, i, a) {
  if (e.decorator) {
    var s = {};
    t = e.decorator(t, s, r, n && n[0], i, a, n), vr.extend(t, s);
  }
  return t;
}
function Tu(e, t, r) {
...
function Nw(e, t) {
  ...
  return xw.wrapHelper(e, function(n) {
...
(function(e, t) {
  ...
  var i = je, a = n(i), s = ww, c = r(s), l = Ge, f = r(l), o = te, d = n(o), u = kt, h = n(u), p = dd, m = r(p);
  function g() {
...
var pd = Ws.exports, Nn = {}, zs = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  var r = function() {
    var n = {
...
var kw = zs.exports, Ys = { exports: {} }, Xs = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  function r(f) {
...
Ve.stripComment = qw;
Ve.preparePath = jw;
Ve.prepareMustache = Gw;
Ve.prepareRawBlock = Vw;
Ve.prepareBlock = Ww;
Ve.prepareProgram = zw;
Ve.preparePartialBlock = Yw;
function Uw(e) {
  return e && e.__esModule ? e : { default: e };
}
var Mw = Ge, Yo = Uw(Mw);
function Xo(e, t) {
  if (t = t.path ? t.path.original : t, e.path.original !== t) {
    ...
    throw new Yo.default(e.path.original + " doesn't match " + t, r);
  }
}
function $w(e, t) {
...
function jw(e, t, r) {
  ...
  for (var n = e ? "@" : "", i = [], a = 0, s = 0, c = t.length; s < c; s++) {
    ...
    if (n += (t[s].separator || "") + l, !f && (l === ".." || l === "." || l === "this")) {
      if (i.length > 0)
        throw new Yo.default("Invalid path: " + n, { loc: r });
      l === ".." && a++;
    } else
      i.push(l);
  }
...
function Ww(e, t, r, n, i, a) {
  ...
  if (r) {
    if (s)
      throw new Yo.default("Unexpected inverse block on decorator", r);
...
var Kw = kw, Ks = Ko(Kw), Jw = Fw, Qw = Ko(Jw), Zw = Ve, eb = Xw(Zw), tb = Ge, Gr = Ko(tb), rb = te;
Nn.parser = Ks.default;
var Ei = {};
rb.extend(Ei, eb);
function md(e, t) {
  if (e.type === "Program")
    return ib(e), e;
  Ks.default.yy = Ei, Ei.locInfo = function(n) {
    return new Ei.SourceLocation(t && t.srcName, n);
  };
  var r = Ks.default.parse(e);
  return r;
}
function nb(e, t) {
  var r = md(e, t), n = new Qw.default(t);
  return n.accept(r);
}
function ib(e) {
  Js(e);
  ...
  if (e != null) {
    ...
    if (typeof e == "object") {
      if (e.type === "PathExpression") {
        if (!ab(e.depth))
          throw new Gr.default("Invalid AST: PathExpression.depth must be an integer");
        if (!Array.isArray(e.parts))
          throw new Gr.default("Invalid AST: PathExpression.parts must be an array");
        for (var t = 0; t < e.parts.length; t++)
          if (typeof e.parts[t] != "string")
            throw new Gr.default("Invalid AST: PathExpression.parts must only contain strings");
      } else if (e.type === "NumberLiteral") {
        if (typeof e.value != "number" || !isFinite(e.value))
          throw new Gr.default("Invalid AST: NumberLiteral.value must be a number");
      } else if (e.type === "BooleanLiteral" && typeof e.value != "boolean")
        throw new Gr.default("Invalid AST: BooleanLiteral.value must be a boolean");
...
var sb = Ge, en = gd(sb), vn = te, ob = pd, Vr = gd(ob), lb = [].slice;
function Qs() {
}
Qs.prototype = {
  compiler: Qs,
  equals: function(t) {
    ...
    for (var n = 0; n < r; n++) {
      ...
      if (i.opcode !== a.opcode || !vd(i.args, a.args))
        return !1;
    }
  ...
  compile: function(t, r) {
    return this.sourceNode = [], this.opcodes = [], this.children = [], this.options = r, this.stringParams = r.stringParams, this.trackIds = r.trackIds, r.blockParams = r.blockParams || [], r.knownHelpers = vn.extend(/* @__PURE__ */ Object.create(null), {
      helperMissing: !0,
  ...
  accept: function(t) {
    if (!this[t.type])
      throw new en.default("Unknown type: " + t.type, t);
  ...
  PartialStatement: function(t) {
    ...
    var n = t.params;
    if (n.length > 1)
      throw new en.default("Unsupported number of partial arguments: " + n.length, t);
  ...
  helperSexpr: function(t, r, n) {
    ...
    if (this.options.knownHelpers[s])
      ...
      if (this.options.knownHelpersOnly)
        throw new en.default("You specified knownHelpersOnly, but used the unknown helper " + s, t);
      a.strict = !0, a.falsy = !0, this.accept(a), this.opcode("invokeHelper", i.length, a.original, Vr.default.helpers.simpleId(a));
    }
  },
  PathExpression: function(t) {
    this.addDepth(t.depth), this.opcode("getContext", t.depth);
    var r = t.parts[0], n = Vr.default.helpers.scopedId(t), i = !t.depth && !n && this.blockParamIndex(r);
  ...
  classifySexpr: function(t) {
    var r = Vr.default.helpers.simpleId(t.path), n = r && !!this.blockParamIndex(t.path.parts[0]), i = !n && Vr.default.helpers.helperExpression(t), a = !n && (i || r);
    if (a && !i) {
  ...
  pushParam: function(t) {
    ...
    if (this.stringParams)
      ...
      if (this.trackIds) {
        var n = void 0;
        if (t.parts && !Vr.default.helpers.scopedId(t) && !t.depth && (n = this.blockParamIndex(t.parts[0])), n) {
  ...
  blockParamIndex: function(t) {
    for (var r = 0, n = this.options.blockParams.length; r < n; r++) {
      var i = this.options.blockParams[r], a = i && vn.indexOf(i, t);
      if (i && a >= 0)
        return [r, a];
    }
  }
...
function cb(e, t, r) {
  if (e == null || typeof e != "string" && e.type !== "Program")
    throw new en.default("You must pass a string or Handlebars AST to Handlebars.precompile. You passed " + e);
...
function ub(e, t, r) {
  if (t === void 0 && (t = {}), e == null || typeof e != "string" && e.type !== "Program")
    throw new en.default("You must pass a string or Handlebars AST to Handlebars.compile. You passed " + e);
  t = vn.extend({}, t), "data" in t || (t.data = !0), t.compat && (t.useDepths = !0);
  var n = void 0;
  function i() {
...
function vd(e, t) {
  if (e === t)
    return !0;
  if (vn.isArray(e) && vn.isArray(t) && e.length === t.length) {
...
var Zs = { exports: {} }, eo = { exports: {} }, Wr = {}, ss = {}, fi = {}, hi = {}, Ou;
function fb() {
  if (Ou) return hi;
  Ou = 1;
  var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split("");
  return hi.encode = function(t) {
    if (0 <= t && t < e.length)
      return e[t];
    throw new TypeError("Must be between 0 and 63: " + t);
  }, hi.decode = function(t) {
...
function yd() {
  ...
  return fi.encode = function(l) {
    var f = "", o, d = a(l);
    do
      o = d & n, d >>>= t, d > 0 && (o |= i), f += e.encode(o);
    while (d > 0);
    return f;
  }, fi.decode = function(l, f, o) {
...
function _d() {
  if (Nu) return ls;
  Nu = 1;
  var e = kn(), t = Object.prototype.hasOwnProperty, r = typeof Map < "u";
  function n() {
...
function Ed() {
  if (ku) return ss;
  ku = 1;
  var e = yd(), t = kn(), r = _d().ArraySet, n = hb().MappingList;
  function i(a) {
...
function pb() {
  ...
  return fs.quickSort = function(n, i) {
    r(n, i, 0, n.length - 1);
  }, fs;
}
var Mu;
function mb() {
  if (Mu) return zr;
  Mu = 1;
  var e = kn(), t = db(), r = _d().ArraySet, n = yd(), i = pb().quickSort;
  function a(f, o) {
    var d = f;
  ...
  }, zr.IndexedSourceMapConsumer = l, zr;
}
var hs = {}, $u;
function gb() {
  if ($u) return hs;
  $u = 1;
  var e = Ed().SourceMapGenerator, t = kn(), r = /(\r?\n)/, n = 10, i = "$$$isSourceNode$$$";
...
var Bu;
function vb() {
  return Bu || (Bu = 1, Wr.SourceMapGenerator = Ed().SourceMapGenerator, Wr.SourceMapConsumer = mb().SourceMapConsumer, Wr.SourceNode = gb().SourceNode), Wr;
}
(function(e, t) {
  t.__esModule = !0;
  var r = te, n = void 0;
...
(function(e, t) {
  ...
  var n = je, i = Ge, a = r(i), s = te, c = yb, l = r(c);
  function f(u) {
    this.value = u;
  }
  function o() {
...
(function(e, t) {
  ...
  var n = Lw, i = r(n), a = pd, s = r(a), c = Nn, l = Ln, f = _b, o = r(f), d = zo, u = r(d), h = dd, p = r(h), m = i.default.create;
  function g() {
    var y = m();
...
var sa = Eb.default, wd = aa;
sa.PrintVisitor = wd.PrintVisitor;
sa.print = wd.print;
var Ab = sa;
function Hu(e, t) {
  var r = Je, n = r.readFileSync(t, "utf8");
  e.exports = sa.compile(n);
}
typeof ui < "u" && ui.extensions && (ui.extensions[".handlebars"] = Hu, ui.extensions[".hbs"] = Hu);
const Pb = /* @__PURE__ */ zu(Ab);
class xb {
  /**
  ...
  static getTemplateDir() {
    if (process.env.VITE_DEV_SERVER_URL)
      return ir.join(process.cwd(), "public", "pdf_templates");
    {
      const t = process.resourcesPath || ir.join(ir.dirname(At.getAppPath()), "..");
      return ir.join(t, "public", "pdf_templates");
    }
  }
  /**
  ...
  static async loadTemplate(t) {
    const r = this.getTemplateDir(), n = ir.join(r, `${t}.html`);
    if (!Mr.existsSync(n))
      throw new Error(`Sablon nem található: ${t}`);
    const i = Mr.readFileSync(n, "utf-8");
    return Pb.compile(i);
  }
  /**
  ...
  static async generatePdf(t, r) {
    const n = ir.dirname(r);
    Mr.existsSync(n) || Mr.mkdirSync(n, { recursive: !0 });
    const i = new no({
      webPreferences: {
        sandbox: !0
      },
    ...
    try {
      ...
      return await Mr.promises.writeFile(r, a), { success: !0, pageCount: Math.max(1, Math.ceil(a.length / 15e3)) };
    } catch (a) {
  ...
  static async saveAndOpen(t, r = !0) {
    if (r)
      try {
        const { default: n } = await import("./index-Ox-6Ucsd.js");
        n(t).catch((i) => {
          console.warn(
...
const yn = ve.dirname(Ap(import.meta.url));
process.env.APP_ROOT = ve.join(yn, "..");
const to = process.env.VITE_DEV_SERVER_URL, Kb = ve.join(process.env.APP_ROOT, "dist-electron"), Tb = ve.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = to ? ve.join(process.env.APP_ROOT, "public") : Tb;
let G, Jt = !1, Dr = !1, ro = !1;
function bd() {
  G = new no({
    icon: ve.join(process.env.VITE_PUBLIC, "balazslogo.svg"),
    title: "Navigator Studio",
    webPreferences: {
      preload: ve.join(yn, "preload.mjs"),
      contextIsolation: !0,
      nodeIntegration: !1,
      sandbox: !1
    },
  ...
  }), to ? G.loadURL(to) : G.loadFile(ve.join(yn, "../dist/index.html")), G.on("close", async (e) => {
    if (!Jt && !Dr || ro)
      return;
    e.preventDefault();
    const t = Jt;
    (await ds.showMessageBox(G, {
      type: "question",
      ...
      noLink: !0
    })).response === 1 && (ro = !0, G == null || G.close());
  });
}
function Ib(e) {
  e && qu.openPath(e).then((t) => {
    t && console.error("Failed to open file:", t);
  });
}
At.on("window-all-closed", () => {
  process.platform !== "darwin" && (At.quit(), G = null);
});
At.on("activate", () => {
  no.getAllWindows().length === 0 && bd();
});
...
Qe.handle("run-executable", (e, t, r = []) => new Promise((n, i) => {
  var o, d;
  const a = At.isPackaged ? ve.join(process.resourcesPath, "public") : ve.join(yn, "../public"), s = ve.join(a, t);
...
Qe.handle("open-file", async (e, t) => {
  const r = At.isPackaged ? ve.join(process.resourcesPath, "public") : ve.join(yn, "../public");
  return Ib(ve.join(r, t)), !0;
});
Qe.handle("select-folder", async (e, t) => {
  const r = {
    properties: ["openDirectory", "createDirectory"],
    defaultPath: t
  }, n = G ? await ds.showOpenDialog(G, r) : await ds.showOpenDialog(r);
...
Qe.handle("pdf-create-schematic", async (e, t) => {
  try {
    return console.log("PDF creation request received:", { companyId: t.companyId, templateId: t.templateId }), await xb.createSchematicPdf(t);
  } catch (r) {
...
Ue.autoUpdater.on("checking-for-update", () => {
  Jt = !1, Dr = !1, G == null || G.webContents.send("update-status", "Checking for updates..."), console.log("Checking for updates...");
});
Ue.autoUpdater.on("update-available", () => {
  Jt = !0, Dr = !1, G == null || G.webContents.send("update-status", "Update available. Starting download..."), console.log("Update available, starting download..."), Ue.autoUpdater.downloadUpdate();
});
Ue.autoUpdater.on("update-not-available", () => {
  Jt = !1, Dr = !1, G == null || G.webContents.send("update-status", ""), console.log("Already up to date.");
});
...
Ue.autoUpdater.on("update-downloaded", () => {
  Jt = !1, Dr = !0, G == null || G.webContents.send("update-status", "Update ready. Restart to install."), G == null || G.webContents.send("update-ready"), console.log("Update downloaded and ready to install.");
});
Ue.autoUpdater.on("error", (e) => {
  Jt = !1, Dr = !1, G == null || G.webContents.send("update-status", ""), G == null || G.webContents.send("update-error", e.message), console.error("Update error:", e.message);
});
...
Qe.handle("restart-and-install", () => {
  ro = !0, Ue.autoUpdater.quitAndInstall();
});
At.whenReady().then(() => {
  bd(), Ue.autoUpdater.checkForUpdates(), setInterval(() => {
