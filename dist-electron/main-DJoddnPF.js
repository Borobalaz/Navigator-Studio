...
var to = { exports: {} }, fi = Cp, vr = fi.Buffer, He = {}, qe;
for (qe in fi)
  fi.hasOwnProperty(qe) && (qe === "SlowBuffer" || qe === "Buffer" || (He[qe] = fi[qe]));
var yr = He.Buffer = {};
for (qe in vr)
  vr.hasOwnProperty(qe) && (qe === "allocUnsafe" || qe === "allocUnsafeSlow" || (yr[qe] = vr[qe]));
He.Buffer.prototype = vr.prototype;
(!yr.from || yr.from === Uint8Array.from) && (yr.from = function(e, t, r) {
  if (typeof e == "number")
...
yr.alloc || (yr.alloc = function(e, t, r) {
  if (typeof e != "number")
...
function Np() {
  ...
  ml = 1;
  var e = Dt.Buffer;
  Ur.utf7 = t, Ur.unicode11utf7 = "utf7";
  function t(m, g) {
    this.iconv = g;
  }
...
function ao(e) {
  ...
  function r(C, F, H) {
    ...
    function j(K, L, D, U) {
      return t(K, L, function(R) {
        R && (R.code === "EMFILE" || R.code === "ENFILE") ? ir([j, [K, L, D], R, U || Date.now(), Date.now()]) : typeof D == "function" && D.apply(this, arguments);
      });
    }
  }
  var n = e.writeFile;
  ...
  function i(C, F, H, j) {
    ...
    function K(L, D, U, R, M) {
      return n(L, D, U, function(k) {
        k && (k.code === "EMFILE" || k.code === "ENFILE") ? ir([K, [L, D, U, R], k, M || Date.now(), Date.now()]) : typeof R == "function" && R.apply(this, arguments);
      });
    }
  }
  var a = e.appendFile;
  ...
  function d(C, F, H) {
    ...
    function K(L, D, U, R) {
      return function(M, k) {
        M && (M.code === "EMFILE" || M.code === "ENFILE") ? ir([
          j,
          [L, D, U],
          M,
          R || Date.now(),
...
function m0(e, t, r) {
  const n = _r.openSync(e, "r+");
  return _r.futimesSync(n, t, r), _r.closeSync(n);
}
var Zu = {
  utimesMillis: p0,
  utimesMillisSync: m0
};
const wr = Jt, ge = se, g0 = eo;
function v0(e, t, r) {
...
function ef(e, t, r, n, i) {
  ...
  wr.stat(s, { bigint: !0 }, (c, l) => c ? c.code === "ENOENT" ? i() : i(c) : _n(t, l) ? i(new Error(ki(e, r, n))) : ef(e, t, s, n, i));
}
function tf(e, t, r, n) {
...
const ke = De, Zr = se, w0 = ot.mkdirs, b0 = Qt.pathExists, S0 = Zu.utimesMillis, en = Ar;
function C0(e, t, r, n) {
  typeof r == "function" && !n ? (n = r, r = {}) : typeof r == "function" && (r = { filter: r }), n = n || function() {
    ...
    "Warning",
    "fs-extra-WARN0001"
  ), en.checkPaths(e, t, "copy", r, (i, a) => {
    if (i) return n(i);
    const { srcStat: s, destStat: c } = a;
    en.checkParentPaths(e, s, t, "copy", (l) => l ? n(l) : r.filter ? rf(Il, c, e, t, r, n) : Il(c, e, t, r, n));
  });
}
function Il(e, t, r, n, i) {
  const a = Zr.dirname(r);
  b0(a, (s, c) => {
    if (s) return i(s);
...
function L0(e, t, r, n, i, a) {
  const s = Zr.join(r, t), c = Zr.join(n, t);
  en.checkPaths(s, c, "copy", i, (l, f) => {
    if (l) return a(l);
    const { destStat: o } = f;
...
function k0(e, t, r, n, i) {
  ke.readlink(t, (a, s) => {
    if (a) return i(a);
    if (n.dereference && (s = Zr.resolve(process.cwd(), s)), e)
      ke.readlink(r, (c, l) => c ? c.code === "EINVAL" || c.code === "UNKNOWN" ? ke.symlink(s, r, i) : i(c) : (n.dereference && (l = Zr.resolve(process.cwd(), l)), en.isSrcSubdir(s, l) ? i(new Error(`Cannot copy '${s}' to a subdirectory of itself, '${l}'.`)) : e.isDirectory() && en.isSrcSubdir(l, s) ? i(new Error(`Cannot overwrite '${l}' with '${s}'.`)) : F0(s, r, i)));
    else
...
var U0 = C0;
const Ce = De, tn = se, M0 = ot.mkdirsSync, $0 = Zu.utimesMillisSync, rn = Ar;
function B0(e, t, r) {
  ...
  const { srcStat: n, destStat: i } = rn.checkPathsSync(e, t, "copy", r);
  return rn.checkParentPathsSync(e, n, t, "copy"), H0(i, e, t, r);
}
function H0(e, t, r, n) {
  if (n.filter && !n.filter(t, r)) return;
  const i = tn.dirname(r);
...
function J0(e, t, r, n) {
  const i = tn.join(t, e), a = tn.join(r, e), { destStat: s } = rn.checkPathsSync(i, a, "copy", n);
  return q0(s, i, a, n);
}
function Q0(e, t, r, n) {
  let i = Ce.readlinkSync(t);
  if (n.dereference && (i = tn.resolve(process.cwd(), i)), e) {
    let a;
    try {
      a = Ce.readlinkSync(r);
    } catch (s) {
    ...
    if (n.dereference && (a = tn.resolve(process.cwd(), a)), rn.isSrcSubdir(i, a))
      throw new Error(`Cannot copy '${i}' to a subdirectory of itself, '${a}'.`);
    if (Ce.statSync(r).isDirectory() && rn.isSrcSubdir(a, i))
...
const Rl = De, uf = se, ee = Bu, nn = process.platform === "win32";
function ff(e) {
  [
    "unlink",
    "chmod",
    ...
    t.unlink(e, (a) => {
      if (a) {
        if (a.code === "ENOENT")
          return r(null);
        if (a.code === "EPERM")
          return nn ? Nl(e, t, a, r) : di(e, t, a, r);
        if (a.code === "EISDIR")
          return di(e, t, a, r);
      }
      return r(a);
...
function n1(e, t) {
  if (ee(e), ee(t), t.readdirSync(e).forEach((r) => hf(uf.join(e, r), t)), nn) {
    const r = Date.now();
    do
      try {
...
const p1 = Re.fromCallback, Ef = se, wt = De, wf = ot, m1 = Qt.pathExists, { areIdentical: bf } = Ar;
function g1(e, t, r) {
  function n(i, a) {
    wt.link(i, a, (s) => {
      if (s) return r(s);
...
const St = se, Yr = De, _1 = Qt.pathExists;
function E1(e, t, r) {
  if (St.isAbsolute(e))
    ...
    }));
  {
    ...
    return _1(i, (a, s) => a ? r(a) : s ? r(null, {
      toCwd: i,
      toDst: e
    }) : Yr.lstat(e, (c) => c ? (c.message = c.message.replace("lstat", "ensureSymlink"), r(c)) : r(null, {
      toCwd: e,
...
const P1 = Re.fromCallback, Cf = se, Ke = Jt, Af = ot, x1 = Af.mkdirs, T1 = Af.mkdirsSync, Pf = b1, I1 = Pf.symlinkPaths, O1 = Pf.symlinkPathsSync, xf = A1, R1 = xf.symlinkType, D1 = xf.symlinkTypeSync, N1 = Qt.pathExists, { areIdentical: Tf } = Ar;
function L1(e, t, r, n) {
...
const Y1 = Re.fromCallback, Xr = De, Rf = se, Df = ot, X1 = Qt.pathExists;
function K1(e, t, r, n) {
  typeof r == "function" && (n = r, r = "utf8");
  const i = Rf.dirname(e);
  X1(i, (a, s) => {
    if (a) return n(a);
    if (s) return Xr.writeFile(e, t, r, n);
    Df.mkdirs(i, (c) => {
      if (c) return n(c);
...
function J1(e, ...t) {
  ...
  Df.mkdirsSync(r), Xr.writeFileSync(e, ...t);
}
var po = {
  outputFile: Y1(K1),
  outputFileSync: J1
...
var om = Oe;
const lm = De, fs = se, cm = uo.copy, Nf = Ui.remove, um = ot.mkdirp, fm = Qt.pathExists, Gl = Ar;
function hm(e, t, r, n) {
...
var mm = hm;
const Lf = De, hs = se, gm = uo.copySync, kf = Ui.removeSync, vm = ot.mkdirpSync, Wl = Ar;
function ym(e, t, r) {
  r = r || {};
...
En.ProgressCallbackTransform = km;
...
const Fm = yn, Um = Nm, Mm = Je, $m = vn, ms = Rt, Bm = xt, Zl = Pr, Hm = En, Ht = (0, Um.default)("electron-builder");
...
`));
    ...
    const f = (l = t.statusCode) !== null && l !== void 0 ? l : 0, o = f >= 300 && f < 400, d = Er(t, "location");
    if (o && d != null) {
      if (s > this.maxRedirects) {
        a(this.createMaxRedirectError());
        return;
      }
      this.doApiRequest(ur.prepareRedirectUrlOptions(d, r), n, c, s).then(i).catch(a);
      return;
    }
    t.setEncoding("utf8");
    let u = "";
    t.on("error", a), t.on("data", (h) => u += h), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const h = Er(t, "content-type"), p = h != null && (Array.isArray(h) ? h.find((m) => m.includes("json")) != null : h.includes("json"));
          a(gs(t, `method: ${r.method || "GET"} url: ${r.protocol || "https:"}//${r.hostname}${r.port ? `:${r.port}` : ""}${r.path}
  ...
  doDownload(t, r, n) {
    const i = this.createRequest(t, (a) => {
      ...
      const s = Er(a, "location");
      if (s != null) {
        n < this.maxRedirects ? this.doDownload(ur.prepareRedirectUrlOptions(s, t), r, n++) : r.callback(this.createMaxRedirectError());
        return;
      }
  ...
  static prepareRedirectUrlOptions(t, r) {
    ...
    if (i != null && i.authorization) {
      const a = ur.reconstructOriginalUrl(r), s = Uf(t, r);
      ur.isCrossOriginRedirect(a, s) && (Ht.enabled && Ht(`Given the cross-origin redirect (from ${a.host} to ${s.host}), the Authorization header will be stripped out.`), delete i.authorization);
    }
    return n;
  }
...
function Vm(e, t) {
  if (!Gm(Er(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const r = [];
...
wn.githubUrl = zm;
wn.githubTagPrefix = Ym;
wn.getS3LikeProviderBaseUrl = Xm;
...
const qf = yn, jf = Pr, eg = "options.name must be either a string or a Buffer", ec = (0, qf.randomBytes)(16);
ec[0] = ec[0] | 1;
const mi = {}, J = [];
for (let e = 0; e < 256; e++) {
...
function tg(e, t, r, n, i = Kr.ASCII) {
...
Sr.nil = new Kt("00000000-0000-0000-0000-000000000000");
var bn = {}, Gf = {};
(function(e) {
  (function(t) {
...
Actual: ` + w.attribValue
    ...
    function X(w, v) {
      if (w.opt.xmlns) {
        ...
        O.ns && Q.ns !== O.ns && Object.keys(O.ns).forEach(function(kn) {
          j(w, "onopennamespace", {
            prefix: kn,
            uri: O.ns[kn]
          });
        ...
        for (var re = 0, oe = w.attribList.length; re < oe; re++) {
          var ye = w.attribList[re], be = ye[0], mt = ye[1], he = k(be, !0), We = he.prefix, aa = he.local, Ln = We === "" ? "" : O.ns[We] || "", Rr = {
            name: be,
            value: mt,
            prefix: We,
            local: aa,
          ...
          ), Rr.uri = We), w.tag.attributes[be] = Rr, j(w, "onattribute", Rr);
        }
...
an.prototype.toString = function(t) {
...
function hg(e, t) {
  ...
  for (l = 1; l <= t.linesBefore && !(s - l < 0); l++)
    f = Oa(
      ...
      d
    ), c = Wr.repeat(" ", t.indent) + Ra((e.line - l + 1).toString(), o) + " | " + f.str + `
` + c;
  for (f = Oa(e.buffer, n[s], i[s], e.position, d), c += Wr.repeat(" ", t.indent) + Ra((e.line + 1).toString(), o) + " | " + f.str + `
`, c += Wr.repeat("-", t.indent + o + 3 + f.pos) + `^
...
}), Vt = Ze, ph = Sn, g2 = dg, v2 = wo, Tt = Object.prototype.hasOwnProperty, Ci = 1, mh = 2, gh = 3, Ai = 4, Na = 1, y2 = 2, ac = 3, _2 = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, E2 = /[\x85\u2028\u2029]/, w2 = /[,\[\]\{\}]/, vh = /^(?:!|!!|![a-z\-]+!)$/i, yh = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function sc(e) {
...
function x2(e, t, r) {
  ...
  if (h = e.input.charCodeAt(e.position), Fe(h) || fr(h) || h === 35 || h === 38 || h === 42 || h === 33 || h === 124 || h === 62 || h === 39 || h === 34 || h === 37 || h === 64 || h === 96 || (h === 63 || h === 45) && (i = e.input.charCodeAt(e.position + 1), Fe(i) || r && fr(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", a = s = e.position, c = !1; h !== 0; ) {
    if (h === 58) {
      if (i = e.input.charCodeAt(e.position + 1), Fe(i) || r && fr(i))
        break;
    } else if (h === 35) {
      if (n = e.input.charCodeAt(e.position - 1), Fe(n))
        break;
    } else {
      if (e.position === e.lineStart && Bi(e) || r && fr(h))
        break;
      if (st(h))
...
function O2(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = c), y = e.input.charCodeAt(++e.position); y !== 0; ) {
    ...
    r ? y === 44 && q(e, "expected the node content, but found ','") : q(e, "missed comma between flow collection entries"), g = m = E = null, d = u = !1, y === 63 && (f = e.input.charCodeAt(e.position + 1), Fe(f) && (d = u = !0, e.position++, ue(e, !0, t))), n = e.line, i = e.lineStart, a = e.position, Cr(e, t, Ci, !1, !0), g = e.tag, m = e.result, ue(e, !0, t), y = e.input.charCodeAt(e.position), (u || e.line === n) && y === 58 && (d = !0, y = e.input.charCodeAt(++e.position), ue(e, !0, t), Cr(e, t, Ci, !1, !0), E = e.result), h ? hr(e, c, p, g, m, E, n, i, a) : d ? c.push(hr(e, null, p, g, m, E, n, i, a)) : c.push(m), ue(e, !0, t), y = e.input.charCodeAt(e.position), y === 44 ? (r = !0, y = e.input.charCodeAt(++e.position)) : r = !1;
  }
...
function uc(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), l = e.input.charCodeAt(e.position); l !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, q(e, "tab characters must not be used in indentation")), !(l !== 45 || (s = e.input.charCodeAt(e.position + 1), !Fe(s)))); ) {
    ...
    if (r = e.line, Cr(e, t, gh, !1, !0), a.push(e.result), ue(e, !0, -1), l = e.input.charCodeAt(e.position), (e.line === r || e.lineIndent > t) && l !== 0)
...
function D2(e, t, r) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = d), y = e.input.charCodeAt(e.position); y !== 0; ) {
    if (!g && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, q(e, "tab characters must not be used in indentation")), n = e.input.charCodeAt(e.position + 1), a = e.line, (y === 63 || y === 58) && Fe(n))
      y === 63 ? (g && (hr(e, d, u, h, p, null, s, c, l), h = p = m = null), E = !0, g = !0, i = !0) : g ? (g = !1, i = !0) : q(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, y = n;
    else {
      if (s = e.line, c = e.lineStart, l = e.position, !Cr(e, r, mh, !1, !0))
        break;
      if (e.line === a) {
        for (y = e.input.charCodeAt(e.position); Yt(y); )
          y = e.input.charCodeAt(++e.position);
        if (y === 58)
          y = e.input.charCodeAt(++e.position), Fe(y) || q(e, "a whitespace character is expected after the key-value separator within a block mapping"), g && (hr(e, d, u, h, p, null, s, c, l), h = p = m = null), E = !0, g = !1, i = !1, h = e.tag, p = e.result;
        else if (E)
    ...
    if ((e.line === a || e.lineIndent > t) && (g && (s = e.line, c = e.lineStart, l = e.position), Cr(e, t, Ai, !0, i) && (g ? p = e.result : m = e.result), g || (hr(e, d, u, h, p, m, s, c, l), h = p = m = null), ue(e, !0, -1), y = e.input.charCodeAt(e.position)), (e.line === a || e.lineIndent > t) && y !== 0)
      q(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return g && hr(e, d, u, h, p, null, s, c, l), E && (e.tag = f, e.anchor = o, e.kind = "mapping", e.result = d), E;
}
function N2(e) {
  var t, r = !1, n = !1, i, a, s;
...
function L2(e) {
  ...
  for (e.anchor !== null && q(e, "duplication of an anchor property"), r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !Fe(r) && !fr(r); )
...
function k2(e) {
  ...
  for (n = e.input.charCodeAt(++e.position), t = e.position; n !== 0 && !Fe(n) && !fr(n); )
...
function F2(e) {
  ...
  if (ue(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, ue(e, !0, -1)) : a && q(e, "directives end mark is expected"), Cr(e, e.lineIndent - 1, Ai, !1, !0), ue(e, !0, -1), e.checkLineBreaks && E2.test(e.input.slice(t, e.position)) && Pi(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Bi(e)) {
...
_o.loadAll = U2;
_o.load = M2;
var Ch = {}, Hi = Ze, Cn = Sn, $2 = wo, Ah = Object.prototype.toString, Ph = Object.prototype.hasOwnProperty, Co = 65279, B2 = 9, sn = 10, H2 = 13, q2 = 32, j2 = 33, G2 = 34, _s = 35, V2 = 37, W2 = 38, z2 = 39, Y2 = 42, xh = 44, X2 = 45, xi = 58, K2 = 61, J2 = 62, Q2 = 63, Z2 = 64, Th = 91, Ih = 93, ev = 96, Oh = 123, tv = 124, Rh = 125, Ae = {};
Ae[0] = "\\0";
Ae[7] = "\\a";
Ae[8] = "\\b";
Ae[9] = "\\t";
...
var sv = 1, on = 2;
function ov(e) {
  this.schema = e.schema || $2, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || !1, this.skipInvalid = e.skipInvalid || !1, this.flowLevel = Hi.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = iv(this.schema, e.styles || null), this.sortKeys = e.sortKeys || !1, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || !1, this.noCompatMode = e.noCompatMode || !1, this.condenseFlow = e.condenseFlow || !1, this.quotingType = e.quotingType === '"' ? on : sv, this.forceQuotes = e.forceQuotes || !1, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function fc(e, t) {
...
function cv(e) {
  return ln(e) && e !== Co && !Ti(e) && e !== X2 && e !== Q2 && e !== xi && e !== xh && e !== Th && e !== Ih && e !== Oh && e !== Rh && e !== _s && e !== W2 && e !== Y2 && e !== j2 && e !== tv && e !== K2 && e !== J2 && e !== z2 && e !== G2 && e !== V2 && e !== Z2 && e !== ev;
}
function uv(e) {
  return !Ti(e) && e !== xi;
}
...
var Nh = 1, ws = 2, Lh = 3, kh = 4, cr = 5;
function fv(e, t, r, n, i, a, s, c) {
  var l, f = 0, o = null, d = !1, u = !1, h = n !== -1, p = -1, m = cv(zr(e, 0)) && uv(zr(e, e.length - 1));
  if (t || s)
  ...
  return !d && !u ? m && !s && !i(e) ? Nh : a === on ? cr : ws : r > 9 && Dh(e) ? cr : s ? a === on ? cr : ws : u ? kh : Lh;
}
function hv(e, t, r, n, i) {
  e.dump = function() {
    if (t.length === 0)
      return e.quotingType === on ? '""' : "''";
...
function pv(e) {
  for (var t = "", r = 0, n, i = 0; i < e.length; r >= 65536 ? i += 2 : i++)
    r = zr(e, i), n = Ae[r], !n && ln(r) ? (t += e[i], r >= 65536 && (t += e[i + 1])) : t += n || av(r);
  return t;
}
function mv(e, t, r) {
  var n = "", i = e.tag, a, s, c;
...
function vc(e, t, r, n) {
  ...
  for (s = 0, c = r.length; s < c; s += 1)
    l = r[s], e.replacer && (l = e.replacer.call(r, String(s), l)), (pt(e, t + 1, l, !0, !0, !1, !0) || typeof l > "u" && pt(e, t + 1, null, !0, !0, !1, !0)) && ((!n || i !== "") && (i += Es(e, t)), e.dump && sn === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
  e.tag = a, e.dump = i || "[]";
}
function gv(e, t, r) {
...
function vv(e, t, r, n) {
  ...
  for (c = 0, l = s.length; c < l; c += 1)
    u = "", (!n || i !== "") && (u += Es(e, t)), f = s[c], o = r[f], e.replacer && (o = e.replacer.call(r, f, o)), pt(e, t + 1, f, !0, !0, !0) && (d = e.tag !== null && e.tag !== "?" || e.dump && e.dump.length > 1024, d && (e.dump && sn === e.dump.charCodeAt(0) ? u += "?" : u += "? "), u += e.dump, d && (u += Es(e, t)), pt(e, t + 1, o, !0, d) && (e.dump && sn === e.dump.charCodeAt(0) ? u += ":" : u += ": ", u += e.dump, i += u));
  e.tag = a, e.dump = i || "{}";
}
function yc(e, t, r) {
  var n, i, a, s, c, l;
    ...
    if (c = i[a], (c.instanceOf || c.predicate) && (!c.instanceOf || typeof t == "object" && t instanceof c.instanceOf) && (!c.predicate || c.predicate(t))) {
      if (r ? c.multi && c.representName ? e.tag = c.representName(t) : e.tag = c.tag : e.tag = "?", c.represent) {
        if (l = e.styleMap[c.tag] || c.defaultStyle, Ah.call(c.represent) === "[object Function]")
          ...
          throw new Cn("!<" + c.tag + '> tag resolver accepts not "' + l + '" style');
        e.dump = n;
      }
      return !0;
    }
...
function pt(e, t, r, n, i, a, s) {
  ...
  if (o && (d = e.duplicates.indexOf(r), u = d !== -1), (e.tag !== null && e.tag !== "?" || u || e.indent !== 2 && t > 0) && (i = !1), u && e.usedDuplicates[d])
    ...
    if (o && u && !e.usedDuplicates[d] && (e.usedDuplicates[d] = !0), c === "[object Object]")
      ...
      throw new Cn("unacceptable kind of an object to dump " + c);
    }
...
const Jn = Gi, { MAX_LENGTH: Ec, MAX_SAFE_INTEGER: Qn } = ji, { safeRe: Zn, t: ei } = An, Dv = Po, { compareIdentifiers: La } = $h;
let Nv = class at {
  constructor(t, r) {
...
var qh = ky;
const Fy = Le, Uy = xr, { safeRe: ti, t: ri } = An, My = (e, t) => {
  if (e instanceof Fy)
    return e;
...
function tt() {
  ...
  const r = Hy, n = new r(), i = Po, a = Wi(), s = Gi, c = Le, {
    ...
    tildeTrimReplace: d,
    caretTrimReplace: u
  } = An, { FLAG_INCLUDE_PRERELEASE: h, FLAG_LOOSE: p } = ji, m = (L) => L.value === "<0.0.0-0", g = (L) => L.value === "", E = (L, D) => {
    let U = !0;
    const R = L.slice();
    let M = R.pop();
    for (; U && R.length; )
...
function Wi() {
  ...
  Fa = t;
  const r = Po, { safeRe: n, t: i } = An, a = qh, s = Gi, c = Le, l = tt();
  return Fa;
}
...
const Dc = tt(), Do = Wi(), { ANY: Ma } = Do, $r = zi, No = et, A8 = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  for (const h of n) {
    if (i && !$r(h, String(i), r) || a && !$r(h, String(a), r))
      return null;
    for (const p of t)
      if (!$r(h, String(p), r))
        return !1;
    ...
    if (o = o || h.operator === ">" || h.operator === ">=", f = f || h.operator === "<" || h.operator === "<=", i) {
      if (u && h.semver.prerelease && h.semver.prerelease.length && h.semver.major === u.major && h.semver.minor === u.minor && h.semver.patch === u.patch && (u = !1), h.operator === ">" || h.operator === ">=") {
        if (c = Lc(i, h, r), c === h && c !== i)
          return !1;
      } else if (i.operator === ">=" && !$r(i.semver, String(h), r))
        return !1;
    }
    if (a) {
      if (d && h.semver.prerelease && h.semver.prerelease.length && h.semver.major === d.major && h.semver.minor === d.minor && h.semver.patch === d.patch && (d = !1), h.operator === "<" || h.operator === "<=") {
        if (l = kc(a, h, r), l === h && l !== a)
          return !1;
      } else if (a.operator === "<=" && !$r(a.semver, String(h), r))
        return !1;
    }
...
var T8 = A8;
const $a = An, Fc = ji, I8 = Le, Uc = $h, O8 = xr, R8 = Uv, D8 = Bv, N8 = qv, L8 = Gv, k8 = zv, F8 = Kv, U8 = Zv, M8 = ry, $8 = et, B8 = sy, H8 = cy, q8 = xo, j8 = dy, G8 = gy, V8 = Vi, W8 = To, z8 = Bh, Y8 = Hh, X8 = Io, K8 = Oo, J8 = qh, Q8 = $y, Z8 = Wi(), e_ = tt(), t_ = zi, r_ = Wy, n_ = Ky, i_ = e8, a_ = n8, s_ = s8, o_ = Ro, l_ = g8, c_ = _8, u_ = w8, f_ = C8, h_ = T8;
var Gh = {
  parse: O8,
  valid: R8,
  clean: D8,
...
(function(e, t) {
  ...
  var bd = Array.prototype, Sd = Function.prototype, Fn = Object.prototype, sa = v["__core-js_shared__"], zo = Sd.toString, it = Fn.hasOwnProperty, Yo = function() {
    var b = /[^.]+$/.exec(sa && sa.keys && sa.keys.IE_PROTO || "");
    return b ? "Symbol(src)_1." + b : "";
  }(), Xo = Fn.toString, Cd = RegExp(
    "^" + zo.call(it).replace(z, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Ko = Q ? v.Buffer : void 0, Un = v.Symbol, Jo = v.Uint8Array, Qo = Fn.propertyIsEnumerable, Ad = bd.splice, Ft = Un ? Un.toStringTag : void 0, Zo = Object.getOwnPropertySymbols, Pd = Ko ? Ko.isBuffer : void 0, xd = Ed(Object.keys, Object), oa = rr(v, "DataView"), Dr = rr(v, "Map"), la = rr(v, "Promise"), ca = rr(v, "Set"), ua = rr(v, "WeakMap"), Nr = rr(Object, "create"), Td = $t(oa), Id = $t(Dr), Od = $t(la), Rd = $t(ca), Dd = $t(ua), el = Un ? Un.prototype : void 0, fa = el ? el.valueOf : void 0;
  function Ut(b) {
  ...
  function Fd(b) {
    var P = this.__data__;
    return Nr ? P[b] !== void 0 : it.call(P, b);
  }
  function Ud(b, P) {
    var N = this.__data__;
    return this.size += this.has(b) ? 0 : 1, N[b] = Nr && P === void 0 ? n : P, this;
  }
  ...
  function Hd(b) {
    return $n(this.__data__, b) > -1;
  }
  function qd(b, P) {
    var N = this.__data__, B = $n(N, b);
  ...
  Mn.prototype.add = Mn.prototype.push = Yd, Mn.prototype.has = Xd;
  function gt(b) {
  ...
  function tp(b, P) {
    var N = Hn(b), B = !N && gp(b), ne = !N && !B && ha(b), Y = !N && !B && !ne && cl(b), le = N || B || ne || Y, me = le ? We(b.length, String) : [], _e = me.length;
    for (var ie in b)
  ...
  function rl(b, P, N, B, ne) {
    return b === P ? !0 : b == null || P == null || !kr(b) && !kr(P) ? b !== b && P !== P : np(b, P, N, B, rl, ne);
  }
  function np(b, P, N, B, ne, Y) {
    var le = Hn(b), me = Hn(P), _e = le ? l : vt(b), ie = me ? l : vt(P);
  ...
  function ap(b) {
    return kr(b) && ol(b.length) && !!G[Lr(b)];
  }
  function sp(b) {
    if (!pp(b))
      return xd(b);
  ...
  function nl(b, P, N, B, ne, Y) {
    ...
    if (ie && Y.get(P))
      return ie == P;
    var Me = -1, ze = !0, Se = N & a ? new Mn() : void 0;
    for (Y.set(b, P), Y.set(P, b); ++Me < me; ) {
      ...
      if (Se) {
        if (!he(P, function(ct, Bt) {
          if (!Ln(Se, Bt) && ($e === ct || ne($e, ct, N, B, Y)))
            return Se.push(Bt);
        })) {
          ze = !1;
          break;
  ...
  function lp(b, P, N, B, ne, Y) {
    ...
    if (Be && !yt) {
      var qn = b.constructor, jn = P.constructor;
      qn != jn && "constructor" in b && "constructor" in P && !(typeof qn == "function" && qn instanceof qn && typeof jn == "function" && jn instanceof jn) && (Be = !1);
    }
  ...
  (oa && vt(new oa(new ArrayBuffer(1))) != j || Dr && vt(new Dr()) != m || la && vt(la.resolve()) != S || ca && vt(new ca()) != I || ua && vt(new ua()) != F) && (vt = function(b) {
    var P = Lr(b), N = P == y ? b.constructor : void 0, B = N ? $t(N) : "";
    if (B)
      switch (B) {
        case Td:
          return j;
  ...
  function pp(b) {
    var P = b && b.constructor, N = typeof P == "function" && P.prototype || Fn;
    return b === N;
  }
  function mp(b) {
    return Xo.call(b);
  ...
  var gp = tl(/* @__PURE__ */ function() {
    ...
    return kr(b) && it.call(b, "callee") && !Qo.call(b, "callee");
  }, Hn = Array.isArray;
  function vp(b) {
...
Pn.createTempUpdateFile = y_;
const p_ = yn, m_ = Je, Mc = d_, qt = Nt, Jr = se;
class g_ {
  constructor(t) {
  ...
  get cacheDirForPendingUpdate() {
    return Jr.join(this.cacheDir, "pending");
  }
  ...
  async getValidCachedUpdateFile(t, r) {
    ...
    const c = Jr.join(this.cacheDirForPendingUpdate, a.fileName);
  ...
  getUpdateInfoFile() {
    return Jr.join(this.cacheDirForPendingUpdate, "update-info.json");
  }
}
Pn.DownloadedUpdateHelper = g_;
...
async function y_(e, t, r) {
  ...
  for (let a = 0; a < 3; a++)
    try {
      ...
      if (s.code === "ENOENT")
        return i;
      r.warn(`Error on remove temp update file: ${s}`), i = Jr.join(t, `${n++}-${e}`);
    }
  return i;
}
var Yi = {}, Lo = {};
...
const ft = de, dr = Gh, z_ = Rt, pr = rt, Cs = fe, Va = /\/tag\/([^/]+)$/;
class Kh extends Cs.Provider {
  constructor(t, r, n) {
    super({
      ...
      isUseMultipleRangeRequest: !1
    }), this.options = t, this.baseUrl = (0, pr.newBaseUrl)((0, ft.githubUrl)(t, r));
    const i = r === "github.com" ? "api.github.com" : r;
    this.baseApiUrl = (0, pr.newBaseUrl)((0, ft.githubUrl)(t, i));
  }
...
class Y_ extends Kh {
  ...
  async getLatestVersion() {
    var t, r, n, i, a;
    const s = new ft.CancellationToken(), c = await this.httpRequest((0, pr.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
      accept: "application/xml, application/atom+xml, text/xml, */*"
    }, s), l = (0, ft.parseXml)(c);
    let f = l.element("entry", !1, "No published versions on GitHub"), o = null;
    try {
      if (this.updater.allowPrerelease) {
        const g = ((t = this.updater) === null || t === void 0 ? void 0 : t.channel) || ((r = dr.prerelease(this.updater.currentVersion)) === null || r === void 0 ? void 0 : r[0]) || null;
        if (g === null)
          ...
          for (const E of l.getElements("entry")) {
            ...
            if (y === null)
              continue;
            const S = y[1], _ = ((n = dr.prerelease(S)) === null || n === void 0 ? void 0 : n[0]) || null, A = !g || ["alpha", "beta"].includes(g), I = _ !== null && !["alpha", "beta"].includes(String(_));
...
${c}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let d, u = "", h = "";
    const p = async (g) => {
      u = (0, pr.getChannelFilename)(g), h = (0, pr.newUrlFromBase)(this.getBaseDownloadPath(String(o), u), this.baseUrl);
    ...
    try {
      let g = this.channel;
      this.updater.allowPrerelease && (!((i = dr.prerelease(o)) === null || i === void 0) && i[0]) && (g = this.getCustomChannelName(String((a = dr.prerelease(o)) === null || a === void 0 ? void 0 : a[0]))), d = await p(g);
    } catch (g) {
      if (this.updater.allowPrerelease)
  ...
  async getLatestTagName(t) {
    const r = this.options, n = r.host == null || r.host === "github.com" ? (0, pr.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new z_.URL(`${this.computeGithubBasePath(`/repos/${r.owner}/${r.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
function Jh(e, t, r, n) {
  ...
  return i.sort((a, s) => dr.rcompare(a.version, s.version));
}
var Ji = {};
...
const sr = de, Q_ = we, Z_ = se, zc = Rt, Yc = rt, e4 = Ot, t4 = fe;
class r4 extends e4.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new sr.CancellationToken(), r = (0, Yc.getChannelFilename)(this.getDefaultChannelName()), n = await this.getLatestVersionInfo(t), i = n.assets.find((c) => c.name === r);
    if (i == null)
    ...
    try {
      ...
      throw c instanceof sr.HttpError && c.statusCode === 404 ? (0, sr.newError)(`Cannot find ${r} in the latest release artifacts (${a}): ${c.stack || c.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : c;
    }
...
Xi.createClient = l4;
const ii = de, n4 = Ki, Xc = xn, i4 = Ot, a4 = Ji, s4 = Qi, o4 = Zi;
function Qh(e) {
...
Tr.DataSplitter = void 0;
Tr.copyData = Zh;
const ai = de, h4 = Je, d4 = vn, p4 = er, Qc = Buffer.from(`\r
\r
`);
var Et;
(function(e) {
...
const Br = de, Ka = Nt, E4 = Je, w4 = Tr, b4 = Rt, si = er, tu = ta, S4 = ra;
class C4 {
  ...
  async doDownloadFile(t, r) {
    ...
    await new Promise((s, c) => {
      ...
      const o = new Br.DigestTransform(this.blockAwareFileInfo.sha512);
      ...
      g.redirect = "manual", h = (E) => {
        ...
        const I = this.httpExecutor.createRequest(g, (T) => {
          ...
          }), T.statusCode >= 400 && c((0, Br.createHttpError)(T)), T.pipe(u, {
            end: !1
          }), T.once("end", () => {
        ...
        I.on("redirect", (T, $, C) => {
          this.logger.info(`Redirect to ${A4(C)}`), m = C, (0, Br.configureRequestUrl)(new b4.URL(m), g), I.followRedirect();
...
const xe = de, T4 = yn, I4 = Li, O4 = Hu, Ye = Nt, R4 = we, Ja = qi, Xe = se, jt = Gh, nu = Pn, D4 = Yi, iu = Vh, N4 = xn, Qa = Xi, Za = ju, L4 = ea, or = Lt;
class ko extends O4.EventEmitter {
  ...
  async executeDownload(t) {
    ...
    this.listenerCount(or.DOWNLOAD_PROGRESS) > 0 && (n.onProgress = (y) => this.emit(or.DOWNLOAD_PROGRESS, y));
  ...
  async differentialDownloadInstaller(t, r, n, i, a) {
    try {
      ...
      this.listenerCount(or.DOWNLOAD_PROGRESS) > 0 && (f.onProgress = (p) => this.emit(or.DOWNLOAD_PROGRESS, p));
      const o = async (p, m) => {
...
In.FileWithEmbeddedBlockMapDifferentialDownloader = void 0;
const lr = Nt, M4 = Tn, $4 = ju;
...
In.FileWithEmbeddedBlockMapDifferentialDownloader = B4;
function td(e) {
...
async function H4(e) {
  ...
  try {
    ...
    return await (0, lr.read)(t, i, 0, i.length, r - n.length - i.length), await (0, lr.close)(t), td(i);
  } catch (r) {
...
const su = de, ou = Ni, q4 = Nt, j4 = Je, Hr = se, G4 = Zt, V4 = In, W4 = fe, lu = Lt;
class z4 extends G4.BaseUpdater {
  ...
  doInstall(t) {
    ...
    (0, j4.unlinkSync)(r);
    let n;
    const i = Hr.basename(r), a = this.installerPath;
    if (a == null)
      return this.dispatchError(new Error("No update filepath provided, can't quit and install")), !1;
    Hr.basename(a) === i || !/\d+\.\d+\.\d+/.test(i) ? n = r : n = Hr.join(Hr.dirname(r), Hr.basename(a)), (0, ou.execFileSync)("mv", ["-f", a, n]), n !== r && this.emit("appimage-filename-updated", n);
    const s = {
      ...process.env,
...
cn.AppImageUpdater = z4;
var un = {}, Ir = {};
Object.defineProperty(Ir, "__esModule", { value: !0 });
Ir.LinuxUpdater = void 0;
const Y4 = Zt;
...
fn.PacmanUpdater = void 0;
const uu = Lt, Q4 = fe, Z4 = Ir;
...
dn.MacUpdater = void 0;
const hu = de, es = Nt, rE = Je, du = se, nE = xp, iE = Pt, aE = fe, pu = Ni, mu = yn;
...
Object.defineProperty(pn, "__esModule", { value: !0 });
pn.NsisUpdater = void 0;
const oi = de, yu = se, fE = Zt, hE = In, _u = Lt, dE = fe, pE = Nt, mE = $o, Eu = Rt;
...
(function(e) {
  ...
  function m() {
    if (process.platform === "win32")
      p = new pn.NsisUpdater();
    else if (process.platform === "darwin")
      p = new dn.MacUpdater();
    else {
      p = new cn.AppImageUpdater();
      try {
...
var Ge = Os.exports, On = {}, Rs = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  var r = te;
...
var NE = Us.exports;
On.__esModule = !0;
On.registerDefaultHelpers = YE;
On.moveHelperToHooks = XE;
function tr(e) {
...
var sd = $s.exports, Or = {};
Or.__esModule = !0;
Or.createProtoAccessControl = iw;
Or.resultIsAllowed = aw;
Or.resetLoggedProperties = ow;
function tw(e) {
  return e && e.__esModule ? e : { default: e };
}
...
var Gt = te, lw = Ge, rs = od(lw), cw = On, uw = Ho, fw = sd, Di = od(fw), hw = Or, dw = "4.7.9";
je.VERSION = dw;
var pw = 8;
...
var bw = te, gr = ww(bw), Sw = Ge, ht = Ew(Sw), dt = je, Su = On, Cw = qo, Cu = Or;
function Aw(e) {
...
function Pw(e, t) {
  ...
  function n(s, c, l) {
    l.hash && (c = gr.extend({}, c, l.hash), l.ids && (l.ids[0] = !0)), s = t.VM.resolvePartial.call(this, s, c, l), l.hooks = this.hooks, l.protoAccessControl = this.protoAccessControl;
...
`);
  ...
  var i = {
    ...
    escapeExpression: gr.escapeExpression,
    invokePartial: n,
    fn: function(c) {
      var l = e[c];
    ...
    mergeIfNeeded: function(c, l) {
      var f = c || l;
      return c && l && c !== l && (f = gr.extend({}, l, c)), f;
    },
  ...
  return a.isTop = !0, a._setup = function(s) {
    if (s.partial)
      ...
      var c = {};
      Au(c, t.helpers, i), Au(c, s.helpers, i), i.helpers = c, e.usePartial && (i.partials = i.mergeIfNeeded(s.partials, t.partials)), (e.usePartial || e.useDecorators) && (i.decorators = gr.extend({}, t.decorators, s.decorators)), i.hooks = {}, i.protoAccessControl = Cu.createProtoAccessControl(s);
...
function Tw(e, t, r) {
  ...
  if (r.fn && r.fn !== ld && function() {
    ...
    }, a.partials && (r.partials = gr.extend({}, r.partials, a.partials));
...
function cd(e, t, r, n, i, a) {
  if (e.decorator) {
    var s = {};
    t = e.decorator(t, s, r, n && n[0], i, a, n), gr.extend(t, s);
  }
  return t;
}
function Au(e, t, r) {
...
var fd = js.exports, Rn = {}, Gs = { exports: {} };
(function(e, t) {
  t.__esModule = !0;
  var r = function() {
    var n = {
...
var zw = Dw, zs = Wo(zw), Yw = Nw, Xw = Wo(Yw), Kw = Ve, Jw = Ww(Kw), Qw = Ge, qr = Wo(Qw), Zw = te;
Rn.parser = zs.default;
var yi = {};
Zw.extend(yi, Jw);
function hd(e, t) {
  if (e.type === "Program")
  ...
  if (e != null) {
    ...
    if (typeof e == "object") {
      if (e.type === "PathExpression") {
        if (!rb(e.depth))
          throw new qr.default("Invalid AST: PathExpression.depth must be an integer");
        if (!Array.isArray(e.parts))
          throw new qr.default("Invalid AST: PathExpression.parts must be an array");
        for (var t = 0; t < e.parts.length; t++)
          if (typeof e.parts[t] != "string")
            throw new qr.default("Invalid AST: PathExpression.parts must only contain strings");
      } else if (e.type === "NumberLiteral") {
        if (typeof e.value != "number" || !isFinite(e.value))
          throw new qr.default("Invalid AST: NumberLiteral.value must be a number");
      } else if (e.type === "BooleanLiteral" && typeof e.value != "boolean")
        throw new qr.default("Invalid AST: BooleanLiteral.value must be a boolean");
...
var nb = Ge, Qr = dd(nb), mn = te, ib = fd, jr = dd(ib), ab = [].slice;
function Xs() {
}
Xs.prototype = {
  compiler: Xs,
  ...
  compile: function(t, r) {
    return this.sourceNode = [], this.opcodes = [], this.children = [], this.options = r, this.stringParams = r.stringParams, this.trackIds = r.trackIds, r.blockParams = r.blockParams || [], r.knownHelpers = mn.extend(/* @__PURE__ */ Object.create(null), {
      helperMissing: !0,
  ...
  accept: function(t) {
    if (!this[t.type])
      throw new Qr.default("Unknown type: " + t.type, t);
  ...
  PartialStatement: function(t) {
    ...
    var n = t.params;
    if (n.length > 1)
      throw new Qr.default("Unsupported number of partial arguments: " + n.length, t);
  ...
  helperSexpr: function(t, r, n) {
    ...
    if (this.options.knownHelpers[s])
      ...
      if (this.options.knownHelpersOnly)
        throw new Qr.default("You specified knownHelpersOnly, but used the unknown helper " + s, t);
      a.strict = !0, a.falsy = !0, this.accept(a), this.opcode("invokeHelper", i.length, a.original, jr.default.helpers.simpleId(a));
    }
  },
  PathExpression: function(t) {
    this.addDepth(t.depth), this.opcode("getContext", t.depth);
    var r = t.parts[0], n = jr.default.helpers.scopedId(t), i = !t.depth && !n && this.blockParamIndex(r);
  ...
  classifySexpr: function(t) {
    var r = jr.default.helpers.simpleId(t.path), n = r && !!this.blockParamIndex(t.path.parts[0]), i = !n && jr.default.helpers.helperExpression(t), a = !n && (i || r);
    if (a && !i) {
  ...
  pushParam: function(t) {
    ...
    if (this.stringParams)
      ...
      if (this.trackIds) {
        var n = void 0;
        if (t.parts && !jr.default.helpers.scopedId(t) && !t.depth && (n = this.blockParamIndex(t.parts[0])), n) {
  ...
  blockParamIndex: function(t) {
    for (var r = 0, n = this.options.blockParams.length; r < n; r++) {
      var i = this.options.blockParams[r], a = i && mn.indexOf(i, t);
      if (i && a >= 0)
        return [r, a];
    }
  }
...
function sb(e, t, r) {
  if (e == null || typeof e != "string" && e.type !== "Program")
    throw new Qr.default("You must pass a string or Handlebars AST to Handlebars.precompile. You passed " + e);
...
function ob(e, t, r) {
  if (t === void 0 && (t = {}), e == null || typeof e != "string" && e.type !== "Program")
    throw new Qr.default("You must pass a string or Handlebars AST to Handlebars.compile. You passed " + e);
  t = mn.extend({}, t), "data" in t || (t.data = !0), t.compat && (t.useDepths = !0);
  var n = void 0;
  function i() {
...
function pd(e, t) {
  if (e === t)
    return !0;
  if (mn.isArray(e) && mn.isArray(t) && e.length === t.length) {
...
var Ks = { exports: {} }, Js = { exports: {} }, Gr = {}, is = {}, ci = {}, ui = {}, xu;
function lb() {
  if (xu) return ui;
  xu = 1;
...
function gd() {
  if (Ou) return ss;
  Ou = 1;
  var e = Nn(), t = Object.prototype.hasOwnProperty, r = typeof Map < "u";
  function n() {
...
function vd() {
  if (Du) return is;
  Du = 1;
  var e = md(), t = Nn(), r = gd().ArraySet, n = cb().MappingList;
  function i(a) {
...
function hb() {
  if (ku) return Vr;
  ku = 1;
  var e = Nn(), t = ub(), r = gd().ArraySet, n = md(), i = fb().quickSort;
  function a(f, o) {
    var d = f;
  ...
  }, Vr.IndexedSourceMapConsumer = l, Vr;
}
var us = {}, Fu;
function db() {
  if (Fu) return us;
  Fu = 1;
  var e = vd().SourceMapGenerator, t = Nn(), r = /(\r?\n)/, n = 10, i = "$$$isSourceNode$$$";
...
var Uu;
function pb() {
  return Uu || (Uu = 1, Gr.SourceMapGenerator = vd().SourceMapGenerator, Gr.SourceMapConsumer = hb().SourceMapConsumer, Gr.SourceNode = db().SourceNode), Gr;
}
(function(e, t) {
  t.__esModule = !0;
  var r = te, n = void 0;
...
(function(e, t) {
  ...
  var n = Rw, i = r(n), a = fd, s = r(a), c = Rn, l = Dn, f = gb, o = r(f), d = jo, u = r(d), h = ud, p = r(h), m = i.default.create;
  function g() {
    var y = m();
...
class Cb {
  ...
  static getTemplateDir() {
    if (process.env.VITE_DEV_SERVER_URL)
      return nr.join(process.cwd(), "public", "pdf_templates");
    {
      const t = process.resourcesPath || nr.join(nr.dirname(At.getAppPath()), "..");
      return nr.join(t, "public", "pdf_templates");
    }
  }
  /**
  ...
  static async loadTemplate(t) {
    const r = this.getTemplateDir(), n = nr.join(r, `${t}.html`);
    if (!Fr.existsSync(n))
      throw new Error(`Sablon nem található: ${t}`);
    const i = Fr.readFileSync(n, "utf-8");
    return Sb.compile(i);
  }
  /**
  ...
  static async generatePdf(t, r) {
    const n = nr.dirname(r);
    Fr.existsSync(n) || Fr.mkdirSync(n, { recursive: !0 });
    const i = new Zs({
      webPreferences: {
        sandbox: !0
      },
    ...
    try {
      ...
      return await Fr.promises.writeFile(r, a), { success: !0, pageCount: Math.max(1, Math.ceil(a.length / 15e3)) };
    } catch (a) {
  ...
  static async saveAndOpen(t, r = !0) {
    if (r)
      try {
        const { default: n } = await import("./index-nDHurHhB.js");
        n(t).catch((i) => {
          console.warn(
...
const gn = ve.dirname(bp(import.meta.url));
process.env.APP_ROOT = ve.join(gn, "..");
...
function _d() {
  W = new Zs({
    ...
    webPreferences: {
      preload: ve.join(gn, "preload.mjs"),
      contextIsolation: !0,
      nodeIntegration: !1,
      sandbox: !1
    },
  ...
  }), Qs ? W.loadURL(Qs) : W.loadFile(ve.join(gn, "../dist/index.html"));
}
function Pb(e) {
...
Qe.handle("run-executable", (e, t, r = []) => new Promise((n, i) => {
  var o, d;
  const a = At.isPackaged ? ve.join(process.resourcesPath, "public") : ve.join(gn, "../public"), s = ve.join(a, t);
...
Qe.handle("open-file", async (e, t) => {
  const r = At.isPackaged ? ve.join(process.resourcesPath, "public") : ve.join(gn, "../public");
