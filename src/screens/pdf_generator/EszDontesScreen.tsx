...
export function EszDontesScreen() {
  ...
  const [inputs, setInputs] = useState<EszDontesInputs>({
    court: '',
    dissolutionDate: '',
  ...
  const setInputValue = (key: keyof EszDontesInputs, value: string) => {
  ...
  const buildPayload = () => {
    ...
    const outputPath = `${outputFolder}\\alapitoi-hatarozat-dontes-${safeCompanyName}.pdf`;
  ...
  return (
    <div className="screen-base pdf-creator-screen">
      <div className="pdf-creator-panel">
        <h2>Alapítói Határozat döntésről</h2>
        ...
        <section className="pdf-creator-section">
          <div className="pdf-creator-options">
            <div className="pdf-creator-input-grid">
              ...
              <LabeledDropdown
                id="esz-dontes-dissolver-person"
              ...
              <LabeledTextInput
                id="esz-dontes-dissolution-date"
